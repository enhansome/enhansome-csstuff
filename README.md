...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 359,256 | 🐛 125 | 📅 2025-08-28
* [The Book of Secret Knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) ⭐ 239,246 | 🐛 166 | 📅 2024-11-19
* [z3](https://github.com/Z3Prover/z3) ⭐ 12,572 | 🐛 61 | 🌐 C++ | 📅 2026-08-19: The Z3 Theorem Prover
...
* [ClickHouse](https://github.com/ClickHouse/ClickHouse) ⭐ 49,345 | 🐛 6,938 | 🌐 C++ | 📅 2026-08-20: is a free analytics DBMS for big data.
...
* [Every Programmer Should Know thinking](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,263 | 🐛 25 | 📅 2025-12-29: A collection of (mostly) technical things every software developer should know
...
* [Prettier is an opinionated code formatter](https://github.com/prettier/prettier) ⭐ 52,207 | 🐛 1,422 | 🌐 JavaScript | 📅 2026-08-19
...
* [dev.to](https://github.com/thepracticaldev/dev.to) ⭐ 22,767 | 🐛 130 | 🌐 Ruby | 📅 2026-08-19: Where programmers share ideas and help each other grow
* [Flow](https://github.com/facebook/flow) ⭐ 22,276 | 🐛 524 | 🌐 Rust | 📅 2026-08-20: Adds static typing to JavaScript to improve developer productivity and code quality.
...
* [vscodium](https://github.com/VSCodium/vscodium) ⭐ 32,892 | 🐛 139 | 🌐 Shell | 📅 2026-08-12: binary releases of VS Code without MS branding/telemetry/licensing
  * [awesome-vscode](https://github.com/viatsko/awesome-vscode) ⭐ 28,960 | 🐛 48 | 🌐 JavaScript | 📅 2026-06-21: art A curated list of delightful VS Code packages and resources.
...
* [CppCoreGuidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,253 | 🐛 246 | 🌐 CSS | 📅 2026-08-06: The C++ Core Guidelines are a set of tried-and-true guidelines, rules, and best practices about coding in C++
* [Microsoft's C++ Standard Library](https://github.com/microsoft/STL) ⭐ 11,132 | 🐛 585 | 🌐 C++ | 📅 2026-08-19: MSVC's implementation of the C++ Standard Library.
* mozilla [rr](https://github.com/mozilla/rr) ⭐ 10,622 | 🐛 480 | 🌐 C++ | 📅 2026-08-16: is a lightweight tool for recording, replaying and debugging execution of applications (trees of processes and threads). Debugging extends gdb with very efficient reverse-execution, which in combination with standard gdb/x86 features like hardware data watchpoints, makes debugging much more fun.
...
* [libpostal](https://github.com/openvenues/libpostal) ⭐ 4,873 | 🐛 299 | 🌐 C | 📅 2026-05-13: A C library for parsing/normalizing street addresses around the world. Powered by statistical NLP and open geo data.
...
* TDD C:
  * [Google Test](https://github.com/google/googletest) ⭐ 38,940 | 🐛 493 | 🌐 C++ | 📅 2026-08-19: Google Testing and Mocking Framework.
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,646 | 🐛 313 | 🌐 JavaScript | 📅 2026-04-08: A simple and modern GTK eBook viewer, built with GJS and Epub.js.
...
* [A curated list of awesome Python frameworks, libraries, software and resources](https://github.com/vinta/awesome-python#authentication) ⭐ 314,982 | 🐛 18 | 🌐 Python | 📅 2026-08-16
* [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) ⭐ 223,883 | 🐛 1,045 | 🌐 Python | 📅 2026-08-03: All Algorithms implemented in Python
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,712 | 🐛 74 | 🌐 Python | 📅 2026-08-19 framework, high performance, easy to learn, fast to code, ready for production
* cython [dtoa.c](https://github.com/python/cpython/blob/master/Python/dtoa.c) ⭐ 74,410 | 🐛 9,543 | 🌐 Python | 📅 2026-08-20
* [Rich](https://github.com/willmcgugan/rich) ⭐ 57,090 | 🐛 371 | 🌐 Python | 📅 2026-06-23 is a Python library for rich text and beautiful formatting in the terminal.
* [black](https://github.com/ambv/black/) ⭐ 41,809 | 🐛 296 | 🌐 Python | 📅 2026-08-19: The uncompromising Python code formatter
...
* [Course Files for Complete Python 3 Bootcamp Course on Udemy](https://github.com/Pierian-Data/Complete-Python-3-Bootcamp) ⭐ 29,719 | 🐛 268 | 🌐 Jupyter Notebook | 📅 2025-06-24
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,290 | 🐛 404 | 🌐 Rust | 📅 2026-08-19A Python Interpreter written in Rust
* [kivy](https://github.com/kivy/kivy) ⭐ 19,003 | 🐛 853 | 🌐 Python | 📅 2026-08-15: Open source UI framework written in Python, running on Windows, Linux, macOS, Android and iOS.
...
* [OpenTelemetry Python](https://github.com/open-telemetry/opentelemetry-python) ⭐ 2,591 | 🐛 396 | 🌐 Python | 📅 2026-08-19: OpenTelemetry Python API and SDK
...
* Agda:
  * [Agda 2](https://github.com/agda/agda) ⭐ 2,916 | 🐛 1,043 | 🌐 Haskell | 📅 2026-08-19
...
* Dafny:
  * [dafny](https://github.com/Microsoft/dafny) ⭐ 3,505 | 🐛 1,377 | 🌐 C# | 📅 2026-08-16: Dafny is a verification-aware programming language.
* Clean:
...
* Go:
  * [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 181,599 | 🐛 214 | 🌐 Go | 📅 2026-08-19: A curated list of awesome Go frameworks, libraries and software
...
* Lua:
  * [xmake](https://github.com/xmake-io/xmake) ⭐ 12,155 | 🐛 247 | 🌐 Lua | 📅 2026-08-18: 🔥 A cross-platform build [utility based on Lua](https://xmake.io)
* Nim:
  * [nim](https://nim-lang.org/): Efficient and expressive programming. [github](https://github.com/nim-lang/nim) ⭐ 18,177 | 🐛 2,189 | 🌐 Nim | 📅 2026-08-19
* Perl:
...
* PHP:
  * [A curated list of bookmarks, packages, tutorials, videos and other cool resources from the Laravel ecosystem](https://github.com/chiraggude/awesome-laravel) ⭐ 13,094 | 🐛 86 | 📅 2024-07-03
...
* V:
  * [V](https://github.com/vlang-io/V) ⭐ 37,797 | 🐛 85 | 🌐 V | 📅 2026-08-19: Simple, fast, safe, compiled language for creating maintainable software. Supports translation from C/C++.
  * [vlang](https://github.com/vlang/v) ⭐ 37,797 | 🐛 85 | 🌐 V | 📅 2026-08-19: Simple, fast, safe, compiled language for developing maintainable software. Supports translation from C and (soon) C++. Compiles itself in <1s.
* Verilog:
...
* Starting Pull Requests:
  * [Awesome First PR Opportunities](https://github.com/MunGell/awesome-for-beginners) ⭐ 88,530 | 🐛 143 | 📅 2026-07-25
...
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,475 | 🐛 1,025 | 🌐 Go | 📅 2026-08-19: simple terminal UI for git commands
* [gitea](https://github.com/go-gitea/gitea) ⭐ 57,501 | 🐛 2,545 | 🌐 Go | 📅 2026-08-20: Git with a cup of tea, painless self-hosted git service
* [gogs](https://github.com/gogs/gogs) ⭐ 47,744 | 🐛 1,010 | 🌐 Go | 📅 2026-08-06: Gogs is a painless self-hosted Git service.
* [github-cli](https://github.com/cli/cli) ⭐ 45,894 | 🐛 1,088 | 🌐 Go | 📅 2026-08-19:  GitHub’s official command line tool
* [husky](https://github.com/typicode/husky) ⭐ 35,277 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19: Git hooks made easy
* [Learn git branching](https://learngitbranching.js.org/): An interactive git visualization to challenge and educate! [github](https://github.com/pcottle/learnGitBranching) ⭐ 33,904 | 🐛 60 | 🌐 JavaScript | 📅 2026-08-19.
* [cz-cli](https://github.com/commitizen/cz-cli) ⭐ 17,499 | 🐛 194 | 🌐 JavaScript | 📅 2026-08-11: The commitizen command line utility.
* [lint-staged](https://github.com/okonet/lint-staged) ⭐ 14,715 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-19: Run linters on git staged files
...
* [Pro Git book](https://git-scm.com/book/en/v2), written by Scott Chacon and Ben Straub ([github](https://github.com/progit/progit2) ⭐ 6,561 | 🐛 219 | 🌐 CSS | 📅 2026-05-25 repo)
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,064 | 🐛 14 | 🌐 Shell | 📅 2026-08-19 is a utility tool for git taking advantage of fuzzy finder fzf. [Interactive Git Commands With Previews Powered By fzf Fuzzy Finder](https://www.linuxuprising.com/2019/11/forgit-interactive-git-commands-with.html)
...
* [SkyWater Open Source PDK](https://github.com/google/skywater-pdk) ⭐ 3,658 | 🐛 199 | 🌐 Python | 📅 2026-07-21: Open source process design kit for usage with SkyWater Technology Foundry's 130nm node.
* [Ariane is a 6-stage RISC-V CPU](https://github.com/pulp-platform/ariane) ⭐ 3,070 | 🐛 269 | 🌐 Assembly | 📅 2026-08-19
* [cva6](https://github.com/openhwgroup/cva6) ⭐ 3,070 | 🐛 269 | 🌐 Assembly | 📅 2026-08-19: The CORE-V CVA6 is an Application class 6-stage RISC-V CPU capable of booting Linux.
...
* [Circuit Simulator](http://www.lushprojects.com/circuitjs/). [github](https://github.com/sharpie7/circuitjs1) ⭐ 2,928 | 🐛 266 | 🌐 Java | 📅 2024-01-22.
...
* [How to create an OS from scratch](https://github.com/cfenollosa/os-tutorial) ⭐ 30,658 | 🐛 130 | 🌐 C | 📅 2026-02-04
* [Mezzano](https://github.com/froggey/Mezzano/) ⭐ 3,884 | 🐛 14 | 🌐 Common Lisp | 📅 2026-08-16: An operating system written in Common Lisp.
* [bootOS](https://github.com/nanochess/bootOS) ⭐ 2,136 | 🐛 0 | 🌐 Assembly | 📅 2026-08-01 is a monolithic operating system in 512 bytes of x86 machine code.
* [Write your Own Virtual Machine](https://justinmeiners.github.io/lc3-vm/) with code repo: [lc3-vm](https://github.com/justinmeiners/lc3-vm) ⭐ 2,086 | 🐛 3 | 🌐 Makefile | 📅 2026-04-02
...
* [GraalVM](https://github.com/oracle/graal) ⭐ 21,666 | 🐛 847 | 🌐 Java | 📅 2026-08-20: GraalVM is a universal virtual machine for running applications written in JavaScript, Python, Ruby, R, JVM-based languages like Java, Scala, Clojure, Kotlin, and LLVM-based languages such as C and C++. [GraalVM Implementation of Python](https://github.com/graalvm/graalpython) ⭐ 1,636 | 🐛 57 | 🌐 Python | 📅 2026-08-19
* [Compiler Explorer](https://godbolt.org/): Run compilers interactively from your web browser and interact with the assembly. [github](https://github.com/mattgodbolt/compiler-explorer) ⭐ 18,991 | 🐛 831 | 🌐 TypeScript | 📅 2026-08-19, [how it works](https://xania.org/201609/how-compiler-explorer-runs-on-amazon).
...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,008 | 🐛 485 | 🌐 C++ | 📅 2026-08-17: Tesseract Open Source OCR Engine (main repository)
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,920 | 🐛 530 | 🌐 Python | 📅 2025-12-05: Ready-to-use OCR with 40+ languages supported including Chinese, Japanese, Korean and Thai.
* [annoy](https://github.com/spotify/annoy) ⭐ 14,289 | 🐛 84 | 🌐 C++ | 📅 2025-10-29: Approximate Nearest Neighbors in C++/Python optimized for memory usage and loading/saving to disk
...
* [faceswap](https://github.com/deepfakes/faceswap) ⭐ 57,469 | 🐛 14 | 🌐 Python | 📅 2026-08-05: Non official project based on original /r/Deepfakes thread. Many thanks to him!
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 164,269 | 🐛 2,390 | 🌐 Python | 📅 2026-08-20: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch.
* [nanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,215 | 🐛 351 | 🌐 Python | 📅 2025-11-12: The simplest, fastest repository for training/finetuning medium-sized GPTs.
* [Industrial-strength Natural Language Processing (NLP) with Python and Cython](https://github.com/explosion/spaCy/) ⭐ 33,832 | 🐛 236 | 🌐 Python | 📅 2026-08-07
...
* [DeepMind Research](https://github.com/deepmind/deepmind-research) ⭐ 15,159 | 🐛 341 | 🌐 Jupyter Notebook | 📅 2026-06-17: This repository contains implementations and illustrative code to accompany DeepMind publications.
...
* [CARLA](https://carla.org): Open-source simulator for [autonomous driving research](https://github.com/carla-simulator/carla) ⭐ 14,303 | 🐛 1,192 | 🌐 C++ | 📅 2026-08-19.
* [Python Machine Learning (2nd Ed.) Code Repository](https://github.com/rasbt/python-machine-learning-book-2nd-edition) ⭐ 7,198 | 🐛 32 | 🌐 Jupyter Notebook | 📅 2020-10-01: The "Python Machine Learning (2nd edition)" book code repository and info resource
* [60\_Days\_RL\_Challenge](https://github.com/andri27-ts/60_Days_RL_Challenge) ⭐ 4,732 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2020-06-30: Learn Deep Reinforcement Learning in depth in 60 days
...
* Autonomous Vehicles:
  * [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,409 | 🐛 780 | 🌐 C++ | 📅 2026-06-30: Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
...
* [mit-deep-learning](https://github.com/lexfridman/mit-deep-learning) ⭐ 10,448 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2024-01-03: Tutorials, assignments, and competitions for MIT Deep Learning related courses.
...
* [DeepLabCut](http://www.mackenziemathislab.org/deeplabcut): is an efficient method for 3D markerless pose estimation based on transfer learning with deep neural networks that achieves excellent results (i.e. you can match human labeling accuracy) with minimal training data (typically 50-200 frames). [repo](https://github.com/DeepLabCut/DeepLabCut) ⭐ 5,738 | 🐛 52 | 🌐 Python | 📅 2026-08-19
...
* [Stable Diffusion](https://github.com/CompVis/stable-diffusion) ⭐ 73,316 | 🐛 618 | 🌐 Jupyter Notebook | 📅 2024-06-18: is a latent text-to-image diffusion model. Thanks to a generous compute donation from Stability AI and support from LAION, we were able to train a Latent Diffusion Model on 512x512 images from a subset of the LAION-5B database.
* [Wan](https://github.com/Wan-Video/Wan2.2) ⭐ 17,203 | 🐛 291 | 🌐 Python | 📅 2026-03-17: Open and Advanced Large-Scale Video Generative Models
* [Bbrain.js](https://github.com/BrainJS/brain.js) ⭐ 14,863 | 🐛 90 | 🌐 TypeScript | 📅 2024-09-26: 🤖 Neural networks in JavaScript
...
* [Image Deduplicator](https://idealo.github.io/imagededup/): [imagededup](https://github.com/idealo/imagededup) ⭐ 5,663 | 🐛 38 | 🌐 Python | 📅 2025-08-15 is a python package that simplifies the task of finding exact and near duplicates in an image collection.
...
* [fiftyone](https://github.com/voxel51/fiftyone) ⭐ 11,017 | 🐛 668 | 🌐 TypeScript | 📅 2026-08-20: The open-source tool for building high-quality datasets and computer vision models
...
*Frameworks for Neural Networks and Deep Learning. See: [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,781 | 🐛 84 | 📅 2025-05-26.*

* [Keras](https://github.com/fchollet/keras) ⭐ 64,242 | 🐛 227 | 🌐 Python | 📅 2026-08-20 - A high-level neural networks library and capable of running on top of either TensorFlow or Theano.
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,490 | 🐛 17,141 | 🌐 Python | 📅 2026-08-20: Tensors and Dynamic neural networks in Python with strong GPU acceleration a ([tour](http://blog.christianperone.com/2018/03/pytorch-internal-architecture-tour/)):
* [tinygrad](https://github.com/geohot/tinygrad) ⭐ 33,469 | 🐛 185 | 🌐 Python | 📅 2026-08-20: You like pytorch? You like [micrograd](https://github.com/karpathy/micrograd) ⭐ 17,201 | 🐛 78 | 🌐 Jupyter Notebook | 📅 2026-08-03? You love tinygrad! ❤️
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,068 | 🐛 3,094 | 🌐 C++ | 📅 2026-08-20 - The most popular Deep Learning framework created by Google.
* [BERT](https://github.com/google-research/bert) ⚠️ Archived: TensorFlow code and pre-trained models for BERT
* [Machine Learning Notebooks](https://github.com/ageron/handson-ml2) ⭐ 29,952 | 🐛 230 | 🌐 Jupyter Notebook | 📅 2026-05-19: A series of Jupyter notebooks that walk you through the fundamentals of Machine Learning and Deep Learning in Python using Scikit-Learn, Keras and TensorFlow 2.
...
* Good channels:
  * [3blue1brown](https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw/): 3blue1brown, by Grant Sanderson, is some combination of math and entertainment, depending on your disposition ([site](https://www.3blue1brown.com/)) and [manim](https://github.com/3b1b/manim) ⭐ 91,731 | 🐛 487 | 🌐 Python | 📅 2026-08-18(Animation engine for explanatory math videos).
...
* [The Data Engineering Cookbook](https://github.com/andkret/Cookbook) ⭐ 15,332 | 🐛 128 | 🌐 Python | 📅 2026-07-23
* [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,290 | 🐛 1,345 | 🌐 Python | 📅 2026-08-19: Official repository for Spyder - The Scientific Python Development Environment
...
* [RAPIDS](http://rapids.ai): Open GPU Data Science. The RAPIDS suite of software libraries gives you the freedom to execute end-to-end data science and analytics pipelines entirely on GPUs. It relies on NVIDIA® CUDA® primitives for low-level compute optimization, but exposes that GPU parallelism and high-bandwidth memory speed through user-friendly Python interfaces. [cuml](https://github.com/rapidsai/cuml) ⭐ 5,255 | 🐛 834 | 🌐 Python | 📅 2026-08-19 - RAPIDS Machine Learning Library.
...
* [insight](https://github.com/easystats/insight) ⭐ 439 | 🐛 60 | 🌐 R | 📅 2026-08-17: Easy access to model information for various model objects.
...
* Python:
  ...
  * [pyjanitor](https://github.com/ericmjl/pyjanitor) ⭐ 1,499 | 🐛 129 | 🌐 Python | 📅 2026-08-20: Python implementation of R package Janitor
...
* R Lang
  * [brms](https://github.com/paul-buerkner/brms) ⭐ 1,422 | 🐛 157 | 🌐 R | 📅 2026-08-19: R package for Bayesian generalized multivariate non-linear multilevel models using Stan
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,758 | 🐛 886 | 🌐 Go | 📅 2026-08-19: The Prometheus monitoring system and time series database.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,122 | 🐛 158 | 🌐 C++ | 📅 2026-08-10: The Time Series Visualization Tool that you deserve.
...
* [amsterdam-schema](https://github.com/Amsterdam/amsterdam-schema) ⭐ 21 | 🐛 5 | 🌐 Python | 📅 2026-08-19: Data modeling & verification for the City of Amsterdam's open data - based on JSON Schema
...
* [ImageMagick creates huge temporary files · Issue #395 · ImageMagick/ImageMagick](https://github.com/ImageMagick/ImageMagick/issues/395) ⭐ 17,186 | 🐛 162 | 🌐 C | 📅 2026-08-19
...
* [OpenSubdiv](http://graphics.pixar.com/opensubdiv/docs/intro.html) ([github](https://github.com/PixarAnimationStudios/OpenSubdiv) ⭐ 3,071 | 🐛 58 | 🌐 C++ | 📅 2026-08-19): is a set of open source libraries that implement high performance subdivision surface (subdiv) evaluation on massively parallel CPU and GPU architectures.
...
* Color Palettes:
  * [wesanderson](https://github.com/karthik/wesanderson) ⭐ 2,148 | 🐛 23 | 🌐 R | 📅 2024-06-13: A Wes Anderson color palette for R.
...
* [jax](https://github.com/google/jax) ⭐ 36,180 | 🐛 2,590 | 🌐 Python | 📅 2026-08-20: Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more
* [micro](https://micro-editor.github.io/): a modern and intuitive [terminal-based text editor](https://github.com/zyedidia/micro#linux-clipboard-support) ⭐ 29,391 | 🐛 1,033 | 🌐 Go | 📅 2026-08-20.
* [pyodide](https://github.com/iodide-project/pyodide) ⭐ 14,795 | 🐛 399 | 🌐 Python | 📅 2026-08-19: The Python scientific stack, compiled to WebAssembly
* [libvips](https://github.com/libvips/libvips) ⭐ 11,581 | 🐛 84 | 🌐 C | 📅 2026-08-18: A fast image processing library with low memory needs.
...
* [Rack](https://github.com/VCVRack/Rack) ⭐ 4,406 | 🐛 307 | 🌐 C++ | 📅 2025-11-04: The virtual Eurorack studio
...
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,956 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13: Easily add particles animations to your website. Compatible also with React, Vue.js (2.x and 3.x), Angular, Svelte, jQuery, Preact, Inferno.
* [Walk through an infinite, procedurally generated city](https://github.com/marian42/wavefunctioncollapse) ⭐ 4,856 | 🐛 9 | 🌐 C# | 📅 2021-03-28
* [An interactive, explorable explanation about the peculiar magic of sound waves.](https://github.com/joshwcomeau/waveforms) ⭐ 1,481 | 🐛 4 | 🌐 JavaScript | 📅 2018-02-21
* [SOFA](https://www.sofa-framework.org/): is an efficient framework dedicated to research, prototyping and development of physics-based simulations. [github](https://github.com/sofa-framework/sofa/) ⭐ 1,245 | 🐛 448 | 🌐 C++ | 📅 2026-08-18.
...
* [Open MCT](https://nasa.github.io/openmct/): is a next-generation mission control framework for visualization of data on desktop and mobile devices - [github](https://github.com/nasa/openmct) ⭐ 13,085 | 🐛 1,068 | 🌐 JavaScript | 📅 2026-08-18
* [fprime](https://github.com/nasa/fprime) ⭐ 11,675 | 🐛 438 | 🌐 C++ | 📅 2026-08-20: A flight software and embedded systems framework.
...
* [MNE-Python](https://github.com/mne-tools/mne-python) ⭐ 3,490 | 🐛 636 | 🌐 Python | 📅 2026-08-19: Magnetoencephalography (MEG) and Electroencephalography (EEG) in Python
...
* [Awesome-Design-Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 40,927 | 🐛 184 | 🌐 JavaScript | 📅 2024-07-28: The best design tools for everything.
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,414 | 🐛 287 | 🌐 C++ | 📅 2026-08-19:Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
...
* [gb-studio](https://github.com/chrismaltby/gb-studio) ⭐ 9,373 | 🐛 789 | 🌐 TypeScript | 📅 2026-08-19: A free and easy to use retro adventure game creator for your favourite [handheld video game system](https://www.gbstudio.dev)
* [sm64](https://github.com/n64decomp/sm64) ⭐ 8,727 | 🐛 28 | 🌐 C | 📅 2024-02-04: A Super Mario 64 decompilation, brought to you by a bunch of clever folks.
...
* [Citybound](https://github.com/citybound/citybound) ⭐ 8,149 | 🐛 153 | 🌐 Rust | 📅 2023-01-07: Citybound is a city building game with a focus on realism, collaborative planning and simulation of microscopic details.
* [OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,421 | 🐛 50 | 🌐 C++ | 📅 2026-08-12: A Framework for Reinforcement Learning in Games.
...
* [Clspv](https://github.com/google/clspv) ⭐ 725 | 🐛 89 | 🌐 LLVM | 📅 2026-08-19 is a prototype compiler for a subset of OpenCL C to Vulkan compute shaders.
...
* [veyon](https://github.com/veyon/veyon/) ⭐ 1,927 | 🐛 221 | 🌐 C++ | 📅 2026-08-19: Cross-platform computer monitoring and classroom management.

## Studies

* [Path to a free self-taught education in Computer Science!](https://github.com/ossu/computer-science) ⭐ 208,187 | 🐛 25 | 🌐 HTML | 📅 2026-07-14
* [the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,550 | 🐛 200 | 🌐 Jupyter Notebook | 📅 2026-05-20: One has no future if one couldn't teach themself.
...
* [Awesome Accessibility](https://github.com/brunopulis/awesome-a11y) ⭐ 1,977 | 🐛 58 | 📅 2026-08-03: A curate list about A11Y
...
* [FreshRSS](https://github.com/FreshRSS/FreshRSS) ⭐ 15,803 | 🐛 658 | 🌐 PHP | 📅 2026-08-19: A free, self-hostable aggregator…
* guardian [frontend](https://github.com/guardian/frontend) ⭐ 5,897 | 🐛 197 | 🌐 Scala | 📅 2026-08-19: Source for theguardian.com
...
* [Apache Flink](https://github.com/apache/flink) ⭐ 26,272 | 🐛 376 | 🌐 Java | 📅 2026-08-19: Apache Flink is an open source stream processing framework with powerful stream- and batch-processing capabilities.
* [lists](https://github.com/jnv/lists) ⭐ 11,421 | 🐛 21 | 📅 2026-03-23: The definitive list of lists (of lists) curated on GitHub
* [awesome-uses](https://github.com/wesbos/awesome-uses) ⭐ 5,299 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-17: A list of /uses pages that detail apps and gear used by professional web developers.
...
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 364,936 | 🐛 608 | 🌐 Python | 📅 2026-03-20: Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 359,256 | 🐛 125 | 📅 2025-08-28: A complete computer science study plan to become a software engineer.
* [GitHub Résumé](https://github.com/resume/resume.github.com) ⭐ 62,883 | 🐛 76 | 🌐 JavaScript | 📅 2023-02-15
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 51,421 | 🐛 12 | 🌐 JavaScript | 📅 2026-06-06: Companies that don't have a broken hiring process.
...
* [OpenResume](https://www.open-resume.com/) Create a professional resume easily with this free, open-source, and powerful [resume builder](https://github.com/xitanggg/open-resume) ⭐ 8,845 | 🐛 141 | 🌐 TypeScript | 📅 2024-10-29.
* [linux-sysadmin-interview-questions](https://github.com/chassing/linux-sysadmin-interview-questions) ⭐ 5,329 | 🐛 7 | 📅 2024-03-11: Collection of Linux Sysadmin/DevOps interview questions
...
* [awesome-scifi](https://github.com/sindresorhus/awesome-scifi) ⭐ 5,011 | 🐛 0 | 📅 2025-12-22: I asked on Twitter for recommendations as I want to get into reading Sci-Fi novels. The below is the result. Thanks everyone for recommending your favorites! :)
...
* [📚 Freely available programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 394,805 | 🐛 81 | 🌐 Python | 📅 2026-08-18
