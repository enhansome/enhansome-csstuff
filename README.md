...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 360,468 | 🐛 126 | 📅 2025-08-28
* [The Book of Secret Knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) ⭐ 242,416 | 🐛 170 | 📅 2024-11-19
* [z3](https://github.com/Z3Prover/z3) ⭐ 12,647 | 🐛 41 | 🌐 C++ | 📅 2026-09-07: The Z3 Theorem Prover
...
* [ClickHouse](https://github.com/ClickHouse/ClickHouse) ⭐ 49,678 | 🐛 7,400 | 🌐 C++ | 📅 2026-09-07: is a free analytics DBMS for big data.
* [HikariCP](https://github.com/brettwooldridge/HikariCP) ⭐ 21,202 | 🐛 544 | 🌐 Java | 📅 2026-06-14: 光 HikariCP・A solid, high-performance, JDBC connection pool at last.
...
* [pgFormatter](https://github.com/darold/pgFormatter) ⭐ 1,953 | 🐛 19 | 🌐 PLpgSQL | 📅 2026-09-06: A PostgreSQL SQL syntax beautifier that can work as a console program or as a CGI. On-line demo [site](http://sqlformat.darold.net/)
...
* [Every Programmer Should Know thinking](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,389 | 🐛 25 | 📅 2025-12-29: A collection of (mostly) technical things every software developer should know
...
* [Prettier is an opinionated code formatter](https://github.com/prettier/prettier) ⭐ 52,238 | 🐛 1,420 | 🌐 JavaScript | 📅 2026-09-07
...
* [dev.to](https://github.com/thepracticaldev/dev.to) ⭐ 22,775 | 🐛 133 | 🌐 Ruby | 📅 2026-09-05: Where programmers share ideas and help each other grow
* [Flow](https://github.com/facebook/flow) ⭐ 22,285 | 🐛 524 | 🌐 Rust | 📅 2026-09-06: Adds static typing to JavaScript to improve developer productivity and code quality.
* [Quine Relay](https://github.com/mame/quine-relay) ⭐ 14,594 | 🐛 18 | 🌐 Ruby | 📅 2026-09-01: An uroboros program with 100+ programming languages.
...
* (pt-br) [OsProgramadores](https://osprogramadores.com) - [op-desafios](https://github.com/OsProgramadores/op-desafios) ⭐ 159 | 🐛 3 | 🌐 C | 📅 2026-09-06: Soluções para os desafios (por usuário)
...
* [vscodium](https://github.com/VSCodium/vscodium) ⭐ 33,148 | 🐛 140 | 🌐 Shell | 📅 2026-09-07: binary releases of VS Code without MS branding/telemetry/licensing
  * [awesome-vscode](https://github.com/viatsko/awesome-vscode) ⭐ 29,011 | 🐛 57 | 🌐 JavaScript | 📅 2026-06-21: art A curated list of delightful VS Code packages and resources.
...
* GDB:
  * [gdbgui](https://github.com/cs01/gdbgui/) ⭐ 10,351 | 🐛 180 | 🌐 TypeScript | 📅 2025-06-29: Browser-based frontend to gdb (gnu debugger). Add breakpoints, view the stack, visualize data structures, and more in C, C++, Go, Rust, and Fortran. Run gdbgui from the terminal and a new tab will open in your browser.
...
* [CppCoreGuidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,308 | 🐛 246 | 🌐 CSS | 📅 2026-08-06: The C++ Core Guidelines are a set of tried-and-true guidelines, rules, and best practices about coding in C++
* [Microsoft's C++ Standard Library](https://github.com/microsoft/STL) ⭐ 11,144 | 🐛 595 | 🌐 C++ | 📅 2026-09-06: MSVC's implementation of the C++ Standard Library.
* mozilla [rr](https://github.com/mozilla/rr) ⭐ 10,644 | 🐛 482 | 🌐 C++ | 📅 2026-08-16: is a lightweight tool for recording, replaying and debugging execution of applications (trees of processes and threads). Debugging extends gdb with very efficient reverse-execution, which in combination with standard gdb/x86 features like hardware data watchpoints, makes debugging much more fun.
...
* [memory-profiler](https://github.com/nokia/memory-profiler) ⭐ 4,808 | 🐛 52 | 🌐 C | 📅 2023-07-28
* [Checked C](https://github.com/microsoft/checkedc) ⭐ 3,259 | 🐛 74 | 🌐 C | 📅 2024-10-07 is an extension to C that adds checking to detect or prevent common programming errors such as buffer overruns and out-of-bounds memory accesses. This repo has a wiki for Checked C, sample code, the specification, and test code.
...
* [libtcod](https://github.com/libtcod/libtcod) ⭐ 1,223 | 🐛 27 | 🌐 C | 📅 2026-07-20: The official repository for libtcod. A roguelike development library.
...
* TDD C:
  * [Google Test](https://github.com/google/googletest) ⭐ 39,499 | 🐛 501 | 🌐 C++ | 📅 2026-09-03: Google Testing and Mocking Framework.
...
* [Makefile Tutorial by Example](https://makefiletutorial.com/) and [repo](https://github.com/theicfire/makefiletutorial) ⭐ 5,977 | 🐛 8 | 🌐 SCSS | 📅 2025-06-02
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,689 | 🐛 318 | 🌐 JavaScript | 📅 2026-04-08: A simple and modern GTK eBook viewer, built with GJS and Epub.js.
...
* [A curated list of awesome Python frameworks, libraries, software and resources](https://github.com/vinta/awesome-python#authentication) ⭐ 318,909 | 🐛 18 | 🌐 Python | 📅 2026-09-01
* [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) ⭐ 224,327 | 🐛 776 | 🌐 Python | 📅 2026-09-06: All Algorithms implemented in Python
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,163 | 🐛 92 | 🌐 Python | 📅 2026-09-01 framework, high performance, easy to learn, fast to code, ready for production
* cython [dtoa.c](https://github.com/python/cpython/blob/master/Python/dtoa.c) ⭐ 76,053 | 🐛 9,640 | 🌐 Python | 📅 2026-09-06
* [Rich](https://github.com/willmcgugan/rich) ⭐ 57,334 | 🐛 375 | 🌐 Python | 📅 2026-06-23 is a Python library for rich text and beautiful formatting in the terminal.
* [black](https://github.com/ambv/black/) ⭐ 41,830 | 🐛 309 | 🌐 Python | 📅 2026-09-04: The uncompromising Python code formatter
* [wtfpython](https://github.com/satwikkansal/wtfpython#-is-not--is-not-is-not-) ⭐ 37,074 | 🐛 72 | 🌐 Python | 📅 2026-01-13: A collection of surprising Python snippets and lesser-known features.
* [wtfpython](https://github.com/satwikkansal/wtfpython) ⭐ 37,074 | 🐛 72 | 🌐 Python | 📅 2026-01-13: What the f\*ck Python? ￼
* [Course Files for Complete Python 3 Bootcamp Course on Udemy](https://github.com/Pierian-Data/Complete-Python-3-Bootcamp) ⭐ 29,755 | 🐛 272 | 🌐 Jupyter Notebook | 📅 2025-06-24
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,337 | 🐛 396 | 🌐 Rust | 📅 2026-09-07A Python Interpreter written in Rust
* [kivy](https://github.com/kivy/kivy) ⭐ 19,019 | 🐛 848 | 🌐 Python | 📅 2026-09-03: Open source UI framework written in Python, running on Windows, Linux, macOS, Android and iOS.
* [Modular visual interface for GDB in Python](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,246 | 🐛 19 | 🌐 Python | 📅 2026-07-17
...
* [alive-progress](https://github.com/rsalmei/alive-progress) ⭐ 6,302 | 🐛 21 | 🌐 Python | 📅 2026-05-24: An animated and smart Progress Bar for python.
...
* [cinder](https://github.com/facebookincubator/cinder) ⭐ 3,791 | 🐛 31 | 🌐 Python | 📅 2026-09-06
...
* [OpenTelemetry Python](https://github.com/open-telemetry/opentelemetry-python) ⭐ 2,618 | 🐛 410 | 🌐 Python | 📅 2026-09-07: OpenTelemetry Python API and SDK
* [austin](https://github.com/P403n1x87/austin) ⭐ 2,208 | 🐛 9 | 🌐 C | 📅 2026-09-04: Python frame stack sampler for CPython. Austin has a [tui](https://github.com/P403n1x87/austin-tui) ⭐ 665 | 🐛 2 | 🌐 Python | 📅 2026-06-04: The top-like text-based user interface for Austin.
...
* [vyper](https://github.com/ethereum/vyper/) ⭐ 5,181 | 🐛 637 | 🌐 Python | 📅 2026-09-06:
...
* Agda:
  * [Agda 2](https://github.com/agda/agda) ⭐ 2,927 | 🐛 1,037 | 🌐 Haskell | 📅 2026-09-06
...
* Answer Set Programming(ASP): offers a simple and powerful modeling language to solve combinatorial problems.
  * [Potassco](https://potassco.org/), [clingo](https://potassco.org/clingo/) and [github](https://github.com/potassco/clingo) ⭐ 830 | 🐛 19 | 🌐 C++ | 📅 2026-09-02.
* Brainfuck:
  * [Brainfuck](https://www.dcode.fr/brainfuck-language) encoder/decoder.
* Dafny:
  * [dafny](https://github.com/Microsoft/dafny) ⭐ 3,531 | 🐛 1,386 | 🌐 C# | 📅 2026-08-31: Dafny is a verification-aware programming language.
* Clean:
...
* Elixir:
  * [Nerves](https://github.com/nerves-project/nerves) ⭐ 2,487 | 🐛 21 | 🌐 Elixir | 📅 2026-09-06: Craft and deploy bulletproof embedded software in Elixir. [official site](http://nerves-project.org)
...
* Go:
  * [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 183,374 | 🐛 224 | 🌐 Go | 📅 2026-09-06: A curated list of awesome Go frameworks, libraries and software
  * [lattigo](https://github.com/lca1/lattigo) ⭐ 1,443 | 🐛 11 | 🌐 Go | 📅 2026-06-16: A lattice-based cryptographic library in Go.
...
* Java:
  ...
  * [Procyon](https://github.com/mstrobel/procyon) ⭐ 1,215 | 🐛 59 | 🌐 Java | 📅 2022-06-12: is a suite of Java metaprogramming tools, including a rich reflection API, a LINQ-inspired expression tree API for runtime code generation, and a Java decompiler.
* JavaScript:
...
* Lua:
  * [xmake](https://github.com/xmake-io/xmake) ⭐ 12,201 | 🐛 250 | 🌐 Lua | 📅 2026-09-06: 🔥 A cross-platform build [utility based on Lua](https://xmake.io)
* Nim:
  * [nim](https://nim-lang.org/): Efficient and expressive programming. [github](https://github.com/nim-lang/nim) ⭐ 18,217 | 🐛 2,189 | 🌐 Nim | 📅 2026-09-04
* Perl:
...
* PHP:
  * [A curated list of bookmarks, packages, tutorials, videos and other cool resources from the Laravel ecosystem](https://github.com/chiraggude/awesome-laravel) ⭐ 13,096 | 🐛 88 | 📅 2024-07-03
...
* V:
  * [V](https://github.com/vlang-io/V) ⭐ 37,817 | 🐛 113 | 🌐 V | 📅 2026-09-07: Simple, fast, safe, compiled language for creating maintainable software. Supports translation from C/C++.
  * [vlang](https://github.com/vlang/v) ⭐ 37,817 | 🐛 113 | 🌐 V | 📅 2026-09-07: Simple, fast, safe, compiled language for developing maintainable software. Supports translation from C and (soon) C++. Compiles itself in <1s.
* Verilog:
...
* [kompare](https://github.com/KDE/kompare) ⭐ 59 | 🐛 0 | 🌐 C++ | 📅 2026-09-06: Graphical File Differences Tool
...
* Starting Pull Requests:
  * [Awesome First PR Opportunities](https://github.com/MunGell/awesome-for-beginners) ⭐ 89,047 | 🐛 152 | 📅 2026-07-25
...
* [.gitignore](https://github.com/github/gitignore) ⭐ 175,638 | 🐛 74 | 📅 2026-09-04: A collection of useful .gitignore templates
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,084 | 🐛 1,029 | 🌐 Go | 📅 2026-09-06: simple terminal UI for git commands
* [gitea](https://github.com/go-gitea/gitea) ⭐ 57,854 | 🐛 2,520 | 🌐 Go | 📅 2026-09-07: Git with a cup of tea, painless self-hosted git service
* [gogs](https://github.com/gogs/gogs) ⭐ 47,806 | 🐛 1,010 | 🌐 Go | 📅 2026-09-06: Gogs is a painless self-hosted Git service.
* [github-cli](https://github.com/cli/cli) ⭐ 46,179 | 🐛 1,080 | 🌐 Go | 📅 2026-09-05:  GitHub’s official command line tool
* [husky](https://github.com/typicode/husky) ⭐ 35,306 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19: Git hooks made easy
* [Learn git branching](https://learngitbranching.js.org/): An interactive git visualization to challenge and educate! [github](https://github.com/pcottle/learnGitBranching) ⭐ 34,006 | 🐛 61 | 🌐 JavaScript | 📅 2026-09-07.
* [cz-cli](https://github.com/commitizen/cz-cli) ⭐ 17,499 | 🐛 195 | 🌐 JavaScript | 📅 2026-09-04: The commitizen command line utility.
* [lint-staged](https://github.com/okonet/lint-staged) ⭐ 14,731 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-05: Run linters on git staged files
...
* [Pro Git book](https://git-scm.com/book/en/v2), written by Scott Chacon and Ben Straub ([github](https://github.com/progit/progit2) ⭐ 6,578 | 🐛 220 | 🌐 CSS | 📅 2026-05-25 repo)
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,076 | 🐛 10 | 🌐 Shell | 📅 2026-09-05 is a utility tool for git taking advantage of fuzzy finder fzf. [Interactive Git Commands With Previews Powered By fzf Fuzzy Finder](https://www.linuxuprising.com/2019/11/forgit-interactive-git-commands-with.html)
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,935 | 🐛 36 | 🌐 Python | 📅 2026-07-06: Manage multiple git repos side by side for sanity
* [Git4Noobs](https://github.com/DanielHe4rt/git4noobs) ⭐ 1,613 | 🐛 3 | 📅 2024-09-28
* [Forge](https://github.com/magit/forge/) ⭐ 1,574 | 🐛 6 | 🌐 Emacs Lisp | 📅 2026-09-01: Work with Git forges from the comfort of Magit
...
* GitHub Profiles:
  * [Awesome Readme Stats](https://github.com/anmol098/waka-readme-stats) ⭐ 3,990 | 🐛 68 | 🌐 Python | 📅 2026-08-24
...
* [SkyWater Open Source PDK](https://github.com/google/skywater-pdk) ⭐ 3,696 | 🐛 200 | 🌐 Python | 📅 2026-07-21: Open source process design kit for usage with SkyWater Technology Foundry's 130nm node.
* [Ariane is a 6-stage RISC-V CPU](https://github.com/pulp-platform/ariane) ⭐ 3,091 | 🐛 275 | 🌐 Assembly | 📅 2026-09-07
* [cva6](https://github.com/openhwgroup/cva6) ⭐ 3,091 | 🐛 275 | 🌐 Assembly | 📅 2026-09-07: The CORE-V CVA6 is an Application class 6-stage RISC-V CPU capable of booting Linux.
...
* [RARS](https://github.com/TheThirdOne/rars) ⭐ 1,631 | 🐛 77 | 🌐 Java | 📅 2024-07-19: RISC-V Assembler and Runtime Simulator.
* [The Zip CPU](https://github.com/ZipCPU/zipcpu) ⭐ 1,580 | 🐛 3 | 🌐 Verilog | 📅 2026-08-19: A small, light weight, RISC CPU soft core
...
* [VGChips](https://github.com/furrtek/VGChips) ⭐ 229 | 🐛 23 | 🌐 Verilog | 📅 2026-09-06: Video Game custom chips reverse-engineered from silicon.
...
* [Circuit Simulator](http://www.lushprojects.com/circuitjs/). [github](https://github.com/sharpie7/circuitjs1) ⭐ 2,947 | 🐛 265 | 🌐 Java | 📅 2024-01-22.
...
* [How to create an OS from scratch](https://github.com/cfenollosa/os-tutorial) ⭐ 30,695 | 🐛 130 | 🌐 C | 📅 2026-02-04
* [Mezzano](https://github.com/froggey/Mezzano/) ⭐ 3,893 | 🐛 14 | 🌐 Common Lisp | 📅 2026-08-16: An operating system written in Common Lisp.
* [bootOS](https://github.com/nanochess/bootOS) ⭐ 2,140 | 🐛 0 | 🌐 Assembly | 📅 2026-08-01 is a monolithic operating system in 512 bytes of x86 machine code.
...
* [EmuTOS](https://github.com/emutos/emutos) ⭐ 302 | 🐛 14 | 🌐 C | 📅 2026-08-30: is a Free operating system for Atari computers, and more.
...
* [GraalVM](https://github.com/oracle/graal) ⭐ 21,689 | 🐛 849 | 🌐 Java | 📅 2026-09-06: GraalVM is a universal virtual machine for running applications written in JavaScript, Python, Ruby, R, JVM-based languages like Java, Scala, Clojure, Kotlin, and LLVM-based languages such as C and C++. [GraalVM Implementation of Python](https://github.com/graalvm/graalpython) ⭐ 1,641 | 🐛 66 | 🌐 Python | 📅 2026-09-04
* [Compiler Explorer](https://godbolt.org/): Run compilers interactively from your web browser and interact with the assembly. [github](https://github.com/mattgodbolt/compiler-explorer) ⭐ 19,049 | 🐛 843 | 🌐 TypeScript | 📅 2026-09-06, [how it works](https://xania.org/201609/how-compiler-explorer-runs-on-amazon).
...
* [porcupine](https://github.com/anishathalye/porcupine/) ⭐ 1,246 | 🐛 4 | 🌐 Go | 📅 2026-08-06: A fast linearizability checker written in Go
...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,371 | 🐛 483 | 🌐 C++ | 📅 2026-09-02: Tesseract Open Source OCR Engine (main repository)
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,977 | 🐛 530 | 🌐 Python | 📅 2025-12-05: Ready-to-use OCR with 40+ languages supported including Chinese, Japanese, Korean and Thai.
* [annoy](https://github.com/spotify/annoy) ⭐ 14,294 | 🐛 86 | 🌐 C++ | 📅 2025-10-29: Approximate Nearest Neighbors in C++/Python optimized for memory usage and loading/saving to disk
...
* [faceswap](https://github.com/deepfakes/faceswap) ⭐ 57,529 | 🐛 14 | 🌐 Python | 📅 2026-08-05: Non official project based on original /r/Deepfakes thread. Many thanks to him!
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 164,924 | 🐛 2,414 | 🌐 Python | 📅 2026-09-06: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch.
* [nanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,867 | 🐛 348 | 🌐 Python | 📅 2025-11-12: The simplest, fastest repository for training/finetuning medium-sized GPTs.
* [Industrial-strength Natural Language Processing (NLP) with Python and Cython](https://github.com/explosion/spaCy/) ⭐ 33,877 | 🐛 239 | 🌐 Python | 📅 2026-08-24
...
* [Language Interpretability Tool (LIT)](https://github.com/pair-code/lit/) ⭐ 3,667 | 🐛 138 | 🌐 TypeScript | 📅 2026-07-29: Interactively analyze NLP models for model understanding in an extensible and framework agnostic interface.
* [PromptSource](https://github.com/bigscience-workshop/promptsource) ⭐ 3,033 | 🐛 44 | 🌐 Python | 📅 2023-10-23
* [Argdown](https://argdown.org/): A simple syntax for complex argumentation. [argdown repo](https://github.com/christianvoigt/argdown) ⭐ 1,036 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-06
...
* Python NLTK:
  * [ToTTo](https://github.com/google-research-datasets/totto) ⭐ 469 | 🐛 6 | 📅 2024-09-11: ToTTo is an open-domain English table-to-text dataset with over 120,000 training examples that proposes a controlled generation task: given a Wikipedia table and a set of highlighted table cells, produce a one-sentence description. We hope it can serve as a useful research benchmark for high-precision conditional text generation.
...
* [google-10000-english](https://github.com/first20hours/google-10000-english) ⭐ 4,472 | 🐛 28 | 📅 2023-05-17: This repo contains a list of the 10,000 most common English words in order of frequency, as determined by n-gram frequency analysis of the Google's Trillion Word Corpus.
...
* [Real-Time Voice Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning) ⭐ 60,122 | 🐛 177 | 🌐 Python | 📅 2026-03-09: Clone a voice in 5 seconds to generate arbitrary speech in real-time
...
* [DeepMind Research](https://github.com/deepmind/deepmind-research) ⭐ 15,185 | 🐛 358 | 🌐 Jupyter Notebook | 📅 2026-06-17: This repository contains implementations and illustrative code to accompany DeepMind publications.
* [vosk-api](https://github.com/alphacep/vosk-api) ⭐ 15,106 | 🐛 604 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API for Android, iOS, Raspberry Pi and servers with Python, Java, C# and Node.
* [CARLA](https://carla.org): Open-source simulator for [autonomous driving research](https://github.com/carla-simulator/carla) ⭐ 14,369 | 🐛 1,202 | 🌐 C++ | 📅 2026-09-06.
...
* [GAN Lab](https://poloclub.github.io/ganlab/): Play with Generated Adversarial Networks (GANs) in your browser! [repo](https://github.com/poloclub/ganlab) ⭐ 1,536 | 🐛 27 | 🌐 JavaScript | 📅 2026-03-22
...
* Autonomous Vehicles:
  * [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,457 | 🐛 780 | 🌐 C++ | 📅 2026-06-30: Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
...
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,357 | 🐛 828 | 🌐 C# | 📅 2026-09-06: is an open source and cross-platform machine learning framework for .NET.
* [DeepLabCut](http://www.mackenziemathislab.org/deeplabcut): is an efficient method for 3D markerless pose estimation based on transfer learning with deep neural networks that achieves excellent results (i.e. you can match human labeling accuracy) with minimal training data (typically 50-200 frames). [repo](https://github.com/DeepLabCut/DeepLabCut) ⭐ 5,760 | 🐛 43 | 🌐 Python | 📅 2026-09-04
...
* [Stable Diffusion](https://github.com/CompVis/stable-diffusion) ⭐ 73,391 | 🐛 618 | 🌐 Jupyter Notebook | 📅 2024-06-18: is a latent text-to-image diffusion model. Thanks to a generous compute donation from Stability AI and support from LAION, we were able to train a Latent Diffusion Model on 512x512 images from a subset of the LAION-5B database.
* [Wan](https://github.com/Wan-Video/Wan2.2) ⭐ 17,411 | 🐛 297 | 🌐 Python | 📅 2026-03-17: Open and Advanced Large-Scale Video Generative Models
...
* [Image Deduplicator](https://idealo.github.io/imagededup/): [imagededup](https://github.com/idealo/imagededup) ⭐ 5,666 | 🐛 39 | 🌐 Python | 📅 2025-08-15 is a python package that simplifies the task of finding exact and near duplicates in an image collection.
* [tensorspace](https://github.com/tensorspace-team/tensorspace) ⭐ 5,194 | 🐛 28 | 🌐 JavaScript | 📅 2022-12-05: Neural network 3D visualization framework, build interactive and intuitive model in browsers, support pre-trained deep learning models from TensorFlow, Keras, TensorFlow\.js
* [Handwriting Synthesis](https://github.com/sjvasquez/handwriting-synthesis) ⭐ 4,809 | 🐛 63 | 🌐 Python | 📅 2024-01-11
...
* [NEST](https://github.com/nest/nest-simulator) ⭐ 664 | 🐛 231 | 🌐 C++ | 📅 2026-09-03: NEST is a simulator for spiking neural network models that focuses on the dynamics, size and structure of neural systems rather than on the exact morphology of individual neurons.
...
* [fiftyone](https://github.com/voxel51/fiftyone) ⭐ 11,060 | 🐛 678 | 🌐 TypeScript | 📅 2026-09-07: The open-source tool for building high-quality datasets and computer vision models
...
*Frameworks for Neural Networks and Deep Learning. See: [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,871 | 🐛 85 | 📅 2025-05-26.*

* [Keras](https://github.com/fchollet/keras) ⭐ 64,319 | 🐛 212 | 🌐 Python | 📅 2026-09-05 - A high-level neural networks library and capable of running on top of either TensorFlow or Theano.
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,826 | 🐛 17,562 | 🌐 Python | 📅 2026-09-07: Tensors and Dynamic neural networks in Python with strong GPU acceleration a ([tour](http://blog.christianperone.com/2018/03/pytorch-internal-architecture-tour/)):
* [tinygrad](https://github.com/geohot/tinygrad) ⭐ 33,564 | 🐛 192 | 🌐 Python | 📅 2026-09-07: You like pytorch? You like [micrograd](https://github.com/karpathy/micrograd) ⭐ 17,417 | 🐛 80 | 🌐 Jupyter Notebook | 📅 2026-08-03? You love tinygrad! ❤️
...
* [pytorch-kaldi](https://github.com/mravanelli/pytorch-kaldi) ⭐ 2,406 | 🐛 26 | 🌐 Python | 📅 2022-03-14 is a project for developing state-of-the-art DNN/RNN hybrid speech recognition systems. The DNN part is managed by pytorch, while feature extraction, label computation, and decoding are performed with the kaldi toolkit.
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 198,915 | 🐛 3,134 | 🌐 C++ | 📅 2026-09-07 - The most popular Deep Learning framework created by Google.
* [BERT](https://github.com/google-research/bert) ⚠️ Archived: TensorFlow code and pre-trained models for BERT
* [Machine Learning Notebooks](https://github.com/ageron/handson-ml2) ⭐ 29,953 | 🐛 229 | 🌐 Jupyter Notebook | 📅 2026-05-19: A series of Jupyter notebooks that walk you through the fundamentals of Machine Learning and Deep Learning in Python using Scikit-Learn, Keras and TensorFlow 2.
...
* [Ludwig](https://github.com/uber/ludwig) ⭐ 11,749 | 🐛 1 | 🌐 Python | 📅 2026-08-31: [is a toolbox built](https://uber.github.io/ludwig/) on top of TensorFlow that allows to train and test deep learning models without the need to write code.
...
* [tensorFlow Privacy](https://github.com/tensorflow/privacy) ⭐ 2,031 | 🐛 136 | 🌐 Python | 📅 2026-08-26: Library for training machine learning models with privacy for training data
...
* [Queueing theory](https://github.com/joelparkerhenderson/queueing_theory) ⭐ 2,238 | 🐛 1 | 📅 2026-06-07: an introduction for software development.
...
* Good channels:
  * [3blue1brown](https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw/): 3blue1brown, by Grant Sanderson, is some combination of math and entertainment, depending on your disposition ([site](https://www.3blue1brown.com/)) and [manim](https://github.com/3b1b/manim) ⭐ 93,314 | 🐛 494 | 🌐 Python | 📅 2026-09-01(Animation engine for explanatory math videos).
...
* [The Data Engineering Cookbook](https://github.com/andkret/Cookbook) ⭐ 15,405 | 🐛 129 | 🌐 Python | 📅 2026-07-23
* [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,310 | 🐛 1,344 | 🌐 Python | 📅 2026-09-04: Official repository for Spyder - The Scientific Python Development Environment
...
* [RAPIDS](http://rapids.ai): Open GPU Data Science. The RAPIDS suite of software libraries gives you the freedom to execute end-to-end data science and analytics pipelines entirely on GPUs. It relies on NVIDIA® CUDA® primitives for low-level compute optimization, but exposes that GPU parallelism and high-bandwidth memory speed through user-friendly Python interfaces. [cuml](https://github.com/rapidsai/cuml) ⭐ 5,271 | 🐛 811 | 🌐 Python | 📅 2026-09-06 - RAPIDS Machine Learning Library.
...
* [insight](https://github.com/easystats/insight) ⭐ 441 | 🐛 61 | 🌐 R | 📅 2026-09-05: Easy access to model information for various model objects.
...
* Python:
  ...
  * [arviz](https://github.com/arviz-devs/arviz) ⭐ 1,851 | 🐛 111 | 🌐 TeX | 📅 2026-09-04: Python package to plot and analyse samples from probabilistic models
  ...
  * [pyjanitor](https://github.com/ericmjl/pyjanitor) ⭐ 1,497 | 🐛 155 | 🌐 Python | 📅 2026-09-05: Python implementation of R package Janitor
  ...
  * [Python Plotting for Exploratory Data Analysis](https://pythonplot.com/)  by [Tim Hopper](https://twitter.com/tdhopper/status/1212821555710963712) [repo](https://github.com/tdhopper/pythonplot.com) ⭐ 114 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-09-02
...
* Jupyter:
  * [jupyter-themes](https://github.com/dunovank/jupyter-themes) ⭐ 9,816 | 🐛 205 | 🌐 CSS | 📅 2025-06-22: Custom Jupyter Notebook Themes
  * [jupytext](https://github.com/mwouts/jupytext) ⭐ 7,241 | 🐛 169 | 🌐 Python | 📅 2026-09-05: Jupyter notebooks as Markdown documents, Julia, Python or R scripts
  * [The Jupyter Notebooks behind: "A Whirlwind Tour of Python"](https://github.com/jakevdp/WhirlwindTourOfPython) ⭐ 4,039 | 🐛 25 | 🌐 Jupyter Notebook | 📅 2024-01-31
  * [nbviewer](https://github.com/jupyter/nbviewer) ⭐ 2,280 | 🐛 192 | 🌐 Python | 📅 2026-09-04 as a web service: Render Jupyter Notebooks as static web pages.
  ...
  * [nbtutor](https://github.com/lgpage/nbtutor) ⭐ 472 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-06: Visualize Python code execution (line-by-line) in Jupyter Notebook cells.
...
* R Lang
  * [brms](https://github.com/paul-buerkner/brms) ⭐ 1,426 | 🐛 156 | 🌐 R | 📅 2026-09-04: R package for Bayesian generalized multivariate non-linear multilevel models using Stan
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,979 | 🐛 904 | 🌐 Go | 📅 2026-09-07: The Prometheus monitoring system and time series database.
* [dart](https://github.com/unit8co/darts) ⭐ 9,509 | 🐛 229 | 🌐 Python | 📅 2026-09-04: A python library for easy manipulation and forecasting of time series.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,155 | 🐛 163 | 🌐 C++ | 📅 2026-08-10: The Time Series Visualization Tool that you deserve.
...
* [amsterdam-schema](https://github.com/Amsterdam/amsterdam-schema) ⭐ 21 | 🐛 6 | 🌐 Python | 📅 2026-09-04: Data modeling & verification for the City of Amsterdam's open data - based on JSON Schema
...
* [ImageMagick creates huge temporary files · Issue #395 · ImageMagick/ImageMagick](https://github.com/ImageMagick/ImageMagick/issues/395) ⭐ 17,356 | 🐛 162 | 🌐 C | 📅 2026-09-07
* [roughViz](https://github.com/jwilber/roughViz) ⭐ 7,154 | 🐛 13 | 🌐 JavaScript | 📅 2024-04-26: Reusable JavaScript library for creating sketchy/hand-drawn styled charts in the browser.
...
* [vedo](https://github.com/marcomusy/vedo) ⭐ 2,267 | 🐛 172 | 🌐 Python | 📅 2026-08-04: A python module for scientific analysis of 3D objects based on VTK and numpy
* [Pseudo-bandlimited pixel art filtering in 3D – a mathematical derivation](http://themaister.net/blog/2018/08/25/pseudo-bandlimited-pixel-art-filtering-in-3d-a-mathematical-derivation/) [github](https://github.com/Themaister/Granite) ⭐ 1,941 | 🐛 4 | 🌐 C++ | 📅 2026-08-31
...
* GGplot2:
  ...
  * [ggalluvial](https://github.com/corybrunson/ggalluvial) ⭐ 522 | 🐛 21 | 🌐 R | 📅 2026-07-31
...
* [jax](https://github.com/google/jax) ⭐ 36,262 | 🐛 2,518 | 🌐 Python | 📅 2026-09-07: Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more
* [micro](https://micro-editor.github.io/): a modern and intuitive [terminal-based text editor](https://github.com/zyedidia/micro#linux-clipboard-support) ⭐ 29,535 | 🐛 975 | 🌐 Go | 📅 2026-09-07.
* [pyodide](https://github.com/iodide-project/pyodide) ⭐ 14,819 | 🐛 398 | 🌐 Python | 📅 2026-09-07: The Python scientific stack, compiled to WebAssembly
...
* [bild](https://github.com/anthonynsimon/bild) ⭐ 4,210 | 🐛 18 | 🌐 Go | 📅 2026-08-01: A collection of parallel image processing algorithms in pure Go
* [programmers-introduction-to-mathematics](https://github.com/pim-book/programmers-introduction-to-mathematics) ⭐ 3,651 | 🐛 10 | 🌐 JavaScript | 📅 2023-03-04: Code for [A Programmer's Introduction to Mathematics](https://pimbook.org)
...
* [hatetris](https://github.com/qntm/hatetris) ⭐ 894 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-02: Tetris which always gives you the worst piece
* [alcFreeliner](https://github.com/maxdee/alc_freeliner) ⭐ 123 | 🐛 18 | 🌐 Processing | 📅 2022-01-26: [live geometric animation tool powerhouse](https://freeliner.xyz)
...
* [Rack](https://github.com/VCVRack/Rack) ⭐ 4,411 | 🐛 307 | 🌐 C++ | 📅 2025-11-04: The virtual Eurorack studio
* [Sonic Visualiser](https://www.sonicvisualiser.org/) is a free, open-source application for Windows, Linux, and Mac, designed to be the first program you reach for when want to study a music recording closely. It's designed for musicologists, archivists, signal-processing researchers, and anyone else looking for a friendly way to look at what lies inside the audio file. [github repo](https://github.com/sonic-visualiser/sonic-visualiser) ⭐ 892 | 🐛 84 | 🌐 C++ | 📅 2025-12-07
...
* [This program generates bitmaps that are locally similar to the input bitmap](https://github.com/mxgmn/WaveFunctionCollapse) ⭐ 25,311 | 🐛 9 | 🌐 C# | 📅 2026-03-22
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,978 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-02: Easily add particles animations to your website. Compatible also with React, Vue.js (2.x and 3.x), Angular, Svelte, jQuery, Preact, Inferno.
* [Walk through an infinite, procedurally generated city](https://github.com/marian42/wavefunctioncollapse) ⭐ 4,859 | 🐛 9 | 🌐 C# | 📅 2021-03-28
* [An interactive, explorable explanation about the peculiar magic of sound waves.](https://github.com/joshwcomeau/waveforms) ⭐ 1,481 | 🐛 4 | 🌐 JavaScript | 📅 2018-02-21
* [SOFA](https://www.sofa-framework.org/): is an efficient framework dedicated to research, prototyping and development of physics-based simulations. [github](https://github.com/sofa-framework/sofa/) ⭐ 1,253 | 🐛 458 | 🌐 C++ | 📅 2026-09-07.
...
* [gqrx](https://gqrx.dk/): is an open source software defined radio receiver (SDR) powered by the GNU Radio and the Qt graphical toolkit. [Gqrx](https://github.com/csete/gqrx) ⭐ 3,672 | 🐛 265 | 🌐 C++ | 📅 2026-08-06
...
* [Open MCT](https://nasa.github.io/openmct/): is a next-generation mission control framework for visualization of data on desktop and mobile devices - [github](https://github.com/nasa/openmct) ⭐ 13,112 | 🐛 1,087 | 🌐 JavaScript | 📅 2026-09-05
* [fprime](https://github.com/nasa/fprime) ⭐ 11,731 | 🐛 434 | 🌐 C++ | 📅 2026-09-06: A flight software and embedded systems framework.
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,630 | 🐛 14 | 🌐 HTML | 📅 2026-09-03: A build-it-yourself, 6-wheel rover based on the rovers on Mars!
...
* [MNE-Python](https://github.com/mne-tools/mne-python) ⭐ 3,502 | 🐛 626 | 🌐 Python | 📅 2026-09-04: Magnetoencephalography (MEG) and Electroencephalography (EEG) in Python
...
* [S2Geometry](http://s2geometry.io/): S2 is a library for spherical geometry that aims to have the same robustness, flexibility, and performance as the very best planar geometry libraries [github](https://github.com/google/s2geometry) ⭐ 2,722 | 🐛 79 | 🌐 C++ | 📅 2026-08-25.
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 945 | 🐛 21 | 🌐 R | 📅 2026-09-04: Easy access to shapefiles of the Brazilian Institute of Geography and Statistics (IBGE) and other official spatial data sets of Brazil.
...
* [Awesome-Design-Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 41,117 | 🐛 200 | 🌐 JavaScript | 📅 2024-07-28: The best design tools for everything.
...
* [This is a collection of simple to more involved examples to scripting in Blender with Python.](https://github.com/njanakiev/blender-scripting/blob/master/README.md#phyllotaxis-flower) ⭐ 823 | 🐛 2 | 🌐 Python | 📅 2021-09-28
...
* [gb-studio](https://github.com/chrismaltby/gb-studio) ⭐ 9,396 | 🐛 799 | 🌐 TypeScript | 📅 2026-09-06: A free and easy to use retro adventure game creator for your favourite [handheld video game system](https://www.gbstudio.dev)
* [sm64](https://github.com/n64decomp/sm64) ⭐ 8,755 | 🐛 28 | 🌐 C | 📅 2024-02-04: A Super Mario 64 decompilation, brought to you by a bunch of clever folks.
* [MarkovJunior](https://github.com/mxgmn/MarkovJunior) ⭐ 8,183 | 🐛 9 | 🌐 C# | 📅 2026-03-20: Probabilistic PL based on pattern matching and constraint propagation, 148 examples.
* [Citybound](https://github.com/citybound/citybound) ⭐ 8,158 | 🐛 153 | 🌐 Rust | 📅 2023-01-07: Citybound is a city building game with a focus on realism, collaborative planning and simulation of microscopic details.
* [OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,466 | 🐛 52 | 🌐 C++ | 📅 2026-08-31: A Framework for Reinforcement Learning in Games.
* [Zelda 3 in C](https://github.com/snesrev/zelda3) ⭐ 4,750 | 🐛 88 | 🌐 C | 📅 2023-12-27: A reimplementation of Zelda 3.
* [The Comprehensive Kerbal Archive Network (CKAN)](https://github.com/KSP-CKAN/CKAN) ⭐ 2,637 | 🐛 86 | 🌐 C# | 📅 2026-07-17
* [Synfig Studio](https://github.com/synfig/synfig/) ⭐ 2,293 | 🐛 725 | 🌐 C++ | 📅 2026-09-06: This is the Official source code repository of the Synfig project.
* [Hypersomnia](https://github.com/TeamHypersomnia/Hypersomnia) ⭐ 1,636 | 🐛 13 | 🌐 C++ | 📅 2026-09-04: Multiplayer top-down shooter made from scratch. Comes with an in-game Editor!
* [toy](https://github.com/hugoam/toy) ⭐ 1,593 | 🐛 13 | 🌐 C++ | 📅 2021-04-25: the thin c++ game engine - [toyengine](https://hugoam.github.io/toy-io/).
* [SDLPoP](https://github.com/NagyD/SDLPoP) ⭐ 1,279 | 🐛 80 | 🌐 C | 📅 2025-12-24: An open-source port of Prince of Persia, based on the disassembly of the DOS version.
* [quinesanek](https://github.com/taylorconor/quinesnake) ⭐ 926 | 🐛 1 | 🌐 C++ | 📅 2019-07-27: A quine that plays snake over its own source!
* [Links Awakening DX Disassembly](https://github.com/zladx/LADX-Disassembly) ⭐ 900 | 🐛 18 | 🌐 Assembly | 📅 2026-08-27: Disassembly of Legend of Zelda: Links Awakening DX.
* [wick editor](https://www.wickeditor.com/): [The Wick Editor is a free](https://github.com/Wicklets/wick-editor) ⭐ 843 | 🐛 186 | 🌐 JavaScript | 📅 2023-03-06, open-source tool for creating games, animations, and everything in-between!
* [Clspv](https://github.com/google/clspv) ⭐ 728 | 🐛 64 | 🌐 LLVM | 📅 2026-09-04 is a prototype compiler for a subset of OpenCL C to Vulkan compute shaders.
...
* [veyon](https://github.com/veyon/veyon/) ⭐ 1,940 | 🐛 222 | 🌐 C++ | 📅 2026-08-26: Cross-platform computer monitoring and classroom management.

## Studies

* [Path to a free self-taught education in Computer Science!](https://github.com/ossu/computer-science) ⭐ 208,780 | 🐛 27 | 🌐 HTML | 📅 2026-07-14
* [the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,764 | 🐛 200 | 🌐 Jupyter Notebook | 📅 2026-05-20: One has no future if one couldn't teach themself.
...
* [Awesome Accessibility](https://github.com/brunopulis/awesome-a11y) ⭐ 1,985 | 🐛 72 | 📅 2026-08-03: A curate list about A11Y
...
* [FreshRSS](https://github.com/FreshRSS/FreshRSS) ⭐ 15,938 | 🐛 663 | 🌐 PHP | 📅 2026-09-06: A free, self-hostable aggregator…
* guardian [frontend](https://github.com/guardian/frontend) ⭐ 5,899 | 🐛 213 | 🌐 Scala | 📅 2026-09-04: Source for theguardian.com
...
* [umbrella](https://github.com/thi-ng/umbrella) ⭐ 3,827 | 🐛 62 | 🌐 TypeScript | 📅 2026-09-05: ⛱ Mono-repository of \~50 TypeScript/ES6 projects for modern web development
...
* [Sanic](https://github.com/sanic-org/sanic) ⭐ 18,642 | 🐛 148 | 🌐 Python | 📅 2026-07-29: Async Python 3.7+ web server/framework | Build fast. Run fast.
...
* [Differential Privacy](https://github.com/google/differential-privacy) ⭐ 3,352 | 🐛 62 | 🌐 Go | 📅 2026-09-02: This project contains a C++ library of ε-differentially private algorithms, which can be used to produce aggregate statistics over numeric data sets containing private or sensitive information.
...
* [Apache Flink](https://github.com/apache/flink) ⭐ 26,324 | 🐛 379 | 🌐 Java | 📅 2026-09-06: Apache Flink is an open source stream processing framework with powerful stream- and batch-processing capabilities.
* [lists](https://github.com/jnv/lists) ⭐ 11,461 | 🐛 25 | 📅 2026-03-23: The definitive list of lists (of lists) curated on GitHub
* [awesome-uses](https://github.com/wesbos/awesome-uses) ⭐ 5,300 | 🐛 30 | 🌐 JavaScript | 📅 2026-09-04: A list of /uses pages that detail apps and gear used by professional web developers.
...
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 368,405 | 🐛 613 | 🌐 Python | 📅 2026-03-20: Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 360,468 | 🐛 126 | 📅 2025-08-28: A complete computer science study plan to become a software engineer.
* [GitHub Résumé](https://github.com/resume/resume.github.com) ⭐ 62,895 | 🐛 76 | 🌐 JavaScript | 📅 2023-02-15
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 51,951 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-24: Companies that don't have a broken hiring process.
...
* [test-your-sysadmin-skills](https://github.com/trimstray/test-your-sysadmin-skills) ⭐ 11,852 | 🐛 19 | 📅 2024-11-19
* [OpenResume](https://www.open-resume.com/) Create a professional resume easily with this free, open-source, and powerful [resume builder](https://github.com/xitanggg/open-resume) ⭐ 8,888 | 🐛 143 | 🌐 TypeScript | 📅 2024-10-29.
...
* [awesome-scifi](https://github.com/sindresorhus/awesome-scifi) ⭐ 5,031 | 🐛 0 | 📅 2025-12-22: I asked on Twitter for recommendations as I want to get into reading Sci-Fi novels. The below is the result. Thanks everyone for recommending your favorites! :)
...
* [📚 Freely available programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 396,149 | 🐛 78 | 🌐 Python | 📅 2026-09-06
