...
* [PortalData](https://github.com/weecology/PortalData) ⭐ 52 | 🐛 6 | 🌐 R | 📅 2026-09-21 (Official Repo of the Portal Project Data) and [livedat](https://github.com/weecology/livedat) ⭐ 13 | 🐛 2 | 🌐 R | 📅 2019-01-30 (Template for living data workflow ).
...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 361,740 | 🐛 126 | 📅 2025-08-28
* [The Book of Secret Knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) ⭐ 245,415 | 🐛 171 | 📅 2024-11-19
* [z3](https://github.com/Z3Prover/z3) ⭐ 12,706 | 🐛 52 | 🌐 C++ | 📅 2026-09-23: The Z3 Theorem Prover
...
* [ClickHouse](https://github.com/ClickHouse/ClickHouse) ⭐ 50,028 | 🐛 7,891 | 🌐 C++ | 📅 2026-09-23: is a free analytics DBMS for big data.
* [HikariCP](https://github.com/brettwooldridge/HikariCP) ⭐ 21,225 | 🐛 544 | 🌐 Java | 📅 2026-06-14: 光 HikariCP・A solid, high-performance, JDBC connection pool at last.
...
* [Every Programmer Should Know thinking](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,474 | 🐛 28 | 📅 2025-12-29: A collection of (mostly) technical things every software developer should know
...
* [Prettier is an opinionated code formatter](https://github.com/prettier/prettier) ⭐ 52,301 | 🐛 1,448 | 🌐 JavaScript | 📅 2026-09-23
...
* [dev.to](https://github.com/thepracticaldev/dev.to) ⭐ 22,780 | 🐛 140 | 🌐 Ruby | 📅 2026-09-23: Where programmers share ideas and help each other grow
* [Flow](https://github.com/facebook/flow) ⭐ 22,295 | 🐛 514 | 🌐 Rust | 📅 2026-09-22: Adds static typing to JavaScript to improve developer productivity and code quality.
...
* [vscodium](https://github.com/VSCodium/vscodium) ⭐ 33,345 | 🐛 147 | 🌐 Shell | 📅 2026-09-16: binary releases of VS Code without MS branding/telemetry/licensing
  * [awesome-vscode](https://github.com/viatsko/awesome-vscode) ⭐ 29,065 | 🐛 64 | 🌐 JavaScript | 📅 2026-06-21: art A curated list of delightful VS Code packages and resources.
...
* [CppCoreGuidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,328 | 🐛 247 | 🌐 CSS | 📅 2026-08-06: The C++ Core Guidelines are a set of tried-and-true guidelines, rules, and best practices about coding in C++
* [Microsoft's C++ Standard Library](https://github.com/microsoft/STL) ⭐ 11,152 | 🐛 594 | 🌐 C++ | 📅 2026-09-22: MSVC's implementation of the C++ Standard Library.
...
* TDD C:
  * [Google Test](https://github.com/google/googletest) ⭐ 39,573 | 🐛 510 | 🌐 C++ | 📅 2026-09-17: Google Testing and Mocking Framework.
...
* [Makefile Tutorial by Example](https://makefiletutorial.com/) and [repo](https://github.com/theicfire/makefiletutorial) ⭐ 5,991 | 🐛 8 | 🌐 SCSS | 📅 2025-06-02
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,757 | 🐛 321 | 🌐 JavaScript | 📅 2026-04-08: A simple and modern GTK eBook viewer, built with GJS and Epub.js.
...
* [A curated list of awesome Python frameworks, libraries, software and resources](https://github.com/vinta/awesome-python#authentication) ⭐ 322,388 | 🐛 21 | 🌐 Python | 📅 2026-09-22
* [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) ⭐ 224,888 | 🐛 173 | 🌐 Python | 📅 2026-09-22: All Algorithms implemented in Python
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,544 | 🐛 86 | 🌐 Python | 📅 2026-09-18 framework, high performance, easy to learn, fast to code, ready for production
* cython [dtoa.c](https://github.com/python/cpython/blob/master/Python/dtoa.c) ⭐ 77,240 | 🐛 9,707 | 🌐 Python | 📅 2026-09-23
* [Rich](https://github.com/willmcgugan/rich) ⭐ 57,418 | 🐛 379 | 🌐 Python | 📅 2026-06-23 is a Python library for rich text and beautiful formatting in the terminal.
* [black](https://github.com/ambv/black/) ⭐ 41,851 | 🐛 294 | 🌐 Python | 📅 2026-09-22: The uncompromising Python code formatter
...
* [Course Files for Complete Python 3 Bootcamp Course on Udemy](https://github.com/Pierian-Data/Complete-Python-3-Bootcamp) ⭐ 29,783 | 🐛 274 | 🌐 Jupyter Notebook | 📅 2025-06-24
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,352 | 🐛 398 | 🌐 Rust | 📅 2026-09-23A Python Interpreter written in Rust
* [kivy](https://github.com/kivy/kivy) ⭐ 19,023 | 🐛 846 | 🌐 Python | 📅 2026-09-22: Open source UI framework written in Python, running on Windows, Linux, macOS, Android and iOS.
* [Modular visual interface for GDB in Python](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,255 | 🐛 19 | 🌐 Python | 📅 2026-07-17
...
* [cinder](https://github.com/facebookincubator/cinder) ⭐ 3,794 | 🐛 31 | 🌐 Python | 📅 2026-09-22
...
* [OpenTelemetry Python](https://github.com/open-telemetry/opentelemetry-python) ⭐ 2,643 | 🐛 416 | 🌐 Python | 📅 2026-09-22: OpenTelemetry Python API and SDK
...
* [vyper](https://github.com/ethereum/vyper/) ⭐ 5,181 | 🐛 625 | 🌐 Python | 📅 2026-09-21:
...
* Agda:
  * [Agda 2](https://github.com/agda/agda) ⭐ 2,931 | 🐛 1,054 | 🌐 Haskell | 📅 2026-09-22
...
* Answer Set Programming(ASP): offers a simple and powerful modeling language to solve combinatorial problems.
  * [Potassco](https://potassco.org/), [clingo](https://potassco.org/clingo/) and [github](https://github.com/potassco/clingo) ⭐ 835 | 🐛 14 | 🌐 C++ | 📅 2026-09-22.
* Brainfuck:
  * [Brainfuck](https://www.dcode.fr/brainfuck-language) encoder/decoder.
* Dafny:
  * [dafny](https://github.com/Microsoft/dafny) ⭐ 3,552 | 🐛 1,391 | 🌐 C# | 📅 2026-09-20: Dafny is a verification-aware programming language.
* Clean:
...
* Go:
  * [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 185,196 | 🐛 230 | 🌐 Go | 📅 2026-09-22: A curated list of awesome Go frameworks, libraries and software
  * [lattigo](https://github.com/lca1/lattigo) ⭐ 1,448 | 🐛 14 | 🌐 Go | 📅 2026-09-22: A lattice-based cryptographic library in Go.
...
* JavaScript:
  * [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,798 | 🐛 407 | 🌐 JavaScript | 📅 2026-07-26: Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
...
* Lua:
  * [xmake](https://github.com/xmake-io/xmake) ⭐ 12,228 | 🐛 260 | 🌐 Lua | 📅 2026-09-22: 🔥 A cross-platform build [utility based on Lua](https://xmake.io)
* Nim:
  * [nim](https://nim-lang.org/): Efficient and expressive programming. [github](https://github.com/nim-lang/nim) ⭐ 18,242 | 🐛 2,206 | 🌐 Nim | 📅 2026-09-22
* Perl:
...
* Rust:
  * [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,503 | 🐛 9 | 🌐 Rust | 📅 2026-09-22: A curated list of Rust code and resources.
...
* V:
  * [V](https://github.com/vlang-io/V) ⭐ 37,902 | 🐛 141 | 🌐 V | 📅 2026-09-23: Simple, fast, safe, compiled language for creating maintainable software. Supports translation from C/C++.
  * [vlang](https://github.com/vlang/v) ⭐ 37,902 | 🐛 141 | 🌐 V | 📅 2026-09-23: Simple, fast, safe, compiled language for developing maintainable software. Supports translation from C and (soon) C++. Compiles itself in <1s.
* Verilog:
...
* [kompare](https://github.com/KDE/kompare) ⭐ 59 | 🐛 0 | 🌐 C++ | 📅 2026-09-23: Graphical File Differences Tool
...
* Starting Pull Requests:
  * [Awesome First PR Opportunities](https://github.com/MunGell/awesome-for-beginners) ⭐ 89,510 | 🐛 154 | 📅 2026-07-25
...
* [.gitignore](https://github.com/github/gitignore) ⭐ 175,875 | 🐛 77 | 📅 2026-09-11: A collection of useful .gitignore templates
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,585 | 🐛 1,052 | 🌐 Go | 📅 2026-09-23: simple terminal UI for git commands
* [gitea](https://github.com/go-gitea/gitea) ⭐ 58,120 | 🐛 2,477 | 🌐 Go | 📅 2026-09-22: Git with a cup of tea, painless self-hosted git service
* [gogs](https://github.com/gogs/gogs) ⭐ 47,820 | 🐛 1,012 | 🌐 Go | 📅 2026-09-12: Gogs is a painless self-hosted Git service.
* [github-cli](https://github.com/cli/cli) ⭐ 46,377 | 🐛 1,088 | 🌐 Go | 📅 2026-09-22:  GitHub’s official command line tool
* [husky](https://github.com/typicode/husky) ⭐ 35,330 | 🐛 107 | 🌐 JavaScript | 📅 2026-03-19: Git hooks made easy
* [Learn git branching](https://learngitbranching.js.org/): An interactive git visualization to challenge and educate! [github](https://github.com/pcottle/learnGitBranching) ⭐ 34,061 | 🐛 57 | 🌐 JavaScript | 📅 2026-09-21.
* [cz-cli](https://github.com/commitizen/cz-cli) ⭐ 17,500 | 🐛 195 | 🌐 JavaScript | 📅 2026-09-04: The commitizen command line utility.
* [lint-staged](https://github.com/okonet/lint-staged) ⭐ 14,734 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-22: Run linters on git staged files
...
* [Pro Git book](https://git-scm.com/book/en/v2), written by Scott Chacon and Ben Straub ([github](https://github.com/progit/progit2) ⭐ 6,598 | 🐛 219 | 🌐 CSS | 📅 2026-05-25 repo)
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,083 | 🐛 7 | 🌐 Shell | 📅 2026-09-17 is a utility tool for git taking advantage of fuzzy finder fzf. [Interactive Git Commands With Previews Powered By fzf Fuzzy Finder](https://www.linuxuprising.com/2019/11/forgit-interactive-git-commands-with.html)
...
* GitHub Profiles:
  * [Awesome Readme Stats](https://github.com/anmol098/waka-readme-stats) ⭐ 3,998 | 🐛 68 | 🌐 Python | 📅 2026-08-24
...
* [SkyWater Open Source PDK](https://github.com/google/skywater-pdk) ⭐ 3,724 | 🐛 200 | 🌐 Python | 📅 2026-07-21: Open source process design kit for usage with SkyWater Technology Foundry's 130nm node.
* [Ariane is a 6-stage RISC-V CPU](https://github.com/pulp-platform/ariane) ⭐ 3,127 | 🐛 261 | 🌐 Assembly | 📅 2026-09-22
* [cva6](https://github.com/openhwgroup/cva6) ⭐ 3,127 | 🐛 261 | 🌐 Assembly | 📅 2026-09-22: The CORE-V CVA6 is an Application class 6-stage RISC-V CPU capable of booting Linux.
...
* [RARS](https://github.com/TheThirdOne/rars) ⭐ 1,644 | 🐛 77 | 🌐 Java | 📅 2024-07-19: RISC-V Assembler and Runtime Simulator.
...
* [Circuit Simulator](http://www.lushprojects.com/circuitjs/). [github](https://github.com/sharpie7/circuitjs1) ⭐ 2,951 | 🐛 266 | 🌐 Java | 📅 2024-01-22.
...
* [How to create an OS from scratch](https://github.com/cfenollosa/os-tutorial) ⭐ 30,724 | 🐛 129 | 🌐 C | 📅 2026-02-04
* [Mezzano](https://github.com/froggey/Mezzano/) ⭐ 3,898 | 🐛 14 | 🌐 Common Lisp | 📅 2026-08-16: An operating system written in Common Lisp.
* [bootOS](https://github.com/nanochess/bootOS) ⭐ 2,143 | 🐛 1 | 🌐 Assembly | 📅 2026-08-01 is a monolithic operating system in 512 bytes of x86 machine code.
...
* [GraalVM](https://github.com/oracle/graal) ⭐ 21,706 | 🐛 848 | 🌐 Java | 📅 2026-09-23: GraalVM is a universal virtual machine for running applications written in JavaScript, Python, Ruby, R, JVM-based languages like Java, Scala, Clojure, Kotlin, and LLVM-based languages such as C and C++. [GraalVM Implementation of Python](https://github.com/graalvm/graalpython) ⭐ 1,647 | 🐛 62 | 🌐 Python | 📅 2026-09-23
* [Compiler Explorer](https://godbolt.org/): Run compilers interactively from your web browser and interact with the assembly. [github](https://github.com/mattgodbolt/compiler-explorer) ⭐ 19,089 | 🐛 858 | 🌐 TypeScript | 📅 2026-09-22, [how it works](https://xania.org/201609/how-compiler-explorer-runs-on-amazon).
...
* [FASTER](https://github.com/Microsoft/FASTER) ⭐ 6,635 | 🐛 36 | 🌐 C# | 📅 2026-08-19: Fast key-value store from Microsoft Research
...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,635 | 🐛 484 | 🌐 C++ | 📅 2026-09-11: Tesseract Open Source OCR Engine (main repository)
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 30,023 | 🐛 531 | 🌐 Python | 📅 2025-12-05: Ready-to-use OCR with 40+ languages supported including Chinese, Japanese, Korean and Thai.
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 166,544 | 🐛 2,393 | 🌐 Python | 📅 2026-09-22: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch.
* [nanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 63,327 | 🐛 349 | 🌐 Python | 📅 2025-11-12: The simplest, fastest repository for training/finetuning medium-sized GPTs.
* [Industrial-strength Natural Language Processing (NLP) with Python and Cython](https://github.com/explosion/spaCy/) ⭐ 33,916 | 🐛 245 | 🌐 Python | 📅 2026-08-24
...
* [Real-Time Voice Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning) ⭐ 60,146 | 🐛 177 | 🌐 Python | 📅 2026-03-09: Clone a voice in 5 seconds to generate arbitrary speech in real-time
...
* [Homemade Machine Learning](https://github.com/trekhleb/homemade-machine-learning) ⭐ 24,801 | 🐛 30 | 🌐 Jupyter Notebook | 📅 2025-11-23: 🤖 Python examples of popular machine learning algorithms with interactive Jupyter demos and math being explained
...
* [CARLA](https://carla.org): Open-source simulator for [autonomous driving research](https://github.com/carla-simulator/carla) ⭐ 14,420 | 🐛 1,198 | 🌐 C++ | 📅 2026-09-22.
...
* [GAN Lab](https://poloclub.github.io/ganlab/): Play with Generated Adversarial Networks (GANs) in your browser! [repo](https://github.com/poloclub/ganlab) ⭐ 1,537 | 🐛 27 | 🌐 JavaScript | 📅 2026-03-22
...
* Autonomous Vehicles:
  * [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,508 | 🐛 781 | 🌐 C++ | 📅 2026-09-15: Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
...
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,357 | 🐛 761 | 🌐 C# | 📅 2026-09-22: is an open source and cross-platform machine learning framework for .NET.
* [DeepLabCut](http://www.mackenziemathislab.org/deeplabcut): is an efficient method for 3D markerless pose estimation based on transfer learning with deep neural networks that achieves excellent results (i.e. you can match human labeling accuracy) with minimal training data (typically 50-200 frames). [repo](https://github.com/DeepLabCut/DeepLabCut) ⭐ 5,778 | 🐛 46 | 🌐 Python | 📅 2026-09-18
...
* [Stable Diffusion](https://github.com/CompVis/stable-diffusion) ⭐ 73,465 | 🐛 619 | 🌐 Jupyter Notebook | 📅 2024-06-18: is a latent text-to-image diffusion model. Thanks to a generous compute donation from Stability AI and support from LAION, we were able to train a Latent Diffusion Model on 512x512 images from a subset of the LAION-5B database.
* [Wan](https://github.com/Wan-Video/Wan2.2) ⭐ 17,604 | 🐛 302 | 🌐 Python | 📅 2026-09-21: Open and Advanced Large-Scale Video Generative Models
...
* [NEST](https://github.com/nest/nest-simulator) ⭐ 669 | 🐛 223 | 🌐 C++ | 📅 2026-09-18: NEST is a simulator for spiking neural network models that focuses on the dynamics, size and structure of neural systems rather than on the exact morphology of individual neurons.
...
* [fiftyone](https://github.com/voxel51/fiftyone) ⭐ 11,110 | 🐛 706 | 🌐 TypeScript | 📅 2026-09-22: The open-source tool for building high-quality datasets and computer vision models
...
*Frameworks for Neural Networks and Deep Learning. See: [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,958 | 🐛 88 | 📅 2025-05-26.*

* [Keras](https://github.com/fchollet/keras) ⭐ 64,330 | 🐛 238 | 🌐 Python | 📅 2026-09-23 - A high-level neural networks library and capable of running on top of either TensorFlow or Theano.
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 103,183 | 🐛 17,566 | 🌐 Python | 📅 2026-09-23: Tensors and Dynamic neural networks in Python with strong GPU acceleration a ([tour](http://blog.christianperone.com/2018/03/pytorch-internal-architecture-tour/)):
* [tinygrad](https://github.com/geohot/tinygrad) ⭐ 33,642 | 🐛 184 | 🌐 Python | 📅 2026-09-23: You like pytorch? You like [micrograd](https://github.com/karpathy/micrograd) ⭐ 17,632 | 🐛 80 | 🌐 Jupyter Notebook | 📅 2026-08-03? You love tinygrad! ❤️
...
* [Alias-Free Generative Adversarial Networks (StyleGAN3)](https://github.com/NVlabs/stylegan3) ⭐ 6,945 | 🐛 192 | 🌐 Python | 📅 2023-09-12: Official PyTorch implementation of StyleGAN3.
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 200,259 | 🐛 3,328 | 🌐 C++ | 📅 2026-09-23 - The most popular Deep Learning framework created by Google.
...
* [Queueing theory](https://github.com/joelparkerhenderson/queueing_theory) ⭐ 2,242 | 🐛 1 | 📅 2026-06-07: an introduction for software development.
...
* Good channels:
  * [3blue1brown](https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw/): 3blue1brown, by Grant Sanderson, is some combination of math and entertainment, depending on your disposition ([site](https://www.3blue1brown.com/)) and [manim](https://github.com/3b1b/manim) ⭐ 94,156 | 🐛 500 | 🌐 Python | 📅 2026-09-09(Animation engine for explanatory math videos).
...
* [The Data Engineering Cookbook](https://github.com/andkret/Cookbook) ⭐ 15,435 | 🐛 129 | 🌐 Python | 📅 2026-07-23
* [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,336 | 🐛 1,351 | 🌐 Python | 📅 2026-09-23: Official repository for Spyder - The Scientific Python Development Environment
...
* [ferret](https://github.com/MontFerret/ferret) ⭐ 6,012 | 🐛 11 | 🌐 Go | 📅 2026-09-23: Declarative web scraping
* [RAPIDS](http://rapids.ai): Open GPU Data Science. The RAPIDS suite of software libraries gives you the freedom to execute end-to-end data science and analytics pipelines entirely on GPUs. It relies on NVIDIA® CUDA® primitives for low-level compute optimization, but exposes that GPU parallelism and high-bandwidth memory speed through user-friendly Python interfaces. [cuml](https://github.com/rapidsai/cuml) ⭐ 5,287 | 🐛 800 | 🌐 Python | 📅 2026-09-23 - RAPIDS Machine Learning Library.
...
* Python:
  ...
  * [arviz](https://github.com/arviz-devs/arviz) ⭐ 1,853 | 🐛 112 | 🌐 TeX | 📅 2026-09-09: Python package to plot and analyse samples from probabilistic models
  ...
  * [pyjanitor](https://github.com/ericmjl/pyjanitor) ⭐ 1,500 | 🐛 147 | 🌐 Python | 📅 2026-09-23: Python implementation of R package Janitor
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 66,180 | 🐛 911 | 🌐 Go | 📅 2026-09-22: The Prometheus monitoring system and time series database.
* [dart](https://github.com/unit8co/darts) ⭐ 9,522 | 🐛 221 | 🌐 Python | 📅 2026-09-18: A python library for easy manipulation and forecasting of time series.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,199 | 🐛 101 | 🌐 C++ | 📅 2026-09-23: The Time Series Visualization Tool that you deserve.
...
* [ImageMagick creates huge temporary files · Issue #395 · ImageMagick/ImageMagick](https://github.com/ImageMagick/ImageMagick/issues/395) ⭐ 17,494 | 🐛 162 | 🌐 C | 📅 2026-09-23
...
* [Pseudo-bandlimited pixel art filtering in 3D – a mathematical derivation](http://themaister.net/blog/2018/08/25/pseudo-bandlimited-pixel-art-filtering-in-3d-a-mathematical-derivation/) [github](https://github.com/Themaister/Granite) ⭐ 1,949 | 🐛 3 | 🌐 C++ | 📅 2026-09-19
...
* GGplot2:
  ...
  * [ggalluvial](https://github.com/corybrunson/ggalluvial) ⭐ 524 | 🐛 24 | 🌐 R | 📅 2026-09-22
...
* [FiPy](https://github.com/usnistgov/fipy) ⭐ 641 | 🐛 179 | 🌐 Python | 📅 2026-09-18: is a Finite Volume PDE solver written in Python.
...
* [jax](https://github.com/google/jax) ⭐ 36,326 | 🐛 2,607 | 🌐 Python | 📅 2026-09-23: Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more
* [micro](https://micro-editor.github.io/): a modern and intuitive [terminal-based text editor](https://github.com/zyedidia/micro#linux-clipboard-support) ⭐ 29,623 | 🐛 914 | 🌐 Go | 📅 2026-09-23.
* [pyodide](https://github.com/iodide-project/pyodide) ⭐ 14,849 | 🐛 392 | 🌐 Python | 📅 2026-09-22: The Python scientific stack, compiled to WebAssembly
* [libvips](https://github.com/libvips/libvips) ⭐ 11,668 | 🐛 79 | 🌐 C | 📅 2026-09-21: A fast image processing library with low memory needs.
...
* [Rack](https://github.com/VCVRack/Rack) ⭐ 4,421 | 🐛 307 | 🌐 C++ | 📅 2025-11-04: The virtual Eurorack studio
* [Sonic Visualiser](https://www.sonicvisualiser.org/) is a free, open-source application for Windows, Linux, and Mac, designed to be the first program you reach for when want to study a music recording closely. It's designed for musicologists, archivists, signal-processing researchers, and anyone else looking for a friendly way to look at what lies inside the audio file. [github repo](https://github.com/sonic-visualiser/sonic-visualiser) ⭐ 897 | 🐛 84 | 🌐 C++ | 📅 2025-12-07
...
* [This program generates bitmaps that are locally similar to the input bitmap](https://github.com/mxgmn/WaveFunctionCollapse) ⭐ 25,340 | 🐛 9 | 🌐 C# | 📅 2026-03-22
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,985 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-22: Easily add particles animations to your website. Compatible also with React, Vue.js (2.x and 3.x), Angular, Svelte, jQuery, Preact, Inferno.
* [Walk through an infinite, procedurally generated city](https://github.com/marian42/wavefunctioncollapse) ⭐ 4,861 | 🐛 9 | 🌐 C# | 📅 2021-03-28
* [An interactive, explorable explanation about the peculiar magic of sound waves.](https://github.com/joshwcomeau/waveforms) ⭐ 1,481 | 🐛 4 | 🌐 JavaScript | 📅 2018-02-21
* [SOFA](https://www.sofa-framework.org/): is an efficient framework dedicated to research, prototyping and development of physics-based simulations. [github](https://github.com/sofa-framework/sofa/) ⭐ 1,258 | 🐛 449 | 🌐 C++ | 📅 2026-09-23.
...
* [astroquery](https://github.com/astropy/astroquery) ⭐ 792 | 🐛 414 | 🌐 Python | 📅 2026-09-22: Functions and classes to access online data resources. Maintainers: @keflavich and @bsipocz and @ceb8
...
* [fprime](https://github.com/nasa/fprime) ⭐ 11,774 | 🐛 474 | 🌐 C++ | 📅 2026-09-22: A flight software and embedded systems framework.
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,665 | 🐛 16 | 🌐 HTML | 📅 2026-09-03: A build-it-yourself, 6-wheel rover based on the rovers on Mars!
...
* [MNE-Python](https://github.com/mne-tools/mne-python) ⭐ 3,524 | 🐛 619 | 🌐 Python | 📅 2026-09-22: Magnetoencephalography (MEG) and Electroencephalography (EEG) in Python
...
* [baltic](https://github.com/evogytis/baltic) ⭐ 131 | 🐛 5 | 🌐 Python | 📅 2026-09-22: backronymed adaptable lightweight tree import code for molecular phylogeny manipulation, analysis and visualisation. Development is back on the evogytis/baltic branch (i.e. here).
* [Seraphim](http://evolve.zoo.ox.ac.uk/Evolve/Seraphim.html): Studying Environmental Rasters And PHylogenetically Informed Movements. [seraphim](https://github.com/evogytis/baltic) ⭐ 131 | 🐛 5 | 🌐 Python | 📅 2026-09-22 is a R package for studying environmental rasters and phylogenetic informed movements
...
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 951 | 🐛 16 | 🌐 Python | 📅 2026-09-21: Easy access to shapefiles of the Brazilian Institute of Geography and Statistics (IBGE) and other official spatial data sets of Brazil.
...
* [Awesome-Design-Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 41,289 | 🐛 208 | 🌐 JavaScript | 📅 2024-07-28: The best design tools for everything.
...
* [PhysX SDK](https://news.developer.nvidia.com/announcing-physx-sdk-4-0-an-open-source-physics-engine/): an Open-Source [Physics Engine](https://github.com/NVIDIAGameWorks/PhysX-3.4) ⭐ 2,418 | 🐛 59 | 🌐 C++ | 📅 2022-11-15
...
* [Craft](https://github.com/fogleman/Craft) ⭐ 11,109 | 🐛 129 | 🌐 C | 📅 2024-04-03: A simple Minecraft clone written in C using modern OpenGL (shaders).
* [Opendiablo2](https://github.com/OpenDiablo2/OpenDiablo2) ⚠️ Archived: An open source re-implementation of Diablo 2
* [gb-studio](https://github.com/chrismaltby/gb-studio) ⭐ 9,408 | 🐛 806 | 🌐 TypeScript | 📅 2026-09-21: A free and easy to use retro adventure game creator for your favourite [handheld video game system](https://www.gbstudio.dev)
* [sm64](https://github.com/n64decomp/sm64) ⭐ 8,785 | 🐛 29 | 🌐 C | 📅 2024-02-04: A Super Mario 64 decompilation, brought to you by a bunch of clever folks.
...
* [OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,499 | 🐛 63 | 🌐 C++ | 📅 2026-08-31: A Framework for Reinforcement Learning in Games.
* [Zelda 3 in C](https://github.com/snesrev/zelda3) ⭐ 4,803 | 🐛 89 | 🌐 C | 📅 2023-12-27: A reimplementation of Zelda 3.
* [The Comprehensive Kerbal Archive Network (CKAN)](https://github.com/KSP-CKAN/CKAN) ⭐ 2,649 | 🐛 85 | 🌐 C# | 📅 2026-07-17
* [Synfig Studio](https://github.com/synfig/synfig/) ⭐ 2,298 | 🐛 722 | 🌐 C++ | 📅 2026-09-20: This is the Official source code repository of the Synfig project.
* [Hypersomnia](https://github.com/TeamHypersomnia/Hypersomnia) ⭐ 1,657 | 🐛 13 | 🌐 C++ | 📅 2026-09-22: Multiplayer top-down shooter made from scratch. Comes with an in-game Editor!
...
* [veyon](https://github.com/veyon/veyon/) ⭐ 1,969 | 🐛 227 | 🌐 C++ | 📅 2026-09-18: Cross-platform computer monitoring and classroom management.

## Studies

* [Path to a free self-taught education in Computer Science!](https://github.com/ossu/computer-science) ⭐ 209,385 | 🐛 28 | 🌐 HTML | 📅 2026-07-14
* [the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 17,103 | 🐛 200 | 🌐 Jupyter Notebook | 📅 2026-05-20: One has no future if one couldn't teach themself.
...
* [Awesome Accessibility](https://github.com/brunopulis/awesome-a11y) ⭐ 1,989 | 🐛 77 | 📅 2026-08-03: A curate list about A11Y
...
* [FreshRSS](https://github.com/FreshRSS/FreshRSS) ⭐ 16,116 | 🐛 686 | 🌐 PHP | 📅 2026-09-20: A free, self-hostable aggregator…
* guardian [frontend](https://github.com/guardian/frontend) ⭐ 5,899 | 🐛 220 | 🌐 Scala | 📅 2026-09-22: Source for theguardian.com
...
* [Differential Privacy](https://github.com/google/differential-privacy) ⭐ 3,362 | 🐛 59 | 🌐 Go | 📅 2026-09-21: This project contains a C++ library of ε-differentially private algorithms, which can be used to produce aggregate statistics over numeric data sets containing private or sensitive information.
...
* [Apache Flink](https://github.com/apache/flink) ⭐ 26,358 | 🐛 378 | 🌐 Java | 📅 2026-09-22: Apache Flink is an open source stream processing framework with powerful stream- and batch-processing capabilities.
* [lists](https://github.com/jnv/lists) ⭐ 11,506 | 🐛 28 | 📅 2026-03-23: The definitive list of lists (of lists) curated on GitHub
* [awesome-uses](https://github.com/wesbos/awesome-uses) ⭐ 5,302 | 🐛 25 | 🌐 JavaScript | 📅 2026-09-20: A list of /uses pages that detail apps and gear used by professional web developers.
...
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 371,352 | 🐛 615 | 🌐 Python | 📅 2026-09-15: Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 361,740 | 🐛 126 | 📅 2025-08-28: A complete computer science study plan to become a software engineer.
...
* [test-your-sysadmin-skills](https://github.com/trimstray/test-your-sysadmin-skills) ⭐ 11,865 | 🐛 19 | 📅 2024-11-19
* [OpenResume](https://www.open-resume.com/) Create a professional resume easily with this free, open-source, and powerful [resume builder](https://github.com/xitanggg/open-resume) ⭐ 8,908 | 🐛 145 | 🌐 TypeScript | 📅 2024-10-29.
...
* [awesome-scifi](https://github.com/sindresorhus/awesome-scifi) ⭐ 5,057 | 🐛 1 | 📅 2025-12-22: I asked on Twitter for recommendations as I want to get into reading Sci-Fi novels. The below is the result. Thanks everyone for recommending your favorites! :)
...
* [📚 Freely available programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 397,473 | 🐛 82 | 🌐 Python | 📅 2026-09-22
