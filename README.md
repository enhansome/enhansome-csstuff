...
* [PortalData](https://github.com/weecology/PortalData) ⭐ 51 | 🐛 5 | 🌐 R | 📅 2026-08-13 (Official Repo of the Portal Project Data) and [livedat](https://github.com/weecology/livedat) ⭐ 13 | 🐛 2 | 🌐 R | 📅 2019-01-30 (Template for living data workflow ).
...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 358,824 | 🐛 124 | 📅 2025-08-28
* [The Book of Secret Knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) ⭐ 238,573 | 🐛 164 | 📅 2024-11-19
* [z3](https://github.com/Z3Prover/z3) ⭐ 12,562 | 🐛 73 | 🌐 C++ | 📅 2026-08-16: The Z3 Theorem Prover
...
* [ClickHouse](https://github.com/ClickHouse/ClickHouse) ⭐ 49,267 | 🐛 6,904 | 🌐 C++ | 📅 2026-08-16: is a free analytics DBMS for big data.
* [HikariCP](https://github.com/brettwooldridge/HikariCP) ⭐ 21,184 | 🐛 543 | 🌐 Java | 📅 2026-06-14: 光 HikariCP・A solid, high-performance, JDBC connection pool at last.
...
* [litetree](https://github.com/aergoio/litetree) ⭐ 1,637 | 🐛 9 | 🌐 C | 📅 2026-04-27: SQLite with Branches
* [litetree](https://github.com/aergoio/litetree) ⭐ 1,637 | 🐛 9 | 🌐 C | 📅 2026-04-27: SQLite with Branches
...
* [Every Programmer Should Know thinking](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,258 | 🐛 25 | 📅 2025-12-29: A collection of (mostly) technical things every software developer should know
...
* [Prettier is an opinionated code formatter](https://github.com/prettier/prettier) ⭐ 52,204 | 🐛 1,427 | 🌐 JavaScript | 📅 2026-08-15
...
* [dev.to](https://github.com/thepracticaldev/dev.to) ⭐ 22,767 | 🐛 123 | 🌐 Ruby | 📅 2026-08-16: Where programmers share ideas and help each other grow
* [Flow](https://github.com/facebook/flow) ⭐ 22,276 | 🐛 524 | 🌐 Rust | 📅 2026-08-15: Adds static typing to JavaScript to improve developer productivity and code quality.
* [Quine Relay](https://github.com/mame/quine-relay) ⭐ 14,578 | 🐛 18 | 🌐 Ruby | 📅 2025-10-24: An uroboros program with 100+ programming languages.
* [semantic](https://github.com/github/semantic) ⚠️ Archived: Parsing, analyzing, and comparing source code across many languages
* [Algorithms](http://jeffe.cs.illinois.edu/teaching/algorithms/): this web page contains a free electronic version of my (soon to be) self-published textbook Algorithms, along with other lecture notes I have written for various theoretical computer science classes at the University of Illinois, Urbana-Champaign since 1998. [github](https://github.com/jeffgerickson/algorithms) ⭐ 8,125 | 🐛 173 | 📅 2019-11-23
...
* [small](https://github.com/mathiasbynens/small) ⭐ 2,296 | 🐛 55 | 🌐 HTML | 📅 2024-07-18: Smallest possible syntactically valid files of different types.
...
* (pt-br) [OsProgramadores](https://osprogramadores.com) - [op-desafios](https://github.com/OsProgramadores/op-desafios) ⭐ 159 | 🐛 2 | 🌐 C | 📅 2026-07-30: Soluções para os desafios (por usuário)
...
* [vscodium](https://github.com/VSCodium/vscodium) ⭐ 32,832 | 🐛 139 | 🌐 Shell | 📅 2026-08-12: binary releases of VS Code without MS branding/telemetry/licensing
  * [awesome-vscode](https://github.com/viatsko/awesome-vscode) ⭐ 28,964 | 🐛 45 | 🌐 JavaScript | 📅 2026-06-21: art A curated list of delightful VS Code packages and resources.
...
* GDB:
  ...
  * [gdbgui](https://github.com/cs01/gdbgui/) ⭐ 10,350 | 🐛 179 | 🌐 TypeScript | 📅 2025-06-29: Browser-based frontend to gdb (gnu debugger). Add breakpoints, view the stack, visualize data structures, and more in C, C++, Go, Rust, and Fortran. Run gdbgui from the terminal and a new tab will open in your browser.
...
* [CppCoreGuidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,245 | 🐛 245 | 🌐 CSS | 📅 2026-08-06: The C++ Core Guidelines are a set of tried-and-true guidelines, rules, and best practices about coding in C++
* [Microsoft's C++ Standard Library](https://github.com/microsoft/STL) ⭐ 11,130 | 🐛 583 | 🌐 C++ | 📅 2026-08-15: MSVC's implementation of the C++ Standard Library.
* mozilla [rr](https://github.com/mozilla/rr) ⭐ 10,621 | 🐛 479 | 🌐 C++ | 📅 2026-08-15: is a lightweight tool for recording, replaying and debugging execution of applications (trees of processes and threads). Debugging extends gdb with very efficient reverse-execution, which in combination with standard gdb/x86 features like hardware data watchpoints, makes debugging much more fun.
...
* [memory-profiler](https://github.com/nokia/memory-profiler) ⭐ 4,799 | 🐛 52 | 🌐 C | 📅 2023-07-28
* [Checked C](https://github.com/microsoft/checkedc) ⭐ 3,258 | 🐛 74 | 🌐 C | 📅 2024-10-07 is an extension to C that adds checking to detect or prevent common programming errors such as buffer overruns and out-of-bounds memory accesses. This repo has a wiki for Checked C, sample code, the specification, and test code.
...
* [9cc](https://github.com/rui314/9cc) ⭐ 1,948 | 🐛 15 | 🌐 C | 📅 2020-11-28: A Small C Compiler
...
* TDD C:
  * [Google Test](https://github.com/google/googletest) ⭐ 38,930 | 🐛 490 | 🌐 C++ | 📅 2026-08-16: Google Testing and Mocking Framework.
...
* [Makefile Tutorial by Example](https://makefiletutorial.com/) and [repo](https://github.com/theicfire/makefiletutorial) ⭐ 5,963 | 🐛 8 | 🌐 SCSS | 📅 2025-06-02
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,634 | 🐛 308 | 🌐 JavaScript | 📅 2026-04-08: A simple and modern GTK eBook viewer, built with GJS and Epub.js.
...
* [A curated list of awesome Python frameworks, libraries, software and resources](https://github.com/vinta/awesome-python#authentication) ⭐ 314,171 | 🐛 27 | 🌐 Python | 📅 2026-08-05
* [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) ⭐ 223,769 | 🐛 1,028 | 🌐 Python | 📅 2026-08-03: All Algorithms implemented in Python
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,615 | 🐛 87 | 🌐 Python | 📅 2026-08-15 framework, high performance, easy to learn, fast to code, ready for production
* cython [dtoa.c](https://github.com/python/cpython/blob/master/Python/dtoa.c) ⭐ 74,326 | 🐛 9,514 | 🌐 Python | 📅 2026-08-15
* [Rich](https://github.com/willmcgugan/rich) ⭐ 57,072 | 🐛 369 | 🌐 Python | 📅 2026-06-23 is a Python library for rich text and beautiful formatting in the terminal.
* [black](https://github.com/ambv/black/) ⭐ 41,807 | 🐛 303 | 🌐 Python | 📅 2026-08-10: The uncompromising Python code formatter
* [wtfpython](https://github.com/satwikkansal/wtfpython#-is-not--is-not-is-not-) ⭐ 37,056 | 🐛 72 | 🌐 Python | 📅 2026-01-13: A collection of surprising Python snippets and lesser-known features.
* [wtfpython](https://github.com/satwikkansal/wtfpython) ⭐ 37,056 | 🐛 72 | 🌐 Python | 📅 2026-01-13: What the f\*ck Python? ￼
* [Course Files for Complete Python 3 Bootcamp Course on Udemy](https://github.com/Pierian-Data/Complete-Python-3-Bootcamp) ⭐ 29,707 | 🐛 268 | 🌐 Jupyter Notebook | 📅 2025-06-24
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,281 | 🐛 409 | 🌐 Rust | 📅 2026-08-15A Python Interpreter written in Rust
* [kivy](https://github.com/kivy/kivy) ⭐ 18,991 | 🐛 853 | 🌐 Python | 📅 2026-08-15: Open source UI framework written in Python, running on Windows, Linux, macOS, Android and iOS.
* [Modular visual interface for GDB in Python](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,241 | 🐛 19 | 🌐 Python | 📅 2026-07-17
...
* [alive-progress](https://github.com/rsalmei/alive-progress) ⭐ 6,294 | 🐛 17 | 🌐 Python | 📅 2026-05-24: An animated and smart Progress Bar for python.
...
* [Coconut Lang](https://github.com/evhub/coconut) ⭐ 4,349 | 🐛 90 | 🌐 Python | 📅 2026-02-16
* [cinder](https://github.com/facebookincubator/cinder) ⭐ 3,792 | 🐛 33 | 🌐 Python | 📅 2026-08-15
...
* [OpenTelemetry Python](https://github.com/open-telemetry/opentelemetry-python) ⭐ 2,588 | 🐛 393 | 🌐 Python | 📅 2026-08-15: OpenTelemetry Python API and SDK
* [austin](https://github.com/P403n1x87/austin) ⭐ 2,211 | 🐛 12 | 🌐 C | 📅 2026-07-02: Python frame stack sampler for CPython. Austin has a [tui](https://github.com/P403n1x87/austin-tui) ⭐ 665 | 🐛 2 | 🌐 Python | 📅 2026-06-04: The top-like text-based user interface for Austin.
...
* [Python Verbal Expressions](https://github.com/VerbalExpressions/PythonVerbalExpressions) ⭐ 1,634 | 🐛 8 | 🌐 Python | 📅 2024-04-28: Python regular expressions made easy
...
* [reloading](https://github.com/julvo/reloading) ⭐ 1,129 | 🐛 13 | 🌐 Python | 📅 2024-06-15: Change Python code while it's running using a reloading loop
...
* Agda:
  * [Agda 2](https://github.com/agda/agda) ⭐ 2,914 | 🐛 1,045 | 🌐 Haskell | 📅 2026-08-14
  * [plfa](https://github.com/plfa/plfa.github.io/) ⭐ 1,513 | 🐛 65 | 🌐 Agda | 📅 2026-08-10: Introduction to programming language theory in Agda and [Programming Language Foundations in Agda](https://plfa.github.io/).
* Anglican:
...
* Answer Set Programming(ASP): offers a simple and powerful modeling language to solve combinatorial problems.
  * [Potassco](https://potassco.org/), [clingo](https://potassco.org/clingo/) and [github](https://github.com/potassco/clingo) ⭐ 823 | 🐛 14 | 🌐 C++ | 📅 2026-08-15.
* Brainfuck:
  * [Brainfuck](https://www.dcode.fr/brainfuck-language) encoder/decoder.
* Dafny:
  * [dafny](https://github.com/Microsoft/dafny) ⭐ 3,501 | 🐛 1,376 | 🌐 C# | 📅 2026-08-09: Dafny is a verification-aware programming language.
* Clean:
...
* Elixir:
  * [Nerves](https://github.com/nerves-project/nerves) ⭐ 2,483 | 🐛 22 | 🌐 Elixir | 📅 2026-08-16: Craft and deploy bulletproof embedded software in Elixir. [official site](http://nerves-project.org)
...
* Go:
  * [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 181,159 | 🐛 208 | 🌐 Go | 📅 2026-08-15: A curated list of awesome Go frameworks, libraries and software
  * [lattigo](https://github.com/lca1/lattigo) ⭐ 1,438 | 🐛 7 | 🌐 Go | 📅 2026-06-16: A lattice-based cryptographic library in Go.
...
* Java:
  * [1brc](https://github.com/gunnarmorling/1brc) ⭐ 8,104 | 🐛 41 | 🌐 Java | 📅 2024-08-20: [The One Billion Row Challenge](https://www.morling.dev/blog/one-billion-row-challenge/) -- A fun exploration of how quickly 1B rows from a text file can be aggregated with Java
  * [Procyon](https://github.com/mstrobel/procyon) ⭐ 1,209 | 🐛 59 | 🌐 Java | 📅 2022-06-12: is a suite of Java metaprogramming tools, including a rich reflection API, a LINQ-inspired expression tree API for runtime code generation, and a Java decompiler.
* JavaScript:
...
* Lua:
  * [xmake](https://github.com/xmake-io/xmake) ⭐ 12,143 | 🐛 253 | 🌐 Lua | 📅 2026-08-16: 🔥 A cross-platform build [utility based on Lua](https://xmake.io)
* Nim:
  * [nim](https://nim-lang.org/): Efficient and expressive programming. [github](https://github.com/nim-lang/nim) ⭐ 18,172 | 🐛 2,184 | 🌐 Nim | 📅 2026-08-15
* Perl:
...
* PHP:
  * [A curated list of bookmarks, packages, tutorials, videos and other cool resources from the Laravel ecosystem](https://github.com/chiraggude/awesome-laravel) ⭐ 13,089 | 🐛 85 | 📅 2024-07-03
...
* V:
  * [V](https://github.com/vlang-io/V) ⭐ 37,793 | 🐛 81 | 🌐 V | 📅 2026-08-16: Simple, fast, safe, compiled language for creating maintainable software. Supports translation from C/C++.
  * [vlang](https://github.com/vlang/v) ⭐ 37,793 | 🐛 81 | 🌐 V | 📅 2026-08-16: Simple, fast, safe, compiled language for developing maintainable software. Supports translation from C and (soon) C++. Compiles itself in <1s.
* Verilog:
  * [Designing Hardware with Verilog](http://8bitworkshop.com/blog/release/2018/12/15/verilog-programming.html)
* Yorlang:
  * [yorlang](https://github.com/anoniscoding/yorlang) ⭐ 457 | 🐛 21 | 🌐 JavaScript | 📅 2026-01-12: [Yorlang](https://anoniscoding.github.io/yorlang/) is an esoteric programming language designed to write small programs using yoruba language constructs. It is the first of its kind and it can carry out basic programming operations in yoruba language (a language spoken in some parts of Nigeria ).
...
* Starting Pull Requests:
  * [Awesome First PR Opportunities](https://github.com/MunGell/awesome-for-beginners) ⭐ 88,416 | 🐛 141 | 📅 2026-07-25
...
* [.gitignore](https://github.com/github/gitignore) ⭐ 175,301 | 🐛 83 | 📅 2026-07-23: A collection of useful .gitignore templates
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,360 | 🐛 1,018 | 🌐 Go | 📅 2026-08-15: simple terminal UI for git commands
* [gitea](https://github.com/go-gitea/gitea) ⭐ 57,390 | 🐛 2,551 | 🌐 Go | 📅 2026-08-16: Git with a cup of tea, painless self-hosted git service
* [gogs](https://github.com/gogs/gogs) ⭐ 47,736 | 🐛 1,010 | 🌐 Go | 📅 2026-08-06: Gogs is a painless self-hosted Git service.
* [github-cli](https://github.com/cli/cli) ⭐ 45,834 | 🐛 1,064 | 🌐 Go | 📅 2026-08-14:  GitHub’s official command line tool
* [husky](https://github.com/typicode/husky) ⭐ 35,272 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19: Git hooks made easy
* [Learn git branching](https://learngitbranching.js.org/): An interactive git visualization to challenge and educate! [github](https://github.com/pcottle/learnGitBranching) ⭐ 33,881 | 🐛 59 | 🌐 JavaScript | 📅 2026-08-11.
* [cz-cli](https://github.com/commitizen/cz-cli) ⭐ 17,502 | 🐛 194 | 🌐 JavaScript | 📅 2026-08-11: The commitizen command line utility.
* [lint-staged](https://github.com/okonet/lint-staged) ⭐ 14,714 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-08: Run linters on git staged files
* [git-blame-someone-else](https://github.com/jayphelps/git-blame-someone-else) ⭐ 11,697 | 🐛 21 | 🌐 Shell | 📅 2023-12-04: Blame someone else for your bad code.
* [devhub](https://github.com/devhubapp/devhub) ⭐ 10,118 | 🐛 102 | 🌐 TypeScript | 📅 2024-09-07: DevHub: TweetDeck for GitHub - Android, iOS and Web 👉
* [Pro Git book](https://git-scm.com/book/en/v2), written by Scott Chacon and Ben Straub ([github](https://github.com/progit/progit2) ⭐ 6,554 | 🐛 219 | 🌐 CSS | 📅 2026-05-25 repo)
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,061 | 🐛 12 | 🌐 Shell | 📅 2026-08-01 is a utility tool for git taking advantage of fuzzy finder fzf. [Interactive Git Commands With Previews Powered By fzf Fuzzy Finder](https://www.linuxuprising.com/2019/11/forgit-interactive-git-commands-with.html)
* [git-sizer](https://github.com/github/git-sizer/) ⭐ 4,069 | 🐛 18 | 🌐 Go | 📅 2026-01-16: Compute various size metrics for a Git repository, flagging those that might cause problems ( [article](https://blog.github.com/2018-03-05-measuring-the-many-sizes-of-a-git-repository/))
...
* [gitless](https://gitless.com): A version control system built on top of Git [github](https://github.com/sdg-mit/gitless) ⭐ 1,947 | 🐛 91 | 🌐 Python | 📅 2023-10-01.
...
* [Forge](https://github.com/magit/forge/) ⭐ 1,569 | 🐛 10 | 🌐 Emacs Lisp | 📅 2026-08-15: Work with Git forges from the comfort of Magit
...
* GitHub Profiles:
  * [Awesome Readme Stats](https://github.com/anmol098/waka-readme-stats) ⭐ 3,978 | 🐛 65 | 🌐 Python | 📅 2026-08-04
...
* [SkyWater Open Source PDK](https://github.com/google/skywater-pdk) ⭐ 3,655 | 🐛 199 | 🌐 Python | 📅 2026-07-21: Open source process design kit for usage with SkyWater Technology Foundry's 130nm node.
* [Ariane is a 6-stage RISC-V CPU](https://github.com/pulp-platform/ariane) ⭐ 3,067 | 🐛 262 | 🌐 Assembly | 📅 2026-08-16
* [cva6](https://github.com/openhwgroup/cva6) ⭐ 3,067 | 🐛 262 | 🌐 Assembly | 📅 2026-08-16: The CORE-V CVA6 is an Application class 6-stage RISC-V CPU capable of booting Linux.
* [hardware-effects](https://github.com/Kobzol/hardware-effects) ⭐ 2,996 | 🐛 11 | 🌐 C++ | 📅 2024-02-29: Demonstration of various hardware effects.
* [darkriscv](https://github.com/darklife/darkriscv) ⭐ 2,599 | 🐛 5 | 🌐 Verilog | 📅 2026-05-12: opensouce RISC-V implemented from scratch in one night!
* [NyuziProcessor](https://github.com/jbush001/NyuziProcessor/) ⭐ 2,215 | 🐛 91 | 🌐 C | 📅 2024-11-08: GPGPU microprocessor architecture
* [RARS](https://github.com/TheThirdOne/rars) ⭐ 1,615 | 🐛 76 | 🌐 Java | 📅 2024-07-19: RISC-V Assembler and Runtime Simulator.
...
* [VGChips](https://github.com/furrtek/VGChips) ⭐ 229 | 🐛 23 | 🌐 Verilog | 📅 2026-08-15: Video Game custom chips reverse-engineered from silicon.
...
* [Circuit Simulator](http://www.lushprojects.com/circuitjs/). [github](https://github.com/sharpie7/circuitjs1) ⭐ 2,921 | 🐛 266 | 🌐 Java | 📅 2024-01-22.
...
* [Mezzano](https://github.com/froggey/Mezzano/) ⭐ 3,880 | 🐛 14 | 🌐 Common Lisp | 📅 2026-06-16: An operating system written in Common Lisp.
...
* [GraalVM](https://github.com/oracle/graal) ⭐ 21,661 | 🐛 846 | 🌐 Java | 📅 2026-08-15: GraalVM is a universal virtual machine for running applications written in JavaScript, Python, Ruby, R, JVM-based languages like Java, Scala, Clojure, Kotlin, and LLVM-based languages such as C and C++. [GraalVM Implementation of Python](https://github.com/graalvm/graalpython) ⭐ 1,635 | 🐛 62 | 🌐 Python | 📅 2026-08-13
* [Compiler Explorer](https://godbolt.org/): Run compilers interactively from your web browser and interact with the assembly. [github](https://github.com/mattgodbolt/compiler-explorer) ⭐ 18,979 | 🐛 824 | 🌐 TypeScript | 📅 2026-08-15, [how it works](https://xania.org/201609/how-compiler-explorer-runs-on-amazon).
...
* [FASTER](https://github.com/Microsoft/FASTER) ⭐ 6,636 | 🐛 35 | 🌐 C# | 📅 2026-08-13: Fast key-value store from Microsoft Research
* [porcupine](https://github.com/anishathalye/porcupine/) ⭐ 1,235 | 🐛 4 | 🌐 Go | 📅 2026-08-06: A fast linearizability checker written in Go
* [DrTLAPlus](https://github.com/tlaplus/DrTLAPlus/) ⭐ 861 | 🐛 0 | 🌐 TLA | 📅 2022-04-18:  learn an algorithm and protocol, study a specification
...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 75,937 | 🐛 486 | 🌐 C++ | 📅 2026-08-15: Tesseract Open Source OCR Engine (main repository)
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,908 | 🐛 530 | 🌐 Python | 📅 2025-12-05: Ready-to-use OCR with 40+ languages supported including Chinese, Japanese, Korean and Thai.
* [annoy](https://github.com/spotify/annoy) ⭐ 14,287 | 🐛 84 | 🌐 C++ | 📅 2025-10-29: Approximate Nearest Neighbors in C++/Python optimized for memory usage and loading/saving to disk
* [pampy](https://github.com/santinic/pampy) ⭐ 3,526 | 🐛 23 | 🌐 Python | 📅 2025-01-16: The Pattern Matching for Python you always dreamed of.

## Artificial Intelligence

* [faceswap](https://github.com/deepfakes/faceswap) ⭐ 57,457 | 🐛 12 | 🌐 Python | 📅 2026-08-05: Non official project based on original /r/Deepfakes thread. Many thanks to him!
...
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,778 | 🐛 56 | 🌐 C++ | 📅 2026-06-28: An open source library for face detection in images. The face detection speed can reach 1500FPS.
* [SPADE](https://github.com/NVlabs/SPADE) ⭐ 7,714 | 🐛 100 | 🌐 Python | 📅 2023-08-07: Semantic Image Synthesis with Spatially-Adaptive Normalization - [paper](https://nvlabs.github.io/SPADE/)
...
* [donkeycar](https://github.com/autorope/donkeycar) ⭐ 3,490 | 🐛 135 | 🌐 Python | 📅 2026-08-08: Open source hardware and software platform to build a small scale self driving car.
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 164,125 | 🐛 2,382 | 🌐 Python | 📅 2026-08-15: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch.
* [nanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,134 | 🐛 351 | 🌐 Python | 📅 2025-11-12: The simplest, fastest repository for training/finetuning medium-sized GPTs.
* [Industrial-strength Natural Language Processing (NLP) with Python and Cython](https://github.com/explosion/spaCy/) ⭐ 33,823 | 🐛 232 | 🌐 Python | 📅 2026-08-07
...
* [Language Interpretability Tool (LIT)](https://github.com/pair-code/lit/) ⭐ 3,660 | 🐛 139 | 🌐 TypeScript | 📅 2026-07-29: Interactively analyze NLP models for model understanding in an extensible and framework agnostic interface.
* [PromptSource](https://github.com/bigscience-workshop/promptsource) ⭐ 3,029 | 🐛 43 | 🌐 Python | 📅 2023-10-23
* [Argdown](https://argdown.org/): A simple syntax for complex argumentation. [argdown repo](https://github.com/christianvoigt/argdown) ⭐ 1,027 | 🐛 96 | 🌐 TypeScript | 📅 2026-08-11
* [PatrickStar](https://github.com/Tencent/PatrickStar) ⭐ 773 | 🐛 8 | 🌐 Python | 📅 2025-11-18: enables Larger, Faster, Greener Pretrained Models for NLP and democratizes AI for everyone.
* [spaCy + StanfordNLP](https://github.com/explosion/spacy-stanfordnlp) ⭐ 747 | 🐛 14 | 🌐 Python | 📅 2024-08-15:💥 Use the latest StanfordNLP research models directly in spaCy.
* [RecipeNLG](https://github.com/Glorf/recipenlg) ⭐ 626 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2022-03-07: A Cooking Recipes Dataset for Semi-Structured Text Generation
...
* [Real-Time Voice Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning) ⭐ 60,090 | 🐛 177 | 🌐 Python | 📅 2026-03-09: Clone a voice in 5 seconds to generate arbitrary speech in real-time
...
* [Homemade Machine Learning](https://github.com/trekhleb/homemade-machine-learning) ⭐ 24,756 | 🐛 31 | 🌐 Jupyter Notebook | 📅 2025-11-23: 🤖 Python examples of popular machine learning algorithms with interactive Jupyter demos and math being explained
...
* [DeepMind Research](https://github.com/deepmind/deepmind-research) ⭐ 15,154 | 🐛 341 | 🌐 Jupyter Notebook | 📅 2026-06-17: This repository contains implementations and illustrative code to accompany DeepMind publications.
* [vosk-api](https://github.com/alphacep/vosk-api) ⭐ 15,057 | 🐛 600 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API for Android, iOS, Raspberry Pi and servers with Python, Java, C# and Node.
* [Transfer Learning](https://github.com/jindongwang/transferlearning) ⭐ 14,346 | 🐛 24 | 🌐 Python | 📅 2025-02-18: Everything about Transfer Learning and Domain Adaptation--迁移学习
* [CARLA](https://carla.org): Open-source simulator for [autonomous driving research](https://github.com/carla-simulator/carla) ⭐ 14,299 | 🐛 1,190 | 🌐 C++ | 📅 2026-08-15.
...
* [60\_Days\_RL\_Challenge](https://github.com/andri27-ts/60_Days_RL_Challenge) ⭐ 4,729 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2020-06-30: Learn Deep Reinforcement Learning in depth in 60 days
* [make-sense](https://github.com/SkalskiP/make-sense) ⭐ 3,557 | 🐛 132 | 🌐 TypeScript | 📅 2024-08-15: [Free to use online tool for labelling photos](https://makesense.ai).
...
* [GAN Lab](https://poloclub.github.io/ganlab/): Play with Generated Adversarial Networks (GANs) in your browser! [repo](https://github.com/poloclub/ganlab) ⭐ 1,531 | 🐛 27 | 🌐 JavaScript | 📅 2026-03-22
...
* [frugally-deep](https://github.com/Dobiasd/frugally-deep) ⭐ 1,127 | 🐛 0 | 🌐 C++ | 📅 2026-05-06: Header-only library for using Keras models in C++.
...
* Autonomous Vehicles:
  * [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,401 | 🐛 780 | 🌐 C++ | 📅 2026-06-30: Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
...
* [mit-deep-learning](https://github.com/lexfridman/mit-deep-learning) ⭐ 10,447 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2024-01-03: Tutorials, assignments, and competitions for MIT Deep Learning related courses.
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,347 | 🐛 1,008 | 🌐 C# | 📅 2026-08-13: is an open source and cross-platform machine learning framework for .NET.
* [DeepLabCut](http://www.mackenziemathislab.org/deeplabcut): is an efficient method for 3D markerless pose estimation based on transfer learning with deep neural networks that achieves excellent results (i.e. you can match human labeling accuracy) with minimal training data (typically 50-200 frames). [repo](https://github.com/DeepLabCut/DeepLabCut) ⭐ 5,736 | 🐛 48 | 🌐 Python | 📅 2026-08-14
...
* [Nevergrad](https://code.fb.com/ai-research/nevergrad/): An open source tool for derivative-free optimization. [github](https://github.com/facebookresearch/nevergrad) ⭐ 4,202 | 🐛 141 | 🌐 Python | 📅 2026-07-24
...
* [Stable Diffusion](https://github.com/CompVis/stable-diffusion) ⭐ 73,296 | 🐛 619 | 🌐 Jupyter Notebook | 📅 2024-06-18: is a latent text-to-image diffusion model. Thanks to a generous compute donation from Stability AI and support from LAION, we were able to train a Latent Diffusion Model on 512x512 images from a subset of the LAION-5B database.
* [Wan](https://github.com/Wan-Video/Wan2.2) ⭐ 17,139 | 🐛 287 | 🌐 Python | 📅 2026-03-17: Open and Advanced Large-Scale Video Generative Models
* [Bbrain.js](https://github.com/BrainJS/brain.js) ⭐ 14,868 | 🐛 90 | 🌐 TypeScript | 📅 2024-09-26: 🤖 Neural networks in JavaScript
* [Paddle Fluid](https://www.paddlepaddle.org.cn/) with [Pre-trained and Reproduced Deep Learning Models](https://github.com/PaddlePaddle/models) ⭐ 6,934 | 🐛 870 | 🌐 Python | 📅 2025-01-15, [ERNIE](https://github.com/PaddlePaddle/ERNIE) ⭐ 7,736 | 🐛 82 | 🌐 Python | 📅 2026-07-24:  An Implementation of ERNIE For Language Understanding (including Pre-training models and Fine-tuning tools).
...
* [Handwriting Synthesis](https://github.com/sjvasquez/handwriting-synthesis) ⭐ 4,796 | 🐛 63 | 🌐 Python | 📅 2024-01-11
* [Random Forest vs Neural Network](https://mljar.com/blog/random-forest-vs-neural-network-classification/)(classification, tabular data) - [github](https://github.com/mljar/mljar-supervised) ⭐ 3,281 | 🐛 128 | 🌐 Python | 📅 2026-07-27
...
* [NEST](https://github.com/nest/nest-simulator) ⭐ 658 | 🐛 227 | 🌐 C++ | 📅 2026-08-10: NEST is a simulator for spiking neural network models that focuses on the dynamics, size and structure of neural systems rather than on the exact morphology of individual neurons.
...
* [fiftyone](https://github.com/voxel51/fiftyone) ⭐ 11,015 | 🐛 663 | 🌐 TypeScript | 📅 2026-08-16: The open-source tool for building high-quality datasets and computer vision models
...
* [OpenSimpleLidar](https://github.com/iliasam/OpenSimpleLidar) ⭐ 2,551 | 🐛 1 | 🌐 C | 📅 2025-07-22: Open Hardware scanning laser rangefinder ([howto](https://hackaday.io/project/20628-open-simple-lidar))
...
*Frameworks for Neural Networks and Deep Learning. See: [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,761 | 🐛 84 | 📅 2025-05-26.*

* [Keras](https://github.com/fchollet/keras) ⭐ 64,232 | 🐛 216 | 🌐 Python | 📅 2026-08-14 - A high-level neural networks library and capable of running on top of either TensorFlow or Theano.
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,576 | 🐛 1,565 | 🌐 C++ | 📅 2024-07-31 - A fast open framework for deep learning..
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,395 | 🐛 17,328 | 🌐 Python | 📅 2026-08-16: Tensors and Dynamic neural networks in Python with strong GPU acceleration a ([tour](http://blog.christianperone.com/2018/03/pytorch-internal-architecture-tour/)):
* [tinygrad](https://github.com/geohot/tinygrad) ⭐ 33,452 | 🐛 180 | 🌐 Python | 📅 2026-08-16: You like pytorch? You like [micrograd](https://github.com/karpathy/micrograd) ⭐ 17,143 | 🐛 78 | 🌐 Jupyter Notebook | 📅 2026-08-03? You love tinygrad! ❤️
...
* [Alias-Free Generative Adversarial Networks (StyleGAN3)](https://github.com/NVlabs/stylegan3) ⭐ 6,939 | 🐛 192 | 🌐 Python | 📅 2023-09-12: Official PyTorch implementation of StyleGAN3.
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,047 | 🐛 2,859 | 🌐 C++ | 📅 2026-08-16 - The most popular Deep Learning framework created by Google.
* [BERT](https://github.com/google-research/bert) ⚠️ Archived: TensorFlow code and pre-trained models for BERT
* [Machine Learning Notebooks](https://github.com/ageron/handson-ml2) ⭐ 29,957 | 🐛 230 | 🌐 Jupyter Notebook | 📅 2026-05-19: A series of Jupyter notebooks that walk you through the fundamentals of Machine Learning and Deep Learning in Python using Scikit-Learn, Keras and TensorFlow 2.
...
* [Ludwig](https://github.com/uber/ludwig) ⭐ 11,747 | 🐛 2 | 🌐 Python | 📅 2026-08-10: [is a toolbox built](https://uber.github.io/ludwig/) on top of TensorFlow that allows to train and test deep learning models without the need to write code.
...
* [tensorFlow Privacy](https://github.com/tensorflow/privacy) ⭐ 2,022 | 🐛 136 | 🌐 Python | 📅 2026-07-08: Library for training machine learning models with privacy for training data
...
* [Queueing theory](https://github.com/joelparkerhenderson/queueing_theory) ⭐ 2,231 | 🐛 1 | 📅 2026-06-07: an introduction for software development.
* [Mesh Spreadsheet](http://mesh-spreadsheet.com/): A free, [portable spreadsheet program](https://github.com/chrispsn/mesh) ⭐ 1,559 | 🐛 41 | 🌐 JavaScript | 📅 2024-05-29.
...
* Good channels:
  * [3blue1brown](https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw/): 3blue1brown, by Grant Sanderson, is some combination of math and entertainment, depending on your disposition ([site](https://www.3blue1brown.com/)) and [manim](https://github.com/3b1b/manim) ⭐ 91,238 | 🐛 493 | 🌐 Python | 📅 2026-08-15(Animation engine for explanatory math videos).
...
* [pycm](https://github.com/sepandhaghighi/pycm) ⭐ 1,506 | 🐛 16 | 🌐 Python | 📅 2026-08-15: Multi-class confusion matrix library in Python.
...
* [Kyle Walker](https://gist.github.com/walkerke) Gist, a lot of R scripts and interesting stuff [github](https://github.com/walkerke/tidycensus) ⭐ 683 | 🐛 23 | 🌐 R | 📅 2026-05-25
...
* [The Data Engineering Cookbook](https://github.com/andkret/Cookbook) ⭐ 15,296 | 🐛 128 | 🌐 Python | 📅 2026-07-23
* [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,288 | 🐛 1,346 | 🌐 Python | 📅 2026-08-15: Official repository for Spyder - The Scientific Python Development Environment
* [Luna](https://www.luna-lang.org/) is a data processing and visualization environment built on a principle that people need an immediate connection to what they are building. [github repo](https://github.com/luna/luna) ⭐ 7,436 | 🐛 325 | 🌐 Java | 📅 2026-08-10, [studio](https://github.com/luna/luna-studio) (IDE) and [docs](https://luna-lang.gitbooks.io/docs/content/interface.html)
* [ferret](https://github.com/MontFerret/ferret) ⭐ 6,008 | 🐛 11 | 🌐 Go | 📅 2026-08-14: Declarative web scraping
* [RAPIDS](http://rapids.ai): Open GPU Data Science. The RAPIDS suite of software libraries gives you the freedom to execute end-to-end data science and analytics pipelines entirely on GPUs. It relies on NVIDIA® CUDA® primitives for low-level compute optimization, but exposes that GPU parallelism and high-bandwidth memory speed through user-friendly Python interfaces. [cuml](https://github.com/rapidsai/cuml) ⭐ 5,254 | 🐛 836 | 🌐 Python | 📅 2026-08-15 - RAPIDS Machine Learning Library.
...
* [insight](https://github.com/easystats/insight) ⭐ 439 | 🐛 60 | 🌐 R | 📅 2026-08-15: Easy access to model information for various model objects.
...
* Python:
  * [termgraph](https://github.com/mkaz/termgraph) ⭐ 3,291 | 🐛 25 | 🌐 Python | 📅 2026-03-25: a python command-line tool which draws basic graphs in the terminal
  * [arviz](https://github.com/arviz-devs/arviz) ⭐ 1,845 | 🐛 112 | 🌐 TeX | 📅 2026-08-11: Python package to plot and analyse samples from probabilistic models
  ...
  * [pyjanitor](https://github.com/ericmjl/pyjanitor) ⭐ 1,499 | 🐛 109 | 🌐 Python | 📅 2026-08-11: Python implementation of R package Janitor
...
* Jupyter:
  * [jupyter-themes](https://github.com/dunovank/jupyter-themes) ⭐ 9,818 | 🐛 205 | 🌐 CSS | 📅 2025-06-22: Custom Jupyter Notebook Themes
  ...
  * [nbtutor](https://github.com/lgpage/nbtutor) ⭐ 472 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-12: Visualize Python code execution (line-by-line) in Jupyter Notebook cells.
  * [Teaching and Learning with Jupyter](https://github.com/jupyter4edu/jupyter-edu-book) ⭐ 467 | 🐛 29 | 🌐 TeX | 📅 2023-03-30 [book](https://jupyter4edu.github.io/jupyter-edu-book/)
...
* R Lang
  * [brms](https://github.com/paul-buerkner/brms) ⭐ 1,422 | 🐛 157 | 🌐 R | 📅 2026-08-04: R package for Bayesian generalized multivariate non-linear multilevel models using Stan
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,710 | 🐛 889 | 🌐 Go | 📅 2026-08-15: The Prometheus monitoring system and time series database.
* [dart](https://github.com/unit8co/darts) ⭐ 9,494 | 🐛 219 | 🌐 Python | 📅 2026-08-06: A python library for easy manipulation and forecasting of time series.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,116 | 🐛 157 | 🌐 C++ | 📅 2026-08-10: The Time Series Visualization Tool that you deserve.
...
* (pt-br) [Catálogos de dados abertos no Brasil](https://github.com/dadosgovbr/catalogos-dados-brasil) ⭐ 268 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2021-10-07: Mapeamento de iniciativas (e catálogos) de dados abertos governamentais no Brasil.
...
* [amsterdam-schema](https://github.com/Amsterdam/amsterdam-schema) ⭐ 21 | 🐛 5 | 🌐 Python | 📅 2026-08-14: Data modeling & verification for the City of Amsterdam's open data - based on JSON Schema
...
* [ImageMagick creates huge temporary files · Issue #395 · ImageMagick/ImageMagick](https://github.com/ImageMagick/ImageMagick/issues/395) ⭐ 17,164 | 🐛 161 | 🌐 C | 📅 2026-08-15
* [roughViz](https://github.com/jwilber/roughViz) ⭐ 7,148 | 🐛 13 | 🌐 JavaScript | 📅 2024-04-26: Reusable JavaScript library for creating sketchy/hand-drawn styled charts in the browser.
* [Microsoft open sources SandDance, a visual data exploration tool](https://cloudblogs.microsoft.com/opensource/2019/10/10/microsoft-open-sources-sanddance-visual-data-exploration-tool/). [site](https://sanddance.js.org/), [repo](https://github.com/Microsoft/SandDance) ⭐ 7,145 | 🐛 107 | 🌐 TypeScript | 📅 2026-08-10
* [OpenSubdiv](http://graphics.pixar.com/opensubdiv/docs/intro.html) ([github](https://github.com/PixarAnimationStudios/OpenSubdiv) ⭐ 3,069 | 🐛 62 | 🌐 C++ | 📅 2026-07-17): is a set of open source libraries that implement high performance subdivision surface (subdiv) evaluation on massively parallel CPU and GPU architectures.
* [vedo](https://github.com/marcomusy/vedo) ⭐ 2,261 | 🐛 171 | 🌐 Python | 📅 2026-08-04: A python module for scientific analysis of 3D objects based on VTK and numpy
* [Pseudo-bandlimited pixel art filtering in 3D – a mathematical derivation](http://themaister.net/blog/2018/08/25/pseudo-bandlimited-pixel-art-filtering-in-3d-a-mathematical-derivation/) [github](https://github.com/Themaister/Granite) ⭐ 1,935 | 🐛 2 | 🌐 C++ | 📅 2026-08-15
* [see](https://github.com/easystats/see) ⭐ 950 | 🐛 32 | 🌐 R | 📅 2026-08-04 Visualisation toolbox for beautiful and publication-ready figures
* [JPEG \[JAY-peg\]](https://github.com/corkami/docs/blob/master/images/jpeg.md) ⭐ 832 | 🐛 6 | 🌐 TeX | 📅 2024-05-04, some pocs [JPEG PoCs](https://github.com/corkami/pocs/blob/master/images/jpg/README.md) ⭐ 1,553 | 🐛 7 | 🌐 Assembly | 📅 2024-12-22
...
* Color Palettes:
  * [wesanderson](https://github.com/karthik/wesanderson) ⭐ 2,145 | 🐛 23 | 🌐 R | 📅 2024-06-13: A Wes Anderson color palette for R.
  ...
  * [Palettes for R based on the Scientific Colour-Maps](https://github.com/thomasp85/scico) ⭐ 481 | 🐛 4 | 🌐 R | 📅 2023-12-09: This is a small package to provide access to the colour palettes developed by Fabio Crameri..
...
* [jax](https://github.com/google/jax) ⭐ 36,163 | 🐛 2,584 | 🌐 Python | 📅 2026-08-15: Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more
* [micro](https://micro-editor.github.io/): a modern and intuitive [terminal-based text editor](https://github.com/zyedidia/micro#linux-clipboard-support) ⭐ 29,345 | 🐛 1,033 | 🌐 Go | 📅 2026-08-16.
* [pyodide](https://github.com/iodide-project/pyodide) ⭐ 14,791 | 🐛 400 | 🌐 Python | 📅 2026-08-15: The Python scientific stack, compiled to WebAssembly
...
* [programmers-introduction-to-mathematics](https://github.com/pim-book/programmers-introduction-to-mathematics) ⭐ 3,656 | 🐛 10 | 🌐 JavaScript | 📅 2023-03-04: Code for [A Programmer's Introduction to Mathematics](https://pimbook.org)
...
* [Rack](https://github.com/VCVRack/Rack) ⭐ 4,402 | 🐛 307 | 🌐 C++ | 📅 2025-11-04: The virtual Eurorack studio
...
* [This program generates bitmaps that are locally similar to the input bitmap](https://github.com/mxgmn/WaveFunctionCollapse) ⭐ 25,272 | 🐛 9 | 🌐 C# | 📅 2026-03-22
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,953 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13: Easily add particles animations to your website. Compatible also with React, Vue.js (2.x and 3.x), Angular, Svelte, jQuery, Preact, Inferno.
* [Walk through an infinite, procedurally generated city](https://github.com/marian42/wavefunctioncollapse) ⭐ 4,856 | 🐛 9 | 🌐 C# | 📅 2021-03-28
* [An interactive, explorable explanation about the peculiar magic of sound waves.](https://github.com/joshwcomeau/waveforms) ⭐ 1,481 | 🐛 4 | 🌐 JavaScript | 📅 2018-02-21
* [SOFA](https://www.sofa-framework.org/): is an efficient framework dedicated to research, prototyping and development of physics-based simulations. [github](https://github.com/sofa-framework/sofa/) ⭐ 1,245 | 🐛 447 | 🌐 C++ | 📅 2026-08-11.
...
* [astroquery](https://github.com/astropy/astroquery) ⭐ 788 | 🐛 410 | 🌐 Python | 📅 2026-08-13: Functions and classes to access online data resources. Maintainers: @keflavich and @bsipocz and @ceb8
...
* CDS Astro:
  ...
  * [CDS Tutorials](https://github.com/cds-astro/tutorials) ⭐ 85 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-08-16
...
* [Open MCT](https://nasa.github.io/openmct/): is a next-generation mission control framework for visualization of data on desktop and mobile devices - [github](https://github.com/nasa/openmct) ⭐ 13,084 | 🐛 1,066 | 🌐 JavaScript | 📅 2026-08-14
* [fprime](https://github.com/nasa/fprime) ⭐ 11,663 | 🐛 435 | 🌐 C++ | 📅 2026-08-15: A flight software and embedded systems framework.
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,580 | 🐛 18 | 🌐 Prolog | 📅 2026-08-13: A build-it-yourself, 6-wheel rover based on the rovers on Mars!
* [Sawppy](https://github.com/Roger-random/Sawppy_Rover) ⭐ 505 | 🐛 1 | 🌐 C | 📅 2025-09-21: is a motorized model of Mars rovers Curiosity and Mars 2020. It faithfully reproduces the Rocker-Bogie suspension kinematics of real rovers and is intended to be a hardware platform for future software projects in autonomous operation. Go forth and boldly explore the back yard, Sawppy!
...
* [MNE-Python](https://github.com/mne-tools/mne-python) ⭐ 3,484 | 🐛 635 | 🌐 Python | 📅 2026-08-15: Magnetoencephalography (MEG) and Electroencephalography (EEG) in Python
...
* [S2Geometry](http://s2geometry.io/): S2 is a library for spherical geometry that aims to have the same robustness, flexibility, and performance as the very best planar geometry libraries [github](https://github.com/google/s2geometry) ⭐ 2,709 | 🐛 75 | 🌐 C++ | 📅 2026-08-11.
...
* [Awesome Blockchain](https://github.com/yjjnls/awesome-blockchain) ⭐ 3,624 | 🐛 53 | 🌐 Go | 📅 2024-03-22: Curated list of resources for the development and applications of blockchain.
* [surpriver](https://github.com/tradytics/surpriver) ⭐ 1,872 | 🐛 13 | 🌐 Python | 📅 2021-08-13: Find big moving stocks before they move using machine learning and anomaly detection.
...
* [Memex](https://worldbrain.io/#) - your photographic memory for the web. Open-Source. Private. [repo](https://github.com/WorldBrain/Memex) ⭐ 4,713 | 🐛 319 | 🌐 TypeScript | 📅 2025-12-02
...
* [Awesome-Design-Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 40,889 | 🐛 180 | 🌐 JavaScript | 📅 2024-07-28: The best design tools for everything.
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,397 | 🐛 288 | 🌐 C | 📅 2026-08-15:Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
* [A single-header ANSI C gui library](https://github.com/vurtun/nuklear) ⚠️ Archived
* [PhysX SDK](https://news.developer.nvidia.com/announcing-physx-sdk-4-0-an-open-source-physics-engine/): an Open-Source [Physics Engine](https://github.com/NVIDIAGameWorks/PhysX-3.4) ⭐ 2,411 | 🐛 59 | 🌐 C++ | 📅 2022-11-15
* [Perceptual image hashing for PHP](https://github.com/jenssegers/imagehash) ⭐ 2,059 | 🐛 39 | 🌐 PHP | 📅 2025-09-17
* [glChAoS.P](https://www.michelemorrone.eu/glchaosp/)(opengl Chaotic Attractor of Slight (dot) Particles): open source - multiplatform - 3D real time strange attractors scout... and hypercomplex fractals. [github](https://github.com/BrutPitt/glChAoS.P) ⭐ 857 | 🐛 8 | 🌐 C++ | 📅 2025-02-10
* [This is a collection of simple to more involved examples to scripting in Blender with Python.](https://github.com/njanakiev/blender-scripting/blob/master/README.md#phyllotaxis-flower) ⭐ 822 | 🐛 2 | 🌐 Python | 📅 2021-09-28
...
* [Craft](https://github.com/fogleman/Craft) ⭐ 11,087 | 🐛 129 | 🌐 C | 📅 2024-04-03: A simple Minecraft clone written in C using modern OpenGL (shaders).
* [Opendiablo2](https://github.com/OpenDiablo2/OpenDiablo2) ⚠️ Archived: An open source re-implementation of Diablo 2
* [gb-studio](https://github.com/chrismaltby/gb-studio) ⭐ 9,363 | 🐛 796 | 🌐 TypeScript | 📅 2026-08-14: A free and easy to use retro adventure game creator for your favourite [handheld video game system](https://www.gbstudio.dev)
* [sm64](https://github.com/n64decomp/sm64) ⭐ 8,721 | 🐛 28 | 🌐 C | 📅 2024-02-04: A Super Mario 64 decompilation, brought to you by a bunch of clever folks.
* [MarkovJunior](https://github.com/mxgmn/MarkovJunior) ⭐ 8,163 | 🐛 9 | 🌐 C# | 📅 2026-03-20: Probabilistic PL based on pattern matching and constraint propagation, 148 examples.
...
* [OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,412 | 🐛 49 | 🌐 C++ | 📅 2026-08-12: A Framework for Reinforcement Learning in Games.
* [Zelda 3 in C](https://github.com/snesrev/zelda3) ⭐ 4,726 | 🐛 88 | 🌐 C | 📅 2023-12-27: A reimplementation of Zelda 3.
* [The Comprehensive Kerbal Archive Network (CKAN)](https://github.com/KSP-CKAN/CKAN) ⭐ 2,616 | 🐛 83 | 🌐 C# | 📅 2026-07-17
* [Synfig Studio](https://github.com/synfig/synfig/) ⭐ 2,280 | 🐛 730 | 🌐 C++ | 📅 2026-08-15: This is the Official source code repository of the Synfig project.
...
* [SDLPoP](https://github.com/NagyD/SDLPoP) ⭐ 1,272 | 🐛 78 | 🌐 C | 📅 2025-12-24: An open-source port of Prince of Persia, based on the disassembly of the DOS version.
* [quinesanek](https://github.com/taylorconor/quinesnake) ⭐ 926 | 🐛 1 | 🌐 C++ | 📅 2019-07-27: A quine that plays snake over its own source!
* [Links Awakening DX Disassembly](https://github.com/zladx/LADX-Disassembly) ⭐ 896 | 🐛 23 | 🌐 Assembly | 📅 2026-08-14: Disassembly of Legend of Zelda: Links Awakening DX.
* [wick editor](https://www.wickeditor.com/): [The Wick Editor is a free](https://github.com/Wicklets/wick-editor) ⭐ 833 | 🐛 186 | 🌐 JavaScript | 📅 2023-03-06, open-source tool for creating games, animations, and everything in-between!
...
* [Path to a free self-taught education in Computer Science!](https://github.com/ossu/computer-science) ⭐ 208,034 | 🐛 25 | 🌐 HTML | 📅 2026-07-14
* [the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,425 | 🐛 199 | 🌐 Jupyter Notebook | 📅 2026-05-20: One has no future if one couldn't teach themself.
...
* [FreshRSS](https://github.com/FreshRSS/FreshRSS) ⭐ 15,783 | 🐛 658 | 🌐 PHP | 📅 2026-08-14: A free, self-hostable aggregator…
* guardian [frontend](https://github.com/guardian/frontend) ⭐ 5,897 | 🐛 194 | 🌐 Scala | 📅 2026-08-15: Source for theguardian.com
...
* [walt](https://github.com/ballercat/walt) ⭐ 4,632 | 🐛 27 | 🌐 JavaScript | 📅 2023-01-02: Walt is a JavaScript-like syntax for WebAssembly text format
...
* [Sanic](https://github.com/sanic-org/sanic) ⭐ 18,645 | 🐛 145 | 🌐 Python | 📅 2026-07-29: Async Python 3.7+ web server/framework | Build fast. Run fast.
...
* [Differential Privacy](https://github.com/google/differential-privacy) ⭐ 3,341 | 🐛 60 | 🌐 Go | 📅 2026-08-06: This project contains a C++ library of ε-differentially private algorithms, which can be used to produce aggregate statistics over numeric data sets containing private or sensitive information.
...
* [Philosophy](https://github.com/Jfaler/Philosophize) ⭐ 363 | 🐛 1 | 📅 2020-12-27: 📚 A curated list of philosophy resources.
* [Translating and Interpreting Chinese Philosophy](https://plato.stanford.edu/entries/chinese-translate-interpret/)

## General

* [Apache Flink](https://github.com/apache/flink) ⭐ 26,262 | 🐛 377 | 🌐 Java | 📅 2026-08-14: Apache Flink is an open source stream processing framework with powerful stream- and batch-processing capabilities.
* [lists](https://github.com/jnv/lists) ⭐ 11,419 | 🐛 19 | 📅 2026-03-23: The definitive list of lists (of lists) curated on GitHub
* [awesome-uses](https://github.com/wesbos/awesome-uses) ⭐ 5,299 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-13: A list of /uses pages that detail apps and gear used by professional web developers.
* (pt-br) [Lista Maravilhosa de Projetos Open-Source](https://github.com/camilatigre/listamaravilhosaopensource) ⭐ 2,565 | 🐛 25 | 🌐 JavaScript | 📅 2026-06-15: Lista com links de projetos open-source para os níveis: iniciante, intermediário e avançado. Dividido por linguagem e idiomas!
* [gh-card](https://github.com/nwtgck/gh-card) ⭐ 1,350 | 🐛 55 | 🌐 TypeScript | 📅 2021-08-01, [link](https://gh-card.dev/)
* [pbspro](https://github.com/pbspro/pbspro) ⭐ 801 | 🐛 116 | 🌐 C | 📅 2026-04-10: An HPC workload manager and job scheduler for desktops, clusters, and clouds.
...
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 364,031 | 🐛 603 | 🌐 Python | 📅 2026-03-20: Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 358,824 | 🐛 124 | 📅 2025-08-28: A complete computer science study plan to become a software engineer.
* [GitHub Résumé](https://github.com/resume/resume.github.com) ⭐ 62,884 | 🐛 76 | 🌐 JavaScript | 📅 2023-02-15
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 51,365 | 🐛 12 | 🌐 JavaScript | 📅 2026-06-06: Companies that don't have a broken hiring process.
...
* [OpenResume](https://www.open-resume.com/) Create a professional resume easily with this free, open-source, and powerful [resume builder](https://github.com/xitanggg/open-resume) ⭐ 8,838 | 🐛 141 | 🌐 TypeScript | 📅 2024-10-29.
...
* [awesome-scifi](https://github.com/sindresorhus/awesome-scifi) ⭐ 5,006 | 🐛 0 | 📅 2025-12-22: I asked on Twitter for recommendations as I want to get into reading Sci-Fi novels. The below is the result. Thanks everyone for recommending your favorites! :)
...
* [📚 Freely available programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 394,475 | 🐛 82 | 🌐 Python | 📅 2026-08-11
* (pt-br) [Conteúdo gratuito](https://github.com/perifacode/conteudo-gratuito) ⭐ 1,854 | 🐛 37 | 📅 2024-04-17.
