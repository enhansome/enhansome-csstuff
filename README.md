...
* [PortalData](https://github.com/weecology/PortalData) ⭐ 51 | 🐛 5 | 🌐 R | 📅 2026-08-27 (Official Repo of the Portal Project Data) and [livedat](https://github.com/weecology/livedat) ⭐ 13 | 🐛 2 | 🌐 R | 📅 2019-01-30 (Template for living data workflow ).
...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 359,894 | 🐛 125 | 📅 2025-08-28
* [The Book of Secret Knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) ⭐ 240,766 | 🐛 170 | 📅 2024-11-19
* [z3](https://github.com/Z3Prover/z3) ⭐ 12,613 | 🐛 52 | 🌐 C++ | 📅 2026-08-28: The Z3 Theorem Prover
...
* [awesome-graph-embedding](https://github.com/benedekrozemberczki/awesome-graph-embedding) ⭐ 4,801 | 🐛 0 | 🌐 Python | 📅 2023-03-18: A collection of important graph embedding, classification and representation learning papers with implementations.
...
* [ClickHouse](https://github.com/ClickHouse/ClickHouse) ⭐ 49,507 | 🐛 7,208 | 🌐 C++ | 📅 2026-08-28: is a free analytics DBMS for big data.
* [HikariCP](https://github.com/brettwooldridge/HikariCP) ⭐ 21,195 | 🐛 544 | 🌐 Java | 📅 2026-06-14: 光 HikariCP・A solid, high-performance, JDBC connection pool at last.
* [quick-SQL-cheatsheet](https://github.com/enochtangg/quick-SQL-cheatsheet) ⭐ 5,450 | 🐛 11 | 📅 2020-10-01: A quick reminder of all SQL queries and examples on how to use them.
* [pgFormatter](https://github.com/darold/pgFormatter) ⭐ 1,953 | 🐛 25 | 🌐 PLpgSQL | 📅 2026-08-15: A PostgreSQL SQL syntax beautifier that can work as a console program or as a CGI. On-line demo [site](http://sqlformat.darold.net/)
...
* [Every Programmer Should Know thinking](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,346 | 🐛 25 | 📅 2025-12-29: A collection of (mostly) technical things every software developer should know
...
* [Prettier is an opinionated code formatter](https://github.com/prettier/prettier) ⭐ 52,215 | 🐛 1,414 | 🌐 JavaScript | 📅 2026-08-28
* [Mega Project List](https://github.com/karan/Projects) ⭐ 47,896 | 🐛 123 | 📅 2024-08-14: A list of practical projects that anyone can solve in any programming language.
* [dev.to](https://github.com/thepracticaldev/dev.to) ⭐ 22,770 | 🐛 128 | 🌐 Ruby | 📅 2026-08-27: Where programmers share ideas and help each other grow
* [Flow](https://github.com/facebook/flow) ⭐ 22,280 | 🐛 524 | 🌐 Rust | 📅 2026-08-27: Adds static typing to JavaScript to improve developer productivity and code quality.
* [Quine Relay](https://github.com/mame/quine-relay) ⭐ 14,592 | 🐛 18 | 🌐 Ruby | 📅 2025-10-24: An uroboros program with 100+ programming languages.
* [semantic](https://github.com/github/semantic) ⚠️ Archived: Parsing, analyzing, and comparing source code across many languages
* [Algorithms](http://jeffe.cs.illinois.edu/teaching/algorithms/): this web page contains a free electronic version of my (soon to be) self-published textbook Algorithms, along with other lecture notes I have written for various theoretical computer science classes at the University of Illinois, Urbana-Champaign since 1998. [github](https://github.com/jeffgerickson/algorithms) ⭐ 8,129 | 🐛 173 | 📅 2019-11-23
...
* (pt-br) [Canais Brasileiros para Pessoas Desenvolvedoras](https://github.com/carolcodes/youtube-br-desenvolvimento) ⭐ 2,505 | 🐛 0 | 🌐 Ruby | 📅 2025-03-24: Repositório de canais no Youtube BR sobre desenvolvimento.
* [small](https://github.com/mathiasbynens/small) ⭐ 2,300 | 🐛 55 | 🌐 HTML | 📅 2024-07-18: Smallest possible syntactically valid files of different types.
...
* [vscodium](https://github.com/VSCodium/vscodium) ⭐ 33,004 | 🐛 140 | 🌐 Shell | 📅 2026-08-28: binary releases of VS Code without MS branding/telemetry/licensing
  * [awesome-vscode](https://github.com/viatsko/awesome-vscode) ⭐ 28,981 | 🐛 53 | 🌐 JavaScript | 📅 2026-06-21: art A curated list of delightful VS Code packages and resources.
...
* [PC Assembly Language book](https://github.com/pacman128/pcasm) ⭐ 187 | 🐛 4 | 🌐 TeX | 📅 2025-05-27.
...
* [CppCoreGuidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,280 | 🐛 246 | 🌐 CSS | 📅 2026-08-06: The C++ Core Guidelines are a set of tried-and-true guidelines, rules, and best practices about coding in C++
* [Microsoft's C++ Standard Library](https://github.com/microsoft/STL) ⭐ 11,136 | 🐛 590 | 🌐 C++ | 📅 2026-08-28: MSVC's implementation of the C++ Standard Library.
* mozilla [rr](https://github.com/mozilla/rr) ⭐ 10,631 | 🐛 481 | 🌐 C++ | 📅 2026-08-16: is a lightweight tool for recording, replaying and debugging execution of applications (trees of processes and threads). Debugging extends gdb with very efficient reverse-execution, which in combination with standard gdb/x86 features like hardware data watchpoints, makes debugging much more fun.
* [GuiLite](https://github.com/idea4good/GuiLite) ⭐ 7,767 | 🐛 18 | 🌐 C++ | 📅 2025-10-22: heavy\_check\_markThe smallest UI framework for all platform -- 5K lines code
...
* [memory-profiler](https://github.com/nokia/memory-profiler) ⭐ 4,805 | 🐛 52 | 🌐 C | 📅 2023-07-28
...
* TDD C:
  * [Google Test](https://github.com/google/googletest) ⭐ 39,108 | 🐛 491 | 🌐 C++ | 📅 2026-08-27: Google Testing and Mocking Framework.
...
* [Makefile Tutorial by Example](https://makefiletutorial.com/) and [repo](https://github.com/theicfire/makefiletutorial) ⭐ 5,973 | 🐛 8 | 🌐 SCSS | 📅 2025-06-02
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,668 | 🐛 316 | 🌐 JavaScript | 📅 2026-04-08: A simple and modern GTK eBook viewer, built with GJS and Epub.js.
...
* [A curated list of awesome Python frameworks, libraries, software and resources](https://github.com/vinta/awesome-python#authentication) ⭐ 316,646 | 🐛 18 | 🌐 Python | 📅 2026-08-25
* [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) ⭐ 224,072 | 🐛 1,063 | 🌐 Python | 📅 2026-08-28: All Algorithms implemented in Python
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,903 | 🐛 80 | 🌐 Python | 📅 2026-08-26 framework, high performance, easy to learn, fast to code, ready for production
* cython [dtoa.c](https://github.com/python/cpython/blob/master/Python/dtoa.c) ⭐ 75,024 | 🐛 9,617 | 🌐 Python | 📅 2026-08-28
* [Rich](https://github.com/willmcgugan/rich) ⭐ 57,264 | 🐛 372 | 🌐 Python | 📅 2026-06-23 is a Python library for rich text and beautiful formatting in the terminal.
* [black](https://github.com/ambv/black/) ⭐ 41,820 | 🐛 303 | 🌐 Python | 📅 2026-08-20: The uncompromising Python code formatter
* [wtfpython](https://github.com/satwikkansal/wtfpython#-is-not--is-not-is-not-) ⭐ 37,066 | 🐛 72 | 🌐 Python | 📅 2026-01-13: A collection of surprising Python snippets and lesser-known features.
* [wtfpython](https://github.com/satwikkansal/wtfpython) ⭐ 37,066 | 🐛 72 | 🌐 Python | 📅 2026-01-13: What the f\*ck Python? ￼
* [Course Files for Complete Python 3 Bootcamp Course on Udemy](https://github.com/Pierian-Data/Complete-Python-3-Bootcamp) ⭐ 29,738 | 🐛 271 | 🌐 Jupyter Notebook | 📅 2025-06-24
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,308 | 🐛 397 | 🌐 Rust | 📅 2026-08-28A Python Interpreter written in Rust
* [kivy](https://github.com/kivy/kivy) ⭐ 19,011 | 🐛 850 | 🌐 Python | 📅 2026-08-28: Open source UI framework written in Python, running on Windows, Linux, macOS, Android and iOS.
...
* [alive-progress](https://github.com/rsalmei/alive-progress) ⭐ 6,296 | 🐛 17 | 🌐 Python | 📅 2026-05-24: An animated and smart Progress Bar for python.
...
* [cinder](https://github.com/facebookincubator/cinder) ⭐ 3,790 | 🐛 33 | 🌐 Python | 📅 2026-08-28
...
* [OpenTelemetry Python](https://github.com/open-telemetry/opentelemetry-python) ⭐ 2,604 | 🐛 398 | 🌐 Python | 📅 2026-08-28: OpenTelemetry Python API and SDK
* [austin](https://github.com/P403n1x87/austin) ⭐ 2,209 | 🐛 8 | 🌐 C | 📅 2026-08-25: Python frame stack sampler for CPython. Austin has a [tui](https://github.com/P403n1x87/austin-tui) ⭐ 665 | 🐛 2 | 🌐 Python | 📅 2026-06-04: The top-like text-based user interface for Austin.
...
* [vyper](https://github.com/ethereum/vyper/) ⭐ 5,180 | 🐛 648 | 🌐 Python | 📅 2026-08-28:
...
* Agda:
  * [Agda 2](https://github.com/agda/agda) ⭐ 2,920 | 🐛 1,040 | 🌐 Haskell | 📅 2026-08-27
  * [plfa](https://github.com/plfa/plfa.github.io/) ⭐ 1,513 | 🐛 65 | 🌐 Agda | 📅 2026-08-24: Introduction to programming language theory in Agda and [Programming Language Foundations in Agda](https://plfa.github.io/).
* Anglican:
...
* Answer Set Programming(ASP): offers a simple and powerful modeling language to solve combinatorial problems.
  * [Potassco](https://potassco.org/), [clingo](https://potassco.org/clingo/) and [github](https://github.com/potassco/clingo) ⭐ 828 | 🐛 17 | 🌐 C++ | 📅 2026-08-27.
* Brainfuck:
  * [Brainfuck](https://www.dcode.fr/brainfuck-language) encoder/decoder.
* Dafny:
  * [dafny](https://github.com/Microsoft/dafny) ⭐ 3,518 | 🐛 1,381 | 🌐 C# | 📅 2026-08-25: Dafny is a verification-aware programming language.
* Clean:
...
* Elixir:
  * [Nerves](https://github.com/nerves-project/nerves) ⭐ 2,484 | 🐛 21 | 🌐 Elixir | 📅 2026-08-27: Craft and deploy bulletproof embedded software in Elixir. [official site](http://nerves-project.org)
...
* Go:
  * [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 182,500 | 🐛 219 | 🌐 Go | 📅 2026-08-27: A curated list of awesome Go frameworks, libraries and software
  * [lattigo](https://github.com/lca1/lattigo) ⭐ 1,441 | 🐛 7 | 🌐 Go | 📅 2026-06-16: A lattice-based cryptographic library in Go.
  * [ObjectBox Go](https://github.com/objectbox/objectbox-go) ⭐ 1,274 | 🐛 19 | 🌐 Go | 📅 2025-03-12: persisting your Go structs/objects superfast and simple
...
* Java:
  ...
  * [Procyon](https://github.com/mstrobel/procyon) ⭐ 1,212 | 🐛 59 | 🌐 Java | 📅 2022-06-12: is a suite of Java metaprogramming tools, including a rich reflection API, a LINQ-inspired expression tree API for runtime code generation, and a Java decompiler.
* JavaScript:
...
* Lua:
  * [xmake](https://github.com/xmake-io/xmake) ⭐ 12,167 | 🐛 249 | 🌐 Lua | 📅 2026-08-28: 🔥 A cross-platform build [utility based on Lua](https://xmake.io)
* Nim:
  * [nim](https://nim-lang.org/): Efficient and expressive programming. [github](https://github.com/nim-lang/nim) ⭐ 18,197 | 🐛 2,199 | 🌐 Nim | 📅 2026-08-28
* Perl:
...
* PHP:
  * [A curated list of bookmarks, packages, tutorials, videos and other cool resources from the Laravel ecosystem](https://github.com/chiraggude/awesome-laravel) ⭐ 13,093 | 🐛 88 | 📅 2024-07-03
...
* Rust:
  * [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,017 | 🐛 7 | 🌐 Rust | 📅 2026-08-28: A curated list of Rust code and resources.
...
* V:
  * [V](https://github.com/vlang-io/V) ⭐ 37,801 | 🐛 99 | 🌐 V | 📅 2026-08-28: Simple, fast, safe, compiled language for creating maintainable software. Supports translation from C/C++.
  * [vlang](https://github.com/vlang/v) ⭐ 37,801 | 🐛 99 | 🌐 V | 📅 2026-08-28: Simple, fast, safe, compiled language for developing maintainable software. Supports translation from C and (soon) C++. Compiles itself in <1s.
* Verilog:
  * [Designing Hardware with Verilog](http://8bitworkshop.com/blog/release/2018/12/15/verilog-programming.html)
* Yorlang:
  * [yorlang](https://github.com/anoniscoding/yorlang) ⭐ 459 | 🐛 21 | 🌐 JavaScript | 📅 2026-01-12: [Yorlang](https://anoniscoding.github.io/yorlang/) is an esoteric programming language designed to write small programs using yoruba language constructs. It is the first of its kind and it can carry out basic programming operations in yoruba language (a language spoken in some parts of Nigeria ).
...
* [kompare](https://github.com/KDE/kompare) ⭐ 58 | 🐛 0 | 🌐 C++ | 📅 2026-08-27: Graphical File Differences Tool
...
* Starting Pull Requests:
  * [Awesome First PR Opportunities](https://github.com/MunGell/awesome-for-beginners) ⭐ 88,789 | 🐛 148 | 📅 2026-07-25
  * [Algorithmic-Pseudocode](https://github.com/Just-A-Visitor/Algorithmic-Pseudocode/issues) ⭐ 783 | 🐛 16 | 🌐 TeX | 📅 2024-04-21
...
* [.gitignore](https://github.com/github/gitignore) ⭐ 175,478 | 🐛 82 | 📅 2026-08-25: A collection of useful .gitignore templates
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,720 | 🐛 1,024 | 🌐 Go | 📅 2026-08-27: simple terminal UI for git commands
* [gitea](https://github.com/go-gitea/gitea) ⭐ 57,649 | 🐛 2,528 | 🌐 Go | 📅 2026-08-28: Git with a cup of tea, painless self-hosted git service
* [gogs](https://github.com/gogs/gogs) ⭐ 47,777 | 🐛 1,007 | 🌐 Go | 📅 2026-08-26: Gogs is a painless self-hosted Git service.
* [github-cli](https://github.com/cli/cli) ⭐ 46,036 | 🐛 1,064 | 🌐 Go | 📅 2026-08-28:  GitHub’s official command line tool
* [husky](https://github.com/typicode/husky) ⭐ 35,290 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19: Git hooks made easy
* [Learn git branching](https://learngitbranching.js.org/): An interactive git visualization to challenge and educate! [github](https://github.com/pcottle/learnGitBranching) ⭐ 33,960 | 🐛 62 | 🌐 JavaScript | 📅 2026-08-25.
* [cz-cli](https://github.com/commitizen/cz-cli) ⭐ 17,499 | 🐛 193 | 🌐 JavaScript | 📅 2026-08-11: The commitizen command line utility.
* [lint-staged](https://github.com/okonet/lint-staged) ⭐ 14,721 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-27: Run linters on git staged files
...
* [Pro Git book](https://git-scm.com/book/en/v2), written by Scott Chacon and Ben Straub ([github](https://github.com/progit/progit2) ⭐ 6,570 | 🐛 218 | 🌐 CSS | 📅 2026-05-25 repo)
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,070 | 🐛 12 | 🌐 Shell | 📅 2026-08-25 is a utility tool for git taking advantage of fuzzy finder fzf. [Interactive Git Commands With Previews Powered By fzf Fuzzy Finder](https://www.linuxuprising.com/2019/11/forgit-interactive-git-commands-with.html)
...
* [GitGuardian Documentation and Resources](https://github.com/GitGuardian/APISecurityBestPractices) ⭐ 1,980 | 🐛 11 | 📅 2019-07-08
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,932 | 🐛 36 | 🌐 Python | 📅 2026-07-06: Manage multiple git repos side by side for sanity
* [Git4Noobs](https://github.com/DanielHe4rt/git4noobs) ⭐ 1,611 | 🐛 3 | 📅 2024-09-28
* [Forge](https://github.com/magit/forge/) ⭐ 1,572 | 🐛 9 | 🌐 Emacs Lisp | 📅 2026-08-21: Work with Git forges from the comfort of Magit
...
* GitHub Profiles:
  * [Awesome Readme Stats](https://github.com/anmol098/waka-readme-stats) ⭐ 3,985 | 🐛 68 | 🌐 Python | 📅 2026-08-24
...
* [SkyWater Open Source PDK](https://github.com/google/skywater-pdk) ⭐ 3,674 | 🐛 199 | 🌐 Python | 📅 2026-07-21: Open source process design kit for usage with SkyWater Technology Foundry's 130nm node.
* [Ariane is a 6-stage RISC-V CPU](https://github.com/pulp-platform/ariane) ⭐ 3,085 | 🐛 286 | 🌐 Assembly | 📅 2026-08-28
* [cva6](https://github.com/openhwgroup/cva6) ⭐ 3,085 | 🐛 286 | 🌐 Assembly | 📅 2026-08-28: The CORE-V CVA6 is an Application class 6-stage RISC-V CPU capable of booting Linux.
* [hardware-effects](https://github.com/Kobzol/hardware-effects) ⭐ 2,999 | 🐛 11 | 🌐 C++ | 📅 2024-02-29: Demonstration of various hardware effects.
* [darkriscv](https://github.com/darklife/darkriscv) ⭐ 2,602 | 🐛 5 | 🌐 Verilog | 📅 2026-05-12: opensouce RISC-V implemented from scratch in one night!
* [NyuziProcessor](https://github.com/jbush001/NyuziProcessor/) ⭐ 2,219 | 🐛 91 | 🌐 C | 📅 2024-11-08: GPGPU microprocessor architecture
* [RARS](https://github.com/TheThirdOne/rars) ⭐ 1,618 | 🐛 76 | 🌐 Java | 📅 2024-07-19: RISC-V Assembler and Runtime Simulator.
* [The Zip CPU](https://github.com/ZipCPU/zipcpu) ⭐ 1,576 | 🐛 3 | 🌐 Verilog | 📅 2026-08-19: A small, light weight, RISC CPU soft core
...
* [Circuit Simulator](http://www.lushprojects.com/circuitjs/). [github](https://github.com/sharpie7/circuitjs1) ⭐ 2,940 | 🐛 266 | 🌐 Java | 📅 2024-01-22.
...
* [Incompatible Timesharing System](https://github.com/PDP-10/its) ⭐ 952 | 🐛 507 | 🌐 Assembly | 📅 2026-08-19: ITS, the Incompatible Timesharing System, is an operating system for the PDP-10 computer family. It was created by hackers at MIT in the 1960s. The MIT site was shut down in 1990, but enthusiasts continue to operate ITS systems to this day.
* [EmuTOS](https://github.com/emutos/emutos) ⭐ 302 | 🐛 13 | 🌐 C | 📅 2026-08-23: is a Free operating system for Atari computers, and more.
* [KTF](https://github.com/awslabs/ktf) ⭐ 155 | 🐛 28 | 🌐 C | 📅 2025-11-25- Kernel Test Framework.
* [9hist](https://github.com/0intro/9hist) ⭐ 142 | 🐛 0 | 🌐 C | 📅 2022-04-04: History of the Plan 9 kernel (1990 - 2003).
...
* [GraalVM](https://github.com/oracle/graal) ⭐ 21,676 | 🐛 850 | 🌐 Java | 📅 2026-08-27: GraalVM is a universal virtual machine for running applications written in JavaScript, Python, Ruby, R, JVM-based languages like Java, Scala, Clojure, Kotlin, and LLVM-based languages such as C and C++. [GraalVM Implementation of Python](https://github.com/graalvm/graalpython) ⭐ 1,636 | 🐛 73 | 🌐 Python | 📅 2026-08-26
* [Compiler Explorer](https://godbolt.org/): Run compilers interactively from your web browser and interact with the assembly. [github](https://github.com/mattgodbolt/compiler-explorer) ⭐ 19,011 | 🐛 833 | 🌐 TypeScript | 📅 2026-08-27, [how it works](https://xania.org/201609/how-compiler-explorer-runs-on-amazon).
...
* [cookiecutter-flask](https://github.com/cookiecutter-flask/cookiecutter-flask) ⭐ 4,722 | 🐛 24 | 🌐 Python | 📅 2025-12-02: A flask template with Bootstrap 4, asset bundling+minification with webpack, starter templates, and registration/authentication. For use with cookiecutter.
...
* (pt-br) [Do zero a implantação](https://github.com/cassiobotaro/do_zero_a_implantacao): utilizando Python. [Construindo API's robustas utilizando Python](https://github.com/luizalabs/tutorial-python-brasil) ⭐ 360 | 🐛 2 | 🌐 Python | 📅 2021-11-23 []()

## Distributed Systems

* [FASTER](https://github.com/Microsoft/FASTER) ⭐ 6,639 | 🐛 35 | 🌐 C# | 📅 2026-08-19: Fast key-value store from Microsoft Research
* [porcupine](https://github.com/anishathalye/porcupine/) ⭐ 1,241 | 🐛 4 | 🌐 Go | 📅 2026-08-06: A fast linearizability checker written in Go
...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,224 | 🐛 489 | 🌐 C++ | 📅 2026-08-25: Tesseract Open Source OCR Engine (main repository)
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,944 | 🐛 530 | 🌐 Python | 📅 2025-12-05: Ready-to-use OCR with 40+ languages supported including Chinese, Japanese, Korean and Thai.
* [annoy](https://github.com/spotify/annoy) ⭐ 14,290 | 🐛 86 | 🌐 C++ | 📅 2025-10-29: Approximate Nearest Neighbors in C++/Python optimized for memory usage and loading/saving to disk
* [pampy](https://github.com/santinic/pampy) ⭐ 3,523 | 🐛 23 | 🌐 Python | 📅 2025-01-16: The Pattern Matching for Python you always dreamed of.

## Artificial Intelligence

* [faceswap](https://github.com/deepfakes/faceswap) ⭐ 57,508 | 🐛 14 | 🌐 Python | 📅 2026-08-05: Non official project based on original /r/Deepfakes thread. Many thanks to him!
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 164,551 | 🐛 2,409 | 🌐 Python | 📅 2026-08-28: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch.
* [nanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,541 | 🐛 351 | 🌐 Python | 📅 2025-11-12: The simplest, fastest repository for training/finetuning medium-sized GPTs.
* [Industrial-strength Natural Language Processing (NLP) with Python and Cython](https://github.com/explosion/spaCy/) ⭐ 33,857 | 🐛 236 | 🌐 Python | 📅 2026-08-24
...
* [Language Interpretability Tool (LIT)](https://github.com/pair-code/lit/) ⭐ 3,661 | 🐛 138 | 🌐 TypeScript | 📅 2026-07-29: Interactively analyze NLP models for model understanding in an extensible and framework agnostic interface.
* [PromptSource](https://github.com/bigscience-workshop/promptsource) ⭐ 3,031 | 🐛 44 | 🌐 Python | 📅 2023-10-23
* [Argdown](https://argdown.org/): A simple syntax for complex argumentation. [argdown repo](https://github.com/christianvoigt/argdown) ⭐ 1,033 | 🐛 96 | 🌐 TypeScript | 📅 2026-08-11
...
* [google-10000-english](https://github.com/first20hours/google-10000-english) ⭐ 4,464 | 🐛 28 | 📅 2023-05-17: This repo contains a list of the 10,000 most common English words in order of frequency, as determined by n-gram frequency analysis of the Google's Trillion Word Corpus.
...
* [Real-Time Voice Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning) ⭐ 60,115 | 🐛 177 | 🌐 Python | 📅 2026-03-09: Clone a voice in 5 seconds to generate arbitrary speech in real-time
...
* [DeepMind Research](https://github.com/deepmind/deepmind-research) ⭐ 15,170 | 🐛 358 | 🌐 Jupyter Notebook | 📅 2026-06-17: This repository contains implementations and illustrative code to accompany DeepMind publications.
* [vosk-api](https://github.com/alphacep/vosk-api) ⭐ 15,080 | 🐛 602 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API for Android, iOS, Raspberry Pi and servers with Python, Java, C# and Node.
...
* [CARLA](https://carla.org): Open-source simulator for [autonomous driving research](https://github.com/carla-simulator/carla) ⭐ 14,334 | 🐛 1,192 | 🌐 C++ | 📅 2026-08-28.
...
* [lip reading](https://github.com/astorfi/lip-reading-deeplearning) ⭐ 1,905 | 🐛 7 | 🌐 Python | 📅 2022-11-07: Cross Audio-Visual Recognition using 3D Architectures
...
* [CFU Playground](https://github.com/google/CFU-Playground) ⭐ 562 | 🐛 142 | 🌐 Verilog | 📅 2026-02-26: Want a faster ML processor? Do it yourself! -- A framework for playing with custom opcodes to accelerate TensorFlow Lite for Microcontrollers (TFLM).
...
* [awesome-edge-machine-learning](https://github.com/Bisonai/awesome-edge-machine-learning) ⭐ 281 | 🐛 3 | 🌐 Python | 📅 2023-02-23: A curated list of awesome edge machine learning resources, including research papers, inference engines, challenges, books, meetups and others.
...
* Autonomous Vehicles:
  * [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,426 | 🐛 780 | 🌐 C++ | 📅 2026-06-30: Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
...
* [mit-deep-learning](https://github.com/lexfridman/mit-deep-learning) ⭐ 10,453 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2024-01-03: Tutorials, assignments, and competitions for MIT Deep Learning related courses.
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,352 | 🐛 1,002 | 🌐 C# | 📅 2026-08-27: is an open source and cross-platform machine learning framework for .NET.
* [DeepLabCut](http://www.mackenziemathislab.org/deeplabcut): is an efficient method for 3D markerless pose estimation based on transfer learning with deep neural networks that achieves excellent results (i.e. you can match human labeling accuracy) with minimal training data (typically 50-200 frames). [repo](https://github.com/DeepLabCut/DeepLabCut) ⭐ 5,747 | 🐛 46 | 🌐 Python | 📅 2026-08-28
* [Is a Green Screen Really Necessary for Real-Time Human Matting?](https://arxiv.org/pdf/2011.11961.pdf), [repo](https://github.com/ZHKKKe/MODNet) ⭐ 4,356 | 🐛 71 | 🌐 Python | 📅 2024-05-06
* [Nevergrad](https://code.fb.com/ai-research/nevergrad/): An open source tool for derivative-free optimization. [github](https://github.com/facebookresearch/nevergrad) ⭐ 4,204 | 🐛 141 | 🌐 Python | 📅 2026-07-24
...
* [The Tsetlin Machine](https://arxiv.org/abs/1804.01508): A Game Theoretic Bandit Driven Approach to Optimal Pattern Recognition with Propositional Logic. [github](https://github.com/cair/TsetlinMachine) ⭐ 506 | 🐛 0 | 🌐 Cython | 📅 2026-02-10.
...
* [Stable Diffusion](https://github.com/CompVis/stable-diffusion) ⭐ 73,354 | 🐛 618 | 🌐 Jupyter Notebook | 📅 2024-06-18: is a latent text-to-image diffusion model. Thanks to a generous compute donation from Stability AI and support from LAION, we were able to train a Latent Diffusion Model on 512x512 images from a subset of the LAION-5B database.
* [Wan](https://github.com/Wan-Video/Wan2.2) ⭐ 17,312 | 🐛 294 | 🌐 Python | 📅 2026-03-17: Open and Advanced Large-Scale Video Generative Models
...
* [Deep Convolutional Generative Adversarial Network](https://www.tensorflow.org/tutorials/generative/dcgan) [jupyter notebook](https://github.com/tensorflow/docs/blob/master/site/en/tutorials/generative/dcgan.ipynb) ⭐ 6,329 | 🐛 67 | 🌐 Jupyter Notebook | 📅 2026-07-09
* [Image Deduplicator](https://idealo.github.io/imagededup/): [imagededup](https://github.com/idealo/imagededup) ⭐ 5,667 | 🐛 38 | 🌐 Python | 📅 2025-08-15 is a python package that simplifies the task of finding exact and near duplicates in an image collection.
...
* [Handwriting Synthesis](https://github.com/sjvasquez/handwriting-synthesis) ⭐ 4,803 | 🐛 63 | 🌐 Python | 📅 2024-01-11
* [Random Forest vs Neural Network](https://mljar.com/blog/random-forest-vs-neural-network-classification/)(classification, tabular data) - [github](https://github.com/mljar/mljar-supervised) ⭐ 3,286 | 🐛 129 | 🌐 Python | 📅 2026-07-27
...
* [NEST](https://github.com/nest/nest-simulator) ⭐ 660 | 🐛 228 | 🌐 C++ | 📅 2026-08-26: NEST is a simulator for spiking neural network models that focuses on the dynamics, size and structure of neural systems rather than on the exact morphology of individual neurons.
...
* [fiftyone](https://github.com/voxel51/fiftyone) ⭐ 11,046 | 🐛 674 | 🌐 TypeScript | 📅 2026-08-28: The open-source tool for building high-quality datasets and computer vision models
...
* [imagenette](https://github.com/fastai/imagenette) ⭐ 1,132 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2022-09-26: A smaller subset of 10 easily classified classes from Imagenet, and a little more French
...
*Frameworks for Neural Networks and Deep Learning. See: [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,822 | 🐛 84 | 📅 2025-05-26.*

* [Keras](https://github.com/fchollet/keras) ⭐ 64,260 | 🐛 253 | 🌐 Python | 📅 2026-08-26 - A high-level neural networks library and capable of running on top of either TensorFlow or Theano.
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,642 | 🐛 17,413 | 🌐 Python | 📅 2026-08-28: Tensors and Dynamic neural networks in Python with strong GPU acceleration a ([tour](http://blog.christianperone.com/2018/03/pytorch-internal-architecture-tour/)):
* [tinygrad](https://github.com/geohot/tinygrad) ⭐ 33,520 | 🐛 182 | 🌐 Python | 📅 2026-08-28: You like pytorch? You like [micrograd](https://github.com/karpathy/micrograd) ⭐ 17,293 | 🐛 79 | 🌐 Jupyter Notebook | 📅 2026-08-03? You love tinygrad! ❤️
...
* [Deep-reinforcement-learning-with-pytorch](https://github.com/sweetice/Deep-reinforcement-learning-with-pytorch) ⭐ 4,650 | 🐛 29 | 🌐 Python | 📅 2023-03-24: PyTorch implementation of DQN, AC, ACER, A2C, A3C, PG, DDPG, TRPO, PPO, SAC, TD3 and ....
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,759 | 🐛 2,960 | 🌐 C++ | 📅 2026-08-28 - The most popular Deep Learning framework created by Google.
* [BERT](https://github.com/google-research/bert) ⚠️ Archived: TensorFlow code and pre-trained models for BERT
* [Machine Learning Notebooks](https://github.com/ageron/handson-ml2) ⭐ 29,956 | 🐛 229 | 🌐 Jupyter Notebook | 📅 2026-05-19: A series of Jupyter notebooks that walk you through the fundamentals of Machine Learning and Deep Learning in Python using Scikit-Learn, Keras and TensorFlow 2.
* [TensorFlow-Course](https://github.com/open-source-for-science/TensorFlow-Course) ⭐ 16,278 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2022-11-28: Simple and ready-to-use tutorials for TensorFlow
* [Ludwig](https://github.com/uber/ludwig) ⭐ 11,745 | 🐛 1 | 🌐 Python | 📅 2026-08-24: [is a toolbox built](https://uber.github.io/ludwig/) on top of TensorFlow that allows to train and test deep learning models without the need to write code.
...
* [tensorFlow Privacy](https://github.com/tensorflow/privacy) ⭐ 2,026 | 🐛 136 | 🌐 Python | 📅 2026-08-26: Library for training machine learning models with privacy for training data
...
* [Queueing theory](https://github.com/joelparkerhenderson/queueing_theory) ⭐ 2,235 | 🐛 1 | 📅 2026-06-07: an introduction for software development.
...
* Good channels:
  * [3blue1brown](https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw/): 3blue1brown, by Grant Sanderson, is some combination of math and entertainment, depending on your disposition ([site](https://www.3blue1brown.com/)) and [manim](https://github.com/3b1b/manim) ⭐ 92,138 | 🐛 490 | 🌐 Python | 📅 2026-08-18(Animation engine for explanatory math videos).
...
* [statrethinking\_winter2019](https://github.com/rmcelreath/statrethinking_winter2019) ⭐ 2,020 | 🐛 26 | 📅 2020-05-24: Statistical Rethinking course at MPI-EVA from Dec 2018 through Feb 2019
...
* [Awesome Data Science](https://github.com/bulutyazilim/awesome-datascience) ⭐ 29,883 | 🐛 8 | 📅 2026-08-27
* [The Data Engineering Cookbook](https://github.com/andkret/Cookbook) ⭐ 15,380 | 🐛 128 | 🌐 Python | 📅 2026-07-23
* [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,297 | 🐛 1,340 | 🌐 Python | 📅 2026-08-28: Official repository for Spyder - The Scientific Python Development Environment
* [Luna](https://www.luna-lang.org/) is a data processing and visualization environment built on a principle that people need an immediate connection to what they are building. [github repo](https://github.com/luna/luna) ⭐ 7,439 | 🐛 325 | 🌐 Java | 📅 2026-08-10, [studio](https://github.com/luna/luna-studio) (IDE) and [docs](https://luna-lang.gitbooks.io/docs/content/interface.html)
* [ferret](https://github.com/MontFerret/ferret) ⭐ 6,008 | 🐛 11 | 🌐 Go | 📅 2026-08-25: Declarative web scraping
* [RAPIDS](http://rapids.ai): Open GPU Data Science. The RAPIDS suite of software libraries gives you the freedom to execute end-to-end data science and analytics pipelines entirely on GPUs. It relies on NVIDIA® CUDA® primitives for low-level compute optimization, but exposes that GPU parallelism and high-bandwidth memory speed through user-friendly Python interfaces. [cuml](https://github.com/rapidsai/cuml) ⭐ 5,266 | 🐛 844 | 🌐 Python | 📅 2026-08-28 - RAPIDS Machine Learning Library.
...
* [insight](https://github.com/easystats/insight) ⭐ 439 | 🐛 59 | 🌐 R | 📅 2026-08-28: Easy access to model information for various model objects.
...
* Python:
  ...
  * [arviz](https://github.com/arviz-devs/arviz) ⭐ 1,851 | 🐛 110 | 🌐 TeX | 📅 2026-08-17: Python package to plot and analyse samples from probabilistic models
  ...
  * [pyjanitor](https://github.com/ericmjl/pyjanitor) ⭐ 1,498 | 🐛 154 | 🌐 Python | 📅 2026-08-28: Python implementation of R package Janitor
  ...
  * [Python Plotting for Exploratory Data Analysis](https://pythonplot.com/)  by [Tim Hopper](https://twitter.com/tdhopper/status/1212821555710963712) [repo](https://github.com/tdhopper/pythonplot.com) ⭐ 113 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-08-26
...
* Jupyter:
  ...
  * [jupytext](https://github.com/mwouts/jupytext) ⭐ 7,234 | 🐛 171 | 🌐 Python | 📅 2026-08-18: Jupyter notebooks as Markdown documents, Julia, Python or R scripts
  * [The Jupyter Notebooks behind: "A Whirlwind Tour of Python"](https://github.com/jakevdp/WhirlwindTourOfPython) ⭐ 4,034 | 🐛 25 | 🌐 Jupyter Notebook | 📅 2024-01-31
  ...
  * [nbtutor](https://github.com/lgpage/nbtutor) ⭐ 472 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-25: Visualize Python code execution (line-by-line) in Jupyter Notebook cells.
...
* R Lang
  * [brms](https://github.com/paul-buerkner/brms) ⭐ 1,424 | 🐛 159 | 🌐 R | 📅 2026-08-24: R package for Bayesian generalized multivariate non-linear multilevel models using Stan
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,872 | 🐛 878 | 🌐 Go | 📅 2026-08-28: The Prometheus monitoring system and time series database.
* [dart](https://github.com/unit8co/darts) ⭐ 9,510 | 🐛 227 | 🌐 Python | 📅 2026-08-21: A python library for easy manipulation and forecasting of time series.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,133 | 🐛 161 | 🌐 C++ | 📅 2026-08-10: The Time Series Visualization Tool that you deserve.
* [OpenTSDB](http://opentsdb.net/): A scalable, distributed Time Series Database. [repo](https://github.com/OpenTSDB/opentsdb) ⭐ 5,065 | 🐛 538 | 🌐 Java | 📅 2024-12-12
...
* [palmerpenguins](https://github.com/allisonhorst/palmerpenguins) ⭐ 1,016 | 🐛 18 | 🌐 R | 📅 2024-09-19: A great intro dataset for data exploration & visualization (alternative to iris).
...
* [amsterdam-schema](https://github.com/Amsterdam/amsterdam-schema) ⭐ 21 | 🐛 7 | 🌐 Python | 📅 2026-08-26: Data modeling & verification for the City of Amsterdam's open data - based on JSON Schema
...
* [ImageMagick creates huge temporary files · Issue #395 · ImageMagick/ImageMagick](https://github.com/ImageMagick/ImageMagick/issues/395) ⭐ 17,237 | 🐛 158 | 🌐 C | 📅 2026-08-28
* [roughViz](https://github.com/jwilber/roughViz) ⭐ 7,152 | 🐛 13 | 🌐 JavaScript | 📅 2024-04-26: Reusable JavaScript library for creating sketchy/hand-drawn styled charts in the browser.
* [Microsoft open sources SandDance, a visual data exploration tool](https://cloudblogs.microsoft.com/opensource/2019/10/10/microsoft-open-sources-sanddance-visual-data-exploration-tool/). [site](https://sanddance.js.org/), [repo](https://github.com/Microsoft/SandDance) ⭐ 7,143 | 🐛 95 | 🌐 TypeScript | 📅 2026-08-25
* [OpenSubdiv](http://graphics.pixar.com/opensubdiv/docs/intro.html) ([github](https://github.com/PixarAnimationStudios/OpenSubdiv) ⭐ 3,070 | 🐛 58 | 🌐 C++ | 📅 2026-08-19): is a set of open source libraries that implement high performance subdivision surface (subdiv) evaluation on massively parallel CPU and GPU architectures.
* [vedo](https://github.com/marcomusy/vedo) ⭐ 2,265 | 🐛 172 | 🌐 Python | 📅 2026-08-04: A python module for scientific analysis of 3D objects based on VTK and numpy
* [Pseudo-bandlimited pixel art filtering in 3D – a mathematical derivation](http://themaister.net/blog/2018/08/25/pseudo-bandlimited-pixel-art-filtering-in-3d-a-mathematical-derivation/) [github](https://github.com/Themaister/Granite) ⭐ 1,938 | 🐛 3 | 🌐 C++ | 📅 2026-08-15
...
* GGplot2:
  * [ggeffects](https://github.com/strengejacke/ggeffects) ⭐ 608 | 🐛 62 | 🌐 R | 📅 2026-08-19: Tidy Data Frames of Marginal Effects for ggplot2.
  * [ggalluvial](https://github.com/corybrunson/ggalluvial) ⭐ 522 | 🐛 20 | 🌐 R | 📅 2026-07-31
  * [ggseg](https://github.com/LCBC-UiO/ggseg) ⭐ 271 | 🐛 2 | 🌐 R | 📅 2026-08-10: Plotting tool for brain atlases, in ggplot.
...
* Color Palettes:
  * [wesanderson](https://github.com/karthik/wesanderson) ⭐ 2,152 | 🐛 23 | 🌐 R | 📅 2024-06-13: A Wes Anderson color palette for R.
...
* [FiPy](https://github.com/usnistgov/fipy) ⭐ 636 | 🐛 177 | 🌐 Python | 📅 2026-08-27: is a Finite Volume PDE solver written in Python.
...
* [jax](https://github.com/google/jax) ⭐ 36,219 | 🐛 2,489 | 🌐 Python | 📅 2026-08-28: Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more
* [micro](https://micro-editor.github.io/): a modern and intuitive [terminal-based text editor](https://github.com/zyedidia/micro#linux-clipboard-support) ⭐ 29,448 | 🐛 986 | 🌐 Go | 📅 2026-08-28.
* [pyodide](https://github.com/iodide-project/pyodide) ⭐ 14,804 | 🐛 396 | 🌐 Python | 📅 2026-08-27: The Python scientific stack, compiled to WebAssembly
* [libvips](https://github.com/libvips/libvips) ⭐ 11,614 | 🐛 80 | 🌐 C | 📅 2026-08-27: A fast image processing library with low memory needs.
* [Oni](https://github.com/onivim/oni) ⚠️ Archived: Modern Modal Editing - powered by Neovim
* [bild](https://github.com/anthonynsimon/bild) ⭐ 4,206 | 🐛 17 | 🌐 Go | 📅 2026-08-01: A collection of parallel image processing algorithms in pure Go
...
* [Sonic Visualiser](https://www.sonicvisualiser.org/) is a free, open-source application for Windows, Linux, and Mac, designed to be the first program you reach for when want to study a music recording closely. It's designed for musicologists, archivists, signal-processing researchers, and anyone else looking for a friendly way to look at what lies inside the audio file. [github repo](https://github.com/sonic-visualiser/sonic-visualiser) ⭐ 888 | 🐛 83 | 🌐 C++ | 📅 2025-12-07
...
* [This program generates bitmaps that are locally similar to the input bitmap](https://github.com/mxgmn/WaveFunctionCollapse) ⭐ 25,294 | 🐛 9 | 🌐 C# | 📅 2026-03-22
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,972 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13: Easily add particles animations to your website. Compatible also with React, Vue.js (2.x and 3.x), Angular, Svelte, jQuery, Preact, Inferno.
* [Walk through an infinite, procedurally generated city](https://github.com/marian42/wavefunctioncollapse) ⭐ 4,856 | 🐛 9 | 🌐 C# | 📅 2021-03-28
* [An interactive, explorable explanation about the peculiar magic of sound waves.](https://github.com/joshwcomeau/waveforms) ⭐ 1,480 | 🐛 4 | 🌐 JavaScript | 📅 2018-02-21
* [SOFA](https://www.sofa-framework.org/): is an efficient framework dedicated to research, prototyping and development of physics-based simulations. [github](https://github.com/sofa-framework/sofa/) ⭐ 1,251 | 🐛 462 | 🌐 C++ | 📅 2026-08-27.
...
* [gqrx](https://gqrx.dk/): is an open source software defined radio receiver (SDR) powered by the GNU Radio and the Qt graphical toolkit. [Gqrx](https://github.com/csete/gqrx) ⭐ 3,665 | 🐛 265 | 🌐 C++ | 📅 2026-08-06
...
* [astroquery](https://github.com/astropy/astroquery) ⭐ 790 | 🐛 414 | 🌐 Python | 📅 2026-08-25: Functions and classes to access online data resources. Maintainers: @keflavich and @bsipocz and @ceb8
* [astroplan](https://github.com/astropy/astroplan) ⭐ 224 | 🐛 70 | 🌐 Python | 📅 2026-08-27: Observation planning package for astronomers.
...
* CDS Astro:
  ...
  * [Aladin Lite](https://github.com/cds-astro/aladin-lite) ⭐ 154 | 🐛 61 | 🌐 JavaScript | 📅 2026-07-17: An astronomical HiPS visualizer in the browser.
...
* [Open MCT](https://nasa.github.io/openmct/): is a next-generation mission control framework for visualization of data on desktop and mobile devices - [github](https://github.com/nasa/openmct) ⭐ 13,095 | 🐛 1,071 | 🌐 JavaScript | 📅 2026-08-26
* [fprime](https://github.com/nasa/fprime) ⭐ 11,703 | 🐛 451 | 🌐 C++ | 📅 2026-08-28: A flight software and embedded systems framework.
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,612 | 🐛 17 | 🌐 Prolog | 📅 2026-08-13: A build-it-yourself, 6-wheel rover based on the rovers on Mars!
...
* [MNE-Python](https://github.com/mne-tools/mne-python) ⭐ 3,497 | 🐛 627 | 🌐 Python | 📅 2026-08-28: Magnetoencephalography (MEG) and Electroencephalography (EEG) in Python
...
* [baltic](https://github.com/evogytis/baltic) ⭐ 128 | 🐛 5 | 🌐 Python | 📅 2026-08-27: backronymed adaptable lightweight tree import code for molecular phylogeny manipulation, analysis and visualisation. Development is back on the evogytis/baltic branch (i.e. here).
* [Seraphim](http://evolve.zoo.ox.ac.uk/Evolve/Seraphim.html): Studying Environmental Rasters And PHylogenetically Informed Movements. [seraphim](https://github.com/evogytis/baltic) ⭐ 128 | 🐛 5 | 🌐 Python | 📅 2026-08-27 is a R package for studying environmental rasters and phylogenetic informed movements
...
* [plus codes](https://plus.codes/). [open-location-code](https://github.com/google/open-location-code) ⭐ 4,346 | 🐛 61 | 🌐 Java | 📅 2026-03-30: Open Location Code is a library to generate short codes that can be used like street addresses, for places where street addresses don't exist.
* [S2Geometry](http://s2geometry.io/): S2 is a library for spherical geometry that aims to have the same robustness, flexibility, and performance as the very best planar geometry libraries [github](https://github.com/google/s2geometry) ⭐ 2,719 | 🐛 77 | 🌐 C++ | 📅 2026-08-25.
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 942 | 🐛 19 | 🌐 R | 📅 2026-08-21: Easy access to shapefiles of the Brazilian Institute of Geography and Statistics (IBGE) and other official spatial data sets of Brazil.
...
* [Awesome Blockchain](https://github.com/yjjnls/awesome-blockchain) ⭐ 3,628 | 🐛 51 | 🌐 Go | 📅 2024-03-22: Curated list of resources for the development and applications of blockchain.
* [surpriver](https://github.com/tradytics/surpriver) ⭐ 1,876 | 🐛 13 | 🌐 Python | 📅 2021-08-13: Find big moving stocks before they move using machine learning and anomaly detection.
...
* [Awesome-Design-Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 41,017 | 🐛 193 | 🌐 JavaScript | 📅 2024-07-28: The best design tools for everything.
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,438 | 🐛 285 | 🌐 C++ | 📅 2026-08-27:Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
...
* [Perceptual image hashing for PHP](https://github.com/jenssegers/imagehash) ⭐ 2,063 | 🐛 39 | 🌐 PHP | 📅 2025-09-17
...
* [Craft](https://github.com/fogleman/Craft) ⭐ 11,094 | 🐛 129 | 🌐 C | 📅 2024-04-03: A simple Minecraft clone written in C using modern OpenGL (shaders).
* [Opendiablo2](https://github.com/OpenDiablo2/OpenDiablo2) ⚠️ Archived: An open source re-implementation of Diablo 2
* [gb-studio](https://github.com/chrismaltby/gb-studio) ⭐ 9,386 | 🐛 789 | 🌐 TypeScript | 📅 2026-08-28: A free and easy to use retro adventure game creator for your favourite [handheld video game system](https://www.gbstudio.dev)
* [sm64](https://github.com/n64decomp/sm64) ⭐ 8,739 | 🐛 28 | 🌐 C | 📅 2024-02-04: A Super Mario 64 decompilation, brought to you by a bunch of clever folks.
* [MarkovJunior](https://github.com/mxgmn/MarkovJunior) ⭐ 8,168 | 🐛 9 | 🌐 C# | 📅 2026-03-20: Probabilistic PL based on pattern matching and constraint propagation, 148 examples.
* [Citybound](https://github.com/citybound/citybound) ⭐ 8,153 | 🐛 153 | 🌐 Rust | 📅 2023-01-07: Citybound is a city building game with a focus on realism, collaborative planning and simulation of microscopic details.
* [OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,440 | 🐛 42 | 🌐 C++ | 📅 2026-08-25: A Framework for Reinforcement Learning in Games.
* [Zelda 3 in C](https://github.com/snesrev/zelda3) ⭐ 4,739 | 🐛 88 | 🌐 C | 📅 2023-12-27: A reimplementation of Zelda 3.
* [The Comprehensive Kerbal Archive Network (CKAN)](https://github.com/KSP-CKAN/CKAN) ⭐ 2,628 | 🐛 84 | 🌐 C# | 📅 2026-07-17
* [Synfig Studio](https://github.com/synfig/synfig/) ⭐ 2,285 | 🐛 725 | 🌐 C++ | 📅 2026-08-27: This is the Official source code repository of the Synfig project.
* [Hypersomnia](https://github.com/TeamHypersomnia/Hypersomnia) ⭐ 1,624 | 🐛 13 | 🌐 C++ | 📅 2026-08-22: Multiplayer top-down shooter made from scratch. Comes with an in-game Editor!
* [toy](https://github.com/hugoam/toy) ⭐ 1,593 | 🐛 13 | 🌐 C++ | 📅 2021-04-25: the thin c++ game engine - [toyengine](https://hugoam.github.io/toy-io/).
* [SDLPoP](https://github.com/NagyD/SDLPoP) ⭐ 1,274 | 🐛 78 | 🌐 C | 📅 2025-12-24: An open-source port of Prince of Persia, based on the disassembly of the DOS version.
* [quinesanek](https://github.com/taylorconor/quinesnake) ⭐ 926 | 🐛 1 | 🌐 C++ | 📅 2019-07-27: A quine that plays snake over its own source!
* [Links Awakening DX Disassembly](https://github.com/zladx/LADX-Disassembly) ⭐ 897 | 🐛 18 | 🌐 Assembly | 📅 2026-08-27: Disassembly of Legend of Zelda: Links Awakening DX.
* [wick editor](https://www.wickeditor.com/): [The Wick Editor is a free](https://github.com/Wicklets/wick-editor) ⭐ 839 | 🐛 186 | 🌐 JavaScript | 📅 2023-03-06, open-source tool for creating games, animations, and everything in-between!
* [Clspv](https://github.com/google/clspv) ⭐ 726 | 🐛 62 | 🌐 LLVM | 📅 2026-08-27 is a prototype compiler for a subset of OpenCL C to Vulkan compute shaders.
...
* [Tips and Tricks for Writing Scientific Papers](https://github.com/Wookai/paper-tips-and-tricks) ⭐ 3,729 | 🐛 4 | 🌐 Python | 📅 2023-05-17: Best practice and tips & tricks to write scientific papers in LaTeX, with figures generated in Python or Matlab.
...
* [veyon](https://github.com/veyon/veyon/) ⭐ 1,934 | 🐛 222 | 🌐 C++ | 📅 2026-08-26: Cross-platform computer monitoring and classroom management.

## Studies

* [Path to a free self-taught education in Computer Science!](https://github.com/ossu/computer-science) ⭐ 208,473 | 🐛 26 | 🌐 HTML | 📅 2026-07-14
* [the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,712 | 🐛 200 | 🌐 Jupyter Notebook | 📅 2026-05-20: One has no future if one couldn't teach themself.
...
* (pt-br) [Free IT Courses](https://github.com/alinebastos/free-courses) ⭐ 882 | 🐛 6 | 📅 2023-01-19
...
* [Awesome Accessibility](https://github.com/brunopulis/awesome-a11y) ⭐ 1,986 | 🐛 63 | 📅 2026-08-03: A curate list about A11Y
...
* [FreshRSS](https://github.com/FreshRSS/FreshRSS) ⭐ 15,855 | 🐛 662 | 🌐 PHP | 📅 2026-08-28: A free, self-hostable aggregator…
* guardian [frontend](https://github.com/guardian/frontend) ⭐ 5,899 | 🐛 210 | 🌐 Scala | 📅 2026-08-28: Source for theguardian.com
...
* [umbrella](https://github.com/thi-ng/umbrella) ⭐ 3,826 | 🐛 62 | 🌐 TypeScript | 📅 2026-08-25: ⛱ Mono-repository of \~50 TypeScript/ES6 projects for modern web development
...
* [Jápronto!](https://github.com/squeaky-pl/japronto) ⭐ 8,530 | 🐛 91 | 🌐 C | 📅 2023-08-14: Screaming-fast Python 3.5+ HTTP toolkit integrated with pipelining HTTP server based on uvloop and picohttpparser.
* [Vibora](https://github.com/vibora-io/vibora) ⚠️ Archived: Fast, asynchronous and elegant Python web framework.

## Privacy

* [Differential Privacy](https://github.com/google/differential-privacy) ⭐ 3,348 | 🐛 61 | 🌐 Go | 📅 2026-08-27: This project contains a C++ library of ε-differentially private algorithms, which can be used to produce aggregate statistics over numeric data sets containing private or sensitive information.
...
* [Apache Flink](https://github.com/apache/flink) ⭐ 26,302 | 🐛 368 | 🌐 Java | 📅 2026-08-28: Apache Flink is an open source stream processing framework with powerful stream- and batch-processing capabilities.
* [lists](https://github.com/jnv/lists) ⭐ 11,441 | 🐛 22 | 📅 2026-03-23: The definitive list of lists (of lists) curated on GitHub
* [awesome-uses](https://github.com/wesbos/awesome-uses) ⭐ 5,299 | 🐛 31 | 🌐 JavaScript | 📅 2026-08-20: A list of /uses pages that detail apps and gear used by professional web developers.
* (pt-br) [Lista Maravilhosa de Projetos Open-Source](https://github.com/camilatigre/listamaravilhosaopensource) ⭐ 2,570 | 🐛 25 | 🌐 JavaScript | 📅 2026-06-15: Lista com links de projetos open-source para os níveis: iniciante, intermediário e avançado. Dividido por linguagem e idiomas!
...
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 366,494 | 🐛 612 | 🌐 Python | 📅 2026-03-20: Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 359,894 | 🐛 125 | 📅 2025-08-28: A complete computer science study plan to become a software engineer.
* [GitHub Résumé](https://github.com/resume/resume.github.com) ⭐ 62,891 | 🐛 76 | 🌐 JavaScript | 📅 2023-02-15
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 51,795 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-24: Companies that don't have a broken hiring process.
...
* [test-your-sysadmin-skills](https://github.com/trimstray/test-your-sysadmin-skills) ⭐ 11,845 | 🐛 19 | 📅 2024-11-19
* [OpenResume](https://www.open-resume.com/) Create a professional resume easily with this free, open-source, and powerful [resume builder](https://github.com/xitanggg/open-resume) ⭐ 8,866 | 🐛 144 | 🌐 TypeScript | 📅 2024-10-29.
* [linux-sysadmin-interview-questions](https://github.com/chassing/linux-sysadmin-interview-questions) ⭐ 5,336 | 🐛 7 | 📅 2024-03-11: Collection of Linux Sysadmin/DevOps interview questions
* [Jobs and Tips for Remote Work](https://github.com/alinebastos/remote) ⭐ 716 | 🐛 11 | 📅 2024-01-31
...
* [awesome-scifi](https://github.com/sindresorhus/awesome-scifi) ⭐ 5,021 | 🐛 0 | 📅 2025-12-22: I asked on Twitter for recommendations as I want to get into reading Sci-Fi novels. The below is the result. Thanks everyone for recommending your favorites! :)
...
* [📚 Freely available programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 395,412 | 🐛 90 | 🌐 Python | 📅 2026-08-18
* (pt-br) [Conteúdo gratuito](https://github.com/perifacode/conteudo-gratuito) ⭐ 1,857 | 🐛 37 | 📅 2024-04-17.
