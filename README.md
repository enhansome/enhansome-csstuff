...
* [PortalData](https://github.com/weecology/PortalData) ⭐ 51 | 🐛 5 | 🌐 R | 📅 2026-09-10 (Official Repo of the Portal Project Data) and [livedat](https://github.com/weecology/livedat) ⭐ 13 | 🐛 2 | 🌐 R | 📅 2019-01-30 (Template for living data workflow ).
...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 360,717 | 🐛 125 | 📅 2025-08-28
* [The Book of Secret Knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) ⭐ 243,081 | 🐛 169 | 📅 2024-11-19
* [z3](https://github.com/Z3Prover/z3) ⭐ 12,657 | 🐛 46 | 🌐 C++ | 📅 2026-09-11: The Z3 Theorem Prover
...
* [ClickHouse](https://github.com/ClickHouse/ClickHouse) ⭐ 49,810 | 🐛 7,546 | 🌐 C++ | 📅 2026-09-11: is a free analytics DBMS for big data.
* [HikariCP](https://github.com/brettwooldridge/HikariCP) ⭐ 21,209 | 🐛 544 | 🌐 Java | 📅 2026-06-14: 光 HikariCP・A solid, high-performance, JDBC connection pool at last.
...
* [pgFormatter](https://github.com/darold/pgFormatter) ⭐ 1,954 | 🐛 20 | 🌐 PLpgSQL | 📅 2026-09-08: A PostgreSQL SQL syntax beautifier that can work as a console program or as a CGI. On-line demo [site](http://sqlformat.darold.net/)
...
* [Every Programmer Should Know thinking](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,405 | 🐛 25 | 📅 2025-12-29: A collection of (mostly) technical things every software developer should know
...
* [Prettier is an opinionated code formatter](https://github.com/prettier/prettier) ⭐ 52,242 | 🐛 1,433 | 🌐 JavaScript | 📅 2026-09-11
...
* [dev.to](https://github.com/thepracticaldev/dev.to) ⭐ 22,774 | 🐛 132 | 🌐 Ruby | 📅 2026-09-10: Where programmers share ideas and help each other grow
* [Flow](https://github.com/facebook/flow) ⭐ 22,283 | 🐛 518 | 🌐 Rust | 📅 2026-09-11: Adds static typing to JavaScript to improve developer productivity and code quality.
* [Quine Relay](https://github.com/mame/quine-relay) ⭐ 14,600 | 🐛 18 | 🌐 Ruby | 📅 2026-09-01: An uroboros program with 100+ programming languages.
...
* [vscodium](https://github.com/VSCodium/vscodium) ⭐ 33,191 | 🐛 140 | 🌐 Shell | 📅 2026-09-09: binary releases of VS Code without MS branding/telemetry/licensing
  * [awesome-vscode](https://github.com/viatsko/awesome-vscode) ⭐ 29,019 | 🐛 57 | 🌐 JavaScript | 📅 2026-06-21: art A curated list of delightful VS Code packages and resources.
...
* [CppCoreGuidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,311 | 🐛 246 | 🌐 CSS | 📅 2026-08-06: The C++ Core Guidelines are a set of tried-and-true guidelines, rules, and best practices about coding in C++
* [Microsoft's C++ Standard Library](https://github.com/microsoft/STL) ⭐ 11,146 | 🐛 597 | 🌐 C++ | 📅 2026-09-10: MSVC's implementation of the C++ Standard Library.
* mozilla [rr](https://github.com/mozilla/rr) ⭐ 10,649 | 🐛 482 | 🌐 C++ | 📅 2026-08-16: is a lightweight tool for recording, replaying and debugging execution of applications (trees of processes and threads). Debugging extends gdb with very efficient reverse-execution, which in combination with standard gdb/x86 features like hardware data watchpoints, makes debugging much more fun.
...
* [libtcod](https://github.com/libtcod/libtcod) ⭐ 1,224 | 🐛 27 | 🌐 C | 📅 2026-07-20: The official repository for libtcod. A roguelike development library.
...
* [C4Noobs](https://github.com/jpaulohe4rt/c4noobs) ⭐ 261 | 🐛 3 | 🌐 C | 📅 2024-10-08:  Tutorial de C para iniciantes.
...
* TDD C:
  * [Google Test](https://github.com/google/googletest) ⭐ 39,512 | 🐛 505 | 🌐 C++ | 📅 2026-09-10: Google Testing and Mocking Framework.
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,716 | 🐛 318 | 🌐 JavaScript | 📅 2026-04-08: A simple and modern GTK eBook viewer, built with GJS and Epub.js.
...
* [A curated list of awesome Python frameworks, libraries, software and resources](https://github.com/vinta/awesome-python#authentication) ⭐ 319,863 | 🐛 20 | 🌐 Python | 📅 2026-09-01
* [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) ⭐ 224,463 | 🐛 586 | 🌐 Python | 📅 2026-09-11: All Algorithms implemented in Python
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,242 | 🐛 81 | 🌐 Python | 📅 2026-09-01 framework, high performance, easy to learn, fast to code, ready for production
* cython [dtoa.c](https://github.com/python/cpython/blob/master/Python/dtoa.c) ⭐ 76,829 | 🐛 9,636 | 🌐 Python | 📅 2026-09-11
* [Rich](https://github.com/willmcgugan/rich) ⭐ 57,352 | 🐛 374 | 🌐 Python | 📅 2026-06-23 is a Python library for rich text and beautiful formatting in the terminal.
* [black](https://github.com/ambv/black/) ⭐ 41,840 | 🐛 310 | 🌐 Python | 📅 2026-09-04: The uncompromising Python code formatter
* [wtfpython](https://github.com/satwikkansal/wtfpython#-is-not--is-not-is-not-) ⭐ 37,080 | 🐛 72 | 🌐 Python | 📅 2026-01-13: A collection of surprising Python snippets and lesser-known features.
* [wtfpython](https://github.com/satwikkansal/wtfpython) ⭐ 37,080 | 🐛 72 | 🌐 Python | 📅 2026-01-13: What the f\*ck Python? ￼
* [Course Files for Complete Python 3 Bootcamp Course on Udemy](https://github.com/Pierian-Data/Complete-Python-3-Bootcamp) ⭐ 29,763 | 🐛 273 | 🌐 Jupyter Notebook | 📅 2025-06-24
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,344 | 🐛 397 | 🌐 Rust | 📅 2026-09-11A Python Interpreter written in Rust
* [kivy](https://github.com/kivy/kivy) ⭐ 19,015 | 🐛 849 | 🌐 Python | 📅 2026-09-09: Open source UI framework written in Python, running on Windows, Linux, macOS, Android and iOS.
* [Modular visual interface for GDB in Python](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,248 | 🐛 19 | 🌐 Python | 📅 2026-07-17
* [Python Prompt Toolkit](https://github.com/prompt-toolkit/python-prompt-toolkit) ⭐ 10,565 | 🐛 714 | 🌐 Python | 📅 2026-07-26: Library for building powerful interactive command line applications in Python.
* [faust](https://github.com/robinhood/faust) ⭐ 6,825 | 🐛 280 | 🌐 Python | 📅 2024-07-27: Python Stream Processing
* [alive-progress](https://github.com/rsalmei/alive-progress) ⭐ 6,305 | 🐛 22 | 🌐 Python | 📅 2026-05-24: An animated and smart Progress Bar for python.
...
* [cinder](https://github.com/facebookincubator/cinder) ⭐ 3,792 | 🐛 31 | 🌐 Python | 📅 2026-09-10
...
* [OpenTelemetry Python](https://github.com/open-telemetry/opentelemetry-python) ⭐ 2,629 | 🐛 416 | 🌐 Python | 📅 2026-09-11: OpenTelemetry Python API and SDK
* [austin](https://github.com/P403n1x87/austin) ⭐ 2,209 | 🐛 9 | 🌐 C | 📅 2026-09-10: Python frame stack sampler for CPython. Austin has a [tui](https://github.com/P403n1x87/austin-tui) ⭐ 665 | 🐛 2 | 🌐 Python | 📅 2026-06-04: The top-like text-based user interface for Austin.
...
* [vyper](https://github.com/ethereum/vyper/) ⭐ 5,181 | 🐛 632 | 🌐 Python | 📅 2026-09-10:
...
* Agda:
  * [Agda 2](https://github.com/agda/agda) ⭐ 2,930 | 🐛 1,041 | 🌐 Haskell | 📅 2026-09-10
...
* Answer Set Programming(ASP): offers a simple and powerful modeling language to solve combinatorial problems.
  * [Potassco](https://potassco.org/), [clingo](https://potassco.org/clingo/) and [github](https://github.com/potassco/clingo) ⭐ 831 | 🐛 15 | 🌐 C++ | 📅 2026-09-09.
* Brainfuck:
  * [Brainfuck](https://www.dcode.fr/brainfuck-language) encoder/decoder.
* Dafny:
  * [dafny](https://github.com/Microsoft/dafny) ⭐ 3,535 | 🐛 1,385 | 🌐 C# | 📅 2026-08-31: Dafny is a verification-aware programming language.
* Clean:
...
* Elixir:
  * [Nerves](https://github.com/nerves-project/nerves) ⭐ 2,491 | 🐛 23 | 🌐 Elixir | 📅 2026-09-10: Craft and deploy bulletproof embedded software in Elixir. [official site](http://nerves-project.org)
...
* Go:
  * [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 183,763 | 🐛 232 | 🌐 Go | 📅 2026-09-10: A curated list of awesome Go frameworks, libraries and software
  * [lattigo](https://github.com/lca1/lattigo) ⭐ 1,444 | 🐛 11 | 🌐 Go | 📅 2026-06-16: A lattice-based cryptographic library in Go.
...
* Lua:
  * [xmake](https://github.com/xmake-io/xmake) ⭐ 12,213 | 🐛 252 | 🌐 Lua | 📅 2026-09-10: 🔥 A cross-platform build [utility based on Lua](https://xmake.io)
* Nim:
  * [nim](https://nim-lang.org/): Efficient and expressive programming. [github](https://github.com/nim-lang/nim) ⭐ 18,232 | 🐛 2,190 | 🌐 Nim | 📅 2026-09-10
* Perl:
...
* PHP:
  * [A curated list of bookmarks, packages, tutorials, videos and other cool resources from the Laravel ecosystem](https://github.com/chiraggude/awesome-laravel) ⭐ 13,099 | 🐛 89 | 📅 2024-07-03
...
* V:
  * [V](https://github.com/vlang-io/V) ⭐ 37,842 | 🐛 62 | 🌐 V | 📅 2026-09-11: Simple, fast, safe, compiled language for creating maintainable software. Supports translation from C/C++.
  * [vlang](https://github.com/vlang/v) ⭐ 37,842 | 🐛 62 | 🌐 V | 📅 2026-09-11: Simple, fast, safe, compiled language for developing maintainable software. Supports translation from C and (soon) C++. Compiles itself in <1s.
* Verilog:
...
* [kompare](https://github.com/KDE/kompare) ⭐ 59 | 🐛 0 | 🌐 C++ | 📅 2026-09-10: Graphical File Differences Tool
...
* Starting Pull Requests:
  * [Awesome First PR Opportunities](https://github.com/MunGell/awesome-for-beginners) ⭐ 89,146 | 🐛 152 | 📅 2026-07-25
...
* [.gitignore](https://github.com/github/gitignore) ⭐ 175,705 | 🐛 74 | 📅 2026-09-08: A collection of useful .gitignore templates
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,215 | 🐛 1,033 | 🌐 Go | 📅 2026-09-09: simple terminal UI for git commands
* [gitea](https://github.com/go-gitea/gitea) ⭐ 57,946 | 🐛 2,455 | 🌐 Go | 📅 2026-09-11: Git with a cup of tea, painless self-hosted git service
* [gogs](https://github.com/gogs/gogs) ⭐ 47,803 | 🐛 1,009 | 🌐 Go | 📅 2026-09-11: Gogs is a painless self-hosted Git service.
* [github-cli](https://github.com/cli/cli) ⭐ 46,233 | 🐛 1,083 | 🌐 Go | 📅 2026-09-11:  GitHub’s official command line tool
* [husky](https://github.com/typicode/husky) ⭐ 35,311 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19: Git hooks made easy
* [Learn git branching](https://learngitbranching.js.org/): An interactive git visualization to challenge and educate! [github](https://github.com/pcottle/learnGitBranching) ⭐ 34,021 | 🐛 60 | 🌐 JavaScript | 📅 2026-09-10.
* [cz-cli](https://github.com/commitizen/cz-cli) ⭐ 17,498 | 🐛 195 | 🌐 JavaScript | 📅 2026-09-04: The commitizen command line utility.
* [lint-staged](https://github.com/okonet/lint-staged) ⭐ 14,731 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-10: Run linters on git staged files
...
* [Pro Git book](https://git-scm.com/book/en/v2), written by Scott Chacon and Ben Straub ([github](https://github.com/progit/progit2) ⭐ 6,584 | 🐛 219 | 🌐 CSS | 📅 2026-05-25 repo)
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,075 | 🐛 7 | 🌐 Shell | 📅 2026-09-09 is a utility tool for git taking advantage of fuzzy finder fzf. [Interactive Git Commands With Previews Powered By fzf Fuzzy Finder](https://www.linuxuprising.com/2019/11/forgit-interactive-git-commands-with.html)
* [git-sizer](https://github.com/github/git-sizer/) ⭐ 4,073 | 🐛 20 | 🌐 Go | 📅 2026-09-10: Compute various size metrics for a Git repository, flagging those that might cause problems ( [article](https://blog.github.com/2018-03-05-measuring-the-many-sizes-of-a-git-repository/))
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,936 | 🐛 36 | 🌐 Python | 📅 2026-07-06: Manage multiple git repos side by side for sanity
* [Git4Noobs](https://github.com/DanielHe4rt/git4noobs) ⭐ 1,613 | 🐛 3 | 📅 2024-09-28
* [Forge](https://github.com/magit/forge/) ⭐ 1,574 | 🐛 7 | 🌐 Emacs Lisp | 📅 2026-09-09: Work with Git forges from the comfort of Magit
...
* [SkyWater Open Source PDK](https://github.com/google/skywater-pdk) ⭐ 3,705 | 🐛 200 | 🌐 Python | 📅 2026-07-21: Open source process design kit for usage with SkyWater Technology Foundry's 130nm node.
* [Ariane is a 6-stage RISC-V CPU](https://github.com/pulp-platform/ariane) ⭐ 3,104 | 🐛 256 | 🌐 Assembly | 📅 2026-09-11
* [cva6](https://github.com/openhwgroup/cva6) ⭐ 3,104 | 🐛 256 | 🌐 Assembly | 📅 2026-09-11: The CORE-V CVA6 is an Application class 6-stage RISC-V CPU capable of booting Linux.
...
* [darkriscv](https://github.com/darklife/darkriscv) ⭐ 2,605 | 🐛 5 | 🌐 Verilog | 📅 2026-09-04: opensouce RISC-V implemented from scratch in one night!
...
* [The Zip CPU](https://github.com/ZipCPU/zipcpu) ⭐ 1,581 | 🐛 3 | 🌐 Verilog | 📅 2026-08-19: A small, light weight, RISC CPU soft core
...
* [Circuit Simulator](http://www.lushprojects.com/circuitjs/). [github](https://github.com/sharpie7/circuitjs1) ⭐ 2,948 | 🐛 266 | 🌐 Java | 📅 2024-01-22.
...
* [GraalVM](https://github.com/oracle/graal) ⭐ 21,696 | 🐛 848 | 🌐 Java | 📅 2026-09-10: GraalVM is a universal virtual machine for running applications written in JavaScript, Python, Ruby, R, JVM-based languages like Java, Scala, Clojure, Kotlin, and LLVM-based languages such as C and C++. [GraalVM Implementation of Python](https://github.com/graalvm/graalpython) ⭐ 1,642 | 🐛 67 | 🌐 Python | 📅 2026-09-10
* [Compiler Explorer](https://godbolt.org/): Run compilers interactively from your web browser and interact with the assembly. [github](https://github.com/mattgodbolt/compiler-explorer) ⭐ 19,059 | 🐛 846 | 🌐 TypeScript | 📅 2026-09-09, [how it works](https://xania.org/201609/how-compiler-explorer-runs-on-amazon).
...
* [FASTER](https://github.com/Microsoft/FASTER) ⭐ 6,637 | 🐛 36 | 🌐 C# | 📅 2026-08-19: Fast key-value store from Microsoft Research
...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,442 | 🐛 485 | 🌐 C++ | 📅 2026-09-09: Tesseract Open Source OCR Engine (main repository)
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,986 | 🐛 530 | 🌐 Python | 📅 2025-12-05: Ready-to-use OCR with 40+ languages supported including Chinese, Japanese, Korean and Thai.
* [annoy](https://github.com/spotify/annoy) ⭐ 14,298 | 🐛 86 | 🌐 C++ | 📅 2025-10-29: Approximate Nearest Neighbors in C++/Python optimized for memory usage and loading/saving to disk
...
* [faceswap](https://github.com/deepfakes/faceswap) ⭐ 57,544 | 🐛 15 | 🌐 Python | 📅 2026-08-05: Non official project based on original /r/Deepfakes thread. Many thanks to him!
...
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,791 | 🐛 56 | 🌐 C++ | 📅 2026-06-28: An open source library for face detection in images. The face detection speed can reach 1500FPS.
...
* [Lisp code](https://github.com/norvig/paip-lisp) ⭐ 7,504 | 🐛 35 | 🌐 Common Lisp | 📅 2024-10-15 for the textbook "Paradigms of Artificial Intelligence Programming"
* [donkeycar](https://github.com/autorope/donkeycar) ⭐ 3,502 | 🐛 135 | 🌐 Python | 📅 2026-09-08: Open source hardware and software platform to build a small scale self driving car.
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 165,099 | 🐛 2,405 | 🌐 Python | 📅 2026-09-11: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch.
* [nanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,975 | 🐛 349 | 🌐 Python | 📅 2025-11-12: The simplest, fastest repository for training/finetuning medium-sized GPTs.
* [Industrial-strength Natural Language Processing (NLP) with Python and Cython](https://github.com/explosion/spaCy/) ⭐ 33,890 | 🐛 240 | 🌐 Python | 📅 2026-08-24
...
* [Argdown](https://argdown.org/): A simple syntax for complex argumentation. [argdown repo](https://github.com/christianvoigt/argdown) ⭐ 1,038 | 🐛 101 | 🌐 TypeScript | 📅 2026-09-10
...
* [DeepMind Research](https://github.com/deepmind/deepmind-research) ⭐ 15,192 | 🐛 358 | 🌐 Jupyter Notebook | 📅 2026-06-17: This repository contains implementations and illustrative code to accompany DeepMind publications.
* [vosk-api](https://github.com/alphacep/vosk-api) ⭐ 15,125 | 🐛 604 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API for Android, iOS, Raspberry Pi and servers with Python, Java, C# and Node.
* [CARLA](https://carla.org): Open-source simulator for [autonomous driving research](https://github.com/carla-simulator/carla) ⭐ 14,385 | 🐛 1,197 | 🌐 C++ | 📅 2026-09-10.
* [Transfer Learning](https://github.com/jindongwang/transferlearning) ⭐ 14,352 | 🐛 24 | 🌐 Python | 📅 2025-02-18: Everything about Transfer Learning and Domain Adaptation--迁移学习
...
* Autonomous Vehicles:
  * [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,469 | 🐛 780 | 🌐 C++ | 📅 2026-06-30: Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
...
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,358 | 🐛 757 | 🌐 C# | 📅 2026-09-10: is an open source and cross-platform machine learning framework for .NET.
* [DeepLabCut](http://www.mackenziemathislab.org/deeplabcut): is an efficient method for 3D markerless pose estimation based on transfer learning with deep neural networks that achieves excellent results (i.e. you can match human labeling accuracy) with minimal training data (typically 50-200 frames). [repo](https://github.com/DeepLabCut/DeepLabCut) ⭐ 5,764 | 🐛 46 | 🌐 Python | 📅 2026-09-09
* [Is a Green Screen Really Necessary for Real-Time Human Matting?](https://arxiv.org/pdf/2011.11961.pdf), [repo](https://github.com/ZHKKKe/MODNet) ⭐ 4,361 | 🐛 71 | 🌐 Python | 📅 2024-05-06
...
* [Stable Diffusion](https://github.com/CompVis/stable-diffusion) ⭐ 73,412 | 🐛 619 | 🌐 Jupyter Notebook | 📅 2024-06-18: is a latent text-to-image diffusion model. Thanks to a generous compute donation from Stability AI and support from LAION, we were able to train a Latent Diffusion Model on 512x512 images from a subset of the LAION-5B database.
* [Wan](https://github.com/Wan-Video/Wan2.2) ⭐ 17,460 | 🐛 298 | 🌐 Python | 📅 2026-03-17: Open and Advanced Large-Scale Video Generative Models
...
* [Deep Convolutional Generative Adversarial Network](https://www.tensorflow.org/tutorials/generative/dcgan) [jupyter notebook](https://github.com/tensorflow/docs/blob/master/site/en/tutorials/generative/dcgan.ipynb) ⭐ 6,330 | 🐛 71 | 🌐 Jupyter Notebook | 📅 2026-07-09
...
* [Handwriting Synthesis](https://github.com/sjvasquez/handwriting-synthesis) ⭐ 4,815 | 🐛 63 | 🌐 Python | 📅 2024-01-11
...
* [NEST](https://github.com/nest/nest-simulator) ⭐ 666 | 🐛 227 | 🌐 C++ | 📅 2026-09-10: NEST is a simulator for spiking neural network models that focuses on the dynamics, size and structure of neural systems rather than on the exact morphology of individual neurons.
...
* [fiftyone](https://github.com/voxel51/fiftyone) ⭐ 11,073 | 🐛 686 | 🌐 TypeScript | 📅 2026-09-10: The open-source tool for building high-quality datasets and computer vision models
...
*Frameworks for Neural Networks and Deep Learning. See: [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,886 | 🐛 85 | 📅 2025-05-26.*

* [Keras](https://github.com/fchollet/keras) ⭐ 64,317 | 🐛 180 | 🌐 Python | 📅 2026-09-11 - A high-level neural networks library and capable of running on top of either TensorFlow or Theano.
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,916 | 🐛 17,717 | 🌐 Python | 📅 2026-09-11: Tensors and Dynamic neural networks in Python with strong GPU acceleration a ([tour](http://blog.christianperone.com/2018/03/pytorch-internal-architecture-tour/)):
* [tinygrad](https://github.com/geohot/tinygrad) ⭐ 33,583 | 🐛 194 | 🌐 Python | 📅 2026-09-11: You like pytorch? You like [micrograd](https://github.com/karpathy/micrograd) ⭐ 17,464 | 🐛 80 | 🌐 Jupyter Notebook | 📅 2026-08-03? You love tinygrad! ❤️
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 199,702 | 🐛 3,120 | 🌐 C++ | 📅 2026-09-11 - The most popular Deep Learning framework created by Google.
...
* [Ludwig](https://github.com/uber/ludwig) ⭐ 11,755 | 🐛 1 | 🌐 Python | 📅 2026-09-07: [is a toolbox built](https://uber.github.io/ludwig/) on top of TensorFlow that allows to train and test deep learning models without the need to write code.
...
* [tensorFlow Privacy](https://github.com/tensorflow/privacy) ⭐ 2,033 | 🐛 136 | 🌐 Python | 📅 2026-08-26: Library for training machine learning models with privacy for training data
...
* Good channels:
  * [3blue1brown](https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw/): 3blue1brown, by Grant Sanderson, is some combination of math and entertainment, depending on your disposition ([site](https://www.3blue1brown.com/)) and [manim](https://github.com/3b1b/manim) ⭐ 93,717 | 🐛 498 | 🌐 Python | 📅 2026-09-09(Animation engine for explanatory math videos).
...
* [Awesome Data Science](https://github.com/bulutyazilim/awesome-datascience) ⭐ 29,963 | 🐛 4 | 📅 2026-09-09
* [The Data Engineering Cookbook](https://github.com/andkret/Cookbook) ⭐ 15,414 | 🐛 129 | 🌐 Python | 📅 2026-07-23
* [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,321 | 🐛 1,346 | 🌐 Python | 📅 2026-09-10: Official repository for Spyder - The Scientific Python Development Environment
...
* [RAPIDS](http://rapids.ai): Open GPU Data Science. The RAPIDS suite of software libraries gives you the freedom to execute end-to-end data science and analytics pipelines entirely on GPUs. It relies on NVIDIA® CUDA® primitives for low-level compute optimization, but exposes that GPU parallelism and high-bandwidth memory speed through user-friendly Python interfaces. [cuml](https://github.com/rapidsai/cuml) ⭐ 5,275 | 🐛 812 | 🌐 Python | 📅 2026-09-11 - RAPIDS Machine Learning Library.
* [Dask tutorial](https://github.com/dask/dask-tutorial) ⭐ 1,859 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2025-11-04
* [easystats](https://github.com/easystats/easystats) ⭐ 1,159 | 🐛 45 | 🌐 R | 📅 2026-09-10: milky\_way The easyverse.
...
* [insight](https://github.com/easystats/insight) ⭐ 441 | 🐛 60 | 🌐 R | 📅 2026-09-08: Easy access to model information for various model objects.
...
* Jupyter:
  ...
  * [nbtutor](https://github.com/lgpage/nbtutor) ⭐ 472 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-10: Visualize Python code execution (line-by-line) in Jupyter Notebook cells.
...
* R Lang
  * [brms](https://github.com/paul-buerkner/brms) ⭐ 1,427 | 🐛 153 | 🌐 R | 📅 2026-09-10: R package for Bayesian generalized multivariate non-linear multilevel models using Stan
  * [haven](https://github.com/tidyverse/haven) ⭐ 452 | 🐛 48 | 🌐 C | 📅 2026-02-09: Read SPSS, Stata and SAS files from R.
  * [ffscrapr](https://ffscrapr.dynastyprocess.com/): An R Client for Fantasy Football League APIs. [repo](https://github.com/dynastyprocess/ffscrapr/) ⭐ 95 | 🐛 22 | 🌐 R | 📅 2024-11-01
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 66,032 | 🐛 890 | 🌐 Go | 📅 2026-09-10: The Prometheus monitoring system and time series database.
* [dart](https://github.com/unit8co/darts) ⭐ 9,519 | 🐛 229 | 🌐 Python | 📅 2026-09-07: A python library for easy manipulation and forecasting of time series.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,172 | 🐛 163 | 🌐 C++ | 📅 2026-08-10: The Time Series Visualization Tool that you deserve.
...
* [amsterdam-schema](https://github.com/Amsterdam/amsterdam-schema) ⭐ 21 | 🐛 7 | 🌐 Python | 📅 2026-09-10: Data modeling & verification for the City of Amsterdam's open data - based on JSON Schema
...
* [ImageMagick creates huge temporary files · Issue #395 · ImageMagick/ImageMagick](https://github.com/ImageMagick/ImageMagick/issues/395) ⭐ 17,389 | 🐛 163 | 🌐 C | 📅 2026-09-10
...
* [Pseudo-bandlimited pixel art filtering in 3D – a mathematical derivation](http://themaister.net/blog/2018/08/25/pseudo-bandlimited-pixel-art-filtering-in-3d-a-mathematical-derivation/) [github](https://github.com/Themaister/Granite) ⭐ 1,942 | 🐛 4 | 🌐 C++ | 📅 2026-09-10
...
* [simplex-method](https://github.com/khalibartan/simplex-method) ⭐ 62 | 🐛 3 | 🌐 Python | 📅 2021-03-17: A python implementation for simplex method
...
* [jax](https://github.com/google/jax) ⭐ 36,288 | 🐛 2,554 | 🌐 Python | 📅 2026-09-11: Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more
* [micro](https://micro-editor.github.io/): a modern and intuitive [terminal-based text editor](https://github.com/zyedidia/micro#linux-clipboard-support) ⭐ 29,560 | 🐛 945 | 🌐 Go | 📅 2026-09-11.
* [pyodide](https://github.com/iodide-project/pyodide) ⭐ 14,825 | 🐛 399 | 🌐 Python | 📅 2026-09-09: The Python scientific stack, compiled to WebAssembly
...
* [This program generates bitmaps that are locally similar to the input bitmap](https://github.com/mxgmn/WaveFunctionCollapse) ⭐ 25,316 | 🐛 9 | 🌐 C# | 📅 2026-03-22
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,977 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-10: Easily add particles animations to your website. Compatible also with React, Vue.js (2.x and 3.x), Angular, Svelte, jQuery, Preact, Inferno.
* [Walk through an infinite, procedurally generated city](https://github.com/marian42/wavefunctioncollapse) ⭐ 4,857 | 🐛 9 | 🌐 C# | 📅 2021-03-28
* [An interactive, explorable explanation about the peculiar magic of sound waves.](https://github.com/joshwcomeau/waveforms) ⭐ 1,481 | 🐛 4 | 🌐 JavaScript | 📅 2018-02-21
* [SOFA](https://www.sofa-framework.org/): is an efficient framework dedicated to research, prototyping and development of physics-based simulations. [github](https://github.com/sofa-framework/sofa/) ⭐ 1,253 | 🐛 453 | 🌐 C++ | 📅 2026-09-10.
...
* [gqrx](https://gqrx.dk/): is an open source software defined radio receiver (SDR) powered by the GNU Radio and the Qt graphical toolkit. [Gqrx](https://github.com/csete/gqrx) ⭐ 3,675 | 🐛 267 | 🌐 C++ | 📅 2026-08-06
...
* [Open MCT](https://nasa.github.io/openmct/): is a next-generation mission control framework for visualization of data on desktop and mobile devices - [github](https://github.com/nasa/openmct) ⭐ 13,115 | 🐛 1,090 | 🌐 JavaScript | 📅 2026-09-10
* [fprime](https://github.com/nasa/fprime) ⭐ 11,732 | 🐛 460 | 🌐 C++ | 📅 2026-09-11: A flight software and embedded systems framework.
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,635 | 🐛 14 | 🌐 HTML | 📅 2026-09-03: A build-it-yourself, 6-wheel rover based on the rovers on Mars!
...
* [MNE-Python](https://github.com/mne-tools/mne-python) ⭐ 3,511 | 🐛 617 | 🌐 Python | 📅 2026-09-10: Magnetoencephalography (MEG) and Electroencephalography (EEG) in Python
...
* [plus codes](https://plus.codes/). [open-location-code](https://github.com/google/open-location-code) ⭐ 4,354 | 🐛 61 | 🌐 Java | 📅 2026-03-30: Open Location Code is a library to generate short codes that can be used like street addresses, for places where street addresses don't exist.
* [S2Geometry](http://s2geometry.io/): S2 is a library for spherical geometry that aims to have the same robustness, flexibility, and performance as the very best planar geometry libraries [github](https://github.com/google/s2geometry) ⭐ 2,724 | 🐛 79 | 🌐 C++ | 📅 2026-09-08.
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 948 | 🐛 18 | 🌐 R | 📅 2026-09-10: Easy access to shapefiles of the Brazilian Institute of Geography and Statistics (IBGE) and other official spatial data sets of Brazil.
...
* [Memex](https://worldbrain.io/#) - your photographic memory for the web. Open-Source. Private. [repo](https://github.com/WorldBrain/Memex) ⭐ 4,721 | 🐛 319 | 🌐 TypeScript | 📅 2025-12-02
...
* [Awesome-Design-Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 41,168 | 🐛 201 | 🌐 JavaScript | 📅 2024-07-28: The best design tools for everything.
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,472 | 🐛 286 | 🌐 C++ | 📅 2026-09-11:Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
...
* [gb-studio](https://github.com/chrismaltby/gb-studio) ⭐ 9,405 | 🐛 804 | 🌐 TypeScript | 📅 2026-09-11: A free and easy to use retro adventure game creator for your favourite [handheld video game system](https://www.gbstudio.dev)
* [sm64](https://github.com/n64decomp/sm64) ⭐ 8,768 | 🐛 29 | 🌐 C | 📅 2024-02-04: A Super Mario 64 decompilation, brought to you by a bunch of clever folks.
* [MarkovJunior](https://github.com/mxgmn/MarkovJunior) ⭐ 8,187 | 🐛 9 | 🌐 C# | 📅 2026-03-20: Probabilistic PL based on pattern matching and constraint propagation, 148 examples.
...
* [OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,474 | 🐛 52 | 🌐 C++ | 📅 2026-08-31: A Framework for Reinforcement Learning in Games.
* [Zelda 3 in C](https://github.com/snesrev/zelda3) ⭐ 4,755 | 🐛 89 | 🌐 C | 📅 2023-12-27: A reimplementation of Zelda 3.
* [The Comprehensive Kerbal Archive Network (CKAN)](https://github.com/KSP-CKAN/CKAN) ⭐ 2,640 | 🐛 85 | 🌐 C# | 📅 2026-07-17
...
* [Hypersomnia](https://github.com/TeamHypersomnia/Hypersomnia) ⭐ 1,639 | 🐛 13 | 🌐 C++ | 📅 2026-09-04: Multiplayer top-down shooter made from scratch. Comes with an in-game Editor!
* [toy](https://github.com/hugoam/toy) ⭐ 1,593 | 🐛 13 | 🌐 C++ | 📅 2021-04-25: the thin c++ game engine - [toyengine](https://hugoam.github.io/toy-io/).
* [SDLPoP](https://github.com/NagyD/SDLPoP) ⭐ 1,282 | 🐛 80 | 🌐 C | 📅 2025-12-24: An open-source port of Prince of Persia, based on the disassembly of the DOS version.
...
* [Clspv](https://github.com/google/clspv) ⭐ 728 | 🐛 65 | 🌐 LLVM | 📅 2026-09-10 is a prototype compiler for a subset of OpenCL C to Vulkan compute shaders.
...
* [veyon](https://github.com/veyon/veyon/) ⭐ 1,947 | 🐛 221 | 🌐 C++ | 📅 2026-09-09: Cross-platform computer monitoring and classroom management.

## Studies

* [Path to a free self-taught education in Computer Science!](https://github.com/ossu/computer-science) ⭐ 208,910 | 🐛 27 | 🌐 HTML | 📅 2026-07-14
* [the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,767 | 🐛 200 | 🌐 Jupyter Notebook | 📅 2026-05-20: One has no future if one couldn't teach themself.
...
* [FreshRSS](https://github.com/FreshRSS/FreshRSS) ⭐ 15,987 | 🐛 669 | 🌐 PHP | 📅 2026-09-10: A free, self-hostable aggregator…
* guardian [frontend](https://github.com/guardian/frontend) ⭐ 5,898 | 🐛 222 | 🌐 Scala | 📅 2026-09-10: Source for theguardian.com
...
* [Sanic](https://github.com/sanic-org/sanic) ⭐ 18,639 | 🐛 148 | 🌐 Python | 📅 2026-07-29: Async Python 3.7+ web server/framework | Build fast. Run fast.
...
* [Differential Privacy](https://github.com/google/differential-privacy) ⭐ 3,355 | 🐛 61 | 🌐 Go | 📅 2026-09-10: This project contains a C++ library of ε-differentially private algorithms, which can be used to produce aggregate statistics over numeric data sets containing private or sensitive information.
...
* [Apache Flink](https://github.com/apache/flink) ⭐ 26,331 | 🐛 366 | 🌐 Java | 📅 2026-09-10: Apache Flink is an open source stream processing framework with powerful stream- and batch-processing capabilities.
...
* (pt-br) [Lista Maravilhosa de Projetos Open-Source](https://github.com/camilatigre/listamaravilhosaopensource) ⭐ 2,573 | 🐛 25 | 🌐 JavaScript | 📅 2026-06-15: Lista com links de projetos open-source para os níveis: iniciante, intermediário e avançado. Dividido por linguagem e idiomas!
* [gh-card](https://github.com/nwtgck/gh-card) ⭐ 1,348 | 🐛 55 | 🌐 TypeScript | 📅 2021-08-01, [link](https://gh-card.dev/)
...
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 369,314 | 🐛 611 | 🌐 Python | 📅 2026-03-20: Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 360,717 | 🐛 125 | 📅 2025-08-28: A complete computer science study plan to become a software engineer.
* [GitHub Résumé](https://github.com/resume/resume.github.com) ⭐ 62,893 | 🐛 76 | 🌐 JavaScript | 📅 2023-02-15
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 52,084 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-24: Companies that don't have a broken hiring process.
...
* [OpenResume](https://www.open-resume.com/) Create a professional resume easily with this free, open-source, and powerful [resume builder](https://github.com/xitanggg/open-resume) ⭐ 8,900 | 🐛 143 | 🌐 TypeScript | 📅 2024-10-29.
...
* [awesome-scifi](https://github.com/sindresorhus/awesome-scifi) ⭐ 5,038 | 🐛 0 | 📅 2025-12-22: I asked on Twitter for recommendations as I want to get into reading Sci-Fi novels. The below is the result. Thanks everyone for recommending your favorites! :)
* [blobs](https://blobs.app): [Blob shapes generator](https://github.com/lokesh-coder/blobs.app) ⭐ 484 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-10
...
* [📚 Freely available programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 396,473 | 🐛 82 | 🌐 Python | 📅 2026-09-10
* (pt-br) [Conteúdo gratuito](https://github.com/perifacode/conteudo-gratuito) ⭐ 1,860 | 🐛 37 | 📅 2024-04-17.
