...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 360,857 | 🐛 125 | 📅 2025-08-28
* [The Book of Secret Knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) ⭐ 243,616 | 🐛 170 | 📅 2024-11-19
* [z3](https://github.com/Z3Prover/z3) ⭐ 12,660 | 🐛 48 | 🌐 C++ | 📅 2026-09-14: The Z3 Theorem Prover
...
* [ClickHouse](https://github.com/ClickHouse/ClickHouse) ⭐ 49,874 | 🐛 7,523 | 🌐 C++ | 📅 2026-09-14: is a free analytics DBMS for big data.
* [HikariCP](https://github.com/brettwooldridge/HikariCP) ⭐ 21,213 | 🐛 545 | 🌐 Java | 📅 2026-06-14: 光 HikariCP・A solid, high-performance, JDBC connection pool at last.
...
* [pgFormatter](https://github.com/darold/pgFormatter) ⭐ 1,956 | 🐛 23 | 🌐 PLpgSQL | 📅 2026-09-08: A PostgreSQL SQL syntax beautifier that can work as a console program or as a CGI. On-line demo [site](http://sqlformat.darold.net/)
...
* [Every Programmer Should Know thinking](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,443 | 🐛 27 | 📅 2025-12-29: A collection of (mostly) technical things every software developer should know
...
* [Prettier is an opinionated code formatter](https://github.com/prettier/prettier) ⭐ 52,261 | 🐛 1,430 | 🌐 JavaScript | 📅 2026-09-13
...
* [Flow](https://github.com/facebook/flow) ⭐ 22,287 | 🐛 518 | 🌐 Rust | 📅 2026-09-14: Adds static typing to JavaScript to improve developer productivity and code quality.
...
* [vscodium](https://github.com/VSCodium/vscodium) ⭐ 33,224 | 🐛 141 | 🌐 Shell | 📅 2026-09-09: binary releases of VS Code without MS branding/telemetry/licensing
  * [awesome-vscode](https://github.com/viatsko/awesome-vscode) ⭐ 29,030 | 🐛 59 | 🌐 JavaScript | 📅 2026-06-21: art A curated list of delightful VS Code packages and resources.
...
* [Microsoft's C++ Standard Library](https://github.com/microsoft/STL) ⭐ 11,149 | 🐛 599 | 🌐 C++ | 📅 2026-09-13: MSVC's implementation of the C++ Standard Library.
...
* TDD C:
  * [Google Test](https://github.com/google/googletest) ⭐ 39,523 | 🐛 506 | 🌐 C++ | 📅 2026-09-10: Google Testing and Mocking Framework.
...
* [Makefile Tutorial by Example](https://makefiletutorial.com/) and [repo](https://github.com/theicfire/makefiletutorial) ⭐ 5,981 | 🐛 8 | 🌐 SCSS | 📅 2025-06-02
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,731 | 🐛 319 | 🌐 JavaScript | 📅 2026-04-08: A simple and modern GTK eBook viewer, built with GJS and Epub.js.
...
* [A curated list of awesome Python frameworks, libraries, software and resources](https://github.com/vinta/awesome-python#authentication) ⭐ 320,495 | 🐛 18 | 🌐 Python | 📅 2026-09-13
* [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) ⭐ 224,554 | 🐛 414 | 🌐 Python | 📅 2026-09-14: All Algorithms implemented in Python
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,318 | 🐛 83 | 🌐 Python | 📅 2026-09-01 framework, high performance, easy to learn, fast to code, ready for production
* cython [dtoa.c](https://github.com/python/cpython/blob/master/Python/dtoa.c) ⭐ 77,137 | 🐛 9,641 | 🌐 Python | 📅 2026-09-13
* [Rich](https://github.com/willmcgugan/rich) ⭐ 57,362 | 🐛 374 | 🌐 Python | 📅 2026-06-23 is a Python library for rich text and beautiful formatting in the terminal.
* [black](https://github.com/ambv/black/) ⭐ 41,845 | 🐛 318 | 🌐 Python | 📅 2026-09-11: The uncompromising Python code formatter
...
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,343 | 🐛 394 | 🌐 Rust | 📅 2026-09-14A Python Interpreter written in Rust
* [kivy](https://github.com/kivy/kivy) ⭐ 19,014 | 🐛 847 | 🌐 Python | 📅 2026-09-13: Open source UI framework written in Python, running on Windows, Linux, macOS, Android and iOS.
...
* [alive-progress](https://github.com/rsalmei/alive-progress) ⭐ 6,306 | 🐛 20 | 🌐 Python | 📅 2026-05-24: An animated and smart Progress Bar for python.
...
* [cinder](https://github.com/facebookincubator/cinder) ⭐ 3,792 | 🐛 31 | 🌐 Python | 📅 2026-09-13
...
* [OpenTelemetry Python](https://github.com/open-telemetry/opentelemetry-python) ⭐ 2,630 | 🐛 420 | 🌐 Python | 📅 2026-09-12: OpenTelemetry Python API and SDK
* [austin](https://github.com/P403n1x87/austin) ⭐ 2,210 | 🐛 10 | 🌐 C | 📅 2026-09-10: Python frame stack sampler for CPython. Austin has a [tui](https://github.com/P403n1x87/austin-tui) ⭐ 665 | 🐛 2 | 🌐 Python | 📅 2026-06-04: The top-like text-based user interface for Austin.
...
* Agda:
  * [Agda 2](https://github.com/agda/agda) ⭐ 2,932 | 🐛 1,042 | 🌐 Haskell | 📅 2026-09-13
  * [plfa](https://github.com/plfa/plfa.github.io/) ⭐ 1,515 | 🐛 66 | 🌐 Agda | 📅 2026-09-07: Introduction to programming language theory in Agda and [Programming Language Foundations in Agda](https://plfa.github.io/).
* Anglican:
...
* Dafny:
  * [dafny](https://github.com/Microsoft/dafny) ⭐ 3,540 | 🐛 1,385 | 🌐 C# | 📅 2026-08-31: Dafny is a verification-aware programming language.
* Clean:
...
* Elixir:
  * [Nerves](https://github.com/nerves-project/nerves) ⭐ 2,491 | 🐛 23 | 🌐 Elixir | 📅 2026-09-13: Craft and deploy bulletproof embedded software in Elixir. [official site](http://nerves-project.org)
...
* Go:
  * [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 184,069 | 🐛 231 | 🌐 Go | 📅 2026-09-14: A curated list of awesome Go frameworks, libraries and software
...
* JavaScript:
  * [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,707 | 🐛 406 | 🌐 JavaScript | 📅 2026-07-26: Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
...
* Lua:
  * [xmake](https://github.com/xmake-io/xmake) ⭐ 12,215 | 🐛 252 | 🌐 Lua | 📅 2026-09-14: 🔥 A cross-platform build [utility based on Lua](https://xmake.io)
* Nim:
  * [nim](https://nim-lang.org/): Efficient and expressive programming. [github](https://github.com/nim-lang/nim) ⭐ 18,231 | 🐛 2,195 | 🌐 Nim | 📅 2026-09-13
* Perl:
...
* PHP:
  * [A curated list of bookmarks, packages, tutorials, videos and other cool resources from the Laravel ecosystem](https://github.com/chiraggude/awesome-laravel) ⭐ 13,098 | 🐛 90 | 📅 2024-07-03
...
* Rust:
  * [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,337 | 🐛 12 | 🌐 Rust | 📅 2026-09-13: A curated list of Rust code and resources.
...
* V:
  * [V](https://github.com/vlang-io/V) ⭐ 37,860 | 🐛 93 | 🌐 V | 📅 2026-09-14: Simple, fast, safe, compiled language for creating maintainable software. Supports translation from C/C++.
  * [vlang](https://github.com/vlang/v) ⭐ 37,860 | 🐛 93 | 🌐 V | 📅 2026-09-14: Simple, fast, safe, compiled language for developing maintainable software. Supports translation from C and (soon) C++. Compiles itself in <1s.
* Verilog:
...
* Starting Pull Requests:
  * [Awesome First PR Opportunities](https://github.com/MunGell/awesome-for-beginners) ⭐ 89,226 | 🐛 151 | 📅 2026-07-25
...
* [.gitignore](https://github.com/github/gitignore) ⭐ 175,764 | 🐛 73 | 📅 2026-09-11: A collection of useful .gitignore templates
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,314 | 🐛 1,032 | 🌐 Go | 📅 2026-09-13: simple terminal UI for git commands
* [gitea](https://github.com/go-gitea/gitea) ⭐ 57,971 | 🐛 2,460 | 🌐 Go | 📅 2026-09-14: Git with a cup of tea, painless self-hosted git service
* [gogs](https://github.com/gogs/gogs) ⭐ 47,810 | 🐛 1,014 | 🌐 Go | 📅 2026-09-12: Gogs is a painless self-hosted Git service.
* [github-cli](https://github.com/cli/cli) ⭐ 46,271 | 🐛 1,078 | 🌐 Go | 📅 2026-09-11:  GitHub’s official command line tool
* [husky](https://github.com/typicode/husky) ⭐ 35,311 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19: Git hooks made easy
* [Learn git branching](https://learngitbranching.js.org/): An interactive git visualization to challenge and educate! [github](https://github.com/pcottle/learnGitBranching) ⭐ 34,024 | 🐛 60 | 🌐 JavaScript | 📅 2026-09-12.
* [cz-cli](https://github.com/commitizen/cz-cli) ⭐ 17,499 | 🐛 195 | 🌐 JavaScript | 📅 2026-09-04: The commitizen command line utility.
* [lint-staged](https://github.com/okonet/lint-staged) ⭐ 14,731 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-12: Run linters on git staged files
...
* [devhub](https://github.com/devhubapp/devhub) ⭐ 10,126 | 🐛 104 | 🌐 TypeScript | 📅 2024-09-07: DevHub: TweetDeck for GitHub - Android, iOS and Web 👉
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,077 | 🐛 7 | 🌐 Shell | 📅 2026-09-09 is a utility tool for git taking advantage of fuzzy finder fzf. [Interactive Git Commands With Previews Powered By fzf Fuzzy Finder](https://www.linuxuprising.com/2019/11/forgit-interactive-git-commands-with.html)
...
* [SkyWater Open Source PDK](https://github.com/google/skywater-pdk) ⭐ 3,709 | 🐛 200 | 🌐 Python | 📅 2026-07-21: Open source process design kit for usage with SkyWater Technology Foundry's 130nm node.
* [Ariane is a 6-stage RISC-V CPU](https://github.com/pulp-platform/ariane) ⭐ 3,108 | 🐛 245 | 🌐 Assembly | 📅 2026-09-13
* [cva6](https://github.com/openhwgroup/cva6) ⭐ 3,108 | 🐛 245 | 🌐 Assembly | 📅 2026-09-13: The CORE-V CVA6 is an Application class 6-stage RISC-V CPU capable of booting Linux.
...
* [darkriscv](https://github.com/darklife/darkriscv) ⭐ 2,608 | 🐛 5 | 🌐 Verilog | 📅 2026-09-04: opensouce RISC-V implemented from scratch in one night!
* [NyuziProcessor](https://github.com/jbush001/NyuziProcessor/) ⭐ 2,222 | 🐛 91 | 🌐 C | 📅 2024-11-08: GPGPU microprocessor architecture
* [RARS](https://github.com/TheThirdOne/rars) ⭐ 1,634 | 🐛 77 | 🌐 Java | 📅 2024-07-19: RISC-V Assembler and Runtime Simulator.
...
* [How to create an OS from scratch](https://github.com/cfenollosa/os-tutorial) ⭐ 30,702 | 🐛 130 | 🌐 C | 📅 2026-02-04
...
* [EmuTOS](https://github.com/emutos/emutos) ⭐ 304 | 🐛 14 | 🌐 C | 📅 2026-08-30: is a Free operating system for Atari computers, and more.
...
* [GraalVM](https://github.com/oracle/graal) ⭐ 21,700 | 🐛 850 | 🌐 Java | 📅 2026-09-14: GraalVM is a universal virtual machine for running applications written in JavaScript, Python, Ruby, R, JVM-based languages like Java, Scala, Clojure, Kotlin, and LLVM-based languages such as C and C++. [GraalVM Implementation of Python](https://github.com/graalvm/graalpython) ⭐ 1,642 | 🐛 66 | 🌐 Python | 📅 2026-09-11
* [Compiler Explorer](https://godbolt.org/): Run compilers interactively from your web browser and interact with the assembly. [github](https://github.com/mattgodbolt/compiler-explorer) ⭐ 19,067 | 🐛 846 | 🌐 TypeScript | 📅 2026-09-11, [how it works](https://xania.org/201609/how-compiler-explorer-runs-on-amazon).
...
* [porcupine](https://github.com/anishathalye/porcupine/) ⭐ 1,247 | 🐛 4 | 🌐 Go | 📅 2026-08-06: A fast linearizability checker written in Go
...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,476 | 🐛 484 | 🌐 C++ | 📅 2026-09-11: Tesseract Open Source OCR Engine (main repository)
...
* [faceswap](https://github.com/deepfakes/faceswap) ⭐ 57,547 | 🐛 15 | 🌐 Python | 📅 2026-08-05: Non official project based on original /r/Deepfakes thread. Many thanks to him!
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 165,639 | 🐛 2,449 | 🌐 Python | 📅 2026-09-14: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch.
* [nanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 63,073 | 🐛 349 | 🌐 Python | 📅 2025-11-12: The simplest, fastest repository for training/finetuning medium-sized GPTs.
* [Industrial-strength Natural Language Processing (NLP) with Python and Cython](https://github.com/explosion/spaCy/) ⭐ 33,899 | 🐛 240 | 🌐 Python | 📅 2026-08-24
...
* [Language Interpretability Tool (LIT)](https://github.com/pair-code/lit/) ⭐ 3,666 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-09: Interactively analyze NLP models for model understanding in an extensible and framework agnostic interface.
* [PromptSource](https://github.com/bigscience-workshop/promptsource) ⭐ 3,035 | 🐛 44 | 🌐 Python | 📅 2023-10-23
* [Argdown](https://argdown.org/): A simple syntax for complex argumentation. [argdown repo](https://github.com/christianvoigt/argdown) ⭐ 1,040 | 🐛 101 | 🌐 TypeScript | 📅 2026-09-10
...
* [google-10000-english](https://github.com/first20hours/google-10000-english) ⭐ 4,475 | 🐛 28 | 📅 2023-05-17: This repo contains a list of the 10,000 most common English words in order of frequency, as determined by n-gram frequency analysis of the Google's Trillion Word Corpus.
...
* [Real-Time Voice Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning) ⭐ 60,132 | 🐛 177 | 🌐 Python | 📅 2026-03-09: Clone a voice in 5 seconds to generate arbitrary speech in real-time
...
* [DeepMind Research](https://github.com/deepmind/deepmind-research) ⭐ 15,197 | 🐛 358 | 🌐 Jupyter Notebook | 📅 2026-06-17: This repository contains implementations and illustrative code to accompany DeepMind publications.
* [vosk-api](https://github.com/alphacep/vosk-api) ⭐ 15,127 | 🐛 604 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API for Android, iOS, Raspberry Pi and servers with Python, Java, C# and Node.
* [CARLA](https://carla.org): Open-source simulator for [autonomous driving research](https://github.com/carla-simulator/carla) ⭐ 14,394 | 🐛 1,199 | 🌐 C++ | 📅 2026-09-11.
...
* [mit-deep-learning](https://github.com/lexfridman/mit-deep-learning) ⭐ 10,456 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2024-01-03: Tutorials, assignments, and competitions for MIT Deep Learning related courses.
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,357 | 🐛 755 | 🌐 C# | 📅 2026-09-14: is an open source and cross-platform machine learning framework for .NET.
...
* [Stable Diffusion](https://github.com/CompVis/stable-diffusion) ⭐ 73,424 | 🐛 619 | 🌐 Jupyter Notebook | 📅 2024-06-18: is a latent text-to-image diffusion model. Thanks to a generous compute donation from Stability AI and support from LAION, we were able to train a Latent Diffusion Model on 512x512 images from a subset of the LAION-5B database.
* [Wan](https://github.com/Wan-Video/Wan2.2) ⭐ 17,493 | 🐛 299 | 🌐 Python | 📅 2026-03-17: Open and Advanced Large-Scale Video Generative Models
...
* [Handwriting Synthesis](https://github.com/sjvasquez/handwriting-synthesis) ⭐ 4,817 | 🐛 63 | 🌐 Python | 📅 2024-01-11
...
* [fiftyone](https://github.com/voxel51/fiftyone) ⭐ 11,082 | 🐛 688 | 🌐 TypeScript | 📅 2026-09-13: The open-source tool for building high-quality datasets and computer vision models
...
* [OpenSimpleLidar](https://github.com/iliasam/OpenSimpleLidar) ⭐ 2,562 | 🐛 1 | 🌐 C | 📅 2025-07-22: Open Hardware scanning laser rangefinder ([howto](https://hackaday.io/project/20628-open-simple-lidar))
...
* [imagenette](https://github.com/fastai/imagenette) ⭐ 1,135 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2022-09-26: A smaller subset of 10 easily classified classes from Imagenet, and a little more French
...
*Frameworks for Neural Networks and Deep Learning. See: [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,907 | 🐛 85 | 📅 2025-05-26.*

* [Keras](https://github.com/fchollet/keras) ⭐ 64,320 | 🐛 192 | 🌐 Python | 📅 2026-09-12 - A high-level neural networks library and capable of running on top of either TensorFlow or Theano.
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,982 | 🐛 17,659 | 🌐 Python | 📅 2026-09-14: Tensors and Dynamic neural networks in Python with strong GPU acceleration a ([tour](http://blog.christianperone.com/2018/03/pytorch-internal-architecture-tour/)):
* [tinygrad](https://github.com/geohot/tinygrad) ⭐ 33,593 | 🐛 190 | 🌐 Python | 📅 2026-09-14: You like pytorch? You like [micrograd](https://github.com/karpathy/micrograd) ⭐ 17,502 | 🐛 80 | 🌐 Jupyter Notebook | 📅 2026-08-03? You love tinygrad! ❤️
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 200,064 | 🐛 3,128 | 🌐 C++ | 📅 2026-09-14 - The most popular Deep Learning framework created by Google.
...
* [TensorFlow-Course](https://github.com/open-source-for-science/TensorFlow-Course) ⭐ 16,272 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2022-11-28: Simple and ready-to-use tutorials for TensorFlow
...
* Good channels:
  * [3blue1brown](https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw/): 3blue1brown, by Grant Sanderson, is some combination of math and entertainment, depending on your disposition ([site](https://www.3blue1brown.com/)) and [manim](https://github.com/3b1b/manim) ⭐ 93,856 | 🐛 501 | 🌐 Python | 📅 2026-09-09(Animation engine for explanatory math videos).
...
* [pycm](https://github.com/sepandhaghighi/pycm) ⭐ 1,506 | 🐛 17 | 🌐 Python | 📅 2026-09-14: Multi-class confusion matrix library in Python.
...
* [Awesome Data Science](https://github.com/bulutyazilim/awesome-datascience) ⭐ 29,979 | 🐛 5 | 📅 2026-09-09
* [The Data Engineering Cookbook](https://github.com/andkret/Cookbook) ⭐ 15,419 | 🐛 129 | 🌐 Python | 📅 2026-07-23
* [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,324 | 🐛 1,347 | 🌐 Python | 📅 2026-09-10: Official repository for Spyder - The Scientific Python Development Environment
...
* [RAPIDS](http://rapids.ai): Open GPU Data Science. The RAPIDS suite of software libraries gives you the freedom to execute end-to-end data science and analytics pipelines entirely on GPUs. It relies on NVIDIA® CUDA® primitives for low-level compute optimization, but exposes that GPU parallelism and high-bandwidth memory speed through user-friendly Python interfaces. [cuml](https://github.com/rapidsai/cuml) ⭐ 5,277 | 🐛 808 | 🌐 Python | 📅 2026-09-13 - RAPIDS Machine Learning Library.
...
* Python:
  ...
  * [pyjanitor](https://github.com/ericmjl/pyjanitor) ⭐ 1,499 | 🐛 144 | 🌐 Python | 📅 2026-09-08: Python implementation of R package Janitor
...
* Jupyter:
  ...
  * [Teaching and Learning with Jupyter](https://github.com/jupyter4edu/jupyter-edu-book) ⭐ 469 | 🐛 29 | 🌐 TeX | 📅 2023-03-30 [book](https://jupyter4edu.github.io/jupyter-edu-book/)
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 66,061 | 🐛 895 | 🌐 Go | 📅 2026-09-11: The Prometheus monitoring system and time series database.
* [dart](https://github.com/unit8co/darts) ⭐ 9,519 | 🐛 231 | 🌐 Python | 📅 2026-09-07: A python library for easy manipulation and forecasting of time series.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,177 | 🐛 163 | 🌐 C++ | 📅 2026-08-10: The Time Series Visualization Tool that you deserve.
...
* [ImageMagick creates huge temporary files · Issue #395 · ImageMagick/ImageMagick](https://github.com/ImageMagick/ImageMagick/issues/395) ⭐ 17,416 | 🐛 162 | 🌐 C | 📅 2026-09-14
...
* [FiPy](https://github.com/usnistgov/fipy) ⭐ 638 | 🐛 177 | 🌐 Python | 📅 2026-08-27: is a Finite Volume PDE solver written in Python.
...
* [jax](https://github.com/google/jax) ⭐ 36,297 | 🐛 2,552 | 🌐 Python | 📅 2026-09-14: Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more
* [micro](https://micro-editor.github.io/): a modern and intuitive [terminal-based text editor](https://github.com/zyedidia/micro#linux-clipboard-support) ⭐ 29,576 | 🐛 931 | 🌐 Go | 📅 2026-09-14.
* [pyodide](https://github.com/iodide-project/pyodide) ⭐ 14,830 | 🐛 400 | 🌐 Python | 📅 2026-09-14: The Python scientific stack, compiled to WebAssembly
...
* [Rack](https://github.com/VCVRack/Rack) ⭐ 4,416 | 🐛 307 | 🌐 C++ | 📅 2025-11-04: The virtual Eurorack studio
* [Sonic Visualiser](https://www.sonicvisualiser.org/) is a free, open-source application for Windows, Linux, and Mac, designed to be the first program you reach for when want to study a music recording closely. It's designed for musicologists, archivists, signal-processing researchers, and anyone else looking for a friendly way to look at what lies inside the audio file. [github repo](https://github.com/sonic-visualiser/sonic-visualiser) ⭐ 895 | 🐛 84 | 🌐 C++ | 📅 2025-12-07
...
* [This program generates bitmaps that are locally similar to the input bitmap](https://github.com/mxgmn/WaveFunctionCollapse) ⭐ 25,322 | 🐛 9 | 🌐 C# | 📅 2026-03-22
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,980 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-13: Easily add particles animations to your website. Compatible also with React, Vue.js (2.x and 3.x), Angular, Svelte, jQuery, Preact, Inferno.
* [Walk through an infinite, procedurally generated city](https://github.com/marian42/wavefunctioncollapse) ⭐ 4,858 | 🐛 9 | 🌐 C# | 📅 2021-03-28
* [An interactive, explorable explanation about the peculiar magic of sound waves.](https://github.com/joshwcomeau/waveforms) ⭐ 1,481 | 🐛 4 | 🌐 JavaScript | 📅 2018-02-21
* [SOFA](https://www.sofa-framework.org/): is an efficient framework dedicated to research, prototyping and development of physics-based simulations. [github](https://github.com/sofa-framework/sofa/) ⭐ 1,255 | 🐛 451 | 🌐 C++ | 📅 2026-09-14.
...
* [gqrx](https://gqrx.dk/): is an open source software defined radio receiver (SDR) powered by the GNU Radio and the Qt graphical toolkit. [Gqrx](https://github.com/csete/gqrx) ⭐ 3,679 | 🐛 269 | 🌐 C++ | 📅 2026-08-06
...
* CDS Astro:
  ...
  * [CDS Tutorials](https://github.com/cds-astro/tutorials) ⭐ 85 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-09-13
...
* [Open MCT](https://nasa.github.io/openmct/): is a next-generation mission control framework for visualization of data on desktop and mobile devices - [github](https://github.com/nasa/openmct) ⭐ 13,118 | 🐛 1,090 | 🌐 JavaScript | 📅 2026-09-11
* [fprime](https://github.com/nasa/fprime) ⭐ 11,737 | 🐛 468 | 🌐 C++ | 📅 2026-09-13: A flight software and embedded systems framework.
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,643 | 🐛 14 | 🌐 HTML | 📅 2026-09-03: A build-it-yourself, 6-wheel rover based on the rovers on Mars!
...
* [MNE-Python](https://github.com/mne-tools/mne-python) ⭐ 3,514 | 🐛 617 | 🌐 Python | 📅 2026-09-14: Magnetoencephalography (MEG) and Electroencephalography (EEG) in Python
...
* [Repositório de dados](https://github.com/mauriciovancine/disciplina-geoprocessamento) ⭐ 15 | 🐛 0 | 🌐 HTML | 📅 2020-03-02: Introdução ao geoprocessamento para Etnobiologia e Conservação da Biodiversidade
...
* [Awesome-Design-Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 41,196 | 🐛 204 | 🌐 JavaScript | 📅 2024-07-28: The best design tools for everything.
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,483 | 🐛 284 | 🌐 C++ | 📅 2026-09-14:Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
...
* [BIM\_Workbench](https://github.com/yorikvanhavre/BIM_Workbench) ⭐ 404 | 🐛 29 | 🌐 Python | 📅 2024-09-02: A BIM Workbench for FreeCAD
...
* [Craft](https://github.com/fogleman/Craft) ⭐ 11,099 | 🐛 129 | 🌐 C | 📅 2024-04-03: A simple Minecraft clone written in C using modern OpenGL (shaders).
* [Opendiablo2](https://github.com/OpenDiablo2/OpenDiablo2) ⚠️ Archived: An open source re-implementation of Diablo 2
* [gb-studio](https://github.com/chrismaltby/gb-studio) ⭐ 9,405 | 🐛 807 | 🌐 TypeScript | 📅 2026-09-13: A free and easy to use retro adventure game creator for your favourite [handheld video game system](https://www.gbstudio.dev)
...
* [MarkovJunior](https://github.com/mxgmn/MarkovJunior) ⭐ 8,191 | 🐛 9 | 🌐 C# | 📅 2026-03-20: Probabilistic PL based on pattern matching and constraint propagation, 148 examples.
* [Citybound](https://github.com/citybound/citybound) ⭐ 8,161 | 🐛 153 | 🌐 Rust | 📅 2023-01-07: Citybound is a city building game with a focus on realism, collaborative planning and simulation of microscopic details.
* [OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,480 | 🐛 55 | 🌐 C++ | 📅 2026-08-31: A Framework for Reinforcement Learning in Games.
* [Zelda 3 in C](https://github.com/snesrev/zelda3) ⭐ 4,762 | 🐛 89 | 🌐 C | 📅 2023-12-27: A reimplementation of Zelda 3.
...
* [SDLPoP](https://github.com/NagyD/SDLPoP) ⭐ 1,280 | 🐛 81 | 🌐 C | 📅 2025-12-24: An open-source port of Prince of Persia, based on the disassembly of the DOS version.
* [quinesanek](https://github.com/taylorconor/quinesnake) ⭐ 925 | 🐛 1 | 🌐 C++ | 📅 2019-07-27: A quine that plays snake over its own source!
* [Links Awakening DX Disassembly](https://github.com/zladx/LADX-Disassembly) ⭐ 901 | 🐛 18 | 🌐 Assembly | 📅 2026-08-27: Disassembly of Legend of Zelda: Links Awakening DX.
...
* [veyon](https://github.com/veyon/veyon/) ⭐ 1,957 | 🐛 222 | 🌐 C++ | 📅 2026-09-09: Cross-platform computer monitoring and classroom management.

## Studies

* [Path to a free self-taught education in Computer Science!](https://github.com/ossu/computer-science) ⭐ 208,994 | 🐛 29 | 🌐 HTML | 📅 2026-07-14
* [the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,813 | 🐛 200 | 🌐 Jupyter Notebook | 📅 2026-05-20: One has no future if one couldn't teach themself.
...
* [FreshRSS](https://github.com/FreshRSS/FreshRSS) ⭐ 16,010 | 🐛 670 | 🌐 PHP | 📅 2026-09-13: A free, self-hostable aggregator…
...
* [Differential Privacy](https://github.com/google/differential-privacy) ⭐ 3,358 | 🐛 57 | 🌐 Go | 📅 2026-09-11: This project contains a C++ library of ε-differentially private algorithms, which can be used to produce aggregate statistics over numeric data sets containing private or sensitive information.
...
* [Apache Flink](https://github.com/apache/flink) ⭐ 26,334 | 🐛 370 | 🌐 Java | 📅 2026-09-13: Apache Flink is an open source stream processing framework with powerful stream- and batch-processing capabilities.
* [lists](https://github.com/jnv/lists) ⭐ 11,477 | 🐛 27 | 📅 2026-03-23: The definitive list of lists (of lists) curated on GitHub
...
* (pt-br) [Lista Maravilhosa de Projetos Open-Source](https://github.com/camilatigre/listamaravilhosaopensource) ⭐ 2,575 | 🐛 25 | 🌐 JavaScript | 📅 2026-06-15: Lista com links de projetos open-source para os níveis: iniciante, intermediário e avançado. Dividido por linguagem e idiomas!
...
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 369,846 | 🐛 612 | 🌐 Python | 📅 2026-03-20: Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 360,857 | 🐛 125 | 📅 2025-08-28: A complete computer science study plan to become a software engineer.
* [GitHub Résumé](https://github.com/resume/resume.github.com) ⭐ 62,895 | 🐛 76 | 🌐 JavaScript | 📅 2023-02-15
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 52,111 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-24: Companies that don't have a broken hiring process.
...
* [test-your-sysadmin-skills](https://github.com/trimstray/test-your-sysadmin-skills) ⭐ 11,856 | 🐛 19 | 📅 2024-11-19
* [OpenResume](https://www.open-resume.com/) Create a professional resume easily with this free, open-source, and powerful [resume builder](https://github.com/xitanggg/open-resume) ⭐ 8,907 | 🐛 144 | 🌐 TypeScript | 📅 2024-10-29.
...
* [awesome-scifi](https://github.com/sindresorhus/awesome-scifi) ⭐ 5,044 | 🐛 1 | 📅 2025-12-22: I asked on Twitter for recommendations as I want to get into reading Sci-Fi novels. The below is the result. Thanks everyone for recommending your favorites! :)
...
* [📚 Freely available programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 396,723 | 🐛 82 | 🌐 Python | 📅 2026-09-13
