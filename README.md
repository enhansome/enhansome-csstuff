...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 358,737 | 🐛 124 | 📅 2025-08-28
* [The Book of Secret Knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) ⭐ 238,395 | 🐛 164 | 📅 2024-11-19
* [z3](https://github.com/Z3Prover/z3) ⭐ 12,561 | 🐛 89 | 🌐 C++ | 📅 2026-08-14: The Z3 Theorem Prover
...
* [ClickHouse](https://github.com/ClickHouse/ClickHouse) ⭐ 49,255 | 🐛 6,927 | 🌐 C++ | 📅 2026-08-15: is a free analytics DBMS for big data.
...
* [pgFormatter](https://github.com/darold/pgFormatter) ⭐ 1,959 | 🐛 24 | 🌐 PLpgSQL | 📅 2026-07-15: A PostgreSQL SQL syntax beautifier that can work as a console program or as a CGI. On-line demo [site](http://sqlformat.darold.net/)
* [litetree](https://github.com/aergoio/litetree) ⭐ 1,636 | 🐛 9 | 🌐 C | 📅 2026-04-27: SQLite with Branches
* [litetree](https://github.com/aergoio/litetree) ⭐ 1,636 | 🐛 9 | 🌐 C | 📅 2026-04-27: SQLite with Branches
...
* [Every Programmer Should Know thinking](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,254 | 🐛 25 | 📅 2025-12-29: A collection of (mostly) technical things every software developer should know
...
* [Prettier is an opinionated code formatter](https://github.com/prettier/prettier) ⭐ 52,200 | 🐛 1,436 | 🌐 JavaScript | 📅 2026-08-15
...
* [dev.to](https://github.com/thepracticaldev/dev.to) ⭐ 22,764 | 🐛 120 | 🌐 Ruby | 📅 2026-08-14: Where programmers share ideas and help each other grow
* [Flow](https://github.com/facebook/flow) ⭐ 22,277 | 🐛 524 | 🌐 Rust | 📅 2026-08-15: Adds static typing to JavaScript to improve developer productivity and code quality.
* [Quine Relay](https://github.com/mame/quine-relay) ⭐ 14,564 | 🐛 18 | 🌐 Ruby | 📅 2025-10-24: An uroboros program with 100+ programming languages.
* [semantic](https://github.com/github/semantic) ⚠️ Archived: Parsing, analyzing, and comparing source code across many languages
* [Algorithms](http://jeffe.cs.illinois.edu/teaching/algorithms/): this web page contains a free electronic version of my (soon to be) self-published textbook Algorithms, along with other lecture notes I have written for various theoretical computer science classes at the University of Illinois, Urbana-Champaign since 1998. [github](https://github.com/jeffgerickson/algorithms) ⭐ 8,124 | 🐛 173 | 📅 2019-11-23
...
* [vscodium](https://github.com/VSCodium/vscodium) ⭐ 32,822 | 🐛 139 | 🌐 Shell | 📅 2026-08-12: binary releases of VS Code without MS branding/telemetry/licensing
  * [awesome-vscode](https://github.com/viatsko/awesome-vscode) ⭐ 28,959 | 🐛 45 | 🌐 JavaScript | 📅 2026-06-21: art A curated list of delightful VS Code packages and resources.
...
* [Microsoft's C++ Standard Library](https://github.com/microsoft/STL) ⭐ 11,129 | 🐛 582 | 🌐 C++ | 📅 2026-08-14: MSVC's implementation of the C++ Standard Library.
* mozilla [rr](https://github.com/mozilla/rr) ⭐ 10,622 | 🐛 479 | 🌐 C++ | 📅 2026-08-11: is a lightweight tool for recording, replaying and debugging execution of applications (trees of processes and threads). Debugging extends gdb with very efficient reverse-execution, which in combination with standard gdb/x86 features like hardware data watchpoints, makes debugging much more fun.
...
* [libtcod](https://github.com/libtcod/libtcod) ⭐ 1,217 | 🐛 27 | 🌐 C | 📅 2026-07-20: The official repository for libtcod. A roguelike development library.
...
* TDD C:
  * [Google Test](https://github.com/google/googletest) ⭐ 38,927 | 🐛 490 | 🌐 C++ | 📅 2026-08-13: Google Testing and Mocking Framework.
...
* [Makefile Tutorial by Example](https://makefiletutorial.com/) and [repo](https://github.com/theicfire/makefiletutorial) ⭐ 5,961 | 🐛 8 | 🌐 SCSS | 📅 2025-06-02
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,633 | 🐛 308 | 🌐 JavaScript | 📅 2026-04-08: A simple and modern GTK eBook viewer, built with GJS and Epub.js.
...
* [A curated list of awesome Python frameworks, libraries, software and resources](https://github.com/vinta/awesome-python#authentication) ⭐ 313,991 | 🐛 27 | 🌐 Python | 📅 2026-08-05
* [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) ⭐ 223,731 | 🐛 1,028 | 🌐 Python | 📅 2026-08-03: All Algorithms implemented in Python
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,597 | 🐛 73 | 🌐 Python | 📅 2026-08-14 framework, high performance, easy to learn, fast to code, ready for production
* cython [dtoa.c](https://github.com/python/cpython/blob/master/Python/dtoa.c) ⭐ 74,321 | 🐛 9,485 | 🌐 Python | 📅 2026-08-14
* [Rich](https://github.com/willmcgugan/rich) ⭐ 57,071 | 🐛 369 | 🌐 Python | 📅 2026-06-23 is a Python library for rich text and beautiful formatting in the terminal.
* [black](https://github.com/ambv/black/) ⭐ 41,805 | 🐛 302 | 🌐 Python | 📅 2026-08-10: The uncompromising Python code formatter
* [wtfpython](https://github.com/satwikkansal/wtfpython#-is-not--is-not-is-not-) ⭐ 37,055 | 🐛 72 | 🌐 Python | 📅 2026-01-13: A collection of surprising Python snippets and lesser-known features.
* [wtfpython](https://github.com/satwikkansal/wtfpython) ⭐ 37,055 | 🐛 72 | 🌐 Python | 📅 2026-01-13: What the f\*ck Python? ￼
* [Course Files for Complete Python 3 Bootcamp Course on Udemy](https://github.com/Pierian-Data/Complete-Python-3-Bootcamp) ⭐ 29,704 | 🐛 268 | 🌐 Jupyter Notebook | 📅 2025-06-24
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,279 | 🐛 408 | 🌐 Rust | 📅 2026-08-14A Python Interpreter written in Rust
* [kivy](https://github.com/kivy/kivy) ⭐ 18,992 | 🐛 854 | 🌐 Python | 📅 2026-08-14: Open source UI framework written in Python, running on Windows, Linux, macOS, Android and iOS.
...
* [cinder](https://github.com/facebookincubator/cinder) ⭐ 3,792 | 🐛 33 | 🌐 Python | 📅 2026-08-14
...
* [OpenTelemetry Python](https://github.com/open-telemetry/opentelemetry-python) ⭐ 2,588 | 🐛 393 | 🌐 Python | 📅 2026-08-14: OpenTelemetry Python API and SDK
...
* Agda:
  * [Agda 2](https://github.com/agda/agda) ⭐ 2,913 | 🐛 1,045 | 🌐 Haskell | 📅 2026-08-14
  * [plfa](https://github.com/plfa/plfa.github.io/) ⭐ 1,512 | 🐛 65 | 🌐 Agda | 📅 2026-08-10: Introduction to programming language theory in Agda and [Programming Language Foundations in Agda](https://plfa.github.io/).
* Anglican:
...
* Answer Set Programming(ASP): offers a simple and powerful modeling language to solve combinatorial problems.
  * [Potassco](https://potassco.org/), [clingo](https://potassco.org/clingo/) and [github](https://github.com/potassco/clingo) ⭐ 823 | 🐛 14 | 🌐 C++ | 📅 2026-08-14.
* Brainfuck:
  * [Brainfuck](https://www.dcode.fr/brainfuck-language) encoder/decoder.
* Dafny:
  * [dafny](https://github.com/Microsoft/dafny) ⭐ 3,498 | 🐛 1,376 | 🌐 C# | 📅 2026-08-09: Dafny is a verification-aware programming language.
* Clean:
...
* Elixir:
  * [Nerves](https://github.com/nerves-project/nerves) ⭐ 2,483 | 🐛 22 | 🌐 Elixir | 📅 2026-08-14: Craft and deploy bulletproof embedded software in Elixir. [official site](http://nerves-project.org)
...
* Go:
  * [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 181,068 | 🐛 209 | 🌐 Go | 📅 2026-08-14: A curated list of awesome Go frameworks, libraries and software
...
* Lua:
  * [xmake](https://github.com/xmake-io/xmake) ⭐ 12,140 | 🐛 252 | 🌐 Lua | 📅 2026-08-14: 🔥 A cross-platform build [utility based on Lua](https://xmake.io)
* Nim:
  * [nim](https://nim-lang.org/): Efficient and expressive programming. [github](https://github.com/nim-lang/nim) ⭐ 18,172 | 🐛 2,187 | 🌐 Nim | 📅 2026-08-14
* Perl:
...
* PHP:
  * [A curated list of bookmarks, packages, tutorials, videos and other cool resources from the Laravel ecosystem](https://github.com/chiraggude/awesome-laravel) ⭐ 13,088 | 🐛 85 | 📅 2024-07-03
...
* Rust:
  * [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 58,833 | 🐛 8 | 🌐 Rust | 📅 2026-08-14: A curated list of Rust code and resources.
...
* V:
  * [V](https://github.com/vlang-io/V) ⭐ 37,791 | 🐛 85 | 🌐 V | 📅 2026-08-14: Simple, fast, safe, compiled language for creating maintainable software. Supports translation from C/C++.
  * [vlang](https://github.com/vlang/v) ⭐ 37,791 | 🐛 85 | 🌐 V | 📅 2026-08-14: Simple, fast, safe, compiled language for developing maintainable software. Supports translation from C and (soon) C++. Compiles itself in <1s.
* Verilog:
...
* Starting Pull Requests:
  * [Awesome First PR Opportunities](https://github.com/MunGell/awesome-for-beginners) ⭐ 88,390 | 🐛 140 | 📅 2026-07-25
...
* [.gitignore](https://github.com/github/gitignore) ⭐ 175,285 | 🐛 83 | 📅 2026-07-23: A collection of useful .gitignore templates
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,338 | 🐛 1,020 | 🌐 Go | 📅 2026-08-14: simple terminal UI for git commands
* [gitea](https://github.com/go-gitea/gitea) ⭐ 57,376 | 🐛 2,554 | 🌐 Go | 📅 2026-08-15: Git with a cup of tea, painless self-hosted git service
* [gogs](https://github.com/gogs/gogs) ⭐ 47,735 | 🐛 1,010 | 🌐 Go | 📅 2026-08-06: Gogs is a painless self-hosted Git service.
* [github-cli](https://github.com/cli/cli) ⭐ 45,821 | 🐛 1,054 | 🌐 Go | 📅 2026-08-14:  GitHub’s official command line tool
* [husky](https://github.com/typicode/husky) ⭐ 35,273 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19: Git hooks made easy
* [Learn git branching](https://learngitbranching.js.org/): An interactive git visualization to challenge and educate! [github](https://github.com/pcottle/learnGitBranching) ⭐ 33,876 | 🐛 58 | 🌐 JavaScript | 📅 2026-08-11.
* [cz-cli](https://github.com/commitizen/cz-cli) ⭐ 17,502 | 🐛 194 | 🌐 JavaScript | 📅 2026-08-11: The commitizen command line utility.
* [lint-staged](https://github.com/okonet/lint-staged) ⭐ 14,712 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-08: Run linters on git staged files
...
* [Pro Git book](https://git-scm.com/book/en/v2), written by Scott Chacon and Ben Straub ([github](https://github.com/progit/progit2) ⭐ 6,553 | 🐛 219 | 🌐 CSS | 📅 2026-05-25 repo)
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,059 | 🐛 12 | 🌐 Shell | 📅 2026-08-01 is a utility tool for git taking advantage of fuzzy finder fzf. [Interactive Git Commands With Previews Powered By fzf Fuzzy Finder](https://www.linuxuprising.com/2019/11/forgit-interactive-git-commands-with.html)
* [git-sizer](https://github.com/github/git-sizer/) ⭐ 4,068 | 🐛 18 | 🌐 Go | 📅 2026-01-16: Compute various size metrics for a Git repository, flagging those that might cause problems ( [article](https://blog.github.com/2018-03-05-measuring-the-many-sizes-of-a-git-repository/))
...
* [Forge](https://github.com/magit/forge/) ⭐ 1,569 | 🐛 10 | 🌐 Emacs Lisp | 📅 2026-08-14: Work with Git forges from the comfort of Magit
...
* [SkyWater Open Source PDK](https://github.com/google/skywater-pdk) ⭐ 3,653 | 🐛 199 | 🌐 Python | 📅 2026-07-21: Open source process design kit for usage with SkyWater Technology Foundry's 130nm node.
* [Ariane is a 6-stage RISC-V CPU](https://github.com/pulp-platform/ariane) ⭐ 3,065 | 🐛 258 | 🌐 Assembly | 📅 2026-08-14
* [cva6](https://github.com/openhwgroup/cva6) ⭐ 3,065 | 🐛 258 | 🌐 Assembly | 📅 2026-08-14: The CORE-V CVA6 is an Application class 6-stage RISC-V CPU capable of booting Linux.
...
* [VGChips](https://github.com/furrtek/VGChips) ⭐ 229 | 🐛 23 | 🌐 Verilog | 📅 2026-08-02: Video Game custom chips reverse-engineered from silicon.
...
* [Circuit Simulator](http://www.lushprojects.com/circuitjs/). [github](https://github.com/sharpie7/circuitjs1) ⭐ 2,921 | 🐛 263 | 🌐 Java | 📅 2024-01-22.
...
* [How to create an OS from scratch](https://github.com/cfenollosa/os-tutorial) ⭐ 30,654 | 🐛 130 | 🌐 C | 📅 2026-02-04
* [Mezzano](https://github.com/froggey/Mezzano/) ⭐ 3,881 | 🐛 14 | 🌐 Common Lisp | 📅 2026-06-16: An operating system written in Common Lisp.
* [bootOS](https://github.com/nanochess/bootOS) ⭐ 2,132 | 🐛 0 | 🌐 Assembly | 📅 2026-08-01 is a monolithic operating system in 512 bytes of x86 machine code.
...
* [GraalVM](https://github.com/oracle/graal) ⭐ 21,662 | 🐛 843 | 🌐 Java | 📅 2026-08-14: GraalVM is a universal virtual machine for running applications written in JavaScript, Python, Ruby, R, JVM-based languages like Java, Scala, Clojure, Kotlin, and LLVM-based languages such as C and C++. [GraalVM Implementation of Python](https://github.com/graalvm/graalpython) ⭐ 1,635 | 🐛 61 | 🌐 Python | 📅 2026-08-13
* [Compiler Explorer](https://godbolt.org/): Run compilers interactively from your web browser and interact with the assembly. [github](https://github.com/mattgodbolt/compiler-explorer) ⭐ 18,977 | 🐛 824 | 🌐 TypeScript | 📅 2026-08-14, [how it works](https://xania.org/201609/how-compiler-explorer-runs-on-amazon).
...
* [porcupine](https://github.com/anishathalye/porcupine/) ⭐ 1,236 | 🐛 4 | 🌐 Go | 📅 2026-08-06: A fast linearizability checker written in Go
...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 75,919 | 🐛 486 | 🌐 C++ | 📅 2026-08-14: Tesseract Open Source OCR Engine (main repository)
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,907 | 🐛 530 | 🌐 Python | 📅 2025-12-05: Ready-to-use OCR with 40+ languages supported including Chinese, Japanese, Korean and Thai.
...
* [faceswap](https://github.com/deepfakes/faceswap) ⭐ 57,455 | 🐛 12 | 🌐 Python | 📅 2026-08-05: Non official project based on original /r/Deepfakes thread. Many thanks to him!
* [Jina](https://github.com/jina-ai/jina) ⭐ 21,861 | 🐛 26 | 🌐 Python | 📅 2025-03-24: Cloud-native neural search framework for any kind of data.
...
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,777 | 🐛 56 | 🌐 C++ | 📅 2026-06-28: An open source library for face detection in images. The face detection speed can reach 1500FPS.
...
* [Lisp code](https://github.com/norvig/paip-lisp) ⭐ 7,505 | 🐛 35 | 🌐 Common Lisp | 📅 2024-10-15 for the textbook "Paradigms of Artificial Intelligence Programming"
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 164,083 | 🐛 2,381 | 🌐 Python | 📅 2026-08-14: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch.
* [nanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,110 | 🐛 351 | 🌐 Python | 📅 2025-11-12: The simplest, fastest repository for training/finetuning medium-sized GPTs.
* [Industrial-strength Natural Language Processing (NLP) with Python and Cython](https://github.com/explosion/spaCy/) ⭐ 33,821 | 🐛 232 | 🌐 Python | 📅 2026-08-07
...
* [PromptSource](https://github.com/bigscience-workshop/promptsource) ⭐ 3,028 | 🐛 43 | 🌐 Python | 📅 2023-10-23
...
* [google-10000-english](https://github.com/first20hours/google-10000-english) ⭐ 4,457 | 🐛 28 | 📅 2023-05-17: This repo contains a list of the 10,000 most common English words in order of frequency, as determined by n-gram frequency analysis of the Google's Trillion Word Corpus.
...
* [Real-Time Voice Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning) ⭐ 60,087 | 🐛 177 | 🌐 Python | 📅 2026-03-09: Clone a voice in 5 seconds to generate arbitrary speech in real-time
...
* [DeepMind Research](https://github.com/deepmind/deepmind-research) ⭐ 15,152 | 🐛 341 | 🌐 Jupyter Notebook | 📅 2026-06-17: This repository contains implementations and illustrative code to accompany DeepMind publications.
* [vosk-api](https://github.com/alphacep/vosk-api) ⭐ 15,055 | 🐛 600 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API for Android, iOS, Raspberry Pi and servers with Python, Java, C# and Node.
* [Transfer Learning](https://github.com/jindongwang/transferlearning) ⭐ 14,347 | 🐛 24 | 🌐 Python | 📅 2025-02-18: Everything about Transfer Learning and Domain Adaptation--迁移学习
* [CARLA](https://carla.org): Open-source simulator for [autonomous driving research](https://github.com/carla-simulator/carla) ⭐ 14,296 | 🐛 1,190 | 🌐 C++ | 📅 2026-08-14.
...
* [60\_Days\_RL\_Challenge](https://github.com/andri27-ts/60_Days_RL_Challenge) ⭐ 4,728 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2020-06-30: Learn Deep Reinforcement Learning in depth in 60 days
* [make-sense](https://github.com/SkalskiP/make-sense) ⭐ 3,558 | 🐛 132 | 🌐 TypeScript | 📅 2024-08-15: [Free to use online tool for labelling photos](https://makesense.ai).
...
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,346 | 🐛 1,008 | 🌐 C# | 📅 2026-08-13: is an open source and cross-platform machine learning framework for .NET.
* [DeepLabCut](http://www.mackenziemathislab.org/deeplabcut): is an efficient method for 3D markerless pose estimation based on transfer learning with deep neural networks that achieves excellent results (i.e. you can match human labeling accuracy) with minimal training data (typically 50-200 frames). [repo](https://github.com/DeepLabCut/DeepLabCut) ⭐ 5,735 | 🐛 48 | 🌐 Python | 📅 2026-08-14
* [Is a Green Screen Really Necessary for Real-Time Human Matting?](https://arxiv.org/pdf/2011.11961.pdf), [repo](https://github.com/ZHKKKe/MODNet) ⭐ 4,349 | 🐛 71 | 🌐 Python | 📅 2024-05-06
* [Nevergrad](https://code.fb.com/ai-research/nevergrad/): An open source tool for derivative-free optimization. [github](https://github.com/facebookresearch/nevergrad) ⭐ 4,201 | 🐛 141 | 🌐 Python | 📅 2026-07-24
...
* [Stable Diffusion](https://github.com/CompVis/stable-diffusion) ⭐ 73,300 | 🐛 619 | 🌐 Jupyter Notebook | 📅 2024-06-18: is a latent text-to-image diffusion model. Thanks to a generous compute donation from Stability AI and support from LAION, we were able to train a Latent Diffusion Model on 512x512 images from a subset of the LAION-5B database.
* [Wan](https://github.com/Wan-Video/Wan2.2) ⭐ 17,127 | 🐛 286 | 🌐 Python | 📅 2026-03-17: Open and Advanced Large-Scale Video Generative Models
...
* [Handwriting Synthesis](https://github.com/sjvasquez/handwriting-synthesis) ⭐ 4,797 | 🐛 63 | 🌐 Python | 📅 2024-01-11
...
* [Pupyl](https://github.com/policratus/pupyl) ⭐ 116 | 🐛 7 | 🌐 Python | 📅 2024-12-24 is a really fast image search library which you can index your own (millions of) images and find similar images in milliseconds.
...
* [fiftyone](https://github.com/voxel51/fiftyone) ⭐ 11,015 | 🐛 660 | 🌐 TypeScript | 📅 2026-08-15: The open-source tool for building high-quality datasets and computer vision models
...
* [YOLOv7](https://github.com/jinfagang/yolov7) ⭐ 3,107 | 🐛 69 | 🌐 Python | 📅 2023-11-18: YOLO with Transformers and Instance Segmentation, with TensorRT acceleration!
* [MUNIT](https://github.com/nvlabs/munit) ⭐ 2,707 | 🐛 66 | 🌐 Python | 📅 2022-09-20: Multimodal UNsupervised Image-to-image Translation
* [OpenSimpleLidar](https://github.com/iliasam/OpenSimpleLidar) ⭐ 2,550 | 🐛 1 | 🌐 C | 📅 2025-07-22: Open Hardware scanning laser rangefinder ([howto](https://hackaday.io/project/20628-open-simple-lidar))
...
*Frameworks for Neural Networks and Deep Learning. See: [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,753 | 🐛 84 | 📅 2025-05-26.*

* [Keras](https://github.com/fchollet/keras) ⭐ 64,228 | 🐛 216 | 🌐 Python | 📅 2026-08-14 - A high-level neural networks library and capable of running on top of either TensorFlow or Theano.
...
* [Theano](https://github.com/Theano/Theano) ⭐ 9,999 | 🐛 699 | 🌐 Python | 📅 2024-01-15 - A library for fast numerical computation.
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,379 | 🐛 17,307 | 🌐 Python | 📅 2026-08-15: Tensors and Dynamic neural networks in Python with strong GPU acceleration a ([tour](http://blog.christianperone.com/2018/03/pytorch-internal-architecture-tour/)):
* [tinygrad](https://github.com/geohot/tinygrad) ⭐ 33,450 | 🐛 180 | 🌐 Python | 📅 2026-08-15: You like pytorch? You like [micrograd](https://github.com/karpathy/micrograd) ⭐ 17,125 | 🐛 78 | 🌐 Jupyter Notebook | 📅 2026-08-03? You love tinygrad! ❤️
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,024 | 🐛 2,852 | 🌐 C++ | 📅 2026-08-15 - The most popular Deep Learning framework created by Google.
* [BERT](https://github.com/google-research/bert) ⚠️ Archived: TensorFlow code and pre-trained models for BERT
* [Machine Learning Notebooks](https://github.com/ageron/handson-ml2) ⭐ 29,956 | 🐛 230 | 🌐 Jupyter Notebook | 📅 2026-05-19: A series of Jupyter notebooks that walk you through the fundamentals of Machine Learning and Deep Learning in Python using Scikit-Learn, Keras and TensorFlow 2.
...
* Good channels:
  * [3blue1brown](https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw/): 3blue1brown, by Grant Sanderson, is some combination of math and entertainment, depending on your disposition ([site](https://www.3blue1brown.com/)) and [manim](https://github.com/3b1b/manim) ⭐ 91,132 | 🐛 493 | 🌐 Python | 📅 2026-08-14(Animation engine for explanatory math videos).
...
* [pycm](https://github.com/sepandhaghighi/pycm) ⭐ 1,506 | 🐛 16 | 🌐 Python | 📅 2026-08-11: Multi-class confusion matrix library in Python.
...
* [The Data Engineering Cookbook](https://github.com/andkret/Cookbook) ⭐ 15,292 | 🐛 128 | 🌐 Python | 📅 2026-07-23
* [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,289 | 🐛 1,348 | 🌐 Python | 📅 2026-08-15: Official repository for Spyder - The Scientific Python Development Environment
* [Luna](https://www.luna-lang.org/) is a data processing and visualization environment built on a principle that people need an immediate connection to what they are building. [github repo](https://github.com/luna/luna) ⭐ 7,435 | 🐛 325 | 🌐 Java | 📅 2026-08-10, [studio](https://github.com/luna/luna-studio) (IDE) and [docs](https://luna-lang.gitbooks.io/docs/content/interface.html)
* [ferret](https://github.com/MontFerret/ferret) ⭐ 6,008 | 🐛 11 | 🌐 Go | 📅 2026-08-14: Declarative web scraping
* [RAPIDS](http://rapids.ai): Open GPU Data Science. The RAPIDS suite of software libraries gives you the freedom to execute end-to-end data science and analytics pipelines entirely on GPUs. It relies on NVIDIA® CUDA® primitives for low-level compute optimization, but exposes that GPU parallelism and high-bandwidth memory speed through user-friendly Python interfaces. [cuml](https://github.com/rapidsai/cuml) ⭐ 5,252 | 🐛 837 | 🌐 Python | 📅 2026-08-14 - RAPIDS Machine Learning Library.
...
* [insight](https://github.com/easystats/insight) ⭐ 439 | 🐛 59 | 🌐 R | 📅 2026-08-13: Easy access to model information for various model objects.
...
* Python:
  ...
  * [arviz](https://github.com/arviz-devs/arviz) ⭐ 1,846 | 🐛 111 | 🌐 TeX | 📅 2026-08-11: Python package to plot and analyse samples from probabilistic models
  ...
  * [pyjanitor](https://github.com/ericmjl/pyjanitor) ⭐ 1,499 | 🐛 108 | 🌐 Python | 📅 2026-08-11: Python implementation of R package Janitor
...
* R Lang
  ...
  * [ffscrapr](https://ffscrapr.dynastyprocess.com/): An R Client for Fantasy Football League APIs. [repo](https://github.com/dynastyprocess/ffscrapr/) ⭐ 92 | 🐛 22 | 🌐 R | 📅 2024-11-01
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,703 | 🐛 885 | 🌐 Go | 📅 2026-08-14: The Prometheus monitoring system and time series database.
* [dart](https://github.com/unit8co/darts) ⭐ 9,493 | 🐛 219 | 🌐 Python | 📅 2026-08-06: A python library for easy manipulation and forecasting of time series.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,113 | 🐛 157 | 🌐 C++ | 📅 2026-08-10: The Time Series Visualization Tool that you deserve.
* [OpenTSDB](http://opentsdb.net/): A scalable, distributed Time Series Database. [repo](https://github.com/OpenTSDB/opentsdb) ⭐ 5,067 | 🐛 538 | 🌐 Java | 📅 2024-12-12
...
* [ImageMagick creates huge temporary files · Issue #395 · ImageMagick/ImageMagick](https://github.com/ImageMagick/ImageMagick/issues/395) ⭐ 17,162 | 🐛 161 | 🌐 C | 📅 2026-08-15
* [roughViz](https://github.com/jwilber/roughViz) ⭐ 7,147 | 🐛 13 | 🌐 JavaScript | 📅 2024-04-26: Reusable JavaScript library for creating sketchy/hand-drawn styled charts in the browser.
...
* [vedo](https://github.com/marcomusy/vedo) ⭐ 2,261 | 🐛 170 | 🌐 Python | 📅 2026-08-04: A python module for scientific analysis of 3D objects based on VTK and numpy
* [Pseudo-bandlimited pixel art filtering in 3D – a mathematical derivation](http://themaister.net/blog/2018/08/25/pseudo-bandlimited-pixel-art-filtering-in-3d-a-mathematical-derivation/) [github](https://github.com/Themaister/Granite) ⭐ 1,932 | 🐛 2 | 🌐 C++ | 📅 2026-08-14
...
* GGplot2:
  ...
  * [ggcorrplot](https://github.com/kassambara/ggcorrplot) ⭐ 195 | 🐛 1 | 🌐 R | 📅 2026-07-28
...
* [jax](https://github.com/google/jax) ⭐ 36,160 | 🐛 2,579 | 🌐 Python | 📅 2026-08-15: Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more
* [micro](https://micro-editor.github.io/): a modern and intuitive [terminal-based text editor](https://github.com/zyedidia/micro#linux-clipboard-support) ⭐ 29,342 | 🐛 1,033 | 🌐 Go | 📅 2026-08-15.
* [pyodide](https://github.com/iodide-project/pyodide) ⭐ 14,786 | 🐛 399 | 🌐 Python | 📅 2026-08-14: The Python scientific stack, compiled to WebAssembly
...
* [bild](https://github.com/anthonynsimon/bild) ⭐ 4,202 | 🐛 17 | 🌐 Go | 📅 2026-08-01: A collection of parallel image processing algorithms in pure Go
...
* [This program generates bitmaps that are locally similar to the input bitmap](https://github.com/mxgmn/WaveFunctionCollapse) ⭐ 25,271 | 🐛 9 | 🌐 C# | 📅 2026-03-22
...
* [An interactive, explorable explanation about the peculiar magic of sound waves.](https://github.com/joshwcomeau/waveforms) ⭐ 1,481 | 🐛 4 | 🌐 JavaScript | 📅 2018-02-21
* [SOFA](https://www.sofa-framework.org/): is an efficient framework dedicated to research, prototyping and development of physics-based simulations. [github](https://github.com/sofa-framework/sofa/) ⭐ 1,244 | 🐛 447 | 🌐 C++ | 📅 2026-08-11.
...
* [gqrx](https://gqrx.dk/): is an open source software defined radio receiver (SDR) powered by the GNU Radio and the Qt graphical toolkit. [Gqrx](https://github.com/csete/gqrx) ⭐ 3,655 | 🐛 263 | 🌐 C++ | 📅 2026-08-06
...
* CDS Astro:
  ...
  * [CDS Tutorials](https://github.com/cds-astro/tutorials) ⭐ 85 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-07-27
...
* [Open MCT](https://nasa.github.io/openmct/): is a next-generation mission control framework for visualization of data on desktop and mobile devices - [github](https://github.com/nasa/openmct) ⭐ 13,083 | 🐛 1,061 | 🌐 JavaScript | 📅 2026-08-14
* [fprime](https://github.com/nasa/fprime) ⭐ 11,657 | 🐛 432 | 🌐 C++ | 📅 2026-08-14: A flight software and embedded systems framework.
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,578 | 🐛 18 | 🌐 Prolog | 📅 2026-08-13: A build-it-yourself, 6-wheel rover based on the rovers on Mars!
...
* [MNE-Python](https://github.com/mne-tools/mne-python) ⭐ 3,482 | 🐛 637 | 🌐 Python | 📅 2026-08-12: Magnetoencephalography (MEG) and Electroencephalography (EEG) in Python
...
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 936 | 🐛 19 | 🌐 R | 📅 2026-08-14: Easy access to shapefiles of the Brazilian Institute of Geography and Statistics (IBGE) and other official spatial data sets of Brazil.
...
* [Awesome Blockchain](https://github.com/yjjnls/awesome-blockchain) ⭐ 3,621 | 🐛 53 | 🌐 Go | 📅 2024-03-22: Curated list of resources for the development and applications of blockchain.
...
* [Memex](https://worldbrain.io/#) - your photographic memory for the web. Open-Source. Private. [repo](https://github.com/WorldBrain/Memex) ⭐ 4,712 | 🐛 319 | 🌐 TypeScript | 📅 2025-12-02
...
* [Awesome-Design-Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 40,877 | 🐛 179 | 🌐 JavaScript | 📅 2024-07-28: The best design tools for everything.
...
* [gb-studio](https://github.com/chrismaltby/gb-studio) ⭐ 9,362 | 🐛 795 | 🌐 TypeScript | 📅 2026-08-14: A free and easy to use retro adventure game creator for your favourite [handheld video game system](https://www.gbstudio.dev)
* [sm64](https://github.com/n64decomp/sm64) ⭐ 8,718 | 🐛 28 | 🌐 C | 📅 2024-02-04: A Super Mario 64 decompilation, brought to you by a bunch of clever folks.
* [MarkovJunior](https://github.com/mxgmn/MarkovJunior) ⭐ 8,162 | 🐛 9 | 🌐 C# | 📅 2026-03-20: Probabilistic PL based on pattern matching and constraint propagation, 148 examples.
...
* [OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,411 | 🐛 49 | 🌐 C++ | 📅 2026-08-12: A Framework for Reinforcement Learning in Games.
* [Zelda 3 in C](https://github.com/snesrev/zelda3) ⭐ 4,724 | 🐛 88 | 🌐 C | 📅 2023-12-27: A reimplementation of Zelda 3.
* [The Comprehensive Kerbal Archive Network (CKAN)](https://github.com/KSP-CKAN/CKAN) ⭐ 2,615 | 🐛 83 | 🌐 C# | 📅 2026-07-17
* [Synfig Studio](https://github.com/synfig/synfig/) ⭐ 2,279 | 🐛 729 | 🌐 C++ | 📅 2026-08-08: This is the Official source code repository of the Synfig project.
...
* [Path to a free self-taught education in Computer Science!](https://github.com/ossu/computer-science) ⭐ 207,998 | 🐛 25 | 🌐 HTML | 📅 2026-07-14
* [the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,413 | 🐛 199 | 🌐 Jupyter Notebook | 📅 2026-05-20: One has no future if one couldn't teach themself.
...
* [Awesome Accessibility](https://github.com/brunopulis/awesome-a11y) ⭐ 1,976 | 🐛 58 | 📅 2026-08-03: A curate list about A11Y
...
* [FreshRSS](https://github.com/FreshRSS/FreshRSS) ⭐ 15,771 | 🐛 656 | 🌐 PHP | 📅 2026-08-14: A free, self-hostable aggregator…
...
* [Sanic](https://github.com/sanic-org/sanic) ⭐ 18,646 | 🐛 145 | 🌐 Python | 📅 2026-07-29: Async Python 3.7+ web server/framework | Build fast. Run fast.
...
* [Differential Privacy](https://github.com/google/differential-privacy) ⭐ 3,342 | 🐛 60 | 🌐 Go | 📅 2026-08-06: This project contains a C++ library of ε-differentially private algorithms, which can be used to produce aggregate statistics over numeric data sets containing private or sensitive information.
...
* [lists](https://github.com/jnv/lists) ⭐ 11,417 | 🐛 19 | 📅 2026-03-23: The definitive list of lists (of lists) curated on GitHub
* [awesome-uses](https://github.com/wesbos/awesome-uses) ⭐ 5,298 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-13: A list of /uses pages that detail apps and gear used by professional web developers.
...
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 363,791 | 🐛 601 | 🌐 Python | 📅 2026-03-20: Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 358,737 | 🐛 124 | 📅 2025-08-28: A complete computer science study plan to become a software engineer.
* [GitHub Résumé](https://github.com/resume/resume.github.com) ⭐ 62,886 | 🐛 76 | 🌐 JavaScript | 📅 2023-02-15
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 51,349 | 🐛 12 | 🌐 JavaScript | 📅 2026-06-06: Companies that don't have a broken hiring process.
...
* [OpenResume](https://www.open-resume.com/) Create a professional resume easily with this free, open-source, and powerful [resume builder](https://github.com/xitanggg/open-resume) ⭐ 8,837 | 🐛 141 | 🌐 TypeScript | 📅 2024-10-29.
* [linux-sysadmin-interview-questions](https://github.com/chassing/linux-sysadmin-interview-questions) ⭐ 5,327 | 🐛 7 | 📅 2024-03-11: Collection of Linux Sysadmin/DevOps interview questions
...
* [awesome-scifi](https://github.com/sindresorhus/awesome-scifi) ⭐ 5,003 | 🐛 0 | 📅 2025-12-22: I asked on Twitter for recommendations as I want to get into reading Sci-Fi novels. The below is the result. Thanks everyone for recommending your favorites! :)
...
* [📚 Freely available programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 394,405 | 🐛 80 | 🌐 Python | 📅 2026-08-11
