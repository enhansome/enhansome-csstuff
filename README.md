...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 360,661 | 🐛 125 | 📅 2025-08-28
* [The Book of Secret Knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) ⭐ 242,933 | 🐛 170 | 📅 2024-11-19
* [z3](https://github.com/Z3Prover/z3) ⭐ 12,657 | 🐛 42 | 🌐 C++ | 📅 2026-09-10: The Z3 Theorem Prover
...
* [ClickHouse](https://github.com/ClickHouse/ClickHouse) ⭐ 49,783 | 🐛 7,483 | 🌐 C++ | 📅 2026-09-10: is a free analytics DBMS for big data.
* [HikariCP](https://github.com/brettwooldridge/HikariCP) ⭐ 21,206 | 🐛 544 | 🌐 Java | 📅 2026-06-14: 光 HikariCP・A solid, high-performance, JDBC connection pool at last.
...
* [Every Programmer Should Know thinking](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,401 | 🐛 25 | 📅 2025-12-29: A collection of (mostly) technical things every software developer should know
...
* [Prettier is an opinionated code formatter](https://github.com/prettier/prettier) ⭐ 52,240 | 🐛 1,431 | 🌐 JavaScript | 📅 2026-09-09
...
* [dev.to](https://github.com/thepracticaldev/dev.to) ⭐ 22,773 | 🐛 134 | 🌐 Ruby | 📅 2026-09-09: Where programmers share ideas and help each other grow
* [Flow](https://github.com/facebook/flow) ⭐ 22,284 | 🐛 519 | 🌐 Rust | 📅 2026-09-10: Adds static typing to JavaScript to improve developer productivity and code quality.
* [Quine Relay](https://github.com/mame/quine-relay) ⭐ 14,597 | 🐛 18 | 🌐 Ruby | 📅 2026-09-01: An uroboros program with 100+ programming languages.
...
* (pt-br) [OsProgramadores](https://osprogramadores.com) - [op-desafios](https://github.com/OsProgramadores/op-desafios) ⭐ 159 | 🐛 1 | 🌐 C | 📅 2026-09-10: Soluções para os desafios (por usuário)
...
* [vscodium](https://github.com/VSCodium/vscodium) ⭐ 33,177 | 🐛 139 | 🌐 Shell | 📅 2026-09-09: binary releases of VS Code without MS branding/telemetry/licensing
...
* [Microsoft's C++ Standard Library](https://github.com/microsoft/STL) ⭐ 11,145 | 🐛 600 | 🌐 C++ | 📅 2026-09-09: MSVC's implementation of the C++ Standard Library.
...
* TDD C:
  * [Google Test](https://github.com/google/googletest) ⭐ 39,509 | 🐛 505 | 🌐 C++ | 📅 2026-09-09: Google Testing and Mocking Framework.
...
* [Makefile Tutorial by Example](https://makefiletutorial.com/) and [repo](https://github.com/theicfire/makefiletutorial) ⭐ 5,978 | 🐛 8 | 🌐 SCSS | 📅 2025-06-02
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,707 | 🐛 318 | 🌐 JavaScript | 📅 2026-04-08: A simple and modern GTK eBook viewer, built with GJS and Epub.js.
...
* [A curated list of awesome Python frameworks, libraries, software and resources](https://github.com/vinta/awesome-python#authentication) ⭐ 319,611 | 🐛 18 | 🌐 Python | 📅 2026-09-01
* [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) ⭐ 224,425 | 🐛 680 | 🌐 Python | 📅 2026-09-10: All Algorithms implemented in Python
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,219 | 🐛 81 | 🌐 Python | 📅 2026-09-01 framework, high performance, easy to learn, fast to code, ready for production
* cython [dtoa.c](https://github.com/python/cpython/blob/master/Python/dtoa.c) ⭐ 76,419 | 🐛 9,649 | 🌐 Python | 📅 2026-09-10
...
* [black](https://github.com/ambv/black/) ⭐ 41,837 | 🐛 310 | 🌐 Python | 📅 2026-09-04: The uncompromising Python code formatter
* [wtfpython](https://github.com/satwikkansal/wtfpython#-is-not--is-not-is-not-) ⭐ 37,079 | 🐛 72 | 🌐 Python | 📅 2026-01-13: A collection of surprising Python snippets and lesser-known features.
* [wtfpython](https://github.com/satwikkansal/wtfpython) ⭐ 37,079 | 🐛 72 | 🌐 Python | 📅 2026-01-13: What the f\*ck Python? ￼
...
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,342 | 🐛 398 | 🌐 Rust | 📅 2026-09-10A Python Interpreter written in Rust
* [kivy](https://github.com/kivy/kivy) ⭐ 19,015 | 🐛 848 | 🌐 Python | 📅 2026-09-09: Open source UI framework written in Python, running on Windows, Linux, macOS, Android and iOS.
...
* [cinder](https://github.com/facebookincubator/cinder) ⭐ 3,792 | 🐛 31 | 🌐 Python | 📅 2026-09-09
...
* [OpenTelemetry Python](https://github.com/open-telemetry/opentelemetry-python) ⭐ 2,628 | 🐛 417 | 🌐 Python | 📅 2026-09-10: OpenTelemetry Python API and SDK
* [austin](https://github.com/P403n1x87/austin) ⭐ 2,209 | 🐛 9 | 🌐 C | 📅 2026-09-09: Python frame stack sampler for CPython. Austin has a [tui](https://github.com/P403n1x87/austin-tui) ⭐ 665 | 🐛 2 | 🌐 Python | 📅 2026-06-04: The top-like text-based user interface for Austin.
...
* [vyper](https://github.com/ethereum/vyper/) ⭐ 5,181 | 🐛 637 | 🌐 Python | 📅 2026-09-09:
...
* Agda:
  * [Agda 2](https://github.com/agda/agda) ⭐ 2,928 | 🐛 1,042 | 🌐 Haskell | 📅 2026-09-09
  * [plfa](https://github.com/plfa/plfa.github.io/) ⭐ 1,514 | 🐛 66 | 🌐 Agda | 📅 2026-09-07: Introduction to programming language theory in Agda and [Programming Language Foundations in Agda](https://plfa.github.io/).
* Anglican:
...
* Answer Set Programming(ASP): offers a simple and powerful modeling language to solve combinatorial problems.
  * [Potassco](https://potassco.org/), [clingo](https://potassco.org/clingo/) and [github](https://github.com/potassco/clingo) ⭐ 830 | 🐛 15 | 🌐 C++ | 📅 2026-09-09.
* Brainfuck:
  * [Brainfuck](https://www.dcode.fr/brainfuck-language) encoder/decoder.
* Dafny:
  * [dafny](https://github.com/Microsoft/dafny) ⭐ 3,533 | 🐛 1,385 | 🌐 C# | 📅 2026-08-31: Dafny is a verification-aware programming language.
* Clean:
...
* Elixir:
  * [Nerves](https://github.com/nerves-project/nerves) ⭐ 2,489 | 🐛 23 | 🌐 Elixir | 📅 2026-09-09: Craft and deploy bulletproof embedded software in Elixir. [official site](http://nerves-project.org)
...
* Go:
  * [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 183,659 | 🐛 226 | 🌐 Go | 📅 2026-09-09: A curated list of awesome Go frameworks, libraries and software
...
* Lua:
  * [xmake](https://github.com/xmake-io/xmake) ⭐ 12,209 | 🐛 252 | 🌐 Lua | 📅 2026-09-08: 🔥 A cross-platform build [utility based on Lua](https://xmake.io)
* Nim:
  * [nim](https://nim-lang.org/): Efficient and expressive programming. [github](https://github.com/nim-lang/nim) ⭐ 18,228 | 🐛 2,191 | 🌐 Nim | 📅 2026-09-09
* Perl:
...
* PHP:
  * [A curated list of bookmarks, packages, tutorials, videos and other cool resources from the Laravel ecosystem](https://github.com/chiraggude/awesome-laravel) ⭐ 13,099 | 🐛 88 | 📅 2024-07-03
...
* Rust:
  * [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,271 | 🐛 10 | 🌐 Rust | 📅 2026-09-09: A curated list of Rust code and resources.
...
* V:
  * [V](https://github.com/vlang-io/V) ⭐ 37,832 | 🐛 55 | 🌐 V | 📅 2026-09-10: Simple, fast, safe, compiled language for creating maintainable software. Supports translation from C/C++.
  * [vlang](https://github.com/vlang/v) ⭐ 37,832 | 🐛 55 | 🌐 V | 📅 2026-09-10: Simple, fast, safe, compiled language for developing maintainable software. Supports translation from C and (soon) C++. Compiles itself in <1s.
* Verilog:
...
* Starting Pull Requests:
  * [Awesome First PR Opportunities](https://github.com/MunGell/awesome-for-beginners) ⭐ 89,129 | 🐛 152 | 📅 2026-07-25
...
* [.gitignore](https://github.com/github/gitignore) ⭐ 175,682 | 🐛 74 | 📅 2026-09-08: A collection of useful .gitignore templates
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,181 | 🐛 1,032 | 🌐 Go | 📅 2026-09-09: simple terminal UI for git commands
* [gitea](https://github.com/go-gitea/gitea) ⭐ 57,920 | 🐛 2,455 | 🌐 Go | 📅 2026-09-10: Git with a cup of tea, painless self-hosted git service
* [gogs](https://github.com/gogs/gogs) ⭐ 47,802 | 🐛 1,010 | 🌐 Go | 📅 2026-09-06: Gogs is a painless self-hosted Git service.
* [github-cli](https://github.com/cli/cli) ⭐ 46,216 | 🐛 1,085 | 🌐 Go | 📅 2026-09-09:  GitHub’s official command line tool
* [husky](https://github.com/typicode/husky) ⭐ 35,310 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19: Git hooks made easy
* [Learn git branching](https://learngitbranching.js.org/): An interactive git visualization to challenge and educate! [github](https://github.com/pcottle/learnGitBranching) ⭐ 34,018 | 🐛 60 | 🌐 JavaScript | 📅 2026-09-10.
* [cz-cli](https://github.com/commitizen/cz-cli) ⭐ 17,497 | 🐛 195 | 🌐 JavaScript | 📅 2026-09-04: The commitizen command line utility.
* [lint-staged](https://github.com/okonet/lint-staged) ⭐ 14,730 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-05: Run linters on git staged files
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,076 | 🐛 7 | 🌐 Shell | 📅 2026-09-09 is a utility tool for git taking advantage of fuzzy finder fzf. [Interactive Git Commands With Previews Powered By fzf Fuzzy Finder](https://www.linuxuprising.com/2019/11/forgit-interactive-git-commands-with.html)
* [git-sizer](https://github.com/github/git-sizer/) ⭐ 4,073 | 🐛 19 | 🌐 Go | 📅 2026-01-16: Compute various size metrics for a Git repository, flagging those that might cause problems ( [article](https://blog.github.com/2018-03-05-measuring-the-many-sizes-of-a-git-repository/))
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,939 | 🐛 36 | 🌐 Python | 📅 2026-07-06: Manage multiple git repos side by side for sanity
* [Git4Noobs](https://github.com/DanielHe4rt/git4noobs) ⭐ 1,613 | 🐛 3 | 📅 2024-09-28
* [Forge](https://github.com/magit/forge/) ⭐ 1,574 | 🐛 6 | 🌐 Emacs Lisp | 📅 2026-09-09: Work with Git forges from the comfort of Magit
...
* [SkyWater Open Source PDK](https://github.com/google/skywater-pdk) ⭐ 3,700 | 🐛 200 | 🌐 Python | 📅 2026-07-21: Open source process design kit for usage with SkyWater Technology Foundry's 130nm node.
* [Ariane is a 6-stage RISC-V CPU](https://github.com/pulp-platform/ariane) ⭐ 3,102 | 🐛 260 | 🌐 Assembly | 📅 2026-09-10
* [cva6](https://github.com/openhwgroup/cva6) ⭐ 3,102 | 🐛 260 | 🌐 Assembly | 📅 2026-09-10: The CORE-V CVA6 is an Application class 6-stage RISC-V CPU capable of booting Linux.
...
* [Circuit Simulator](http://www.lushprojects.com/circuitjs/). [github](https://github.com/sharpie7/circuitjs1) ⭐ 2,948 | 🐛 265 | 🌐 Java | 📅 2024-01-22.
...
* [How to create an OS from scratch](https://github.com/cfenollosa/os-tutorial) ⭐ 30,701 | 🐛 130 | 🌐 C | 📅 2026-02-04
* [Mezzano](https://github.com/froggey/Mezzano/) ⭐ 3,895 | 🐛 14 | 🌐 Common Lisp | 📅 2026-08-16: An operating system written in Common Lisp.
* [bootOS](https://github.com/nanochess/bootOS) ⭐ 2,141 | 🐛 0 | 🌐 Assembly | 📅 2026-08-01 is a monolithic operating system in 512 bytes of x86 machine code.
...
* [interim](https://github.com/mntmn/interim) ⭐ 1,318 | 🐛 12 | 🌐 C | 📅 2021-06-11: The Interim Operating System
...
* [EmuTOS](https://github.com/emutos/emutos) ⭐ 303 | 🐛 14 | 🌐 C | 📅 2026-08-30: is a Free operating system for Atari computers, and more.
...
* [GraalVM](https://github.com/oracle/graal) ⭐ 21,693 | 🐛 852 | 🌐 Java | 📅 2026-09-09: GraalVM is a universal virtual machine for running applications written in JavaScript, Python, Ruby, R, JVM-based languages like Java, Scala, Clojure, Kotlin, and LLVM-based languages such as C and C++. [GraalVM Implementation of Python](https://github.com/graalvm/graalpython) ⭐ 1,642 | 🐛 67 | 🌐 Python | 📅 2026-09-09
* [Compiler Explorer](https://godbolt.org/): Run compilers interactively from your web browser and interact with the assembly. [github](https://github.com/mattgodbolt/compiler-explorer) ⭐ 19,056 | 🐛 845 | 🌐 TypeScript | 📅 2026-09-09, [how it works](https://xania.org/201609/how-compiler-explorer-runs-on-amazon).
...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,419 | 🐛 484 | 🌐 C++ | 📅 2026-09-09: Tesseract Open Source OCR Engine (main repository)
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,988 | 🐛 530 | 🌐 Python | 📅 2025-12-05: Ready-to-use OCR with 40+ languages supported including Chinese, Japanese, Korean and Thai.
* [annoy](https://github.com/spotify/annoy) ⭐ 14,297 | 🐛 86 | 🌐 C++ | 📅 2025-10-29: Approximate Nearest Neighbors in C++/Python optimized for memory usage and loading/saving to disk
...
* [faceswap](https://github.com/deepfakes/faceswap) ⭐ 57,542 | 🐛 15 | 🌐 Python | 📅 2026-08-05: Non official project based on original /r/Deepfakes thread. Many thanks to him!
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 165,055 | 🐛 2,410 | 🌐 Python | 📅 2026-09-10: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch.
* [nanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,945 | 🐛 349 | 🌐 Python | 📅 2025-11-12: The simplest, fastest repository for training/finetuning medium-sized GPTs.
...
* [Language Interpretability Tool (LIT)](https://github.com/pair-code/lit/) ⭐ 3,667 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-09: Interactively analyze NLP models for model understanding in an extensible and framework agnostic interface.
...
* [Real-Time Voice Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning) ⭐ 60,127 | 🐛 177 | 🌐 Python | 📅 2026-03-09: Clone a voice in 5 seconds to generate arbitrary speech in real-time
...
* [DeepMind Research](https://github.com/deepmind/deepmind-research) ⭐ 15,191 | 🐛 358 | 🌐 Jupyter Notebook | 📅 2026-06-17: This repository contains implementations and illustrative code to accompany DeepMind publications.
* [vosk-api](https://github.com/alphacep/vosk-api) ⭐ 15,120 | 🐛 604 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API for Android, iOS, Raspberry Pi and servers with Python, Java, C# and Node.
* [CARLA](https://carla.org): Open-source simulator for [autonomous driving research](https://github.com/carla-simulator/carla) ⭐ 14,380 | 🐛 1,199 | 🌐 C++ | 📅 2026-09-10.
...
* Autonomous Vehicles:
  * [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,466 | 🐛 780 | 🌐 C++ | 📅 2026-06-30: Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
...
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,358 | 🐛 754 | 🌐 C# | 📅 2026-09-09: is an open source and cross-platform machine learning framework for .NET.
* [DeepLabCut](http://www.mackenziemathislab.org/deeplabcut): is an efficient method for 3D markerless pose estimation based on transfer learning with deep neural networks that achieves excellent results (i.e. you can match human labeling accuracy) with minimal training data (typically 50-200 frames). [repo](https://github.com/DeepLabCut/DeepLabCut) ⭐ 5,762 | 🐛 45 | 🌐 Python | 📅 2026-09-09
* [Is a Green Screen Really Necessary for Real-Time Human Matting?](https://arxiv.org/pdf/2011.11961.pdf), [repo](https://github.com/ZHKKKe/MODNet) ⭐ 4,360 | 🐛 71 | 🌐 Python | 📅 2024-05-06
...
* [Stable Diffusion](https://github.com/CompVis/stable-diffusion) ⭐ 73,403 | 🐛 619 | 🌐 Jupyter Notebook | 📅 2024-06-18: is a latent text-to-image diffusion model. Thanks to a generous compute donation from Stability AI and support from LAION, we were able to train a Latent Diffusion Model on 512x512 images from a subset of the LAION-5B database.
* [Wan](https://github.com/Wan-Video/Wan2.2) ⭐ 17,449 | 🐛 297 | 🌐 Python | 📅 2026-03-17: Open and Advanced Large-Scale Video Generative Models
...
* [Image Deduplicator](https://idealo.github.io/imagededup/): [imagededup](https://github.com/idealo/imagededup) ⭐ 5,667 | 🐛 39 | 🌐 Python | 📅 2025-08-15 is a python package that simplifies the task of finding exact and near duplicates in an image collection.
...
* [NEST](https://github.com/nest/nest-simulator) ⭐ 666 | 🐛 231 | 🌐 C++ | 📅 2026-09-08: NEST is a simulator for spiking neural network models that focuses on the dynamics, size and structure of neural systems rather than on the exact morphology of individual neurons.
...
* [fiftyone](https://github.com/voxel51/fiftyone) ⭐ 11,066 | 🐛 684 | 🌐 TypeScript | 📅 2026-09-10: The open-source tool for building high-quality datasets and computer vision models
...
* [OpenSimpleLidar](https://github.com/iliasam/OpenSimpleLidar) ⭐ 2,560 | 🐛 1 | 🌐 C | 📅 2025-07-22: Open Hardware scanning laser rangefinder ([howto](https://hackaday.io/project/20628-open-simple-lidar))
...
*Frameworks for Neural Networks and Deep Learning. See: [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,884 | 🐛 85 | 📅 2025-05-26.*

* [Keras](https://github.com/fchollet/keras) ⭐ 64,317 | 🐛 199 | 🌐 Python | 📅 2026-09-10 - A high-level neural networks library and capable of running on top of either TensorFlow or Theano.
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,888 | 🐛 17,643 | 🌐 Python | 📅 2026-09-10: Tensors and Dynamic neural networks in Python with strong GPU acceleration a ([tour](http://blog.christianperone.com/2018/03/pytorch-internal-architecture-tour/)):
* [tinygrad](https://github.com/geohot/tinygrad) ⭐ 33,578 | 🐛 191 | 🌐 Python | 📅 2026-09-10: You like pytorch? You like [micrograd](https://github.com/karpathy/micrograd) ⭐ 17,448 | 🐛 80 | 🌐 Jupyter Notebook | 📅 2026-08-03? You love tinygrad! ❤️
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 199,309 | 🐛 3,140 | 🌐 C++ | 📅 2026-09-10 - The most popular Deep Learning framework created by Google.
* [BERT](https://github.com/google-research/bert) ⚠️ Archived: TensorFlow code and pre-trained models for BERT
* [Machine Learning Notebooks](https://github.com/ageron/handson-ml2) ⭐ 29,954 | 🐛 229 | 🌐 Jupyter Notebook | 📅 2026-05-19: A series of Jupyter notebooks that walk you through the fundamentals of Machine Learning and Deep Learning in Python using Scikit-Learn, Keras and TensorFlow 2.
...
* [Ludwig](https://github.com/uber/ludwig) ⭐ 11,753 | 🐛 1 | 🌐 Python | 📅 2026-09-07: [is a toolbox built](https://uber.github.io/ludwig/) on top of TensorFlow that allows to train and test deep learning models without the need to write code.
...
* Good channels:
  * [3blue1brown](https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw/): 3blue1brown, by Grant Sanderson, is some combination of math and entertainment, depending on your disposition ([site](https://www.3blue1brown.com/)) and [manim](https://github.com/3b1b/manim) ⭐ 93,660 | 🐛 498 | 🌐 Python | 📅 2026-09-09(Animation engine for explanatory math videos).
...
* [Kyle Walker](https://gist.github.com/walkerke) Gist, a lot of R scripts and interesting stuff [github](https://github.com/walkerke/tidycensus) ⭐ 684 | 🐛 26 | 🌐 R | 📅 2026-05-25
...
* [The Data Engineering Cookbook](https://github.com/andkret/Cookbook) ⭐ 15,411 | 🐛 129 | 🌐 Python | 📅 2026-07-23
* [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,320 | 🐛 1,345 | 🌐 Python | 📅 2026-09-10: Official repository for Spyder - The Scientific Python Development Environment
...
* [RAPIDS](http://rapids.ai): Open GPU Data Science. The RAPIDS suite of software libraries gives you the freedom to execute end-to-end data science and analytics pipelines entirely on GPUs. It relies on NVIDIA® CUDA® primitives for low-level compute optimization, but exposes that GPU parallelism and high-bandwidth memory speed through user-friendly Python interfaces. [cuml](https://github.com/rapidsai/cuml) ⭐ 5,271 | 🐛 824 | 🌐 Python | 📅 2026-09-10 - RAPIDS Machine Learning Library.
* [Dask tutorial](https://github.com/dask/dask-tutorial) ⭐ 1,859 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2025-11-04
* [easystats](https://github.com/easystats/easystats) ⭐ 1,159 | 🐛 45 | 🌐 R | 📅 2026-09-09: milky\_way The easyverse.
...
* Python:
  ...
  * [pyjanitor](https://github.com/ericmjl/pyjanitor) ⭐ 1,499 | 🐛 157 | 🌐 Python | 📅 2026-09-08: Python implementation of R package Janitor
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 66,014 | 🐛 888 | 🌐 Go | 📅 2026-09-09: The Prometheus monitoring system and time series database.
* [dart](https://github.com/unit8co/darts) ⭐ 9,515 | 🐛 229 | 🌐 Python | 📅 2026-09-07: A python library for easy manipulation and forecasting of time series.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,173 | 🐛 163 | 🌐 C++ | 📅 2026-08-10: The Time Series Visualization Tool that you deserve.
...
* [amsterdam-schema](https://github.com/Amsterdam/amsterdam-schema) ⭐ 21 | 🐛 8 | 🌐 Python | 📅 2026-09-09: Data modeling & verification for the City of Amsterdam's open data - based on JSON Schema
...
* [ImageMagick creates huge temporary files · Issue #395 · ImageMagick/ImageMagick](https://github.com/ImageMagick/ImageMagick/issues/395) ⭐ 17,381 | 🐛 164 | 🌐 C | 📅 2026-09-10
...
* GGplot2:
  ...
  * [ggalluvial](https://github.com/corybrunson/ggalluvial) ⭐ 523 | 🐛 22 | 🌐 R | 📅 2026-07-31
...
* Color Palettes:
  ...
  * [MetBrewer](https://github.com/BlakeRMills/MetBrewer) ⭐ 1,274 | 🐛 11 | 🌐 R | 📅 2025-01-03: Color palette package in R inspired by works at the Metropolitan Museum of Art in New York.
...
* [jax](https://github.com/google/jax) ⭐ 36,282 | 🐛 2,540 | 🌐 Python | 📅 2026-09-10: Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more
* [micro](https://micro-editor.github.io/): a modern and intuitive [terminal-based text editor](https://github.com/zyedidia/micro#linux-clipboard-support) ⭐ 29,555 | 🐛 960 | 🌐 Go | 📅 2026-09-10.
* [pyodide](https://github.com/iodide-project/pyodide) ⭐ 14,823 | 🐛 398 | 🌐 Python | 📅 2026-09-09: The Python scientific stack, compiled to WebAssembly
...
* [hatetris](https://github.com/qntm/hatetris) ⭐ 894 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-09: Tetris which always gives you the worst piece
...
* [Rack](https://github.com/VCVRack/Rack) ⭐ 4,415 | 🐛 307 | 🌐 C++ | 📅 2025-11-04: The virtual Eurorack studio
...
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,978 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-10: Easily add particles animations to your website. Compatible also with React, Vue.js (2.x and 3.x), Angular, Svelte, jQuery, Preact, Inferno.
...
* [gqrx](https://gqrx.dk/): is an open source software defined radio receiver (SDR) powered by the GNU Radio and the Qt graphical toolkit. [Gqrx](https://github.com/csete/gqrx) ⭐ 3,674 | 🐛 267 | 🌐 C++ | 📅 2026-08-06
...
* [astroquery](https://github.com/astropy/astroquery) ⭐ 791 | 🐛 418 | 🌐 Python | 📅 2026-09-04: Functions and classes to access online data resources. Maintainers: @keflavich and @bsipocz and @ceb8
...
* [Open MCT](https://nasa.github.io/openmct/): is a next-generation mission control framework for visualization of data on desktop and mobile devices - [github](https://github.com/nasa/openmct) ⭐ 13,112 | 🐛 1,089 | 🌐 JavaScript | 📅 2026-09-10
* [fprime](https://github.com/nasa/fprime) ⭐ 11,730 | 🐛 435 | 🌐 C++ | 📅 2026-09-09: A flight software and embedded systems framework.
...
* [MNE-Python](https://github.com/mne-tools/mne-python) ⭐ 3,507 | 🐛 620 | 🌐 Python | 📅 2026-09-09: Magnetoencephalography (MEG) and Electroencephalography (EEG) in Python
...
* [plus codes](https://plus.codes/). [open-location-code](https://github.com/google/open-location-code) ⭐ 4,352 | 🐛 61 | 🌐 Java | 📅 2026-03-30: Open Location Code is a library to generate short codes that can be used like street addresses, for places where street addresses don't exist.
* [S2Geometry](http://s2geometry.io/): S2 is a library for spherical geometry that aims to have the same robustness, flexibility, and performance as the very best planar geometry libraries [github](https://github.com/google/s2geometry) ⭐ 2,723 | 🐛 79 | 🌐 C++ | 📅 2026-09-08.
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 947 | 🐛 18 | 🌐 R | 📅 2026-09-10: Easy access to shapefiles of the Brazilian Institute of Geography and Statistics (IBGE) and other official spatial data sets of Brazil.
...
* [Awesome Blockchain](https://github.com/yjjnls/awesome-blockchain) ⭐ 3,631 | 🐛 52 | 🌐 Go | 📅 2024-03-22: Curated list of resources for the development and applications of blockchain.
...
* [Memex](https://worldbrain.io/#) - your photographic memory for the web. Open-Source. Private. [repo](https://github.com/WorldBrain/Memex) ⭐ 4,720 | 🐛 319 | 🌐 TypeScript | 📅 2025-12-02
...
* [Awesome-Design-Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 41,157 | 🐛 199 | 🌐 JavaScript | 📅 2024-07-28: The best design tools for everything.
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,474 | 🐛 285 | 🌐 C++ | 📅 2026-09-09:Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
...
* [Craft](https://github.com/fogleman/Craft) ⭐ 11,097 | 🐛 129 | 🌐 C | 📅 2024-04-03: A simple Minecraft clone written in C using modern OpenGL (shaders).
* [Opendiablo2](https://github.com/OpenDiablo2/OpenDiablo2) ⚠️ Archived: An open source re-implementation of Diablo 2
* [gb-studio](https://github.com/chrismaltby/gb-studio) ⭐ 9,401 | 🐛 800 | 🌐 TypeScript | 📅 2026-09-06: A free and easy to use retro adventure game creator for your favourite [handheld video game system](https://www.gbstudio.dev)
* [sm64](https://github.com/n64decomp/sm64) ⭐ 8,765 | 🐛 29 | 🌐 C | 📅 2024-02-04: A Super Mario 64 decompilation, brought to you by a bunch of clever folks.
...
* [Citybound](https://github.com/citybound/citybound) ⭐ 8,160 | 🐛 153 | 🌐 Rust | 📅 2023-01-07: Citybound is a city building game with a focus on realism, collaborative planning and simulation of microscopic details.
* [OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,470 | 🐛 53 | 🌐 C++ | 📅 2026-08-31: A Framework for Reinforcement Learning in Games.
* [Zelda 3 in C](https://github.com/snesrev/zelda3) ⭐ 4,753 | 🐛 89 | 🌐 C | 📅 2023-12-27: A reimplementation of Zelda 3.
* [The Comprehensive Kerbal Archive Network (CKAN)](https://github.com/KSP-CKAN/CKAN) ⭐ 2,639 | 🐛 85 | 🌐 C# | 📅 2026-07-17
...
* [veyon](https://github.com/veyon/veyon/) ⭐ 1,946 | 🐛 221 | 🌐 C++ | 📅 2026-09-09: Cross-platform computer monitoring and classroom management.

## Studies

* [Path to a free self-taught education in Computer Science!](https://github.com/ossu/computer-science) ⭐ 208,882 | 🐛 27 | 🌐 HTML | 📅 2026-07-14
* [the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,766 | 🐛 200 | 🌐 Jupyter Notebook | 📅 2026-05-20: One has no future if one couldn't teach themself.
...
* [FreshRSS](https://github.com/FreshRSS/FreshRSS) ⭐ 15,975 | 🐛 668 | 🌐 PHP | 📅 2026-09-09: A free, self-hostable aggregator…
* guardian [frontend](https://github.com/guardian/frontend) ⭐ 5,900 | 🐛 223 | 🌐 Scala | 📅 2026-09-09: Source for theguardian.com
...
* [walt](https://github.com/ballercat/walt) ⭐ 4,630 | 🐛 27 | 🌐 JavaScript | 📅 2023-01-02: Walt is a JavaScript-like syntax for WebAssembly text format
...
* [Differential Privacy](https://github.com/google/differential-privacy) ⭐ 3,354 | 🐛 59 | 🌐 Go | 📅 2026-09-09: This project contains a C++ library of ε-differentially private algorithms, which can be used to produce aggregate statistics over numeric data sets containing private or sensitive information.
...
* [Apache Flink](https://github.com/apache/flink) ⭐ 26,327 | 🐛 377 | 🌐 Java | 📅 2026-09-10: Apache Flink is an open source stream processing framework with powerful stream- and batch-processing capabilities.
* [lists](https://github.com/jnv/lists) ⭐ 11,471 | 🐛 26 | 📅 2026-03-23: The definitive list of lists (of lists) curated on GitHub
* [awesome-uses](https://github.com/wesbos/awesome-uses) ⭐ 5,299 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-07: A list of /uses pages that detail apps and gear used by professional web developers.
...
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 369,074 | 🐛 611 | 🌐 Python | 📅 2026-03-20: Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 360,661 | 🐛 125 | 📅 2025-08-28: A complete computer science study plan to become a software engineer.
* [GitHub Résumé](https://github.com/resume/resume.github.com) ⭐ 62,892 | 🐛 76 | 🌐 JavaScript | 📅 2023-02-15
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 52,064 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-24: Companies that don't have a broken hiring process.
...
* [OpenResume](https://www.open-resume.com/) Create a professional resume easily with this free, open-source, and powerful [resume builder](https://github.com/xitanggg/open-resume) ⭐ 8,896 | 🐛 143 | 🌐 TypeScript | 📅 2024-10-29.
...
* [awesome-scifi](https://github.com/sindresorhus/awesome-scifi) ⭐ 5,035 | 🐛 0 | 📅 2025-12-22: I asked on Twitter for recommendations as I want to get into reading Sci-Fi novels. The below is the result. Thanks everyone for recommending your favorites! :)
* [blobs](https://blobs.app): [Blob shapes generator](https://github.com/lokesh-coder/blobs.app) ⭐ 484 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-09
...
* [📚 Freely available programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 396,378 | 🐛 82 | 🌐 Python | 📅 2026-09-09
