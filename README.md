...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 358,968 | 🐛 123 | 📅 2025-08-28
* [The Book of Secret Knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) ⭐ 238,742 | 🐛 164 | 📅 2024-11-19
* [z3](https://github.com/Z3Prover/z3) ⭐ 12,560 | 🐛 65 | 🌐 C++ | 📅 2026-08-17: The Z3 Theorem Prover
...
* [ClickHouse](https://github.com/ClickHouse/ClickHouse) ⭐ 49,281 | 🐛 6,924 | 🌐 C++ | 📅 2026-08-17: is a free analytics DBMS for big data.
...
* [quick-SQL-cheatsheet](https://github.com/enochtangg/quick-SQL-cheatsheet) ⭐ 5,448 | 🐛 11 | 📅 2020-10-01: A quick reminder of all SQL queries and examples on how to use them.
...
* [Every Programmer Should Know thinking](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,248 | 🐛 25 | 📅 2025-12-29: A collection of (mostly) technical things every software developer should know
...
* [dev.to](https://github.com/thepracticaldev/dev.to) ⭐ 22,769 | 🐛 126 | 🌐 Ruby | 📅 2026-08-16: Where programmers share ideas and help each other grow
* [Flow](https://github.com/facebook/flow) ⭐ 22,276 | 🐛 524 | 🌐 Rust | 📅 2026-08-17: Adds static typing to JavaScript to improve developer productivity and code quality.
* [Quine Relay](https://github.com/mame/quine-relay) ⭐ 14,581 | 🐛 18 | 🌐 Ruby | 📅 2025-10-24: An uroboros program with 100+ programming languages.
...
* [vscodium](https://github.com/VSCodium/vscodium) ⭐ 32,847 | 🐛 139 | 🌐 Shell | 📅 2026-08-12: binary releases of VS Code without MS branding/telemetry/licensing
  * [awesome-vscode](https://github.com/viatsko/awesome-vscode) ⭐ 28,956 | 🐛 46 | 🌐 JavaScript | 📅 2026-06-21: art A curated list of delightful VS Code packages and resources.
...
* [CppCoreGuidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,246 | 🐛 246 | 🌐 CSS | 📅 2026-08-06: The C++ Core Guidelines are a set of tried-and-true guidelines, rules, and best practices about coding in C++
* [Microsoft's C++ Standard Library](https://github.com/microsoft/STL) ⭐ 11,130 | 🐛 583 | 🌐 C++ | 📅 2026-08-16: MSVC's implementation of the C++ Standard Library.
* mozilla [rr](https://github.com/mozilla/rr) ⭐ 10,620 | 🐛 479 | 🌐 C++ | 📅 2026-08-16: is a lightweight tool for recording, replaying and debugging execution of applications (trees of processes and threads). Debugging extends gdb with very efficient reverse-execution, which in combination with standard gdb/x86 features like hardware data watchpoints, makes debugging much more fun.
* [GuiLite](https://github.com/idea4good/GuiLite) ⭐ 7,763 | 🐛 18 | 🌐 C++ | 📅 2025-10-22: heavy\_check\_markThe smallest UI framework for all platform -- 5K lines code
...
* TDD C:
  * [Google Test](https://github.com/google/googletest) ⭐ 38,935 | 🐛 491 | 🌐 C++ | 📅 2026-08-16: Google Testing and Mocking Framework.
...
* [Makefile Tutorial by Example](https://makefiletutorial.com/) and [repo](https://github.com/theicfire/makefiletutorial) ⭐ 5,964 | 🐛 8 | 🌐 SCSS | 📅 2025-06-02
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,635 | 🐛 310 | 🌐 JavaScript | 📅 2026-04-08: A simple and modern GTK eBook viewer, built with GJS and Epub.js.
...
* [A curated list of awesome Python frameworks, libraries, software and resources](https://github.com/vinta/awesome-python#authentication) ⭐ 314,334 | 🐛 16 | 🌐 Python | 📅 2026-08-16
* [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) ⭐ 223,797 | 🐛 1,030 | 🌐 Python | 📅 2026-08-03: All Algorithms implemented in Python
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,634 | 🐛 87 | 🌐 Python | 📅 2026-08-15 framework, high performance, easy to learn, fast to code, ready for production
* cython [dtoa.c](https://github.com/python/cpython/blob/master/Python/dtoa.c) ⭐ 74,341 | 🐛 9,505 | 🌐 Python | 📅 2026-08-16
* [Rich](https://github.com/willmcgugan/rich) ⭐ 57,076 | 🐛 370 | 🌐 Python | 📅 2026-06-23 is a Python library for rich text and beautiful formatting in the terminal.
* [black](https://github.com/ambv/black/) ⭐ 41,803 | 🐛 306 | 🌐 Python | 📅 2026-08-10: The uncompromising Python code formatter
...
* [Course Files for Complete Python 3 Bootcamp Course on Udemy](https://github.com/Pierian-Data/Complete-Python-3-Bootcamp) ⭐ 29,711 | 🐛 268 | 🌐 Jupyter Notebook | 📅 2025-06-24
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,286 | 🐛 402 | 🌐 Rust | 📅 2026-08-17A Python Interpreter written in Rust
* [kivy](https://github.com/kivy/kivy) ⭐ 18,993 | 🐛 853 | 🌐 Python | 📅 2026-08-15: Open source UI framework written in Python, running on Windows, Linux, macOS, Android and iOS.
...
* [cinder](https://github.com/facebookincubator/cinder) ⭐ 3,792 | 🐛 33 | 🌐 Python | 📅 2026-08-16
...
* [OpenTelemetry Python](https://github.com/open-telemetry/opentelemetry-python) ⭐ 2,589 | 🐛 395 | 🌐 Python | 📅 2026-08-17: OpenTelemetry Python API and SDK
...
* [reloading](https://github.com/julvo/reloading) ⭐ 1,128 | 🐛 13 | 🌐 Python | 📅 2024-06-15: Change Python code while it's running using a reloading loop
...
* [vyper](https://github.com/ethereum/vyper/) ⭐ 5,180 | 🐛 694 | 🌐 Python | 📅 2026-08-12:
...
* Elixir:
  * [Nerves](https://github.com/nerves-project/nerves) ⭐ 2,484 | 🐛 23 | 🌐 Elixir | 📅 2026-08-16: Craft and deploy bulletproof embedded software in Elixir. [official site](http://nerves-project.org)
...
* Go:
  * [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 181,247 | 🐛 211 | 🌐 Go | 📅 2026-08-16: A curated list of awesome Go frameworks, libraries and software
...
* JavaScript:
  * [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,494 | 🐛 404 | 🌐 JavaScript | 📅 2026-07-26: Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
...
* Lua:
  * [xmake](https://github.com/xmake-io/xmake) ⭐ 12,144 | 🐛 250 | 🌐 Lua | 📅 2026-08-17: 🔥 A cross-platform build [utility based on Lua](https://xmake.io)
* Nim:
  * [nim](https://nim-lang.org/): Efficient and expressive programming. [github](https://github.com/nim-lang/nim) ⭐ 18,171 | 🐛 2,184 | 🌐 Nim | 📅 2026-08-16
* Perl:
...
* PHP:
  * [A curated list of bookmarks, packages, tutorials, videos and other cool resources from the Laravel ecosystem](https://github.com/chiraggude/awesome-laravel) ⭐ 13,090 | 🐛 85 | 📅 2024-07-03
...
* V:
  * [V](https://github.com/vlang-io/V) ⭐ 37,795 | 🐛 81 | 🌐 V | 📅 2026-08-16: Simple, fast, safe, compiled language for creating maintainable software. Supports translation from C/C++.
  * [vlang](https://github.com/vlang/v) ⭐ 37,795 | 🐛 81 | 🌐 V | 📅 2026-08-16: Simple, fast, safe, compiled language for developing maintainable software. Supports translation from C and (soon) C++. Compiles itself in <1s.
* Verilog:
...
* Starting Pull Requests:
  * [Awesome First PR Opportunities](https://github.com/MunGell/awesome-for-beginners) ⭐ 88,440 | 🐛 141 | 📅 2026-07-25
...
* [.gitignore](https://github.com/github/gitignore) ⭐ 175,332 | 🐛 83 | 📅 2026-07-23: A collection of useful .gitignore templates
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,386 | 🐛 1,019 | 🌐 Go | 📅 2026-08-16: simple terminal UI for git commands
* [gitea](https://github.com/go-gitea/gitea) ⭐ 57,415 | 🐛 2,548 | 🌐 Go | 📅 2026-08-17: Git with a cup of tea, painless self-hosted git service
* [gogs](https://github.com/gogs/gogs) ⭐ 47,727 | 🐛 1,010 | 🌐 Go | 📅 2026-08-06: Gogs is a painless self-hosted Git service.
* [github-cli](https://github.com/cli/cli) ⭐ 45,848 | 🐛 1,064 | 🌐 Go | 📅 2026-08-14:  GitHub’s official command line tool
* [husky](https://github.com/typicode/husky) ⭐ 35,275 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19: Git hooks made easy
* [Learn git branching](https://learngitbranching.js.org/): An interactive git visualization to challenge and educate! [github](https://github.com/pcottle/learnGitBranching) ⭐ 33,885 | 🐛 59 | 🌐 JavaScript | 📅 2026-08-11.
* [cz-cli](https://github.com/commitizen/cz-cli) ⭐ 17,501 | 🐛 194 | 🌐 JavaScript | 📅 2026-08-11: The commitizen command line utility.
* [lint-staged](https://github.com/okonet/lint-staged) ⭐ 14,713 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-08: Run linters on git staged files
* [git-blame-someone-else](https://github.com/jayphelps/git-blame-someone-else) ⭐ 11,698 | 🐛 21 | 🌐 Shell | 📅 2023-12-04: Blame someone else for your bad code.
...
* [Pro Git book](https://git-scm.com/book/en/v2), written by Scott Chacon and Ben Straub ([github](https://github.com/progit/progit2) ⭐ 6,555 | 🐛 219 | 🌐 CSS | 📅 2026-05-25 repo)
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,061 | 🐛 13 | 🌐 Shell | 📅 2026-08-01 is a utility tool for git taking advantage of fuzzy finder fzf. [Interactive Git Commands With Previews Powered By fzf Fuzzy Finder](https://www.linuxuprising.com/2019/11/forgit-interactive-git-commands-with.html)
...
* [Mezzano](https://github.com/froggey/Mezzano/) ⭐ 3,882 | 🐛 14 | 🌐 Common Lisp | 📅 2026-08-16: An operating system written in Common Lisp.
...
* [GraalVM](https://github.com/oracle/graal) ⭐ 21,662 | 🐛 846 | 🌐 Java | 📅 2026-08-16: GraalVM is a universal virtual machine for running applications written in JavaScript, Python, Ruby, R, JVM-based languages like Java, Scala, Clojure, Kotlin, and LLVM-based languages such as C and C++. [GraalVM Implementation of Python](https://github.com/graalvm/graalpython) ⭐ 1,635 | 🐛 62 | 🌐 Python | 📅 2026-08-13
* [Compiler Explorer](https://godbolt.org/): Run compilers interactively from your web browser and interact with the assembly. [github](https://github.com/mattgodbolt/compiler-explorer) ⭐ 18,982 | 🐛 826 | 🌐 TypeScript | 📅 2026-08-15, [how it works](https://xania.org/201609/how-compiler-explorer-runs-on-amazon).
...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 75,950 | 🐛 484 | 🌐 C++ | 📅 2026-08-16: Tesseract Open Source OCR Engine (main repository)
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,911 | 🐛 530 | 🌐 Python | 📅 2025-12-05: Ready-to-use OCR with 40+ languages supported including Chinese, Japanese, Korean and Thai.
...
* [faceswap](https://github.com/deepfakes/faceswap) ⭐ 57,462 | 🐛 12 | 🌐 Python | 📅 2026-08-05: Non official project based on original /r/Deepfakes thread. Many thanks to him!
...
* [donkeycar](https://github.com/autorope/donkeycar) ⭐ 3,491 | 🐛 135 | 🌐 Python | 📅 2026-08-08: Open source hardware and software platform to build a small scale self driving car.
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 164,166 | 🐛 2,382 | 🌐 Python | 📅 2026-08-17: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch.
* [nanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,152 | 🐛 351 | 🌐 Python | 📅 2025-11-12: The simplest, fastest repository for training/finetuning medium-sized GPTs.
* [Industrial-strength Natural Language Processing (NLP) with Python and Cython](https://github.com/explosion/spaCy/) ⭐ 33,822 | 🐛 232 | 🌐 Python | 📅 2026-08-07
...
* [DeepMind Research](https://github.com/deepmind/deepmind-research) ⭐ 15,156 | 🐛 341 | 🌐 Jupyter Notebook | 📅 2026-06-17: This repository contains implementations and illustrative code to accompany DeepMind publications.
* [vosk-api](https://github.com/alphacep/vosk-api) ⭐ 15,059 | 🐛 601 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API for Android, iOS, Raspberry Pi and servers with Python, Java, C# and Node.
...
* [CARLA](https://carla.org): Open-source simulator for [autonomous driving research](https://github.com/carla-simulator/carla) ⭐ 14,301 | 🐛 1,190 | 🌐 C++ | 📅 2026-08-16.
...
* [make-sense](https://github.com/SkalskiP/make-sense) ⭐ 3,559 | 🐛 132 | 🌐 TypeScript | 📅 2024-08-15: [Free to use online tool for labelling photos](https://makesense.ai).
...
* [Stable Diffusion](https://github.com/CompVis/stable-diffusion) ⭐ 73,299 | 🐛 619 | 🌐 Jupyter Notebook | 📅 2024-06-18: is a latent text-to-image diffusion model. Thanks to a generous compute donation from Stability AI and support from LAION, we were able to train a Latent Diffusion Model on 512x512 images from a subset of the LAION-5B database.
* [Wan](https://github.com/Wan-Video/Wan2.2) ⭐ 17,154 | 🐛 287 | 🌐 Python | 📅 2026-03-17: Open and Advanced Large-Scale Video Generative Models
* [Bbrain.js](https://github.com/BrainJS/brain.js) ⭐ 14,867 | 🐛 90 | 🌐 TypeScript | 📅 2024-09-26: 🤖 Neural networks in JavaScript
...
* [fiftyone](https://github.com/voxel51/fiftyone) ⭐ 11,017 | 🐛 667 | 🌐 TypeScript | 📅 2026-08-17: The open-source tool for building high-quality datasets and computer vision models
...
*Frameworks for Neural Networks and Deep Learning. See: [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,767 | 🐛 84 | 📅 2025-05-26.*

* [Keras](https://github.com/fchollet/keras) ⭐ 64,232 | 🐛 219 | 🌐 Python | 📅 2026-08-14 - A high-level neural networks library and capable of running on top of either TensorFlow or Theano.
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,428 | 🐛 17,335 | 🌐 Python | 📅 2026-08-17: Tensors and Dynamic neural networks in Python with strong GPU acceleration a ([tour](http://blog.christianperone.com/2018/03/pytorch-internal-architecture-tour/)):
* [tinygrad](https://github.com/geohot/tinygrad) ⭐ 33,454 | 🐛 184 | 🌐 Python | 📅 2026-08-17: You like pytorch? You like [micrograd](https://github.com/karpathy/micrograd) ⭐ 17,155 | 🐛 78 | 🌐 Jupyter Notebook | 📅 2026-08-03? You love tinygrad! ❤️
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,087 | 🐛 2,868 | 🌐 C++ | 📅 2026-08-16 - The most popular Deep Learning framework created by Google.
...
* [Ludwig](https://github.com/uber/ludwig) ⭐ 11,748 | 🐛 0 | 🌐 Python | 📅 2026-08-16: [is a toolbox built](https://uber.github.io/ludwig/) on top of TensorFlow that allows to train and test deep learning models without the need to write code.
...
* Good channels:
  * [3blue1brown](https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw/): 3blue1brown, by Grant Sanderson, is some combination of math and entertainment, depending on your disposition ([site](https://www.3blue1brown.com/)) and [manim](https://github.com/3b1b/manim) ⭐ 91,362 | 🐛 495 | 🌐 Python | 📅 2026-08-16(Animation engine for explanatory math videos).
...
* [The Data Engineering Cookbook](https://github.com/andkret/Cookbook) ⭐ 15,299 | 🐛 128 | 🌐 Python | 📅 2026-07-23
* [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,288 | 🐛 1,348 | 🌐 Python | 📅 2026-08-15: Official repository for Spyder - The Scientific Python Development Environment
...
* [RAPIDS](http://rapids.ai): Open GPU Data Science. The RAPIDS suite of software libraries gives you the freedom to execute end-to-end data science and analytics pipelines entirely on GPUs. It relies on NVIDIA® CUDA® primitives for low-level compute optimization, but exposes that GPU parallelism and high-bandwidth memory speed through user-friendly Python interfaces. [cuml](https://github.com/rapidsai/cuml) ⭐ 5,254 | 🐛 838 | 🌐 Python | 📅 2026-08-15 - RAPIDS Machine Learning Library.
...
* Python:
  * [termgraph](https://github.com/mkaz/termgraph) ⭐ 3,292 | 🐛 25 | 🌐 Python | 📅 2026-03-25: a python command-line tool which draws basic graphs in the terminal
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,717 | 🐛 896 | 🌐 Go | 📅 2026-08-15: The Prometheus monitoring system and time series database.
* [dart](https://github.com/unit8co/darts) ⭐ 9,497 | 🐛 222 | 🌐 Python | 📅 2026-08-06: A python library for easy manipulation and forecasting of time series.
...
* [ImageMagick creates huge temporary files · Issue #395 · ImageMagick/ImageMagick](https://github.com/ImageMagick/ImageMagick/issues/395) ⭐ 17,168 | 🐛 161 | 🌐 C | 📅 2026-08-15
...
* [OpenSubdiv](http://graphics.pixar.com/opensubdiv/docs/intro.html) ([github](https://github.com/PixarAnimationStudios/OpenSubdiv) ⭐ 3,070 | 🐛 62 | 🌐 C++ | 📅 2026-07-17): is a set of open source libraries that implement high performance subdivision surface (subdiv) evaluation on massively parallel CPU and GPU architectures.
...
* [micro](https://micro-editor.github.io/): a modern and intuitive [terminal-based text editor](https://github.com/zyedidia/micro#linux-clipboard-support) ⭐ 29,354 | 🐛 1,034 | 🌐 Go | 📅 2026-08-17.
* [pyodide](https://github.com/iodide-project/pyodide) ⭐ 14,790 | 🐛 400 | 🌐 Python | 📅 2026-08-16: The Python scientific stack, compiled to WebAssembly
...
* [This program generates bitmaps that are locally similar to the input bitmap](https://github.com/mxgmn/WaveFunctionCollapse) ⭐ 25,273 | 🐛 9 | 🌐 C# | 📅 2026-03-22
...
* [Open MCT](https://nasa.github.io/openmct/): is a next-generation mission control framework for visualization of data on desktop and mobile devices - [github](https://github.com/nasa/openmct) ⭐ 13,085 | 🐛 1,067 | 🌐 JavaScript | 📅 2026-08-14
* [fprime](https://github.com/nasa/fprime) ⭐ 11,668 | 🐛 437 | 🌐 C++ | 📅 2026-08-16: A flight software and embedded systems framework.
...
* [MNE-Python](https://github.com/mne-tools/mne-python) ⭐ 3,486 | 🐛 634 | 🌐 Python | 📅 2026-08-17: Magnetoencephalography (MEG) and Electroencephalography (EEG) in Python
...
* [Memex](https://worldbrain.io/#) - your photographic memory for the web. Open-Source. Private. [repo](https://github.com/WorldBrain/Memex) ⭐ 4,715 | 🐛 319 | 🌐 TypeScript | 📅 2025-12-02
...
* [Awesome-Design-Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 40,901 | 🐛 181 | 🌐 JavaScript | 📅 2024-07-28: The best design tools for everything.
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,405 | 🐛 288 | 🌐 C | 📅 2026-08-17:Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
...
* [Perceptual image hashing for PHP](https://github.com/jenssegers/imagehash) ⭐ 2,058 | 🐛 39 | 🌐 PHP | 📅 2025-09-17
...
* [Craft](https://github.com/fogleman/Craft) ⭐ 11,088 | 🐛 129 | 🌐 C | 📅 2024-04-03: A simple Minecraft clone written in C using modern OpenGL (shaders).
* [Opendiablo2](https://github.com/OpenDiablo2/OpenDiablo2) ⚠️ Archived: An open source re-implementation of Diablo 2
* [gb-studio](https://github.com/chrismaltby/gb-studio) ⭐ 9,364 | 🐛 797 | 🌐 TypeScript | 📅 2026-08-14: A free and easy to use retro adventure game creator for your favourite [handheld video game system](https://www.gbstudio.dev)
* [sm64](https://github.com/n64decomp/sm64) ⭐ 8,723 | 🐛 28 | 🌐 C | 📅 2024-02-04: A Super Mario 64 decompilation, brought to you by a bunch of clever folks.
...
* [Zelda 3 in C](https://github.com/snesrev/zelda3) ⭐ 4,727 | 🐛 88 | 🌐 C | 📅 2023-12-27: A reimplementation of Zelda 3.
* [The Comprehensive Kerbal Archive Network (CKAN)](https://github.com/KSP-CKAN/CKAN) ⭐ 2,617 | 🐛 83 | 🌐 C# | 📅 2026-07-17
* [Synfig Studio](https://github.com/synfig/synfig/) ⭐ 2,281 | 🐛 729 | 🌐 C++ | 📅 2026-08-16: This is the Official source code repository of the Synfig project.
...
* [wick editor](https://www.wickeditor.com/): [The Wick Editor is a free](https://github.com/Wicklets/wick-editor) ⭐ 835 | 🐛 186 | 🌐 JavaScript | 📅 2023-03-06, open-source tool for creating games, animations, and everything in-between!
...
* [Path to a free self-taught education in Computer Science!](https://github.com/ossu/computer-science) ⭐ 208,055 | 🐛 25 | 🌐 HTML | 📅 2026-07-14
* [the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,433 | 🐛 199 | 🌐 Jupyter Notebook | 📅 2026-05-20: One has no future if one couldn't teach themself.
...
* [Awesome Accessibility](https://github.com/brunopulis/awesome-a11y) ⭐ 1,978 | 🐛 56 | 📅 2026-08-03: A curate list about A11Y
...
* [FreshRSS](https://github.com/FreshRSS/FreshRSS) ⭐ 15,788 | 🐛 659 | 🌐 PHP | 📅 2026-08-16: A free, self-hostable aggregator…
...
* [Sanic](https://github.com/sanic-org/sanic) ⭐ 18,644 | 🐛 145 | 🌐 Python | 📅 2026-07-29: Async Python 3.7+ web server/framework | Build fast. Run fast.
...
* [Apache Flink](https://github.com/apache/flink) ⭐ 26,265 | 🐛 378 | 🌐 Java | 📅 2026-08-14: Apache Flink is an open source stream processing framework with powerful stream- and batch-processing capabilities.
* [lists](https://github.com/jnv/lists) ⭐ 11,421 | 🐛 19 | 📅 2026-03-23: The definitive list of lists (of lists) curated on GitHub
...
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 364,251 | 🐛 605 | 🌐 Python | 📅 2026-03-20: Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 358,968 | 🐛 123 | 📅 2025-08-28: A complete computer science study plan to become a software engineer.
* [GitHub Résumé](https://github.com/resume/resume.github.com) ⭐ 62,886 | 🐛 76 | 🌐 JavaScript | 📅 2023-02-15
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 51,370 | 🐛 12 | 🌐 JavaScript | 📅 2026-06-06: Companies that don't have a broken hiring process.
...
* [OpenResume](https://www.open-resume.com/) Create a professional resume easily with this free, open-source, and powerful [resume builder](https://github.com/xitanggg/open-resume) ⭐ 8,839 | 🐛 141 | 🌐 TypeScript | 📅 2024-10-29.
...
* [📚 Freely available programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 394,577 | 🐛 78 | 🌐 Python | 📅 2026-08-16
