...
* [PortalData](https://github.com/weecology/PortalData) ⭐ 52 | 🐛 7 | 🌐 R | 📅 2026-09-24 (Official Repo of the Portal Project Data) and [livedat](https://github.com/weecology/livedat) ⭐ 13 | 🐛 2 | 🌐 R | 📅 2019-01-30 (Template for living data workflow ).
...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 361,873 | 🐛 126 | 📅 2025-08-28
* [The Book of Secret Knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) ⭐ 245,990 | 🐛 172 | 📅 2024-11-19
* [z3](https://github.com/Z3Prover/z3) ⭐ 12,717 | 🐛 46 | 🌐 C++ | 📅 2026-09-26: The Z3 Theorem Prover
...
* [awesome-graph-embedding](https://github.com/benedekrozemberczki/awesome-graph-embedding) ⭐ 4,802 | 🐛 0 | 🌐 Python | 📅 2023-03-18: A collection of important graph embedding, classification and representation learning papers with implementations.
...
* [ClickHouse](https://github.com/ClickHouse/ClickHouse) ⭐ 50,077 | 🐛 7,990 | 🌐 C++ | 📅 2026-09-26: is a free analytics DBMS for big data.
* [HikariCP](https://github.com/brettwooldridge/HikariCP) ⭐ 21,231 | 🐛 544 | 🌐 Java | 📅 2026-06-14: 光 HikariCP・A solid, high-performance, JDBC connection pool at last.
* [quick-SQL-cheatsheet](https://github.com/enochtangg/quick-SQL-cheatsheet) ⭐ 5,463 | 🐛 11 | 📅 2020-10-01: A quick reminder of all SQL queries and examples on how to use them.
...
* [Every Programmer Should Know thinking](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,487 | 🐛 28 | 📅 2025-12-29: A collection of (mostly) technical things every software developer should know
...
* [Prettier is an opinionated code formatter](https://github.com/prettier/prettier) ⭐ 52,310 | 🐛 1,442 | 🌐 JavaScript | 📅 2026-09-24
...
* [dev.to](https://github.com/thepracticaldev/dev.to) ⭐ 22,783 | 🐛 146 | 🌐 Ruby | 📅 2026-09-25: Where programmers share ideas and help each other grow
* [Flow](https://github.com/facebook/flow) ⭐ 22,296 | 🐛 515 | 🌐 Rust | 📅 2026-09-26: Adds static typing to JavaScript to improve developer productivity and code quality.
...
* [small](https://github.com/mathiasbynens/small) ⭐ 2,304 | 🐛 55 | 🌐 HTML | 📅 2024-07-18: Smallest possible syntactically valid files of different types.
...
* (pt-br) [OsProgramadores](https://osprogramadores.com) - [op-desafios](https://github.com/OsProgramadores/op-desafios) ⭐ 161 | 🐛 2 | 🌐 C | 📅 2026-09-10: Soluções para os desafios (por usuário)
...
* [vscodium](https://github.com/VSCodium/vscodium) ⭐ 33,397 | 🐛 151 | 🌐 Shell | 📅 2026-09-23: binary releases of VS Code without MS branding/telemetry/licensing
  * [awesome-vscode](https://github.com/viatsko/awesome-vscode) ⭐ 29,079 | 🐛 66 | 🌐 JavaScript | 📅 2026-06-21: art A curated list of delightful VS Code packages and resources.
...
* [CppCoreGuidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,334 | 🐛 248 | 🌐 CSS | 📅 2026-08-06: The C++ Core Guidelines are a set of tried-and-true guidelines, rules, and best practices about coding in C++
* [Microsoft's C++ Standard Library](https://github.com/microsoft/STL) ⭐ 11,155 | 🐛 596 | 🌐 C++ | 📅 2026-09-25: MSVC's implementation of the C++ Standard Library.
* mozilla [rr](https://github.com/mozilla/rr) ⭐ 10,676 | 🐛 481 | 🌐 C++ | 📅 2026-09-19: is a lightweight tool for recording, replaying and debugging execution of applications (trees of processes and threads). Debugging extends gdb with very efficient reverse-execution, which in combination with standard gdb/x86 features like hardware data watchpoints, makes debugging much more fun.
...
* [Checked C](https://github.com/microsoft/checkedc) ⭐ 3,261 | 🐛 74 | 🌐 C | 📅 2024-10-07 is an extension to C that adds checking to detect or prevent common programming errors such as buffer overruns and out-of-bounds memory accesses. This repo has a wiki for Checked C, sample code, the specification, and test code.
* [Intel SPMD Program Compiler](https://ispc.github.io/): ispc is a compiler for a variant of the C programming language, with extensions for "single program, multiple data" (SPMD) programming. Under the SPMD model, the programmer writes a program that generally appears to be a regular serial program, though the execution model is actually that a number of program instances execute in parallel on the hardware. [github](https://github.com/ispc/ispc/) ⭐ 2,960 | 🐛 291 | 🌐 C++ | 📅 2026-09-24
...
* [libtcod](https://github.com/libtcod/libtcod) ⭐ 1,229 | 🐛 27 | 🌐 C | 📅 2026-07-20: The official repository for libtcod. A roguelike development library.
...
* TDD C:
  * [Google Test](https://github.com/google/googletest) ⭐ 39,585 | 🐛 516 | 🌐 C++ | 📅 2026-09-17: Google Testing and Mocking Framework.
...
* [Makefile Tutorial by Example](https://makefiletutorial.com/) and [repo](https://github.com/theicfire/makefiletutorial) ⭐ 5,998 | 🐛 8 | 🌐 SCSS | 📅 2025-06-02
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,764 | 🐛 320 | 🌐 JavaScript | 📅 2026-04-08: A simple and modern GTK eBook viewer, built with GJS and Epub.js.
...
* [A curated list of awesome Python frameworks, libraries, software and resources](https://github.com/vinta/awesome-python#authentication) ⭐ 323,053 | 🐛 20 | 🌐 Python | 📅 2026-09-25
* [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) ⭐ 224,992 | 🐛 102 | 🌐 Python | 📅 2026-09-25: All Algorithms implemented in Python
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,622 | 🐛 82 | 🌐 Python | 📅 2026-09-26 framework, high performance, easy to learn, fast to code, ready for production
* cython [dtoa.c](https://github.com/python/cpython/blob/master/Python/dtoa.c) ⭐ 77,271 | 🐛 9,751 | 🌐 Python | 📅 2026-09-26
...
* [black](https://github.com/ambv/black/) ⭐ 41,853 | 🐛 285 | 🌐 Python | 📅 2026-09-24: The uncompromising Python code formatter
* [wtfpython](https://github.com/satwikkansal/wtfpython#-is-not--is-not-is-not-) ⭐ 37,088 | 🐛 72 | 🌐 Python | 📅 2026-01-13: A collection of surprising Python snippets and lesser-known features.
* [wtfpython](https://github.com/satwikkansal/wtfpython) ⭐ 37,088 | 🐛 72 | 🌐 Python | 📅 2026-01-13: What the f\*ck Python? ￼
* [Course Files for Complete Python 3 Bootcamp Course on Udemy](https://github.com/Pierian-Data/Complete-Python-3-Bootcamp) ⭐ 29,788 | 🐛 274 | 🌐 Jupyter Notebook | 📅 2025-06-24
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,366 | 🐛 402 | 🌐 Rust | 📅 2026-09-26A Python Interpreter written in Rust
* [kivy](https://github.com/kivy/kivy) ⭐ 19,026 | 🐛 846 | 🌐 Python | 📅 2026-09-24: Open source UI framework written in Python, running on Windows, Linux, macOS, Android and iOS.
* [Modular visual interface for GDB in Python](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,258 | 🐛 19 | 🌐 Python | 📅 2026-07-17
...
* [alive-progress](https://github.com/rsalmei/alive-progress) ⭐ 6,310 | 🐛 22 | 🌐 Python | 📅 2026-05-24: An animated and smart Progress Bar for python.
...
* [cinder](https://github.com/facebookincubator/cinder) ⭐ 3,794 | 🐛 31 | 🌐 Python | 📅 2026-09-26
* [Think Python](http://greenteapress.com/wp/think-python-2e/) by [AllenDowney](https://github.com/AllenDowney), including [repo](https://github.com/AllenDowney/ThinkPython2) ⭐ 2,647 | 🐛 1 | 🌐 TeX | 📅 2024-04-09
* [OpenTelemetry Python](https://github.com/open-telemetry/opentelemetry-python) ⭐ 2,646 | 🐛 411 | 🌐 Python | 📅 2026-09-25: OpenTelemetry Python API and SDK
* [austin](https://github.com/P403n1x87/austin) ⭐ 2,210 | 🐛 9 | 🌐 C | 📅 2026-09-25: Python frame stack sampler for CPython. Austin has a [tui](https://github.com/P403n1x87/austin-tui) ⭐ 665 | 🐛 2 | 🌐 Python | 📅 2026-06-04: The top-like text-based user interface for Austin.
...
* [logpy](https://github.com/logpy/logpy) ⭐ 935 | 🐛 15 | 🌐 Python | 📅 2025-10-23: Logic Programming in Python
...
* [Yet Another Roguelike Tutorial - Written in Python 3 and TCOD](http://rogueliketutorials.com/tutorials/tcod/v2/). [python-tcod](https://github.com/libtcod/python-tcod) ⭐ 479 | 🐛 6 | 🌐 Python | 📅 2026-07-20: A high-performance Python port of libtcod. Includes the libtcodpy module for backwards compatibility with older projects.
...
* [dissect.cstruct](https://github.com/fox-it/dissect.cstruct) ⭐ 68 | 🐛 15 | 🌐 Python | 📅 2026-09-25: A no-nonsense c-like structure parsing library for Python
...
* [vyper](https://github.com/ethereum/vyper/) ⭐ 5,183 | 🐛 624 | 🌐 Python | 📅 2026-09-24:
...
* Agda:
  * [Agda 2](https://github.com/agda/agda) ⭐ 2,933 | 🐛 1,057 | 🌐 Haskell | 📅 2026-09-25
  * [plfa](https://github.com/plfa/plfa.github.io/) ⭐ 1,515 | 🐛 66 | 🌐 Agda | 📅 2026-09-22: Introduction to programming language theory in Agda and [Programming Language Foundations in Agda](https://plfa.github.io/).
* Anglican:
...
* Answer Set Programming(ASP): offers a simple and powerful modeling language to solve combinatorial problems.
  * [Potassco](https://potassco.org/), [clingo](https://potassco.org/clingo/) and [github](https://github.com/potassco/clingo) ⭐ 836 | 🐛 12 | 🌐 C++ | 📅 2026-09-22.
* Brainfuck:
  * [Brainfuck](https://www.dcode.fr/brainfuck-language) encoder/decoder.
* Dafny:
  * [dafny](https://github.com/Microsoft/dafny) ⭐ 3,557 | 🐛 1,398 | 🌐 C# | 📅 2026-09-20: Dafny is a verification-aware programming language.
* Clean:
...
* Elixir:
  * [Nerves](https://github.com/nerves-project/nerves) ⭐ 2,496 | 🐛 22 | 🌐 Elixir | 📅 2026-09-21: Craft and deploy bulletproof embedded software in Elixir. [official site](http://nerves-project.org)
...
* Go:
  * [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 185,620 | 🐛 229 | 🌐 Go | 📅 2026-09-25: A curated list of awesome Go frameworks, libraries and software
  * [lattigo](https://github.com/lca1/lattigo) ⭐ 1,451 | 🐛 14 | 🌐 Go | 📅 2026-09-23: A lattice-based cryptographic library in Go.
...
* Java:
  * [1brc](https://github.com/gunnarmorling/1brc) ⭐ 8,121 | 🐛 40 | 🌐 Java | 📅 2024-08-20: [The One Billion Row Challenge](https://www.morling.dev/blog/one-billion-row-challenge/) -- A fun exploration of how quickly 1B rows from a text file can be aggregated with Java
...
* Lua:
  * [xmake](https://github.com/xmake-io/xmake) ⭐ 12,235 | 🐛 259 | 🌐 Lua | 📅 2026-09-22: 🔥 A cross-platform build [utility based on Lua](https://xmake.io)
* Nim:
  * [nim](https://nim-lang.org/): Efficient and expressive programming. [github](https://github.com/nim-lang/nim) ⭐ 18,248 | 🐛 2,205 | 🌐 Nim | 📅 2026-09-26
* Perl:
...
* PHP:
  * [A curated list of bookmarks, packages, tutorials, videos and other cool resources from the Laravel ecosystem](https://github.com/chiraggude/awesome-laravel) ⭐ 13,106 | 🐛 90 | 📅 2024-07-03
...
* Rust:
  * [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,557 | 🐛 9 | 🌐 Rust | 📅 2026-09-25: A curated list of Rust code and resources.
  * [Guide to develop secure applications with Rust](https://github.com/ANSSI-FR/rust-guide) ⭐ 651 | 🐛 26 | 🌐 Rust | 📅 2026-05-19: Recommendations for secure applications development with Rust
...
* V:
  * [V](https://github.com/vlang-io/V) ⭐ 37,911 | 🐛 164 | 🌐 V | 📅 2026-09-26: Simple, fast, safe, compiled language for creating maintainable software. Supports translation from C/C++.
  * [vlang](https://github.com/vlang/v) ⭐ 37,911 | 🐛 164 | 🌐 V | 📅 2026-09-26: Simple, fast, safe, compiled language for developing maintainable software. Supports translation from C and (soon) C++. Compiles itself in <1s.
* Verilog:
...
* [kompare](https://github.com/KDE/kompare) ⭐ 59 | 🐛 0 | 🌐 C++ | 📅 2026-09-24: Graphical File Differences Tool
...
* Starting Pull Requests:
  * [Awesome First PR Opportunities](https://github.com/MunGell/awesome-for-beginners) ⭐ 89,597 | 🐛 157 | 📅 2026-07-25
...
* [.gitignore](https://github.com/github/gitignore) ⭐ 175,923 | 🐛 71 | 📅 2026-09-25: A collection of useful .gitignore templates
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,679 | 🐛 1,057 | 🌐 Go | 📅 2026-09-25: simple terminal UI for git commands
* [gitea](https://github.com/go-gitea/gitea) ⭐ 58,156 | 🐛 2,464 | 🌐 Go | 📅 2026-09-25: Git with a cup of tea, painless self-hosted git service
* [gogs](https://github.com/gogs/gogs) ⭐ 47,836 | 🐛 1,013 | 🌐 Go | 📅 2026-09-12: Gogs is a painless self-hosted Git service.
* [github-cli](https://github.com/cli/cli) ⭐ 46,410 | 🐛 1,097 | 🌐 Go | 📅 2026-09-25:  GitHub’s official command line tool
* [husky](https://github.com/typicode/husky) ⭐ 35,334 | 🐛 107 | 🌐 JavaScript | 📅 2026-03-19: Git hooks made easy
* [Learn git branching](https://learngitbranching.js.org/): An interactive git visualization to challenge and educate! [github](https://github.com/pcottle/learnGitBranching) ⭐ 34,081 | 🐛 58 | 🌐 JavaScript | 📅 2026-09-21.
* [cz-cli](https://github.com/commitizen/cz-cli) ⭐ 17,501 | 🐛 195 | 🌐 JavaScript | 📅 2026-09-25: The commitizen command line utility.
* [lint-staged](https://github.com/okonet/lint-staged) ⭐ 14,737 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-25: Run linters on git staged files
* [git-blame-someone-else](https://github.com/jayphelps/git-blame-someone-else) ⭐ 11,715 | 🐛 21 | 🌐 Shell | 📅 2023-12-04: Blame someone else for your bad code.
...
* [Pro Git book](https://git-scm.com/book/en/v2), written by Scott Chacon and Ben Straub ([github](https://github.com/progit/progit2) ⭐ 6,599 | 🐛 220 | 🌐 CSS | 📅 2026-05-25 repo)
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,085 | 🐛 7 | 🌐 Shell | 📅 2026-09-25 is a utility tool for git taking advantage of fuzzy finder fzf. [Interactive Git Commands With Previews Powered By fzf Fuzzy Finder](https://www.linuxuprising.com/2019/11/forgit-interactive-git-commands-with.html)
* [git-sizer](https://github.com/github/git-sizer/) ⭐ 4,077 | 🐛 20 | 🌐 Go | 📅 2026-09-10: Compute various size metrics for a Git repository, flagging those that might cause problems ( [article](https://blog.github.com/2018-03-05-measuring-the-many-sizes-of-a-git-repository/))
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,943 | 🐛 36 | 🌐 Python | 📅 2026-07-06: Manage multiple git repos side by side for sanity
* [Git4Noobs](https://github.com/DanielHe4rt/git4noobs) ⭐ 1,615 | 🐛 3 | 📅 2024-09-28
* [Forge](https://github.com/magit/forge/) ⭐ 1,575 | 🐛 2 | 🌐 Emacs Lisp | 📅 2026-09-25: Work with Git forges from the comfort of Magit
...
* GitHub Profiles:
  * [Awesome Readme Stats](https://github.com/anmol098/waka-readme-stats) ⭐ 4,001 | 🐛 68 | 🌐 Python | 📅 2026-08-24
...
* [SkyWater Open Source PDK](https://github.com/google/skywater-pdk) ⭐ 3,730 | 🐛 200 | 🌐 Python | 📅 2026-07-21: Open source process design kit for usage with SkyWater Technology Foundry's 130nm node.
* [Ariane is a 6-stage RISC-V CPU](https://github.com/pulp-platform/ariane) ⭐ 3,129 | 🐛 265 | 🌐 Assembly | 📅 2026-09-25
* [cva6](https://github.com/openhwgroup/cva6) ⭐ 3,129 | 🐛 265 | 🌐 Assembly | 📅 2026-09-25: The CORE-V CVA6 is an Application class 6-stage RISC-V CPU capable of booting Linux.
...
* [RARS](https://github.com/TheThirdOne/rars) ⭐ 1,645 | 🐛 77 | 🌐 Java | 📅 2024-07-19: RISC-V Assembler and Runtime Simulator.
...
* [VGChips](https://github.com/furrtek/VGChips) ⭐ 230 | 🐛 23 | 🌐 Verilog | 📅 2026-09-06: Video Game custom chips reverse-engineered from silicon.
...
* [sail-arm](https://github.com/rems-project/sail-arm) ⭐ 97 | 🐛 16 | 🌐 Isabelle | 📅 2026-06-19: Sail version of ARM ISA definition, currently for ARMv8.5-A
...
* [Circuit Simulator](http://www.lushprojects.com/circuitjs/). [github](https://github.com/sharpie7/circuitjs1) ⭐ 2,954 | 🐛 266 | 🌐 Java | 📅 2024-01-22.
...
* [How to create an OS from scratch](https://github.com/cfenollosa/os-tutorial) ⭐ 30,729 | 🐛 128 | 🌐 C | 📅 2026-02-04
* [Mezzano](https://github.com/froggey/Mezzano/) ⭐ 3,900 | 🐛 14 | 🌐 Common Lisp | 📅 2026-09-25: An operating system written in Common Lisp.
* [bootOS](https://github.com/nanochess/bootOS) ⭐ 2,143 | 🐛 0 | 🌐 Assembly | 📅 2026-09-24 is a monolithic operating system in 512 bytes of x86 machine code.
...
* [Incompatible Timesharing System](https://github.com/PDP-10/its) ⭐ 954 | 🐛 506 | 🌐 Assembly | 📅 2026-08-19: ITS, the Incompatible Timesharing System, is an operating system for the PDP-10 computer family. It was created by hackers at MIT in the 1960s. The MIT site was shut down in 1990, but enthusiasts continue to operate ITS systems to this day.
* [EmuTOS](https://github.com/emutos/emutos) ⭐ 305 | 🐛 14 | 🌐 C | 📅 2026-09-23: is a Free operating system for Atari computers, and more.
* [KTF](https://github.com/awslabs/ktf) ⭐ 156 | 🐛 28 | 🌐 C | 📅 2025-11-25- Kernel Test Framework.
* [9hist](https://github.com/0intro/9hist) ⭐ 140 | 🐛 0 | 🌐 C | 📅 2022-04-04: History of the Plan 9 kernel (1990 - 2003).
...
* [GraalVM](https://github.com/oracle/graal) ⭐ 21,715 | 🐛 853 | 🌐 Java | 📅 2026-09-26: GraalVM is a universal virtual machine for running applications written in JavaScript, Python, Ruby, R, JVM-based languages like Java, Scala, Clojure, Kotlin, and LLVM-based languages such as C and C++. [GraalVM Implementation of Python](https://github.com/graalvm/graalpython) ⭐ 1,648 | 🐛 54 | 🌐 Python | 📅 2026-09-25
* [Compiler Explorer](https://godbolt.org/): Run compilers interactively from your web browser and interact with the assembly. [github](https://github.com/mattgodbolt/compiler-explorer) ⭐ 19,095 | 🐛 865 | 🌐 TypeScript | 📅 2026-09-24, [how it works](https://xania.org/201609/how-compiler-explorer-runs-on-amazon).
...
* [FASTER](https://github.com/Microsoft/FASTER) ⭐ 6,634 | 🐛 36 | 🌐 C# | 📅 2026-08-19: Fast key-value store from Microsoft Research
* [porcupine](https://github.com/anishathalye/porcupine/) ⭐ 1,251 | 🐛 4 | 🌐 Go | 📅 2026-09-21: A fast linearizability checker written in Go
...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,689 | 🐛 484 | 🌐 C++ | 📅 2026-09-11: Tesseract Open Source OCR Engine (main repository)
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 30,030 | 🐛 531 | 🌐 Python | 📅 2025-12-05: Ready-to-use OCR with 40+ languages supported including Chinese, Japanese, Korean and Thai.
* [annoy](https://github.com/spotify/annoy) ⭐ 14,304 | 🐛 86 | 🌐 C++ | 📅 2025-10-29: Approximate Nearest Neighbors in C++/Python optimized for memory usage and loading/saving to disk
...
* [faceswap](https://github.com/deepfakes/faceswap) ⭐ 57,557 | 🐛 15 | 🌐 Python | 📅 2026-08-05: Non official project based on original /r/Deepfakes thread. Many thanks to him!
...
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,805 | 🐛 56 | 🌐 C++ | 📅 2026-06-28: An open source library for face detection in images. The face detection speed can reach 1500FPS.
...
* [Lisp code](https://github.com/norvig/paip-lisp) ⭐ 7,510 | 🐛 35 | 🌐 Common Lisp | 📅 2024-10-15 for the textbook "Paradigms of Artificial Intelligence Programming"
* [donkeycar](https://github.com/autorope/donkeycar) ⭐ 3,508 | 🐛 137 | 🌐 Python | 📅 2026-09-19: Open source hardware and software platform to build a small scale self driving car.
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 166,660 | 🐛 2,384 | 🌐 Python | 📅 2026-09-26: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch.
* [nanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 63,374 | 🐛 349 | 🌐 Python | 📅 2025-11-12: The simplest, fastest repository for training/finetuning medium-sized GPTs.
* [Industrial-strength Natural Language Processing (NLP) with Python and Cython](https://github.com/explosion/spaCy/) ⭐ 33,922 | 🐛 246 | 🌐 Python | 📅 2026-08-24
* [flair](https://github.com/zalandoresearch/flair) ⭐ 14,390 | 🐛 31 | 🌐 Python | 📅 2025-10-27: A very simple framework for state-of-the-art Natural Language Processing (NLP)
...
* [Argdown](https://argdown.org/): A simple syntax for complex argumentation. [argdown repo](https://github.com/christianvoigt/argdown) ⭐ 1,041 | 🐛 101 | 🌐 TypeScript | 📅 2026-09-10
...
* [POS-tagger-portuguese-nltk](https://github.com/inoueMashuu/POS-tagger-portuguese-nltk) ⭐ 58 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2019-09-09: Conjunto de POS-taggers treinados para classificação gramatical de sentenças em português.
...
* [google-10000-english](https://github.com/first20hours/google-10000-english) ⭐ 4,482 | 🐛 28 | 📅 2023-05-17: This repo contains a list of the 10,000 most common English words in order of frequency, as determined by n-gram frequency analysis of the Google's Trillion Word Corpus.
...
* [Real-Time Voice Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning) ⭐ 60,154 | 🐛 177 | 🌐 Python | 📅 2026-03-09: Clone a voice in 5 seconds to generate arbitrary speech in real-time
...
* [DeepMind Research](https://github.com/deepmind/deepmind-research) ⭐ 15,206 | 🐛 359 | 🌐 Jupyter Notebook | 📅 2026-06-17: This repository contains implementations and illustrative code to accompany DeepMind publications.
* [vosk-api](https://github.com/alphacep/vosk-api) ⭐ 15,147 | 🐛 605 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API for Android, iOS, Raspberry Pi and servers with Python, Java, C# and Node.
* [CARLA](https://carla.org): Open-source simulator for [autonomous driving research](https://github.com/carla-simulator/carla) ⭐ 14,429 | 🐛 1,203 | 🌐 C++ | 📅 2026-09-25.
...
* [Python Machine Learning (2nd Ed.) Code Repository](https://github.com/rasbt/python-machine-learning-book-2nd-edition) ⭐ 7,201 | 🐛 31 | 🌐 Jupyter Notebook | 📅 2020-10-01: The "Python Machine Learning (2nd edition)" book code repository and info resource
* [60\_Days\_RL\_Challenge](https://github.com/andri27-ts/60_Days_RL_Challenge) ⭐ 4,739 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2020-06-30: Learn Deep Reinforcement Learning in depth in 60 days
...
* [lip reading](https://github.com/astorfi/lip-reading-deeplearning) ⭐ 1,901 | 🐛 7 | 🌐 Python | 📅 2022-11-07: Cross Audio-Visual Recognition using 3D Architectures
...
* [Image-OutPainting](https://github.com/bendangnuksung/Image-OutPainting) ⭐ 1,146 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2022-11-22: Keras Implementation of Painting outside the box
...
* [awesome-edge-machine-learning](https://github.com/Bisonai/awesome-edge-machine-learning) ⭐ 281 | 🐛 3 | 🌐 Python | 📅 2026-09-15: A curated list of awesome edge machine learning resources, including research papers, inference engines, challenges, books, meetups and others.
...
* Autonomous Vehicles:
  * [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,517 | 🐛 781 | 🌐 C++ | 📅 2026-09-15: Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
...
* [mit-deep-learning](https://github.com/lexfridman/mit-deep-learning) ⭐ 10,458 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2024-01-03: Tutorials, assignments, and competitions for MIT Deep Learning related courses.
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,356 | 🐛 760 | 🌐 C# | 📅 2026-09-25: is an open source and cross-platform machine learning framework for .NET.
* [DeepLabCut](http://www.mackenziemathislab.org/deeplabcut): is an efficient method for 3D markerless pose estimation based on transfer learning with deep neural networks that achieves excellent results (i.e. you can match human labeling accuracy) with minimal training data (typically 50-200 frames). [repo](https://github.com/DeepLabCut/DeepLabCut) ⭐ 5,778 | 🐛 48 | 🌐 Python | 📅 2026-09-24
* [Is a Green Screen Really Necessary for Real-Time Human Matting?](https://arxiv.org/pdf/2011.11961.pdf), [repo](https://github.com/ZHKKKe/MODNet) ⭐ 4,369 | 🐛 71 | 🌐 Python | 📅 2024-05-06
...
* [The Tsetlin Machine](https://arxiv.org/abs/1804.01508): A Game Theoretic Bandit Driven Approach to Optimal Pattern Recognition with Propositional Logic. [github](https://github.com/cair/TsetlinMachine) ⭐ 507 | 🐛 1 | 🌐 Cython | 📅 2026-02-10.
...
* [Stable Diffusion](https://github.com/CompVis/stable-diffusion) ⭐ 73,479 | 🐛 619 | 🌐 Jupyter Notebook | 📅 2024-06-18: is a latent text-to-image diffusion model. Thanks to a generous compute donation from Stability AI and support from LAION, we were able to train a Latent Diffusion Model on 512x512 images from a subset of the LAION-5B database.
* [Wan](https://github.com/Wan-Video/Wan2.2) ⭐ 17,636 | 🐛 304 | 🌐 Python | 📅 2026-09-21: Open and Advanced Large-Scale Video Generative Models
* [Bbrain.js](https://github.com/BrainJS/brain.js) ⭐ 14,862 | 🐛 90 | 🌐 TypeScript | 📅 2024-09-26: 🤖 Neural networks in JavaScript
* [Paddle Fluid](https://www.paddlepaddle.org.cn/) with [Pre-trained and Reproduced Deep Learning Models](https://github.com/PaddlePaddle/models) ⭐ 6,931 | 🐛 869 | 🌐 Python | 📅 2025-01-15, [ERNIE](https://github.com/PaddlePaddle/ERNIE) ⭐ 7,736 | 🐛 83 | 🌐 Python | 📅 2026-07-24:  An Implementation of ERNIE For Language Understanding (including Pre-training models and Fine-tuning tools).
* [Deep Convolutional Generative Adversarial Network](https://www.tensorflow.org/tutorials/generative/dcgan) [jupyter notebook](https://github.com/tensorflow/docs/blob/master/site/en/tutorials/generative/dcgan.ipynb) ⭐ 6,334 | 🐛 70 | 🌐 Jupyter Notebook | 📅 2026-09-23
* [Image Deduplicator](https://idealo.github.io/imagededup/): [imagededup](https://github.com/idealo/imagededup) ⭐ 5,672 | 🐛 39 | 🌐 Python | 📅 2025-08-15 is a python package that simplifies the task of finding exact and near duplicates in an image collection.
* [tensorspace](https://github.com/tensorspace-team/tensorspace) ⭐ 5,195 | 🐛 28 | 🌐 JavaScript | 📅 2022-12-05: Neural network 3D visualization framework, build interactive and intuitive model in browsers, support pre-trained deep learning models from TensorFlow, Keras, TensorFlow\.js
* [Handwriting Synthesis](https://github.com/sjvasquez/handwriting-synthesis) ⭐ 4,820 | 🐛 63 | 🌐 Python | 📅 2024-01-11
* [Random Forest vs Neural Network](https://mljar.com/blog/random-forest-vs-neural-network-classification/)(classification, tabular data) - [github](https://github.com/mljar/mljar-supervised) ⭐ 3,296 | 🐛 130 | 🌐 Python | 📅 2026-07-27
...
* [NEST](https://github.com/nest/nest-simulator) ⭐ 670 | 🐛 224 | 🌐 C++ | 📅 2026-09-18: NEST is a simulator for spiking neural network models that focuses on the dynamics, size and structure of neural systems rather than on the exact morphology of individual neurons.
* [GRaNDPapA](https://github.com/joaoperfig/GRaNDPapA) ⭐ 284 | 🐛 1 | 🌐 Python | 📅 2022-02-06: Generator of Rad Names from Decent Paper Acronyms
...
* [fiftyone](https://github.com/voxel51/fiftyone) ⭐ 11,117 | 🐛 708 | 🌐 TypeScript | 📅 2026-09-26: The open-source tool for building high-quality datasets and computer vision models
...
* [YOLOv7](https://github.com/jinfagang/yolov7) ⭐ 3,112 | 🐛 69 | 🌐 Python | 📅 2023-11-18: YOLO with Transformers and Instance Segmentation, with TensorRT acceleration!
* [MUNIT](https://github.com/nvlabs/munit) ⭐ 2,706 | 🐛 66 | 🌐 Python | 📅 2022-09-20: Multimodal UNsupervised Image-to-image Translation
* [OpenSimpleLidar](https://github.com/iliasam/OpenSimpleLidar) ⭐ 2,564 | 🐛 1 | 🌐 C | 📅 2025-07-22: Open Hardware scanning laser rangefinder ([howto](https://hackaday.io/project/20628-open-simple-lidar))
...
* [gradslam](https://github.com/gradslam/gradslam) ⭐ 1,426 | 🐛 18 | 🌐 Python | 📅 2023-09-02: gradslam is an open source differentiable dense SLAM library for PyTorch
...
*Frameworks for Neural Networks and Deep Learning. See: [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,976 | 🐛 88 | 📅 2025-05-26.*

* [Keras](https://github.com/fchollet/keras) ⭐ 64,343 | 🐛 262 | 🌐 Python | 📅 2026-09-26 - A high-level neural networks library and capable of running on top of either TensorFlow or Theano.
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 103,334 | 🐛 17,549 | 🌐 Python | 📅 2026-09-26: Tensors and Dynamic neural networks in Python with strong GPU acceleration a ([tour](http://blog.christianperone.com/2018/03/pytorch-internal-architecture-tour/)):
* [tinygrad](https://github.com/geohot/tinygrad) ⭐ 33,660 | 🐛 180 | 🌐 Python | 📅 2026-09-26: You like pytorch? You like [micrograd](https://github.com/karpathy/micrograd) ⭐ 17,669 | 🐛 80 | 🌐 Jupyter Notebook | 📅 2026-08-03? You love tinygrad! ❤️
...
* [Deep-reinforcement-learning-with-pytorch](https://github.com/sweetice/Deep-reinforcement-learning-with-pytorch) ⭐ 4,655 | 🐛 29 | 🌐 Python | 📅 2023-03-24: PyTorch implementation of DQN, AC, ACER, A2C, A3C, PG, DDPG, TRPO, PPO, SAC, TD3 and ....
...
* [colorization-pytorch](https://github.com/richzhang/colorization-pytorch) ⭐ 602 | 🐛 15 | 🌐 Python | 📅 2020-06-04: PyTorch reimplementation of Interactive Deep Colorization
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 200,321 | 🐛 3,323 | 🌐 C++ | 📅 2026-09-26 - The most popular Deep Learning framework created by Google.
...
* [Ludwig](https://github.com/uber/ludwig) ⭐ 11,765 | 🐛 1 | 🌐 Python | 📅 2026-09-21: [is a toolbox built](https://uber.github.io/ludwig/) on top of TensorFlow that allows to train and test deep learning models without the need to write code.
...
* [tensorFlow Privacy](https://github.com/tensorflow/privacy) ⭐ 2,036 | 🐛 136 | 🌐 Python | 📅 2026-08-26: Library for training machine learning models with privacy for training data
* [TF Encrypted](https://tf-encrypted.io/) is a framework for encrypted deep learning in TensorFlow. It looks and feels like TensorFlow, taking advantage of the ease-of-use of the Keras API while [enabling training and prediction over encrypted data](https://github.com/tf-encrypted/tf-encrypted) ⭐ 1,241 | 🐛 144 | 🌐 Python | 📅 2024-09-25.
...
* Good channels:
  * [3blue1brown](https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw/): 3blue1brown, by Grant Sanderson, is some combination of math and entertainment, depending on your disposition ([site](https://www.3blue1brown.com/)) and [manim](https://github.com/3b1b/manim) ⭐ 94,257 | 🐛 502 | 🌐 Python | 📅 2026-09-09(Animation engine for explanatory math videos).
...
* [Kyle Walker](https://gist.github.com/walkerke) Gist, a lot of R scripts and interesting stuff [github](https://github.com/walkerke/tidycensus) ⭐ 686 | 🐛 26 | 🌐 R | 📅 2026-05-25
...
* [The Data Engineering Cookbook](https://github.com/andkret/Cookbook) ⭐ 15,439 | 🐛 128 | 🌐 Python | 📅 2026-07-23
* [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,340 | 🐛 1,348 | 🌐 Python | 📅 2026-09-26: Official repository for Spyder - The Scientific Python Development Environment
...
* [RAPIDS](http://rapids.ai): Open GPU Data Science. The RAPIDS suite of software libraries gives you the freedom to execute end-to-end data science and analytics pipelines entirely on GPUs. It relies on NVIDIA® CUDA® primitives for low-level compute optimization, but exposes that GPU parallelism and high-bandwidth memory speed through user-friendly Python interfaces. [cuml](https://github.com/rapidsai/cuml) ⭐ 5,290 | 🐛 806 | 🌐 Python | 📅 2026-09-24 - RAPIDS Machine Learning Library.
...
* [insight](https://github.com/easystats/insight) ⭐ 442 | 🐛 59 | 🌐 R | 📅 2026-09-16: Easy access to model information for various model objects.
...
* Python:
  ...
  * [arviz](https://github.com/arviz-devs/arviz) ⭐ 1,852 | 🐛 112 | 🌐 TeX | 📅 2026-09-09: Python package to plot and analyse samples from probabilistic models
  ...
  * [pyjanitor](https://github.com/ericmjl/pyjanitor) ⭐ 1,500 | 🐛 148 | 🌐 Python | 📅 2026-09-26: Python implementation of R package Janitor
  ...
  * [Python Plotting for Exploratory Data Analysis](https://pythonplot.com/)  by [Tim Hopper](https://twitter.com/tdhopper/status/1212821555710963712) [repo](https://github.com/tdhopper/pythonplot.com) ⭐ 114 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-09-23
...
* Jupyter:
  ...
  * [The Jupyter Notebooks behind: "A Whirlwind Tour of Python"](https://github.com/jakevdp/WhirlwindTourOfPython) ⭐ 4,042 | 🐛 25 | 🌐 Jupyter Notebook | 📅 2024-01-31
  ...
  * [nbtutor](https://github.com/lgpage/nbtutor) ⭐ 472 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-24: Visualize Python code execution (line-by-line) in Jupyter Notebook cells.
  * [Teaching and Learning with Jupyter](https://github.com/jupyter4edu/jupyter-edu-book) ⭐ 470 | 🐛 29 | 🌐 TeX | 📅 2023-03-30 [book](https://jupyter4edu.github.io/jupyter-edu-book/)
...
* R Lang
  * [brms](https://github.com/paul-buerkner/brms) ⭐ 1,431 | 🐛 156 | 🌐 R | 📅 2026-09-25: R package for Bayesian generalized multivariate non-linear multilevel models using Stan
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 66,231 | 🐛 918 | 🌐 Go | 📅 2026-09-25: The Prometheus monitoring system and time series database.
* [dart](https://github.com/unit8co/darts) ⭐ 9,525 | 🐛 221 | 🌐 Python | 📅 2026-09-25: A python library for easy manipulation and forecasting of time series.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,210 | 🐛 102 | 🌐 C++ | 📅 2026-09-23: The Time Series Visualization Tool that you deserve.
...
* [amsterdam-schema](https://github.com/Amsterdam/amsterdam-schema) ⭐ 22 | 🐛 10 | 🌐 Python | 📅 2026-09-25: Data modeling & verification for the City of Amsterdam's open data - based on JSON Schema
...
* [ImageMagick creates huge temporary files · Issue #395 · ImageMagick/ImageMagick](https://github.com/ImageMagick/ImageMagick/issues/395) ⭐ 17,516 | 🐛 164 | 🌐 C | 📅 2026-09-26
...
* [Microsoft open sources SandDance, a visual data exploration tool](https://cloudblogs.microsoft.com/opensource/2019/10/10/microsoft-open-sources-sanddance-visual-data-exploration-tool/). [site](https://sanddance.js.org/), [repo](https://github.com/Microsoft/SandDance) ⭐ 7,149 | 🐛 96 | 🌐 TypeScript | 📅 2026-09-22
* [OpenSubdiv](http://graphics.pixar.com/opensubdiv/docs/intro.html) ([github](https://github.com/PixarAnimationStudios/OpenSubdiv) ⭐ 3,074 | 🐛 58 | 🌐 C++ | 📅 2026-09-26): is a set of open source libraries that implement high performance subdivision surface (subdiv) evaluation on massively parallel CPU and GPU architectures.
* [vedo](https://github.com/marcomusy/vedo) ⭐ 2,270 | 🐛 172 | 🌐 Python | 📅 2026-08-04: A python module for scientific analysis of 3D objects based on VTK and numpy
* [Pseudo-bandlimited pixel art filtering in 3D – a mathematical derivation](http://themaister.net/blog/2018/08/25/pseudo-bandlimited-pixel-art-filtering-in-3d-a-mathematical-derivation/) [github](https://github.com/Themaister/Granite) ⭐ 1,950 | 🐛 3 | 🌐 C++ | 📅 2026-09-25
* [see](https://github.com/easystats/see) ⭐ 954 | 🐛 32 | 🌐 R | 📅 2026-09-01 Visualisation toolbox for beautiful and publication-ready figures
* [JPEG \[JAY-peg\]](https://github.com/corkami/docs/blob/master/images/jpeg.md) ⭐ 832 | 🐛 6 | 🌐 TeX | 📅 2024-05-04, some pocs [JPEG PoCs](https://github.com/corkami/pocs/blob/master/images/jpg/README.md) ⭐ 1,559 | 🐛 7 | 🌐 Assembly | 📅 2024-12-22
...
* GGplot2:
  ...
  * [ggalluvial](https://github.com/corybrunson/ggalluvial) ⭐ 524 | 🐛 24 | 🌐 R | 📅 2026-09-23
...
* Color Palettes:
  * [wesanderson](https://github.com/karthik/wesanderson) ⭐ 2,157 | 🐛 23 | 🌐 R | 📅 2024-06-13: A Wes Anderson color palette for R.
  * [MetBrewer](https://github.com/BlakeRMills/MetBrewer) ⭐ 1,277 | 🐛 11 | 🌐 R | 📅 2025-01-03: Color palette package in R inspired by works at the Metropolitan Museum of Art in New York.
  * [Palettes for R based on the Scientific Colour-Maps](https://github.com/thomasp85/scico) ⭐ 483 | 🐛 4 | 🌐 R | 📅 2023-12-09: This is a small package to provide access to the colour palettes developed by Fabio Crameri..
...
* [FiPy](https://github.com/usnistgov/fipy) ⭐ 641 | 🐛 180 | 🌐 Python | 📅 2026-09-23: is a Finite Volume PDE solver written in Python.
...
* [jax](https://github.com/google/jax) ⭐ 36,339 | 🐛 2,596 | 🌐 Python | 📅 2026-09-26: Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more
* [micro](https://micro-editor.github.io/): a modern and intuitive [terminal-based text editor](https://github.com/zyedidia/micro#linux-clipboard-support) ⭐ 29,642 | 🐛 917 | 🌐 Go | 📅 2026-09-26.
* [pyodide](https://github.com/iodide-project/pyodide) ⭐ 14,856 | 🐛 395 | 🌐 Python | 📅 2026-09-23: The Python scientific stack, compiled to WebAssembly
...
* [bild](https://github.com/anthonynsimon/bild) ⭐ 4,215 | 🐛 19 | 🌐 Go | 📅 2026-09-07: A collection of parallel image processing algorithms in pure Go
* [programmers-introduction-to-mathematics](https://github.com/pim-book/programmers-introduction-to-mathematics) ⭐ 3,648 | 🐛 10 | 🌐 JavaScript | 📅 2023-03-04: Code for [A Programmer's Introduction to Mathematics](https://pimbook.org)
...
* [Rack](https://github.com/VCVRack/Rack) ⭐ 4,425 | 🐛 307 | 🌐 C++ | 📅 2025-11-04: The virtual Eurorack studio
* [Sonic Visualiser](https://www.sonicvisualiser.org/) is a free, open-source application for Windows, Linux, and Mac, designed to be the first program you reach for when want to study a music recording closely. It's designed for musicologists, archivists, signal-processing researchers, and anyone else looking for a friendly way to look at what lies inside the audio file. [github repo](https://github.com/sonic-visualiser/sonic-visualiser) ⭐ 899 | 🐛 84 | 🌐 C++ | 📅 2025-12-07
...
* [Hum Synthesizer](https://github.com/crbulakites/hum) ⭐ 44 | 🐛 0 | 🌐 Rust | 📅 2026-02-01: A music notation language and synthesizer written in Rust.
...
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,984 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-25: Easily add particles animations to your website. Compatible also with React, Vue.js (2.x and 3.x), Angular, Svelte, jQuery, Preact, Inferno.
* [Walk through an infinite, procedurally generated city](https://github.com/marian42/wavefunctioncollapse) ⭐ 4,861 | 🐛 9 | 🌐 C# | 📅 2021-03-28
* [An interactive, explorable explanation about the peculiar magic of sound waves.](https://github.com/joshwcomeau/waveforms) ⭐ 1,481 | 🐛 4 | 🌐 JavaScript | 📅 2018-02-21
* [SOFA](https://www.sofa-framework.org/): is an efficient framework dedicated to research, prototyping and development of physics-based simulations. [github](https://github.com/sofa-framework/sofa/) ⭐ 1,261 | 🐛 450 | 🌐 C++ | 📅 2026-09-25.
...
* [gqrx](https://gqrx.dk/): is an open source software defined radio receiver (SDR) powered by the GNU Radio and the Qt graphical toolkit. [Gqrx](https://github.com/csete/gqrx) ⭐ 3,690 | 🐛 270 | 🌐 C++ | 📅 2026-08-06
...
* [AstroML](https://github.com/astroML/astroML) ⭐ 1,201 | 🐛 71 | 🌐 Python | 📅 2024-05-25: Machine learning, statistics, and data mining for astronomy and astrophysics
* [astroquery](https://github.com/astropy/astroquery) ⭐ 794 | 🐛 414 | 🌐 Python | 📅 2026-09-24: Functions and classes to access online data resources. Maintainers: @keflavich and @bsipocz and @ceb8
...
* CDS Astro:
  * [Aladin Lite](https://github.com/cds-astro/aladin-lite) ⭐ 157 | 🐛 64 | 🌐 JavaScript | 📅 2026-09-17: An astronomical HiPS visualizer in the browser.
  * [ipyaladin](https://github.com/cds-astro/ipyaladin) ⭐ 157 | 🐛 14 | 🌐 Python | 📅 2026-09-16: An IPython Widget for Aladin Lite
...
* [Open MCT](https://nasa.github.io/openmct/): is a next-generation mission control framework for visualization of data on desktop and mobile devices - [github](https://github.com/nasa/openmct) ⭐ 13,135 | 🐛 1,091 | 🌐 JavaScript | 📅 2026-09-26
* [fprime](https://github.com/nasa/fprime) ⭐ 11,790 | 🐛 477 | 🌐 C++ | 📅 2026-09-25: A flight software and embedded systems framework.
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,670 | 🐛 17 | 🌐 HTML | 📅 2026-09-03: A build-it-yourself, 6-wheel rover based on the rovers on Mars!
* [Sawppy](https://github.com/Roger-random/Sawppy_Rover) ⭐ 510 | 🐛 1 | 🌐 C | 📅 2025-09-21: is a motorized model of Mars rovers Curiosity and Mars 2020. It faithfully reproduces the Rocker-Bogie suspension kinematics of real rovers and is intended to be a hardware platform for future software projects in autonomous operation. Go forth and boldly explore the back yard, Sawppy!
...
* [MNE-Python](https://github.com/mne-tools/mne-python) ⭐ 3,528 | 🐛 613 | 🌐 Python | 📅 2026-09-25: Magnetoencephalography (MEG) and Electroencephalography (EEG) in Python
...
* [plus codes](https://plus.codes/). [open-location-code](https://github.com/google/open-location-code) ⭐ 4,359 | 🐛 61 | 🌐 Java | 📅 2026-03-30: Open Location Code is a library to generate short codes that can be used like street addresses, for places where street addresses don't exist.
* [S2Geometry](http://s2geometry.io/): S2 is a library for spherical geometry that aims to have the same robustness, flexibility, and performance as the very best planar geometry libraries [github](https://github.com/google/s2geometry) ⭐ 2,729 | 🐛 77 | 🌐 C++ | 📅 2026-09-25.
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 955 | 🐛 15 | 🌐 Python | 📅 2026-09-23: Easy access to shapefiles of the Brazilian Institute of Geography and Statistics (IBGE) and other official spatial data sets of Brazil.
...
* [surpriver](https://github.com/tradytics/surpriver) ⭐ 1,879 | 🐛 13 | 🌐 Python | 📅 2021-08-13: Find big moving stocks before they move using machine learning and anomaly detection.
...
* [Awesome-Design-Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 41,323 | 🐛 209 | 🌐 JavaScript | 📅 2024-07-28: The best design tools for everything.
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,508 | 🐛 284 | 🌐 C++ | 📅 2026-09-26:Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
...
* [glChAoS.P](https://www.michelemorrone.eu/glchaosp/)(opengl Chaotic Attractor of Slight (dot) Particles): open source - multiplatform - 3D real time strange attractors scout... and hypercomplex fractals. [github](https://github.com/BrutPitt/glChAoS.P) ⭐ 860 | 🐛 8 | 🌐 C++ | 📅 2025-02-10
* [This is a collection of simple to more involved examples to scripting in Blender with Python.](https://github.com/njanakiev/blender-scripting/blob/master/README.md#phyllotaxis-flower) ⭐ 824 | 🐛 2 | 🌐 Python | 📅 2021-09-28
...
* [BIM\_Workbench](https://github.com/yorikvanhavre/BIM_Workbench) ⭐ 405 | 🐛 29 | 🌐 Python | 📅 2024-09-02: A BIM Workbench for FreeCAD
...
* [Craft](https://github.com/fogleman/Craft) ⭐ 11,113 | 🐛 129 | 🌐 C | 📅 2024-04-03: A simple Minecraft clone written in C using modern OpenGL (shaders).
* [Opendiablo2](https://github.com/OpenDiablo2/OpenDiablo2) ⚠️ Archived: An open source re-implementation of Diablo 2
* [gb-studio](https://github.com/chrismaltby/gb-studio) ⭐ 9,406 | 🐛 807 | 🌐 TypeScript | 📅 2026-09-21: A free and easy to use retro adventure game creator for your favourite [handheld video game system](https://www.gbstudio.dev)
* [sm64](https://github.com/n64decomp/sm64) ⭐ 8,786 | 🐛 29 | 🌐 C | 📅 2024-02-04: A Super Mario 64 decompilation, brought to you by a bunch of clever folks.
* [MarkovJunior](https://github.com/mxgmn/MarkovJunior) ⭐ 8,197 | 🐛 9 | 🌐 C# | 📅 2026-03-20: Probabilistic PL based on pattern matching and constraint propagation, 148 examples.
* [Citybound](https://github.com/citybound/citybound) ⭐ 8,167 | 🐛 153 | 🌐 Rust | 📅 2023-01-07: Citybound is a city building game with a focus on realism, collaborative planning and simulation of microscopic details.
* [OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,503 | 🐛 64 | 🌐 C++ | 📅 2026-08-31: A Framework for Reinforcement Learning in Games.
* [Zelda 3 in C](https://github.com/snesrev/zelda3) ⭐ 4,806 | 🐛 88 | 🌐 C | 📅 2023-12-27: A reimplementation of Zelda 3.
* [The Comprehensive Kerbal Archive Network (CKAN)](https://github.com/KSP-CKAN/CKAN) ⭐ 2,656 | 🐛 85 | 🌐 C# | 📅 2026-09-23
* [Synfig Studio](https://github.com/synfig/synfig/) ⭐ 2,301 | 🐛 724 | 🌐 C++ | 📅 2026-09-20: This is the Official source code repository of the Synfig project.
* [Hypersomnia](https://github.com/TeamHypersomnia/Hypersomnia) ⭐ 1,660 | 🐛 13 | 🌐 C++ | 📅 2026-09-26: Multiplayer top-down shooter made from scratch. Comes with an in-game Editor!
* [toy](https://github.com/hugoam/toy) ⭐ 1,593 | 🐛 13 | 🌐 C++ | 📅 2021-04-25: the thin c++ game engine - [toyengine](https://hugoam.github.io/toy-io/).
* [SDLPoP](https://github.com/NagyD/SDLPoP) ⭐ 1,287 | 🐛 80 | 🌐 C | 📅 2025-12-24: An open-source port of Prince of Persia, based on the disassembly of the DOS version.
* [quinesanek](https://github.com/taylorconor/quinesnake) ⭐ 925 | 🐛 1 | 🌐 C++ | 📅 2019-07-27: A quine that plays snake over its own source!
* [Links Awakening DX Disassembly](https://github.com/zladx/LADX-Disassembly) ⭐ 903 | 🐛 18 | 🌐 Assembly | 📅 2026-09-25: Disassembly of Legend of Zelda: Links Awakening DX.
...
* [Clspv](https://github.com/google/clspv) ⭐ 730 | 🐛 63 | 🌐 LLVM | 📅 2026-09-25 is a prototype compiler for a subset of OpenCL C to Vulkan compute shaders.
...
* [Tips and Tricks for Writing Scientific Papers](https://github.com/Wookai/paper-tips-and-tricks) ⭐ 3,731 | 🐛 4 | 🌐 Python | 📅 2023-05-17: Best practice and tips & tricks to write scientific papers in LaTeX, with figures generated in Python or Matlab.
...
* [veyon](https://github.com/veyon/veyon/) ⭐ 1,975 | 🐛 233 | 🌐 C++ | 📅 2026-09-25: Cross-platform computer monitoring and classroom management.

## Studies

* [Path to a free self-taught education in Computer Science!](https://github.com/ossu/computer-science) ⭐ 209,471 | 🐛 28 | 🌐 HTML | 📅 2026-07-14
* [the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 17,215 | 🐛 200 | 🌐 Jupyter Notebook | 📅 2026-05-20: One has no future if one couldn't teach themself.
...
* (pt-br) [Free IT Courses](https://github.com/alinebastos/free-courses) ⭐ 879 | 🐛 6 | 📅 2023-01-19
...
* [Awesome Accessibility](https://github.com/brunopulis/awesome-a11y) ⭐ 1,989 | 🐛 81 | 📅 2026-08-03: A curate list about A11Y
...
* [FreshRSS](https://github.com/FreshRSS/FreshRSS) ⭐ 16,144 | 🐛 691 | 🌐 PHP | 📅 2026-09-25: A free, self-hostable aggregator…
* guardian [frontend](https://github.com/guardian/frontend) ⭐ 5,900 | 🐛 227 | 🌐 Scala | 📅 2026-09-25: Source for theguardian.com
...
* [Sanic](https://github.com/sanic-org/sanic) ⭐ 18,635 | 🐛 150 | 🌐 Python | 📅 2026-07-29: Async Python 3.7+ web server/framework | Build fast. Run fast.
...
* [Differential Privacy](https://github.com/google/differential-privacy) ⭐ 3,364 | 🐛 66 | 🌐 Go | 📅 2026-09-23: This project contains a C++ library of ε-differentially private algorithms, which can be used to produce aggregate statistics over numeric data sets containing private or sensitive information.
...
* [Philosophy](https://github.com/Jfaler/Philosophize) ⭐ 367 | 🐛 1 | 📅 2020-12-27: 📚 A curated list of philosophy resources.
* [Translating and Interpreting Chinese Philosophy](https://plato.stanford.edu/entries/chinese-translate-interpret/)

## General

* [Apache Flink](https://github.com/apache/flink) ⭐ 26,367 | 🐛 375 | 🌐 Java | 📅 2026-09-25: Apache Flink is an open source stream processing framework with powerful stream- and batch-processing capabilities.
* [lists](https://github.com/jnv/lists) ⭐ 11,507 | 🐛 30 | 📅 2026-03-23: The definitive list of lists (of lists) curated on GitHub
* [awesome-uses](https://github.com/wesbos/awesome-uses) ⭐ 5,302 | 🐛 29 | 🌐 JavaScript | 📅 2026-09-20: A list of /uses pages that detail apps and gear used by professional web developers.
* (pt-br) [Lista Maravilhosa de Projetos Open-Source](https://github.com/camilatigre/listamaravilhosaopensource) ⭐ 2,582 | 🐛 25 | 🌐 JavaScript | 📅 2026-06-15: Lista com links de projetos open-source para os níveis: iniciante, intermediário e avançado. Dividido por linguagem e idiomas!
...
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 371,831 | 🐛 615 | 🌐 Python | 📅 2026-09-15: Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 361,873 | 🐛 126 | 📅 2025-08-28: A complete computer science study plan to become a software engineer.
* [GitHub Résumé](https://github.com/resume/resume.github.com) ⭐ 62,890 | 🐛 78 | 🌐 JavaScript | 📅 2023-02-15
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 52,203 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-24: Companies that don't have a broken hiring process.
...
* [test-your-sysadmin-skills](https://github.com/trimstray/test-your-sysadmin-skills) ⭐ 11,870 | 🐛 19 | 📅 2024-11-19
* [OpenResume](https://www.open-resume.com/) Create a professional resume easily with this free, open-source, and powerful [resume builder](https://github.com/xitanggg/open-resume) ⭐ 8,910 | 🐛 145 | 🌐 TypeScript | 📅 2024-10-29.
...
* [awesome-scifi](https://github.com/sindresorhus/awesome-scifi) ⭐ 5,061 | 🐛 1 | 📅 2025-12-22: I asked on Twitter for recommendations as I want to get into reading Sci-Fi novels. The below is the result. Thanks everyone for recommending your favorites! :)
* [blobs](https://blobs.app): [Blob shapes generator](https://github.com/lokesh-coder/blobs.app) ⭐ 484 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-22
...
* [📚 Freely available programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 397,713 | 🐛 82 | 🌐 Python | 📅 2026-09-24
