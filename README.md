...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 359,072 | 🐛 123 | 📅 2025-08-28
* [The Book of Secret Knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) ⭐ 238,882 | 🐛 165 | 📅 2024-11-19
* [z3](https://github.com/Z3Prover/z3) ⭐ 12,564 | 🐛 59 | 🌐 C++ | 📅 2026-08-18: The Z3 Theorem Prover
...
* [ClickHouse](https://github.com/ClickHouse/ClickHouse) ⭐ 49,298 | 🐛 6,931 | 🌐 C++ | 📅 2026-08-18: is a free analytics DBMS for big data.
...
* [Prettier is an opinionated code formatter](https://github.com/prettier/prettier) ⭐ 52,203 | 🐛 1,428 | 🌐 JavaScript | 📅 2026-08-17
...
* [dev.to](https://github.com/thepracticaldev/dev.to) ⭐ 22,769 | 🐛 126 | 🌐 Ruby | 📅 2026-08-18: Where programmers share ideas and help each other grow
...
* (pt-br) [OsProgramadores](https://osprogramadores.com) - [op-desafios](https://github.com/OsProgramadores/op-desafios) ⭐ 159 | 🐛 2 | 🌐 C | 📅 2026-08-17: Soluções para os desafios (por usuário)
...
* [CppCoreGuidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,249 | 🐛 246 | 🌐 CSS | 📅 2026-08-06: The C++ Core Guidelines are a set of tried-and-true guidelines, rules, and best practices about coding in C++
* [Microsoft's C++ Standard Library](https://github.com/microsoft/STL) ⭐ 11,130 | 🐛 583 | 🌐 C++ | 📅 2026-08-17: MSVC's implementation of the C++ Standard Library.
...
* [memory-profiler](https://github.com/nokia/memory-profiler) ⭐ 4,800 | 🐛 52 | 🌐 C | 📅 2023-07-28
...
* TDD C:
  * [Google Test](https://github.com/google/googletest) ⭐ 38,936 | 🐛 492 | 🌐 C++ | 📅 2026-08-17: Google Testing and Mocking Framework.
...
* [Makefile Tutorial by Example](https://makefiletutorial.com/) and [repo](https://github.com/theicfire/makefiletutorial) ⭐ 5,965 | 🐛 8 | 🌐 SCSS | 📅 2025-06-02
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,641 | 🐛 311 | 🌐 JavaScript | 📅 2026-04-08: A simple and modern GTK eBook viewer, built with GJS and Epub.js.
...
* [A curated list of awesome Python frameworks, libraries, software and resources](https://github.com/vinta/awesome-python#authentication) ⭐ 314,514 | 🐛 16 | 🌐 Python | 📅 2026-08-16
* [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) ⭐ 223,820 | 🐛 1,037 | 🌐 Python | 📅 2026-08-03: All Algorithms implemented in Python
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,659 | 🐛 85 | 🌐 Python | 📅 2026-08-17 framework, high performance, easy to learn, fast to code, ready for production
* cython [dtoa.c](https://github.com/python/cpython/blob/master/Python/dtoa.c) ⭐ 74,338 | 🐛 9,527 | 🌐 Python | 📅 2026-08-17
* [Rich](https://github.com/willmcgugan/rich) ⭐ 57,079 | 🐛 370 | 🌐 Python | 📅 2026-06-23 is a Python library for rich text and beautiful formatting in the terminal.
* [black](https://github.com/ambv/black/) ⭐ 41,803 | 🐛 304 | 🌐 Python | 📅 2026-08-17: The uncompromising Python code formatter
...
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,288 | 🐛 410 | 🌐 Rust | 📅 2026-08-17A Python Interpreter written in Rust
* [kivy](https://github.com/kivy/kivy) ⭐ 18,996 | 🐛 853 | 🌐 Python | 📅 2026-08-15: Open source UI framework written in Python, running on Windows, Linux, macOS, Android and iOS.
...
* [cinder](https://github.com/facebookincubator/cinder) ⭐ 3,789 | 🐛 33 | 🌐 Python | 📅 2026-08-17
...
* [OpenTelemetry Python](https://github.com/open-telemetry/opentelemetry-python) ⭐ 2,589 | 🐛 394 | 🌐 Python | 📅 2026-08-17: OpenTelemetry Python API and SDK
* [austin](https://github.com/P403n1x87/austin) ⭐ 2,210 | 🐛 12 | 🌐 C | 📅 2026-07-02: Python frame stack sampler for CPython. Austin has a [tui](https://github.com/P403n1x87/austin-tui) ⭐ 665 | 🐛 2 | 🌐 Python | 📅 2026-06-04: The top-like text-based user interface for Austin.
...
* [vyper](https://github.com/ethereum/vyper/) ⭐ 5,181 | 🐛 694 | 🌐 Python | 📅 2026-08-12:
...
* Agda:
  * [Agda 2](https://github.com/agda/agda) ⭐ 2,916 | 🐛 1,046 | 🌐 Haskell | 📅 2026-08-14
  * [plfa](https://github.com/plfa/plfa.github.io/) ⭐ 1,513 | 🐛 66 | 🌐 Agda | 📅 2026-08-17: Introduction to programming language theory in Agda and [Programming Language Foundations in Agda](https://plfa.github.io/).
* Anglican:
...
* Dafny:
  * [dafny](https://github.com/Microsoft/dafny) ⭐ 3,503 | 🐛 1,377 | 🌐 C# | 📅 2026-08-16: Dafny is a verification-aware programming language.
* Clean:
...
* Elixir:
  * [Nerves](https://github.com/nerves-project/nerves) ⭐ 2,484 | 🐛 22 | 🌐 Elixir | 📅 2026-08-17: Craft and deploy bulletproof embedded software in Elixir. [official site](http://nerves-project.org)
...
* Go:
  * [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 181,339 | 🐛 212 | 🌐 Go | 📅 2026-08-16: A curated list of awesome Go frameworks, libraries and software
...
* JavaScript:
  * [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,510 | 🐛 404 | 🌐 JavaScript | 📅 2026-07-26: Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
...
* Lua:
  * [xmake](https://github.com/xmake-io/xmake) ⭐ 12,145 | 🐛 249 | 🌐 Lua | 📅 2026-08-17: 🔥 A cross-platform build [utility based on Lua](https://xmake.io)
* Nim:
  * [nim](https://nim-lang.org/): Efficient and expressive programming. [github](https://github.com/nim-lang/nim) ⭐ 18,174 | 🐛 2,185 | 🌐 Nim | 📅 2026-08-17
* Perl:
...
* PHP:
  * [A curated list of bookmarks, packages, tutorials, videos and other cool resources from the Laravel ecosystem](https://github.com/chiraggude/awesome-laravel) ⭐ 13,094 | 🐛 85 | 📅 2024-07-03
...
* V:
  * [V](https://github.com/vlang-io/V) ⭐ 37,795 | 🐛 86 | 🌐 V | 📅 2026-08-18: Simple, fast, safe, compiled language for creating maintainable software. Supports translation from C/C++.
  * [vlang](https://github.com/vlang/v) ⭐ 37,795 | 🐛 86 | 🌐 V | 📅 2026-08-18: Simple, fast, safe, compiled language for developing maintainable software. Supports translation from C and (soon) C++. Compiles itself in <1s.
* Verilog:
...
* Starting Pull Requests:
  * [Awesome First PR Opportunities](https://github.com/MunGell/awesome-for-beginners) ⭐ 88,466 | 🐛 141 | 📅 2026-07-25
...
* [.gitignore](https://github.com/github/gitignore) ⭐ 175,355 | 🐛 83 | 📅 2026-07-23: A collection of useful .gitignore templates
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,412 | 🐛 1,020 | 🌐 Go | 📅 2026-08-17: simple terminal UI for git commands
* [gitea](https://github.com/go-gitea/gitea) ⭐ 57,457 | 🐛 2,538 | 🌐 Go | 📅 2026-08-18: Git with a cup of tea, painless self-hosted git service
* [gogs](https://github.com/gogs/gogs) ⭐ 47,733 | 🐛 1,010 | 🌐 Go | 📅 2026-08-06: Gogs is a painless self-hosted Git service.
* [github-cli](https://github.com/cli/cli) ⭐ 45,865 | 🐛 1,065 | 🌐 Go | 📅 2026-08-17:  GitHub’s official command line tool
* [husky](https://github.com/typicode/husky) ⭐ 35,277 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19: Git hooks made easy
* [Learn git branching](https://learngitbranching.js.org/): An interactive git visualization to challenge and educate! [github](https://github.com/pcottle/learnGitBranching) ⭐ 33,888 | 🐛 60 | 🌐 JavaScript | 📅 2026-08-18.
* [cz-cli](https://github.com/commitizen/cz-cli) ⭐ 17,498 | 🐛 194 | 🌐 JavaScript | 📅 2026-08-11: The commitizen command line utility.
* [lint-staged](https://github.com/okonet/lint-staged) ⭐ 14,710 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-08: Run linters on git staged files
* [git-blame-someone-else](https://github.com/jayphelps/git-blame-someone-else) ⭐ 11,700 | 🐛 21 | 🌐 Shell | 📅 2023-12-04: Blame someone else for your bad code.
...
* [Pro Git book](https://git-scm.com/book/en/v2), written by Scott Chacon and Ben Straub ([github](https://github.com/progit/progit2) ⭐ 6,556 | 🐛 219 | 🌐 CSS | 📅 2026-05-25 repo)
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,062 | 🐛 13 | 🌐 Shell | 📅 2026-08-01 is a utility tool for git taking advantage of fuzzy finder fzf. [Interactive Git Commands With Previews Powered By fzf Fuzzy Finder](https://www.linuxuprising.com/2019/11/forgit-interactive-git-commands-with.html)
...
* GitHub Profiles:
  * [Awesome Readme Stats](https://github.com/anmol098/waka-readme-stats) ⭐ 3,977 | 🐛 65 | 🌐 Python | 📅 2026-08-04
...
* [SkyWater Open Source PDK](https://github.com/google/skywater-pdk) ⭐ 3,656 | 🐛 199 | 🌐 Python | 📅 2026-07-21: Open source process design kit for usage with SkyWater Technology Foundry's 130nm node.
* [Ariane is a 6-stage RISC-V CPU](https://github.com/pulp-platform/ariane) ⭐ 3,068 | 🐛 264 | 🌐 Assembly | 📅 2026-08-17
* [cva6](https://github.com/openhwgroup/cva6) ⭐ 3,068 | 🐛 264 | 🌐 Assembly | 📅 2026-08-17: The CORE-V CVA6 is an Application class 6-stage RISC-V CPU capable of booting Linux.
...
* [The Zip CPU](https://github.com/ZipCPU/zipcpu) ⭐ 1,574 | 🐛 3 | 🌐 Verilog | 📅 2025-12-08: A small, light weight, RISC CPU soft core
...
* [Circuit Simulator](http://www.lushprojects.com/circuitjs/). [github](https://github.com/sharpie7/circuitjs1) ⭐ 2,925 | 🐛 266 | 🌐 Java | 📅 2024-01-22.
...
* [GraalVM](https://github.com/oracle/graal) ⭐ 21,663 | 🐛 849 | 🌐 Java | 📅 2026-08-17: GraalVM is a universal virtual machine for running applications written in JavaScript, Python, Ruby, R, JVM-based languages like Java, Scala, Clojure, Kotlin, and LLVM-based languages such as C and C++. [GraalVM Implementation of Python](https://github.com/graalvm/graalpython) ⭐ 1,635 | 🐛 60 | 🌐 Python | 📅 2026-08-17
* [Compiler Explorer](https://godbolt.org/): Run compilers interactively from your web browser and interact with the assembly. [github](https://github.com/mattgodbolt/compiler-explorer) ⭐ 18,985 | 🐛 830 | 🌐 TypeScript | 📅 2026-08-18, [how it works](https://xania.org/201609/how-compiler-explorer-runs-on-amazon).
...
* [FASTER](https://github.com/Microsoft/FASTER) ⭐ 6,637 | 🐛 35 | 🌐 C# | 📅 2026-08-13: Fast key-value store from Microsoft Research
...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 75,968 | 🐛 484 | 🌐 C++ | 📅 2026-08-17: Tesseract Open Source OCR Engine (main repository)
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,916 | 🐛 530 | 🌐 Python | 📅 2025-12-05: Ready-to-use OCR with 40+ languages supported including Chinese, Japanese, Korean and Thai.
* [annoy](https://github.com/spotify/annoy) ⭐ 14,288 | 🐛 84 | 🌐 C++ | 📅 2025-10-29: Approximate Nearest Neighbors in C++/Python optimized for memory usage and loading/saving to disk
...
* [faceswap](https://github.com/deepfakes/faceswap) ⭐ 57,468 | 🐛 12 | 🌐 Python | 📅 2026-08-05: Non official project based on original /r/Deepfakes thread. Many thanks to him!
...
* [donkeycar](https://github.com/autorope/donkeycar) ⭐ 3,491 | 🐛 134 | 🌐 Python | 📅 2026-08-17: Open source hardware and software platform to build a small scale self driving car.
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 164,196 | 🐛 2,388 | 🌐 Python | 📅 2026-08-18: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch.
* [nanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,176 | 🐛 351 | 🌐 Python | 📅 2025-11-12: The simplest, fastest repository for training/finetuning medium-sized GPTs.
* [Industrial-strength Natural Language Processing (NLP) with Python and Cython](https://github.com/explosion/spaCy/) ⭐ 33,827 | 🐛 234 | 🌐 Python | 📅 2026-08-07
...
* [Language Interpretability Tool (LIT)](https://github.com/pair-code/lit/) ⭐ 3,658 | 🐛 139 | 🌐 TypeScript | 📅 2026-07-29: Interactively analyze NLP models for model understanding in an extensible and framework agnostic interface.
* [PromptSource](https://github.com/bigscience-workshop/promptsource) ⭐ 3,029 | 🐛 43 | 🌐 Python | 📅 2023-10-23
* [Argdown](https://argdown.org/): A simple syntax for complex argumentation. [argdown repo](https://github.com/christianvoigt/argdown) ⭐ 1,029 | 🐛 96 | 🌐 TypeScript | 📅 2026-08-11
...
* [Real-Time Voice Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning) ⭐ 60,091 | 🐛 177 | 🌐 Python | 📅 2026-03-09: Clone a voice in 5 seconds to generate arbitrary speech in real-time
...
* [vosk-api](https://github.com/alphacep/vosk-api) ⭐ 15,063 | 🐛 601 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API for Android, iOS, Raspberry Pi and servers with Python, Java, C# and Node.
...
* [CARLA](https://carla.org): Open-source simulator for [autonomous driving research](https://github.com/carla-simulator/carla) ⭐ 14,300 | 🐛 1,190 | 🌐 C++ | 📅 2026-08-17.
...
* Autonomous Vehicles:
  * [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,405 | 🐛 780 | 🌐 C++ | 📅 2026-06-30: Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
...
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,347 | 🐛 1,008 | 🌐 C# | 📅 2026-08-17: is an open source and cross-platform machine learning framework for .NET.
* [DeepLabCut](http://www.mackenziemathislab.org/deeplabcut): is an efficient method for 3D markerless pose estimation based on transfer learning with deep neural networks that achieves excellent results (i.e. you can match human labeling accuracy) with minimal training data (typically 50-200 frames). [repo](https://github.com/DeepLabCut/DeepLabCut) ⭐ 5,736 | 🐛 48 | 🌐 Python | 📅 2026-08-17
...
* [Stable Diffusion](https://github.com/CompVis/stable-diffusion) ⭐ 73,301 | 🐛 619 | 🌐 Jupyter Notebook | 📅 2024-06-18: is a latent text-to-image diffusion model. Thanks to a generous compute donation from Stability AI and support from LAION, we were able to train a Latent Diffusion Model on 512x512 images from a subset of the LAION-5B database.
* [Wan](https://github.com/Wan-Video/Wan2.2) ⭐ 17,173 | 🐛 287 | 🌐 Python | 📅 2026-03-17: Open and Advanced Large-Scale Video Generative Models
...
* [NEST](https://github.com/nest/nest-simulator) ⭐ 658 | 🐛 229 | 🌐 C++ | 📅 2026-08-10: NEST is a simulator for spiking neural network models that focuses on the dynamics, size and structure of neural systems rather than on the exact morphology of individual neurons.
...
* [fiftyone](https://github.com/voxel51/fiftyone) ⭐ 11,018 | 🐛 665 | 🌐 TypeScript | 📅 2026-08-17: The open-source tool for building high-quality datasets and computer vision models
...
*Frameworks for Neural Networks and Deep Learning. See: [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,773 | 🐛 84 | 📅 2025-05-26.*

* [Keras](https://github.com/fchollet/keras) ⭐ 64,239 | 🐛 222 | 🌐 Python | 📅 2026-08-14 - A high-level neural networks library and capable of running on top of either TensorFlow or Theano.
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,562 | 🐛 1,566 | 🌐 C++ | 📅 2024-07-31 - A fast open framework for deep learning..
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,441 | 🐛 17,052 | 🌐 Python | 📅 2026-08-18: Tensors and Dynamic neural networks in Python with strong GPU acceleration a ([tour](http://blog.christianperone.com/2018/03/pytorch-internal-architecture-tour/)):
* [tinygrad](https://github.com/geohot/tinygrad) ⭐ 33,457 | 🐛 181 | 🌐 Python | 📅 2026-08-18: You like pytorch? You like [micrograd](https://github.com/karpathy/micrograd) ⭐ 17,164 | 🐛 78 | 🌐 Jupyter Notebook | 📅 2026-08-03? You love tinygrad! ❤️
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 196,990 | 🐛 2,921 | 🌐 C++ | 📅 2026-08-18 - The most popular Deep Learning framework created by Google.
...
* Good channels:
  * [3blue1brown](https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw/): 3blue1brown, by Grant Sanderson, is some combination of math and entertainment, depending on your disposition ([site](https://www.3blue1brown.com/)) and [manim](https://github.com/3b1b/manim) ⭐ 91,506 | 🐛 485 | 🌐 Python | 📅 2026-08-17(Animation engine for explanatory math videos).
...
* [Kyle Walker](https://gist.github.com/walkerke) Gist, a lot of R scripts and interesting stuff [github](https://github.com/walkerke/tidycensus) ⭐ 683 | 🐛 25 | 🌐 R | 📅 2026-05-25
...
* [Awesome Data Science](https://github.com/bulutyazilim/awesome-datascience) ⭐ 29,835 | 🐛 8 | 📅 2026-08-10
* [The Data Engineering Cookbook](https://github.com/andkret/Cookbook) ⭐ 15,305 | 🐛 128 | 🌐 Python | 📅 2026-07-23
* [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,287 | 🐛 1,348 | 🌐 Python | 📅 2026-08-17: Official repository for Spyder - The Scientific Python Development Environment
...
* [RAPIDS](http://rapids.ai): Open GPU Data Science. The RAPIDS suite of software libraries gives you the freedom to execute end-to-end data science and analytics pipelines entirely on GPUs. It relies on NVIDIA® CUDA® primitives for low-level compute optimization, but exposes that GPU parallelism and high-bandwidth memory speed through user-friendly Python interfaces. [cuml](https://github.com/rapidsai/cuml) ⭐ 5,253 | 🐛 835 | 🌐 Python | 📅 2026-08-17 - RAPIDS Machine Learning Library.
...
* Python:
  ...
  * [arviz](https://github.com/arviz-devs/arviz) ⭐ 1,845 | 🐛 110 | 🌐 TeX | 📅 2026-08-17: Python package to plot and analyse samples from probabilistic models
  ...
  * [pyjanitor](https://github.com/ericmjl/pyjanitor) ⭐ 1,499 | 🐛 108 | 🌐 Python | 📅 2026-08-17: Python implementation of R package Janitor
...
* R Lang
  * [brms](https://github.com/paul-buerkner/brms) ⭐ 1,422 | 🐛 159 | 🌐 R | 📅 2026-08-04: R package for Bayesian generalized multivariate non-linear multilevel models using Stan
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,699 | 🐛 887 | 🌐 Go | 📅 2026-08-17: The Prometheus monitoring system and time series database.
* [dart](https://github.com/unit8co/darts) ⭐ 9,496 | 🐛 222 | 🌐 Python | 📅 2026-08-06: A python library for easy manipulation and forecasting of time series.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,118 | 🐛 157 | 🌐 C++ | 📅 2026-08-10: The Time Series Visualization Tool that you deserve.
...
* [ImageMagick creates huge temporary files · Issue #395 · ImageMagick/ImageMagick](https://github.com/ImageMagick/ImageMagick/issues/395) ⭐ 17,173 | 🐛 162 | 🌐 C | 📅 2026-08-18
...
* [OpenSubdiv](http://graphics.pixar.com/opensubdiv/docs/intro.html) ([github](https://github.com/PixarAnimationStudios/OpenSubdiv) ⭐ 3,070 | 🐛 59 | 🌐 C++ | 📅 2026-08-17): is a set of open source libraries that implement high performance subdivision surface (subdiv) evaluation on massively parallel CPU and GPU architectures.
...
* [Pseudo-bandlimited pixel art filtering in 3D – a mathematical derivation](http://themaister.net/blog/2018/08/25/pseudo-bandlimited-pixel-art-filtering-in-3d-a-mathematical-derivation/) [github](https://github.com/Themaister/Granite) ⭐ 1,936 | 🐛 2 | 🌐 C++ | 📅 2026-08-15
* [see](https://github.com/easystats/see) ⭐ 951 | 🐛 32 | 🌐 R | 📅 2026-08-04 Visualisation toolbox for beautiful and publication-ready figures
* [JPEG \[JAY-peg\]](https://github.com/corkami/docs/blob/master/images/jpeg.md) ⭐ 832 | 🐛 6 | 🌐 TeX | 📅 2024-05-04, some pocs [JPEG PoCs](https://github.com/corkami/pocs/blob/master/images/jpg/README.md) ⭐ 1,554 | 🐛 7 | 🌐 Assembly | 📅 2024-12-22
...
* [jax](https://github.com/google/jax) ⭐ 36,172 | 🐛 2,583 | 🌐 Python | 📅 2026-08-18: Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more
* [micro](https://micro-editor.github.io/): a modern and intuitive [terminal-based text editor](https://github.com/zyedidia/micro#linux-clipboard-support) ⭐ 29,363 | 🐛 1,034 | 🌐 Go | 📅 2026-08-18.
...
* [programmers-introduction-to-mathematics](https://github.com/pim-book/programmers-introduction-to-mathematics) ⭐ 3,655 | 🐛 10 | 🌐 JavaScript | 📅 2023-03-04: Code for [A Programmer's Introduction to Mathematics](https://pimbook.org)
...
* [Rack](https://github.com/VCVRack/Rack) ⭐ 4,404 | 🐛 307 | 🌐 C++ | 📅 2025-11-04: The virtual Eurorack studio
...
* [This program generates bitmaps that are locally similar to the input bitmap](https://github.com/mxgmn/WaveFunctionCollapse) ⭐ 25,278 | 🐛 9 | 🌐 C# | 📅 2026-03-22
...
* [Open MCT](https://nasa.github.io/openmct/): is a next-generation mission control framework for visualization of data on desktop and mobile devices - [github](https://github.com/nasa/openmct) ⭐ 13,084 | 🐛 1,068 | 🌐 JavaScript | 📅 2026-08-14
* [fprime](https://github.com/nasa/fprime) ⭐ 11,671 | 🐛 435 | 🌐 C++ | 📅 2026-08-18: A flight software and embedded systems framework.
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,584 | 🐛 18 | 🌐 Prolog | 📅 2026-08-13: A build-it-yourself, 6-wheel rover based on the rovers on Mars!
* [Sawppy](https://github.com/Roger-random/Sawppy_Rover) ⭐ 506 | 🐛 1 | 🌐 C | 📅 2025-09-21: is a motorized model of Mars rovers Curiosity and Mars 2020. It faithfully reproduces the Rocker-Bogie suspension kinematics of real rovers and is intended to be a hardware platform for future software projects in autonomous operation. Go forth and boldly explore the back yard, Sawppy!
...
* [MNE-Python](https://github.com/mne-tools/mne-python) ⭐ 3,487 | 🐛 635 | 🌐 Python | 📅 2026-08-17: Magnetoencephalography (MEG) and Electroencephalography (EEG) in Python
...
* [S2Geometry](http://s2geometry.io/): S2 is a library for spherical geometry that aims to have the same robustness, flexibility, and performance as the very best planar geometry libraries [github](https://github.com/google/s2geometry) ⭐ 2,709 | 🐛 77 | 🌐 C++ | 📅 2026-08-18.
...
* [Awesome Blockchain](https://github.com/yjjnls/awesome-blockchain) ⭐ 3,623 | 🐛 53 | 🌐 Go | 📅 2024-03-22: Curated list of resources for the development and applications of blockchain.
...
* [Awesome-Design-Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 40,909 | 🐛 183 | 🌐 JavaScript | 📅 2024-07-28: The best design tools for everything.
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,407 | 🐛 288 | 🌐 C | 📅 2026-08-18:Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
...
* [gb-studio](https://github.com/chrismaltby/gb-studio) ⭐ 9,370 | 🐛 789 | 🌐 TypeScript | 📅 2026-08-17: A free and easy to use retro adventure game creator for your favourite [handheld video game system](https://www.gbstudio.dev)
...
* [MarkovJunior](https://github.com/mxgmn/MarkovJunior) ⭐ 8,164 | 🐛 9 | 🌐 C# | 📅 2026-03-20: Probabilistic PL based on pattern matching and constraint propagation, 148 examples.
...
* [OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,412 | 🐛 48 | 🌐 C++ | 📅 2026-08-12: A Framework for Reinforcement Learning in Games.
* [Zelda 3 in C](https://github.com/snesrev/zelda3) ⭐ 4,730 | 🐛 88 | 🌐 C | 📅 2023-12-27: A reimplementation of Zelda 3.
* [The Comprehensive Kerbal Archive Network (CKAN)](https://github.com/KSP-CKAN/CKAN) ⭐ 2,616 | 🐛 83 | 🌐 C# | 📅 2026-07-17
* [Synfig Studio](https://github.com/synfig/synfig/) ⭐ 2,280 | 🐛 729 | 🌐 C++ | 📅 2026-08-16: This is the Official source code repository of the Synfig project.
* [Hypersomnia](https://github.com/TeamHypersomnia/Hypersomnia) ⭐ 1,617 | 🐛 13 | 🌐 C++ | 📅 2026-06-21: Multiplayer top-down shooter made from scratch. Comes with an in-game Editor!
...
* [wick editor](https://www.wickeditor.com/): [The Wick Editor is a free](https://github.com/Wicklets/wick-editor) ⭐ 836 | 🐛 186 | 🌐 JavaScript | 📅 2023-03-06, open-source tool for creating games, animations, and everything in-between!
...
* [Path to a free self-taught education in Computer Science!](https://github.com/ossu/computer-science) ⭐ 208,090 | 🐛 25 | 🌐 HTML | 📅 2026-07-14
* [the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,438 | 🐛 199 | 🌐 Jupyter Notebook | 📅 2026-05-20: One has no future if one couldn't teach themself.
...
* [FreshRSS](https://github.com/FreshRSS/FreshRSS) ⭐ 15,797 | 🐛 660 | 🌐 PHP | 📅 2026-08-17: A free, self-hostable aggregator…
* guardian [frontend](https://github.com/guardian/frontend) ⭐ 5,897 | 🐛 194 | 🌐 Scala | 📅 2026-08-17: Source for theguardian.com
...
* [Differential Privacy](https://github.com/google/differential-privacy) ⭐ 3,341 | 🐛 61 | 🌐 Go | 📅 2026-08-17: This project contains a C++ library of ε-differentially private algorithms, which can be used to produce aggregate statistics over numeric data sets containing private or sensitive information.
...
* [Apache Flink](https://github.com/apache/flink) ⭐ 26,270 | 🐛 380 | 🌐 Java | 📅 2026-08-17: Apache Flink is an open source stream processing framework with powerful stream- and batch-processing capabilities.
* [lists](https://github.com/jnv/lists) ⭐ 11,425 | 🐛 20 | 📅 2026-03-23: The definitive list of lists (of lists) curated on GitHub
* [awesome-uses](https://github.com/wesbos/awesome-uses) ⭐ 5,298 | 🐛 24 | 🌐 JavaScript | 📅 2026-08-17: A list of /uses pages that detail apps and gear used by professional web developers.
...
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 364,471 | 🐛 607 | 🌐 Python | 📅 2026-03-20: Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 359,072 | 🐛 123 | 📅 2025-08-28: A complete computer science study plan to become a software engineer.
...
* [test-your-sysadmin-skills](https://github.com/trimstray/test-your-sysadmin-skills) ⭐ 11,837 | 🐛 19 | 📅 2024-11-19
...
* [awesome-scifi](https://github.com/sindresorhus/awesome-scifi) ⭐ 5,007 | 🐛 0 | 📅 2025-12-22: I asked on Twitter for recommendations as I want to get into reading Sci-Fi novels. The below is the result. Thanks everyone for recommending your favorites! :)
...
* [📚 Freely available programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 394,638 | 🐛 81 | 🌐 Python | 📅 2026-08-16
