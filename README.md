...
* [PortalData](https://github.com/weecology/PortalData) ⭐ 51 | 🐛 5 | 🌐 R | 📅 2026-08-20 (Official Repo of the Portal Project Data) and [livedat](https://github.com/weecology/livedat) ⭐ 13 | 🐛 2 | 🌐 R | 📅 2019-01-30 (Template for living data workflow ).
...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 359,360 | 🐛 124 | 📅 2025-08-28
* [The Book of Secret Knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) ⭐ 239,443 | 🐛 166 | 📅 2024-11-19
* [z3](https://github.com/Z3Prover/z3) ⭐ 12,574 | 🐛 57 | 🌐 C++ | 📅 2026-08-20: The Z3 Theorem Prover
...
* [awesome-graph-embedding](https://github.com/benedekrozemberczki/awesome-graph-embedding) ⭐ 4,798 | 🐛 0 | 🌐 Python | 📅 2023-03-18: A collection of important graph embedding, classification and representation learning papers with implementations.
...
* [ClickHouse](https://github.com/ClickHouse/ClickHouse) ⭐ 49,368 | 🐛 6,957 | 🌐 C++ | 📅 2026-08-21: is a free analytics DBMS for big data.
* [HikariCP](https://github.com/brettwooldridge/HikariCP) ⭐ 21,188 | 🐛 544 | 🌐 Java | 📅 2026-06-14: 光 HikariCP・A solid, high-performance, JDBC connection pool at last.
* [quick-SQL-cheatsheet](https://github.com/enochtangg/quick-SQL-cheatsheet) ⭐ 5,449 | 🐛 11 | 📅 2020-10-01: A quick reminder of all SQL queries and examples on how to use them.
* [pgFormatter](https://github.com/darold/pgFormatter) ⭐ 1,952 | 🐛 24 | 🌐 PLpgSQL | 📅 2026-08-15: A PostgreSQL SQL syntax beautifier that can work as a console program or as a CGI. On-line demo [site](http://sqlformat.darold.net/)
...
* [Every Programmer Should Know thinking](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,274 | 🐛 25 | 📅 2025-12-29: A collection of (mostly) technical things every software developer should know
...
* [Prettier is an opinionated code formatter](https://github.com/prettier/prettier) ⭐ 52,206 | 🐛 1,419 | 🌐 JavaScript | 📅 2026-08-20
* [Mega Project List](https://github.com/karan/Projects) ⭐ 47,884 | 🐛 123 | 📅 2024-08-14: A list of practical projects that anyone can solve in any programming language.
* [dev.to](https://github.com/thepracticaldev/dev.to) ⭐ 22,768 | 🐛 131 | 🌐 Ruby | 📅 2026-08-20: Where programmers share ideas and help each other grow
* [Flow](https://github.com/facebook/flow) ⭐ 22,276 | 🐛 524 | 🌐 Rust | 📅 2026-08-21: Adds static typing to JavaScript to improve developer productivity and code quality.
* [Quine Relay](https://github.com/mame/quine-relay) ⭐ 14,586 | 🐛 18 | 🌐 Ruby | 📅 2025-10-24: An uroboros program with 100+ programming languages.
...
* [Programming Talks](https://github.com/hellerve/programming-talks) ⭐ 7,366 | 🐛 2 | 🌐 Python | 📅 2026-08-07: Awesome & interesting talks about programming
...
* (pt-br) [OsProgramadores](https://osprogramadores.com) - [op-desafios](https://github.com/OsProgramadores/op-desafios) ⭐ 159 | 🐛 4 | 🌐 C | 📅 2026-08-17: Soluções para os desafios (por usuário)
...
* [vscodium](https://github.com/VSCodium/vscodium) ⭐ 32,904 | 🐛 140 | 🌐 Shell | 📅 2026-08-12: binary releases of VS Code without MS branding/telemetry/licensing
  * [awesome-vscode](https://github.com/viatsko/awesome-vscode) ⭐ 28,962 | 🐛 48 | 🌐 JavaScript | 📅 2026-06-21: art A curated list of delightful VS Code packages and resources.
...
* [CppCoreGuidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,257 | 🐛 246 | 🌐 CSS | 📅 2026-08-06: The C++ Core Guidelines are a set of tried-and-true guidelines, rules, and best practices about coding in C++
* [Microsoft's C++ Standard Library](https://github.com/microsoft/STL) ⭐ 11,133 | 🐛 586 | 🌐 C++ | 📅 2026-08-20: MSVC's implementation of the C++ Standard Library.
* mozilla [rr](https://github.com/mozilla/rr) ⭐ 10,625 | 🐛 481 | 🌐 C++ | 📅 2026-08-16: is a lightweight tool for recording, replaying and debugging execution of applications (trees of processes and threads). Debugging extends gdb with very efficient reverse-execution, which in combination with standard gdb/x86 features like hardware data watchpoints, makes debugging much more fun.
* [GuiLite](https://github.com/idea4good/GuiLite) ⭐ 7,761 | 🐛 18 | 🌐 C++ | 📅 2025-10-22: heavy\_check\_markThe smallest UI framework for all platform -- 5K lines code
...
* TDD C:
  * [Google Test](https://github.com/google/googletest) ⭐ 38,941 | 🐛 495 | 🌐 C++ | 📅 2026-08-19: Google Testing and Mocking Framework.
...
* [Makefile Tutorial by Example](https://makefiletutorial.com/) and [repo](https://github.com/theicfire/makefiletutorial) ⭐ 5,968 | 🐛 8 | 🌐 SCSS | 📅 2025-06-02
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,650 | 🐛 314 | 🌐 JavaScript | 📅 2026-04-08: A simple and modern GTK eBook viewer, built with GJS and Epub.js.
* [BitsOfBytes](https://github.com/vivaladav/BitsOfBytes) ⭐ 117 | 🐛 1 | 🌐 C++ | 📅 2020-08-19: Code and projects from my blog posts.
...
* [Atelier](https://github.com/kde/atelier) ⭐ 34 | 🐛 0 | 🌐 C++ | 📅 2026-08-20: Open Source 3D Printing Host - User Interface
...
* [A curated list of awesome Python frameworks, libraries, software and resources](https://github.com/vinta/awesome-python#authentication) ⭐ 315,168 | 🐛 17 | 🌐 Python | 📅 2026-08-16
* [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) ⭐ 223,902 | 🐛 1,047 | 🌐 Python | 📅 2026-08-03: All Algorithms implemented in Python
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,737 | 🐛 74 | 🌐 Python | 📅 2026-08-19 framework, high performance, easy to learn, fast to code, ready for production
* cython [dtoa.c](https://github.com/python/cpython/blob/master/Python/dtoa.c) ⭐ 74,453 | 🐛 9,559 | 🌐 Python | 📅 2026-08-21
* [Rich](https://github.com/willmcgugan/rich) ⭐ 57,100 | 🐛 371 | 🌐 Python | 📅 2026-06-23 is a Python library for rich text and beautiful formatting in the terminal.
* [black](https://github.com/ambv/black/) ⭐ 41,814 | 🐛 299 | 🌐 Python | 📅 2026-08-20: The uncompromising Python code formatter
* [wtfpython](https://github.com/satwikkansal/wtfpython#-is-not--is-not-is-not-) ⭐ 37,058 | 🐛 72 | 🌐 Python | 📅 2026-01-13: A collection of surprising Python snippets and lesser-known features.
* [wtfpython](https://github.com/satwikkansal/wtfpython) ⭐ 37,058 | 🐛 72 | 🌐 Python | 📅 2026-01-13: What the f\*ck Python? ￼
* [Course Files for Complete Python 3 Bootcamp Course on Udemy](https://github.com/Pierian-Data/Complete-Python-3-Bootcamp) ⭐ 29,718 | 🐛 267 | 🌐 Jupyter Notebook | 📅 2025-06-24
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,293 | 🐛 412 | 🌐 Rust | 📅 2026-08-20A Python Interpreter written in Rust
* [kivy](https://github.com/kivy/kivy) ⭐ 19,003 | 🐛 853 | 🌐 Python | 📅 2026-08-20: Open source UI framework written in Python, running on Windows, Linux, macOS, Android and iOS.
...
* [cinder](https://github.com/facebookincubator/cinder) ⭐ 3,789 | 🐛 33 | 🌐 Python | 📅 2026-08-20
...
* [OpenTelemetry Python](https://github.com/open-telemetry/opentelemetry-python) ⭐ 2,593 | 🐛 389 | 🌐 Python | 📅 2026-08-20: OpenTelemetry Python API and SDK
* [austin](https://github.com/P403n1x87/austin) ⭐ 2,210 | 🐛 8 | 🌐 C | 📅 2026-08-19: Python frame stack sampler for CPython. Austin has a [tui](https://github.com/P403n1x87/austin-tui) ⭐ 665 | 🐛 2 | 🌐 Python | 📅 2026-06-04: The top-like text-based user interface for Austin.
...
* [wallaroo](https://github.com/WallarooLabs/wallaroo) ⭐ 1,483 | 🐛 348 | 🌐 Pony | 📅 2021-04-06: Build and scale real-time data applications as easily as writing a Python script - by [wallaroo labs](https://www.wallaroolabs.com/)
...
* [Yet Another Roguelike Tutorial - Written in Python 3 and TCOD](http://rogueliketutorials.com/tutorials/tcod/v2/). [python-tcod](https://github.com/libtcod/python-tcod) ⭐ 477 | 🐛 6 | 🌐 Python | 📅 2026-07-20: A high-performance Python port of libtcod. Includes the libtcodpy module for backwards compatibility with older projects.
...
* [AMIE](https://github.com/NeatMonster/AMIE) ⭐ 204 | 🐛 4 | 🌐 Python | 📅 2024-08-16: A Minimalist Instruction Extender
...
* Agda:
  * [Agda 2](https://github.com/agda/agda) ⭐ 2,915 | 🐛 1,033 | 🌐 Haskell | 📅 2026-08-20
  * [plfa](https://github.com/plfa/plfa.github.io/) ⭐ 1,513 | 🐛 66 | 🌐 Agda | 📅 2026-08-20: Introduction to programming language theory in Agda and [Programming Language Foundations in Agda](https://plfa.github.io/).
* Anglican:
...
* Dafny:
  * [dafny](https://github.com/Microsoft/dafny) ⭐ 3,508 | 🐛 1,378 | 🌐 C# | 📅 2026-08-16: Dafny is a verification-aware programming language.
* Clean:
...
* Elixir:
  * [Nerves](https://github.com/nerves-project/nerves) ⭐ 2,484 | 🐛 22 | 🌐 Elixir | 📅 2026-08-20: Craft and deploy bulletproof embedded software in Elixir. [official site](http://nerves-project.org)
...
* Go:
  * [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 181,729 | 🐛 215 | 🌐 Go | 📅 2026-08-20: A curated list of awesome Go frameworks, libraries and software
...
* Lua:
  * [xmake](https://github.com/xmake-io/xmake) ⭐ 12,154 | 🐛 249 | 🌐 Lua | 📅 2026-08-20: 🔥 A cross-platform build [utility based on Lua](https://xmake.io)
* Nim:
  * [nim](https://nim-lang.org/): Efficient and expressive programming. [github](https://github.com/nim-lang/nim) ⭐ 18,178 | 🐛 2,193 | 🌐 Nim | 📅 2026-08-20
* Perl:
...
* PHP:
  * [A curated list of bookmarks, packages, tutorials, videos and other cool resources from the Laravel ecosystem](https://github.com/chiraggude/awesome-laravel) ⭐ 13,096 | 🐛 86 | 📅 2024-07-03
...
* Ruby:
  * [Radiation-hardened Quine](https://github.com/mame/radiation-hardened-quine) ⭐ 709 | 🐛 3 | 🌐 Ruby | 📅 2021-09-06: A robust quine program that works even after any one character is deleted.
...
* Rust:
  * [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 58,910 | 🐛 7 | 🌐 Rust | 📅 2026-08-20: A curated list of Rust code and resources.
...
* V:
  * [V](https://github.com/vlang-io/V) ⭐ 37,798 | 🐛 95 | 🌐 V | 📅 2026-08-20: Simple, fast, safe, compiled language for creating maintainable software. Supports translation from C/C++.
  * [vlang](https://github.com/vlang/v) ⭐ 37,798 | 🐛 95 | 🌐 V | 📅 2026-08-20: Simple, fast, safe, compiled language for developing maintainable software. Supports translation from C and (soon) C++. Compiles itself in <1s.
* Verilog:
...
* Starting Pull Requests:
  * [Awesome First PR Opportunities](https://github.com/MunGell/awesome-for-beginners) ⭐ 88,567 | 🐛 144 | 📅 2026-07-25
...
* [.gitignore](https://github.com/github/gitignore) ⭐ 175,377 | 🐛 84 | 📅 2026-07-23: A collection of useful .gitignore templates
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,509 | 🐛 1,025 | 🌐 Go | 📅 2026-08-20: simple terminal UI for git commands
* [gitea](https://github.com/go-gitea/gitea) ⭐ 57,523 | 🐛 2,539 | 🌐 Go | 📅 2026-08-21: Git with a cup of tea, painless self-hosted git service
* [gogs](https://github.com/gogs/gogs) ⭐ 47,748 | 🐛 1,010 | 🌐 Go | 📅 2026-08-06: Gogs is a painless self-hosted Git service.
* [github-cli](https://github.com/cli/cli) ⭐ 45,910 | 🐛 1,078 | 🌐 Go | 📅 2026-08-20:  GitHub’s official command line tool
* [husky](https://github.com/typicode/husky) ⭐ 35,277 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19: Git hooks made easy
* [Learn git branching](https://learngitbranching.js.org/): An interactive git visualization to challenge and educate! [github](https://github.com/pcottle/learnGitBranching) ⭐ 33,911 | 🐛 60 | 🌐 JavaScript | 📅 2026-08-20.
* [cz-cli](https://github.com/commitizen/cz-cli) ⭐ 17,499 | 🐛 194 | 🌐 JavaScript | 📅 2026-08-11: The commitizen command line utility.
* [lint-staged](https://github.com/okonet/lint-staged) ⭐ 14,714 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-19: Run linters on git staged files
...
* [devhub](https://github.com/devhubapp/devhub) ⭐ 10,122 | 🐛 102 | 🌐 TypeScript | 📅 2024-09-07: DevHub: TweetDeck for GitHub - Android, iOS and Web 👉
* [Pro Git book](https://git-scm.com/book/en/v2), written by Scott Chacon and Ben Straub ([github](https://github.com/progit/progit2) ⭐ 6,563 | 🐛 218 | 🌐 CSS | 📅 2026-05-25 repo)
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,062 | 🐛 14 | 🌐 Shell | 📅 2026-08-21 is a utility tool for git taking advantage of fuzzy finder fzf. [Interactive Git Commands With Previews Powered By fzf Fuzzy Finder](https://www.linuxuprising.com/2019/11/forgit-interactive-git-commands-with.html)
* [git-sizer](https://github.com/github/git-sizer/) ⭐ 4,071 | 🐛 18 | 🌐 Go | 📅 2026-01-16: Compute various size metrics for a Git repository, flagging those that might cause problems ( [article](https://blog.github.com/2018-03-05-measuring-the-many-sizes-of-a-git-repository/))
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,923 | 🐛 36 | 🌐 Python | 📅 2026-07-06: Manage multiple git repos side by side for sanity
* [Git4Noobs](https://github.com/DanielHe4rt/git4noobs) ⭐ 1,610 | 🐛 3 | 📅 2024-09-28
* [Forge](https://github.com/magit/forge/) ⭐ 1,569 | 🐛 9 | 🌐 Emacs Lisp | 📅 2026-08-15: Work with Git forges from the comfort of Magit
...
* GitHub Profiles:
  * [Awesome Readme Stats](https://github.com/anmol098/waka-readme-stats) ⭐ 3,983 | 🐛 65 | 🌐 Python | 📅 2026-08-04
...
* [SkyWater Open Source PDK](https://github.com/google/skywater-pdk) ⭐ 3,659 | 🐛 199 | 🌐 Python | 📅 2026-07-21: Open source process design kit for usage with SkyWater Technology Foundry's 130nm node.
* [Ariane is a 6-stage RISC-V CPU](https://github.com/pulp-platform/ariane) ⭐ 3,070 | 🐛 269 | 🌐 Assembly | 📅 2026-08-20
* [cva6](https://github.com/openhwgroup/cva6) ⭐ 3,070 | 🐛 269 | 🌐 Assembly | 📅 2026-08-20: The CORE-V CVA6 is an Application class 6-stage RISC-V CPU capable of booting Linux.
...
* [NyuziProcessor](https://github.com/jbush001/NyuziProcessor/) ⭐ 2,215 | 🐛 91 | 🌐 C | 📅 2024-11-08: GPGPU microprocessor architecture
* [RARS](https://github.com/TheThirdOne/rars) ⭐ 1,614 | 🐛 76 | 🌐 Java | 📅 2024-07-19: RISC-V Assembler and Runtime Simulator.
* [The Zip CPU](https://github.com/ZipCPU/zipcpu) ⭐ 1,574 | 🐛 3 | 🌐 Verilog | 📅 2026-08-19: A small, light weight, RISC CPU soft core
...
* [vm80a](https://github.com/1801BM1/vm80a) ⭐ 167 | 🐛 0 | 🌐 Verilog | 📅 2019-07-13: i8080 precise replica in Verilog, based on reverse engineering of real die.
...
* [Circuit Simulator](http://www.lushprojects.com/circuitjs/). [github](https://github.com/sharpie7/circuitjs1) ⭐ 2,930 | 🐛 266 | 🌐 Java | 📅 2024-01-22.
...
* [How to create an OS from scratch](https://github.com/cfenollosa/os-tutorial) ⭐ 30,655 | 🐛 130 | 🌐 C | 📅 2026-02-04
...
* [GraalVM](https://github.com/oracle/graal) ⭐ 21,668 | 🐛 848 | 🌐 Java | 📅 2026-08-21: GraalVM is a universal virtual machine for running applications written in JavaScript, Python, Ruby, R, JVM-based languages like Java, Scala, Clojure, Kotlin, and LLVM-based languages such as C and C++. [GraalVM Implementation of Python](https://github.com/graalvm/graalpython) ⭐ 1,636 | 🐛 57 | 🌐 Python | 📅 2026-08-20
* [Compiler Explorer](https://godbolt.org/): Run compilers interactively from your web browser and interact with the assembly. [github](https://github.com/mattgodbolt/compiler-explorer) ⭐ 18,989 | 🐛 841 | 🌐 TypeScript | 📅 2026-08-20, [how it works](https://xania.org/201609/how-compiler-explorer-runs-on-amazon).
...
* (pt-br) [Do zero a implantação](https://github.com/cassiobotaro/do_zero_a_implantacao): utilizando Python. [Construindo API's robustas utilizando Python](https://github.com/luizalabs/tutorial-python-brasil) ⭐ 359 | 🐛 2 | 🌐 Python | 📅 2021-11-23 []()

## Distributed Systems

* [FASTER](https://github.com/Microsoft/FASTER) ⭐ 6,638 | 🐛 35 | 🌐 C# | 📅 2026-08-19: Fast key-value store from Microsoft Research
* [porcupine](https://github.com/anishathalye/porcupine/) ⭐ 1,238 | 🐛 4 | 🌐 Go | 📅 2026-08-06: A fast linearizability checker written in Go
...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,055 | 🐛 486 | 🌐 C++ | 📅 2026-08-17: Tesseract Open Source OCR Engine (main repository)
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,927 | 🐛 530 | 🌐 Python | 📅 2025-12-05: Ready-to-use OCR with 40+ languages supported including Chinese, Japanese, Korean and Thai.
* [annoy](https://github.com/spotify/annoy) ⭐ 14,285 | 🐛 84 | 🌐 C++ | 📅 2025-10-29: Approximate Nearest Neighbors in C++/Python optimized for memory usage and loading/saving to disk
...
* [faceswap](https://github.com/deepfakes/faceswap) ⭐ 57,468 | 🐛 14 | 🌐 Python | 📅 2026-08-05: Non official project based on original /r/Deepfakes thread. Many thanks to him!
* [Jina](https://github.com/jina-ai/jina) ⭐ 21,860 | 🐛 26 | 🌐 Python | 📅 2025-03-24: Cloud-native neural search framework for any kind of data.
...
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,781 | 🐛 56 | 🌐 C++ | 📅 2026-06-28: An open source library for face detection in images. The face detection speed can reach 1500FPS.
...
* [donkeycar](https://github.com/autorope/donkeycar) ⭐ 3,493 | 🐛 134 | 🌐 Python | 📅 2026-08-17: Open source hardware and software platform to build a small scale self driving car.
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 164,286 | 🐛 2,400 | 🌐 Python | 📅 2026-08-21: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch.
* [nanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,262 | 🐛 351 | 🌐 Python | 📅 2025-11-12: The simplest, fastest repository for training/finetuning medium-sized GPTs.
* [Industrial-strength Natural Language Processing (NLP) with Python and Cython](https://github.com/explosion/spaCy/) ⭐ 33,836 | 🐛 236 | 🌐 Python | 📅 2026-08-07
* [flair](https://github.com/zalandoresearch/flair) ⭐ 14,380 | 🐛 31 | 🌐 Python | 📅 2025-10-27: A very simple framework for state-of-the-art Natural Language Processing (NLP)
...
* [RecipeNLG](https://github.com/Glorf/recipenlg) ⭐ 628 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2022-03-07: A Cooking Recipes Dataset for Semi-Structured Text Generation
...
* [Real-Time Voice Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning) ⭐ 60,093 | 🐛 177 | 🌐 Python | 📅 2026-03-09: Clone a voice in 5 seconds to generate arbitrary speech in real-time
...
* [Homemade Machine Learning](https://github.com/trekhleb/homemade-machine-learning) ⭐ 24,770 | 🐛 30 | 🌐 Jupyter Notebook | 📅 2025-11-23: 🤖 Python examples of popular machine learning algorithms with interactive Jupyter demos and math being explained
...
* [DeepMind Research](https://github.com/deepmind/deepmind-research) ⭐ 15,158 | 🐛 341 | 🌐 Jupyter Notebook | 📅 2026-06-17: This repository contains implementations and illustrative code to accompany DeepMind publications.
* [vosk-api](https://github.com/alphacep/vosk-api) ⭐ 15,066 | 🐛 601 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API for Android, iOS, Raspberry Pi and servers with Python, Java, C# and Node.
* [Transfer Learning](https://github.com/jindongwang/transferlearning) ⭐ 14,349 | 🐛 24 | 🌐 Python | 📅 2025-02-18: Everything about Transfer Learning and Domain Adaptation--迁移学习
* [CARLA](https://carla.org): Open-source simulator for [autonomous driving research](https://github.com/carla-simulator/carla) ⭐ 14,307 | 🐛 1,193 | 🌐 C++ | 📅 2026-08-20.
* [Python Machine Learning (2nd Ed.) Code Repository](https://github.com/rasbt/python-machine-learning-book-2nd-edition) ⭐ 7,197 | 🐛 32 | 🌐 Jupyter Notebook | 📅 2020-10-01: The "Python Machine Learning (2nd edition)" book code repository and info resource
* [60\_Days\_RL\_Challenge](https://github.com/andri27-ts/60_Days_RL_Challenge) ⭐ 4,733 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2020-06-30: Learn Deep Reinforcement Learning in depth in 60 days
* [make-sense](https://github.com/SkalskiP/make-sense) ⭐ 3,562 | 🐛 132 | 🌐 TypeScript | 📅 2024-08-15: [Free to use online tool for labelling photos](https://makesense.ai).
...
* [GAN Lab](https://poloclub.github.io/ganlab/): Play with Generated Adversarial Networks (GANs) in your browser! [repo](https://github.com/poloclub/ganlab) ⭐ 1,533 | 🐛 27 | 🌐 JavaScript | 📅 2026-03-22
...
* [CFU Playground](https://github.com/google/CFU-Playground) ⭐ 560 | 🐛 142 | 🌐 Verilog | 📅 2026-02-26: Want a faster ML processor? Do it yourself! -- A framework for playing with custom opcodes to accelerate TensorFlow Lite for Microcontrollers (TFLM).
...
* Autonomous Vehicles:
  * [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,413 | 🐛 780 | 🌐 C++ | 📅 2026-06-30: Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
...
* [mit-deep-learning](https://github.com/lexfridman/mit-deep-learning) ⭐ 10,450 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2024-01-03: Tutorials, assignments, and competitions for MIT Deep Learning related courses.
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,350 | 🐛 1,008 | 🌐 C# | 📅 2026-08-17: is an open source and cross-platform machine learning framework for .NET.
* [DeepLabCut](http://www.mackenziemathislab.org/deeplabcut): is an efficient method for 3D markerless pose estimation based on transfer learning with deep neural networks that achieves excellent results (i.e. you can match human labeling accuracy) with minimal training data (typically 50-200 frames). [repo](https://github.com/DeepLabCut/DeepLabCut) ⭐ 5,742 | 🐛 50 | 🌐 Python | 📅 2026-08-20
* [Is a Green Screen Really Necessary for Real-Time Human Matting?](https://arxiv.org/pdf/2011.11961.pdf), [repo](https://github.com/ZHKKKe/MODNet) ⭐ 4,351 | 🐛 71 | 🌐 Python | 📅 2024-05-06
* [Nevergrad](https://code.fb.com/ai-research/nevergrad/): An open source tool for derivative-free optimization. [github](https://github.com/facebookresearch/nevergrad) ⭐ 4,203 | 🐛 142 | 🌐 Python | 📅 2026-07-24
...
* [Stable Diffusion](https://github.com/CompVis/stable-diffusion) ⭐ 73,330 | 🐛 618 | 🌐 Jupyter Notebook | 📅 2024-06-18: is a latent text-to-image diffusion model. Thanks to a generous compute donation from Stability AI and support from LAION, we were able to train a Latent Diffusion Model on 512x512 images from a subset of the LAION-5B database.
* [Wan](https://github.com/Wan-Video/Wan2.2) ⭐ 17,223 | 🐛 291 | 🌐 Python | 📅 2026-03-17: Open and Advanced Large-Scale Video Generative Models
* [Bbrain.js](https://github.com/BrainJS/brain.js) ⭐ 14,864 | 🐛 90 | 🌐 TypeScript | 📅 2024-09-26: 🤖 Neural networks in JavaScript
* [Paddle Fluid](https://www.paddlepaddle.org.cn/) with [Pre-trained and Reproduced Deep Learning Models](https://github.com/PaddlePaddle/models) ⭐ 6,932 | 🐛 870 | 🌐 Python | 📅 2025-01-15, [ERNIE](https://github.com/PaddlePaddle/ERNIE) ⭐ 7,736 | 🐛 82 | 🌐 Python | 📅 2026-07-24:  An Implementation of ERNIE For Language Understanding (including Pre-training models and Fine-tuning tools).
* [Deep Convolutional Generative Adversarial Network](https://www.tensorflow.org/tutorials/generative/dcgan) [jupyter notebook](https://github.com/tensorflow/docs/blob/master/site/en/tutorials/generative/dcgan.ipynb) ⭐ 6,326 | 🐛 68 | 🌐 Jupyter Notebook | 📅 2026-07-09
* [Image Deduplicator](https://idealo.github.io/imagededup/): [imagededup](https://github.com/idealo/imagededup) ⭐ 5,665 | 🐛 38 | 🌐 Python | 📅 2025-08-15 is a python package that simplifies the task of finding exact and near duplicates in an image collection.
...
* [Handwriting Synthesis](https://github.com/sjvasquez/handwriting-synthesis) ⭐ 4,799 | 🐛 63 | 🌐 Python | 📅 2024-01-11
* [Random Forest vs Neural Network](https://mljar.com/blog/random-forest-vs-neural-network-classification/)(classification, tabular data) - [github](https://github.com/mljar/mljar-supervised) ⭐ 3,284 | 🐛 129 | 🌐 Python | 📅 2026-07-27
...
* [NEST](https://github.com/nest/nest-simulator) ⭐ 658 | 🐛 228 | 🌐 C++ | 📅 2026-08-19: NEST is a simulator for spiking neural network models that focuses on the dynamics, size and structure of neural systems rather than on the exact morphology of individual neurons.
...
* [fiftyone](https://github.com/voxel51/fiftyone) ⭐ 11,024 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-21: The open-source tool for building high-quality datasets and computer vision models
* [Pythia](https://github.com/facebookresearch/pythia) ⭐ 5,633 | 🐛 150 | 🌐 Python | 📅 2026-07-07: A software suite for Visual Question Answering.
...
* [OpenSimpleLidar](https://github.com/iliasam/OpenSimpleLidar) ⭐ 2,554 | 🐛 1 | 🌐 C | 📅 2025-07-22: Open Hardware scanning laser rangefinder ([howto](https://hackaday.io/project/20628-open-simple-lidar))
...
* [gradslam](https://github.com/gradslam/gradslam) ⭐ 1,422 | 🐛 18 | 🌐 Python | 📅 2023-09-02: gradslam is an open source differentiable dense SLAM library for PyTorch
...
*Frameworks for Neural Networks and Deep Learning. See: [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,788 | 🐛 84 | 📅 2025-05-26.*

* [Keras](https://github.com/fchollet/keras) ⭐ 64,241 | 🐛 226 | 🌐 Python | 📅 2026-08-20 - A high-level neural networks library and capable of running on top of either TensorFlow or Theano.
...
* [Theano](https://github.com/Theano/Theano) ⭐ 9,998 | 🐛 699 | 🌐 Python | 📅 2024-01-15 - A library for fast numerical computation.
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,504 | 🐛 17,205 | 🌐 Python | 📅 2026-08-21: Tensors and Dynamic neural networks in Python with strong GPU acceleration a ([tour](http://blog.christianperone.com/2018/03/pytorch-internal-architecture-tour/)):
* [tinygrad](https://github.com/geohot/tinygrad) ⭐ 33,474 | 🐛 181 | 🌐 Python | 📅 2026-08-21: You like pytorch? You like [micrograd](https://github.com/karpathy/micrograd) ⭐ 17,212 | 🐛 78 | 🌐 Jupyter Notebook | 📅 2026-08-03? You love tinygrad! ❤️
* [vid2vid](https://github.com/NVIDIA/vid2vid) ⭐ 8,692 | 🐛 110 | 🌐 Python | 📅 2022-05-17: Pytorch implementation of our method for high-resolution (e.g. 2048x1024) photorealistic video-to-video translation.
* [Alias-Free Generative Adversarial Networks (StyleGAN3)](https://github.com/NVlabs/stylegan3) ⭐ 6,941 | 🐛 192 | 🌐 Python | 📅 2023-09-12: Official PyTorch implementation of StyleGAN3.
* [Deep-reinforcement-learning-with-pytorch](https://github.com/sweetice/Deep-reinforcement-learning-with-pytorch) ⭐ 4,652 | 🐛 29 | 🌐 Python | 📅 2023-03-24: PyTorch implementation of DQN, AC, ACER, A2C, A3C, PG, DDPG, TRPO, PPO, SAC, TD3 and ....
...
* [nnAudio](https://github.com/KinWaiCheuk/nnAudio) ⭐ 1,127 | 🐛 21 | 🌐 Python | 📅 2026-05-21: Audio processing by using pytorch 1D convolution network
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,108 | 🐛 3,134 | 🌐 C++ | 📅 2026-08-21 - The most popular Deep Learning framework created by Google.
* [BERT](https://github.com/google-research/bert) ⚠️ Archived: TensorFlow code and pre-trained models for BERT
* [Machine Learning Notebooks](https://github.com/ageron/handson-ml2) ⭐ 29,954 | 🐛 230 | 🌐 Jupyter Notebook | 📅 2026-05-19: A series of Jupyter notebooks that walk you through the fundamentals of Machine Learning and Deep Learning in Python using Scikit-Learn, Keras and TensorFlow 2.
* [TensorFlow-Course](https://github.com/open-source-for-science/TensorFlow-Course) ⭐ 16,279 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2022-11-28: Simple and ready-to-use tutorials for TensorFlow
* [Ludwig](https://github.com/uber/ludwig) ⭐ 11,747 | 🐛 1 | 🌐 Python | 📅 2026-08-17: [is a toolbox built](https://uber.github.io/ludwig/) on top of TensorFlow that allows to train and test deep learning models without the need to write code.
...
* [tensorFlow Privacy](https://github.com/tensorflow/privacy) ⭐ 2,022 | 🐛 136 | 🌐 Python | 📅 2026-08-19: Library for training machine learning models with privacy for training data
...
* Good channels:
  * [3blue1brown](https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw/): 3blue1brown, by Grant Sanderson, is some combination of math and entertainment, depending on your disposition ([site](https://www.3blue1brown.com/)) and [manim](https://github.com/3b1b/manim) ⭐ 91,779 | 🐛 487 | 🌐 Python | 📅 2026-08-18(Animation engine for explanatory math videos).
...
* [The Data Engineering Cookbook](https://github.com/andkret/Cookbook) ⭐ 15,343 | 🐛 128 | 🌐 Python | 📅 2026-07-23
* [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,290 | 🐛 1,345 | 🌐 Python | 📅 2026-08-20: Official repository for Spyder - The Scientific Python Development Environment
...
* [ferret](https://github.com/MontFerret/ferret) ⭐ 6,008 | 🐛 11 | 🌐 Go | 📅 2026-08-20: Declarative web scraping
* [RAPIDS](http://rapids.ai): Open GPU Data Science. The RAPIDS suite of software libraries gives you the freedom to execute end-to-end data science and analytics pipelines entirely on GPUs. It relies on NVIDIA® CUDA® primitives for low-level compute optimization, but exposes that GPU parallelism and high-bandwidth memory speed through user-friendly Python interfaces. [cuml](https://github.com/rapidsai/cuml) ⭐ 5,257 | 🐛 839 | 🌐 Python | 📅 2026-08-21 - RAPIDS Machine Learning Library.
* [Dask tutorial](https://github.com/dask/dask-tutorial) ⭐ 1,858 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2025-11-04
* [easystats](https://github.com/easystats/easystats) ⭐ 1,159 | 🐛 46 | 🌐 R | 📅 2026-08-05: milky\_way The easyverse.
...
* [insight](https://github.com/easystats/insight) ⭐ 439 | 🐛 61 | 🌐 R | 📅 2026-08-20: Easy access to model information for various model objects.
...
* Python:
  ...
  * [pyjanitor](https://github.com/ericmjl/pyjanitor) ⭐ 1,499 | 🐛 126 | 🌐 Python | 📅 2026-08-21: Python implementation of R package Janitor
  ...
  * [Python Plotting for Exploratory Data Analysis](https://pythonplot.com/)  by [Tim Hopper](https://twitter.com/tdhopper/status/1212821555710963712) [repo](https://github.com/tdhopper/pythonplot.com) ⭐ 113 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-08-19
...
* Jupyter:
  ...
  * [The Jupyter Notebooks behind: "A Whirlwind Tour of Python"](https://github.com/jakevdp/WhirlwindTourOfPython) ⭐ 4,028 | 🐛 25 | 🌐 Jupyter Notebook | 📅 2024-01-31
  * [nbviewer](https://github.com/jupyter/nbviewer) ⭐ 2,280 | 🐛 204 | 🌐 Python | 📅 2026-07-06 as a web service: Render Jupyter Notebooks as static web pages.
...
* R Lang
  * [brms](https://github.com/paul-buerkner/brms) ⭐ 1,423 | 🐛 157 | 🌐 R | 📅 2026-08-20: R package for Bayesian generalized multivariate non-linear multilevel models using Stan
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,767 | 🐛 891 | 🌐 Go | 📅 2026-08-20: The Prometheus monitoring system and time series database.
* [dart](https://github.com/unit8co/darts) ⭐ 9,496 | 🐛 223 | 🌐 Python | 📅 2026-08-20: A python library for easy manipulation and forecasting of time series.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,123 | 🐛 159 | 🌐 C++ | 📅 2026-08-10: The Time Series Visualization Tool that you deserve.
...
* [palmerpenguins](https://github.com/allisonhorst/palmerpenguins) ⭐ 1,015 | 🐛 18 | 🌐 R | 📅 2024-09-19: A great intro dataset for data exploration & visualization (alternative to iris).
...
* (pt-br) [Base dos Dados Mais](https://basedosdados.github.io/mais/): Mecanismo de busca e repositório de [bases de dados](https://github.com/basedosdados/mais/) ⭐ 423 | 🐛 33 | 🌐 SQL | 📅 2026-07-24 brasileiras e internacionais.
...
* [amsterdam-schema](https://github.com/Amsterdam/amsterdam-schema) ⭐ 21 | 🐛 4 | 🌐 Python | 📅 2026-08-20: Data modeling & verification for the City of Amsterdam's open data - based on JSON Schema
...
* [ImageMagick creates huge temporary files · Issue #395 · ImageMagick/ImageMagick](https://github.com/ImageMagick/ImageMagick/issues/395) ⭐ 17,194 | 🐛 162 | 🌐 C | 📅 2026-08-20
...
* [OpenSubdiv](http://graphics.pixar.com/opensubdiv/docs/intro.html) ([github](https://github.com/PixarAnimationStudios/OpenSubdiv) ⭐ 3,072 | 🐛 58 | 🌐 C++ | 📅 2026-08-19): is a set of open source libraries that implement high performance subdivision surface (subdiv) evaluation on massively parallel CPU and GPU architectures.
...
* [Pseudo-bandlimited pixel art filtering in 3D – a mathematical derivation](http://themaister.net/blog/2018/08/25/pseudo-bandlimited-pixel-art-filtering-in-3d-a-mathematical-derivation/) [github](https://github.com/Themaister/Granite) ⭐ 1,939 | 🐛 2 | 🌐 C++ | 📅 2026-08-15
* [see](https://github.com/easystats/see) ⭐ 952 | 🐛 32 | 🌐 R | 📅 2026-08-04 Visualisation toolbox for beautiful and publication-ready figures
* [JPEG \[JAY-peg\]](https://github.com/corkami/docs/blob/master/images/jpeg.md) ⭐ 831 | 🐛 6 | 🌐 TeX | 📅 2024-05-04, some pocs [JPEG PoCs](https://github.com/corkami/pocs/blob/master/images/jpg/README.md) ⭐ 1,556 | 🐛 7 | 🌐 Assembly | 📅 2024-12-22
* [Blender-power-sequencer](https://github.com/GDquest/Blender-power-sequencer/) ⭐ 727 | 🐛 10 | 🌐 Python | 📅 2026-01-16: Video editing add-on for Blender
...
* GGplot2:
  * [ggeffects](https://github.com/strengejacke/ggeffects) ⭐ 607 | 🐛 62 | 🌐 R | 📅 2026-08-19: Tidy Data Frames of Marginal Effects for ggplot2.
  * [ggalluvial](https://github.com/corybrunson/ggalluvial) ⭐ 522 | 🐛 20 | 🌐 R | 📅 2026-07-31
  * [ggseg](https://github.com/LCBC-UiO/ggseg) ⭐ 270 | 🐛 2 | 🌐 R | 📅 2026-08-10: Plotting tool for brain atlases, in ggplot.
...
* Color Palettes:
  * [wesanderson](https://github.com/karthik/wesanderson) ⭐ 2,149 | 🐛 23 | 🌐 R | 📅 2024-06-13: A Wes Anderson color palette for R.
...
* [jax](https://github.com/google/jax) ⭐ 36,186 | 🐛 2,466 | 🌐 Python | 📅 2026-08-21: Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more
* [micro](https://micro-editor.github.io/): a modern and intuitive [terminal-based text editor](https://github.com/zyedidia/micro#linux-clipboard-support) ⭐ 29,404 | 🐛 1,033 | 🌐 Go | 📅 2026-08-21.
* [pyodide](https://github.com/iodide-project/pyodide) ⭐ 14,797 | 🐛 399 | 🌐 Python | 📅 2026-08-19: The Python scientific stack, compiled to WebAssembly
* [libvips](https://github.com/libvips/libvips) ⭐ 11,584 | 🐛 82 | 🌐 C | 📅 2026-08-20: A fast image processing library with low memory needs.
...
* [hatetris](https://github.com/qntm/hatetris) ⭐ 892 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-20: Tetris which always gives you the worst piece
...
* [WASM SYNTH, or, how music taught me the beauty of math](https://timdaub.github.io/2020/02/19/wasm-synth/#f1) [repo](https://github.com/TimDaub/wasm-synth) ⭐ 129 | 🐛 15 | 🌐 JavaScript | 📅 2023-03-02
...
* [This program generates bitmaps that are locally similar to the input bitmap](https://github.com/mxgmn/WaveFunctionCollapse) ⭐ 25,280 | 🐛 9 | 🌐 C# | 📅 2026-03-22
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,960 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13: Easily add particles animations to your website. Compatible also with React, Vue.js (2.x and 3.x), Angular, Svelte, jQuery, Preact, Inferno.
* [Walk through an infinite, procedurally generated city](https://github.com/marian42/wavefunctioncollapse) ⭐ 4,856 | 🐛 9 | 🌐 C# | 📅 2021-03-28
* [An interactive, explorable explanation about the peculiar magic of sound waves.](https://github.com/joshwcomeau/waveforms) ⭐ 1,481 | 🐛 4 | 🌐 JavaScript | 📅 2018-02-21
* [SOFA](https://www.sofa-framework.org/): is an efficient framework dedicated to research, prototyping and development of physics-based simulations. [github](https://github.com/sofa-framework/sofa/) ⭐ 1,247 | 🐛 448 | 🌐 C++ | 📅 2026-08-18.
...
* [gqrx](https://gqrx.dk/): is an open source software defined radio receiver (SDR) powered by the GNU Radio and the Qt graphical toolkit. [Gqrx](https://github.com/csete/gqrx) ⭐ 3,657 | 🐛 264 | 🌐 C++ | 📅 2026-08-06
...
* [astroquery](https://github.com/astropy/astroquery) ⭐ 789 | 🐛 413 | 🌐 Python | 📅 2026-08-13: Functions and classes to access online data resources. Maintainers: @keflavich and @bsipocz and @ceb8
...
* [Open MCT](https://nasa.github.io/openmct/): is a next-generation mission control framework for visualization of data on desktop and mobile devices - [github](https://github.com/nasa/openmct) ⭐ 13,086 | 🐛 1,069 | 🌐 JavaScript | 📅 2026-08-20
* [fprime](https://github.com/nasa/fprime) ⭐ 11,679 | 🐛 442 | 🌐 C++ | 📅 2026-08-20: A flight software and embedded systems framework.
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,591 | 🐛 16 | 🌐 Prolog | 📅 2026-08-13: A build-it-yourself, 6-wheel rover based on the rovers on Mars!
...
* [MNE-Python](https://github.com/mne-tools/mne-python) ⭐ 3,488 | 🐛 637 | 🌐 Python | 📅 2026-08-20: Magnetoencephalography (MEG) and Electroencephalography (EEG) in Python
...
* [baltic](https://github.com/evogytis/baltic) ⭐ 128 | 🐛 5 | 🌐 Python | 📅 2026-08-20: backronymed adaptable lightweight tree import code for molecular phylogeny manipulation, analysis and visualisation. Development is back on the evogytis/baltic branch (i.e. here).
* [Seraphim](http://evolve.zoo.ox.ac.uk/Evolve/Seraphim.html): Studying Environmental Rasters And PHylogenetically Informed Movements. [seraphim](https://github.com/evogytis/baltic) ⭐ 128 | 🐛 5 | 🌐 Python | 📅 2026-08-20 is a R package for studying environmental rasters and phylogenetic informed movements
...
* [S2Geometry](http://s2geometry.io/): S2 is a library for spherical geometry that aims to have the same robustness, flexibility, and performance as the very best planar geometry libraries [github](https://github.com/google/s2geometry) ⭐ 2,710 | 🐛 76 | 🌐 C++ | 📅 2026-08-18.
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 938 | 🐛 19 | 🌐 R | 📅 2026-08-14: Easy access to shapefiles of the Brazilian Institute of Geography and Statistics (IBGE) and other official spatial data sets of Brazil.
...
* [Awesome Blockchain](https://github.com/yjjnls/awesome-blockchain) ⭐ 3,626 | 🐛 52 | 🌐 Go | 📅 2024-03-22: Curated list of resources for the development and applications of blockchain.
...
* [Memex](https://worldbrain.io/#) - your photographic memory for the web. Open-Source. Private. [repo](https://github.com/WorldBrain/Memex) ⭐ 4,716 | 🐛 319 | 🌐 TypeScript | 📅 2025-12-02
...
* [Awesome-Design-Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 40,938 | 🐛 186 | 🌐 JavaScript | 📅 2024-07-28: The best design tools for everything.
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,416 | 🐛 285 | 🌐 C++ | 📅 2026-08-21:Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
...
* [Perceptual image hashing for PHP](https://github.com/jenssegers/imagehash) ⭐ 2,061 | 🐛 39 | 🌐 PHP | 📅 2025-09-17
...
* [BIM\_Workbench](https://github.com/yorikvanhavre/BIM_Workbench) ⭐ 400 | 🐛 29 | 🌐 Python | 📅 2024-09-02: A BIM Workbench for FreeCAD
...
* [Craft](https://github.com/fogleman/Craft) ⭐ 11,091 | 🐛 129 | 🌐 C | 📅 2024-04-03: A simple Minecraft clone written in C using modern OpenGL (shaders).
* [Opendiablo2](https://github.com/OpenDiablo2/OpenDiablo2) ⚠️ Archived: An open source re-implementation of Diablo 2
* [gb-studio](https://github.com/chrismaltby/gb-studio) ⭐ 9,374 | 🐛 794 | 🌐 TypeScript | 📅 2026-08-20: A free and easy to use retro adventure game creator for your favourite [handheld video game system](https://www.gbstudio.dev)
* [sm64](https://github.com/n64decomp/sm64) ⭐ 8,729 | 🐛 28 | 🌐 C | 📅 2024-02-04: A Super Mario 64 decompilation, brought to you by a bunch of clever folks.
...
* [Citybound](https://github.com/citybound/citybound) ⭐ 8,147 | 🐛 153 | 🌐 Rust | 📅 2023-01-07: Citybound is a city building game with a focus on realism, collaborative planning and simulation of microscopic details.
* [OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,422 | 🐛 49 | 🌐 C++ | 📅 2026-08-12: A Framework for Reinforcement Learning in Games.
* [Zelda 3 in C](https://github.com/snesrev/zelda3) ⭐ 4,733 | 🐛 88 | 🌐 C | 📅 2023-12-27: A reimplementation of Zelda 3.
* [The Comprehensive Kerbal Archive Network (CKAN)](https://github.com/KSP-CKAN/CKAN) ⭐ 2,619 | 🐛 84 | 🌐 C# | 📅 2026-07-17
* [Synfig Studio](https://github.com/synfig/synfig/) ⭐ 2,280 | 🐛 726 | 🌐 C++ | 📅 2026-08-18: This is the Official source code repository of the Synfig project.
* [Hypersomnia](https://github.com/TeamHypersomnia/Hypersomnia) ⭐ 1,618 | 🐛 13 | 🌐 C++ | 📅 2026-06-21: Multiplayer top-down shooter made from scratch. Comes with an in-game Editor!
...
* [Links Awakening DX Disassembly](https://github.com/zladx/LADX-Disassembly) ⭐ 895 | 🐛 21 | 🌐 Assembly | 📅 2026-08-20: Disassembly of Legend of Zelda: Links Awakening DX.
* [wick editor](https://www.wickeditor.com/): [The Wick Editor is a free](https://github.com/Wicklets/wick-editor) ⭐ 838 | 🐛 186 | 🌐 JavaScript | 📅 2023-03-06, open-source tool for creating games, animations, and everything in-between!
* [Clspv](https://github.com/google/clspv) ⭐ 725 | 🐛 89 | 🌐 LLVM | 📅 2026-08-20 is a prototype compiler for a subset of OpenCL C to Vulkan compute shaders.
...
* [Renders papers from Arxiv as responsive web pages so you don't have to squint at a PDF.](https://github.com/arxiv-vanity/arxiv-vanity) ⭐ 1,638 | 🐛 74 | 🌐 Python | 📅 2023-05-31
...
* [veyon](https://github.com/veyon/veyon/) ⭐ 1,928 | 🐛 222 | 🌐 C++ | 📅 2026-08-19: Cross-platform computer monitoring and classroom management.

## Studies

* [Path to a free self-taught education in Computer Science!](https://github.com/ossu/computer-science) ⭐ 208,256 | 🐛 25 | 🌐 HTML | 📅 2026-07-14
* [the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,648 | 🐛 200 | 🌐 Jupyter Notebook | 📅 2026-05-20: One has no future if one couldn't teach themself.
...
* [Awesome Accessibility](https://github.com/brunopulis/awesome-a11y) ⭐ 1,979 | 🐛 58 | 📅 2026-08-03: A curate list about A11Y
...
* [FreshRSS](https://github.com/FreshRSS/FreshRSS) ⭐ 15,805 | 🐛 659 | 🌐 PHP | 📅 2026-08-19: A free, self-hostable aggregator…
* guardian [frontend](https://github.com/guardian/frontend) ⭐ 5,897 | 🐛 208 | 🌐 Scala | 📅 2026-08-20: Source for theguardian.com
...
* [umbrella](https://github.com/thi-ng/umbrella) ⭐ 3,824 | 🐛 62 | 🌐 TypeScript | 📅 2026-07-22: ⛱ Mono-repository of \~50 TypeScript/ES6 projects for modern web development
...
* [Sanic](https://github.com/sanic-org/sanic) ⭐ 18,643 | 🐛 146 | 🌐 Python | 📅 2026-07-29: Async Python 3.7+ web server/framework | Build fast. Run fast.
* [Jápronto!](https://github.com/squeaky-pl/japronto) ⭐ 8,531 | 🐛 91 | 🌐 C | 📅 2023-08-14: Screaming-fast Python 3.5+ HTTP toolkit integrated with pipelining HTTP server based on uvloop and picohttpparser.
* [Vibora](https://github.com/vibora-io/vibora) ⚠️ Archived: Fast, asynchronous and elegant Python web framework.

## Privacy

* [Differential Privacy](https://github.com/google/differential-privacy) ⭐ 3,343 | 🐛 61 | 🌐 Go | 📅 2026-08-18: This project contains a C++ library of ε-differentially private algorithms, which can be used to produce aggregate statistics over numeric data sets containing private or sensitive information.
...
* [autodp](https://github.com/yuxiangw/autodp) ⭐ 280 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2023-12-05: Automating differential privacy computation - A flexible and easy-to-use package for differential privacy
...
* [Apache Flink](https://github.com/apache/flink) ⭐ 26,273 | 🐛 378 | 🌐 Java | 📅 2026-08-20: Apache Flink is an open source stream processing framework with powerful stream- and batch-processing capabilities.
* [lists](https://github.com/jnv/lists) ⭐ 11,426 | 🐛 21 | 📅 2026-03-23: The definitive list of lists (of lists) curated on GitHub
* [awesome-uses](https://github.com/wesbos/awesome-uses) ⭐ 5,299 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-20: A list of /uses pages that detail apps and gear used by professional web developers.
* (pt-br) [Lista Maravilhosa de Projetos Open-Source](https://github.com/camilatigre/listamaravilhosaopensource) ⭐ 2,568 | 🐛 25 | 🌐 JavaScript | 📅 2026-06-15: Lista com links de projetos open-source para os níveis: iniciante, intermediário e avançado. Dividido por linguagem e idiomas!
* [gh-card](https://github.com/nwtgck/gh-card) ⭐ 1,350 | 🐛 55 | 🌐 TypeScript | 📅 2021-08-01, [link](https://gh-card.dev/)
* [pbspro](https://github.com/pbspro/pbspro) ⭐ 804 | 🐛 116 | 🌐 C | 📅 2026-04-10: An HPC workload manager and job scheduler for desktops, clusters, and clouds.
* [No Maintenance Intended](http://unmaintained.tech/):If you’re here, that likely means a project linked you here. Thanks so much for being interested in that project! [github](https://github.com/potch/unmaintained.tech) ⭐ 658 | 🐛 14 | 🌐 HTML | 📅 2024-11-18
...
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 365,127 | 🐛 608 | 🌐 Python | 📅 2026-03-20: Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 359,360 | 🐛 124 | 📅 2025-08-28: A complete computer science study plan to become a software engineer.
* [GitHub Résumé](https://github.com/resume/resume.github.com) ⭐ 62,884 | 🐛 76 | 🌐 JavaScript | 📅 2023-02-15
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 51,436 | 🐛 12 | 🌐 JavaScript | 📅 2026-06-06: Companies that don't have a broken hiring process.
...
* [test-your-sysadmin-skills](https://github.com/trimstray/test-your-sysadmin-skills) ⭐ 11,838 | 🐛 19 | 📅 2024-11-19
* [OpenResume](https://www.open-resume.com/) Create a professional resume easily with this free, open-source, and powerful [resume builder](https://github.com/xitanggg/open-resume) ⭐ 8,846 | 🐛 141 | 🌐 TypeScript | 📅 2024-10-29.
* [linux-sysadmin-interview-questions](https://github.com/chassing/linux-sysadmin-interview-questions) ⭐ 5,330 | 🐛 7 | 📅 2024-03-11: Collection of Linux Sysadmin/DevOps interview questions
...
* [awesome-scifi](https://github.com/sindresorhus/awesome-scifi) ⭐ 5,012 | 🐛 0 | 📅 2025-12-22: I asked on Twitter for recommendations as I want to get into reading Sci-Fi novels. The below is the result. Thanks everyone for recommending your favorites! :)
* [blobs](https://blobs.app): [Blob shapes generator](https://github.com/lokesh-coder/blobs.app) ⭐ 484 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-20
...
* [📚 Freely available programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 394,874 | 🐛 81 | 🌐 Python | 📅 2026-08-18
...
* [Brumadinho Location](https://github.com/sosbrumadinho/brumadinho_location) ⭐ 857 | 🐛 19 | 🌐 Python | 📅 2019-02-26: Conjunto de ferramentas para ajudar no resgate e localização das vítimas atingidas pelo rompimento da barragem que ocorreu recentemente em Brumadinho/MG
