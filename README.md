...
* [PortalData](https://github.com/weecology/PortalData) ⭐ 52 | 🐛 6 | 🌐 R | 📅 2026-09-17 (Official Repo of the Portal Project Data) and [livedat](https://github.com/weecology/livedat) ⭐ 13 | 🐛 2 | 🌐 R | 📅 2019-01-30 (Template for living data workflow ).
...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 361,122 | 🐛 125 | 📅 2025-08-28
* [The Book of Secret Knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) ⭐ 244,424 | 🐛 171 | 📅 2024-11-19
* [z3](https://github.com/Z3Prover/z3) ⭐ 12,694 | 🐛 54 | 🌐 C++ | 📅 2026-09-18: The Z3 Theorem Prover
...
* [ClickHouse](https://github.com/ClickHouse/ClickHouse) ⭐ 49,952 | 🐛 7,767 | 🌐 C++ | 📅 2026-09-18: is a free analytics DBMS for big data.
* [HikariCP](https://github.com/brettwooldridge/HikariCP) ⭐ 21,220 | 🐛 544 | 🌐 Java | 📅 2026-06-14: 光 HikariCP・A solid, high-performance, JDBC connection pool at last.
...
* [Every Programmer Should Know thinking](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,460 | 🐛 27 | 📅 2025-12-29: A collection of (mostly) technical things every software developer should know
...
* [Prettier is an opinionated code formatter](https://github.com/prettier/prettier) ⭐ 52,276 | 🐛 1,434 | 🌐 JavaScript | 📅 2026-09-17
...
* [dev.to](https://github.com/thepracticaldev/dev.to) ⭐ 22,775 | 🐛 136 | 🌐 Ruby | 📅 2026-09-16: Where programmers share ideas and help each other grow
* [Flow](https://github.com/facebook/flow) ⭐ 22,291 | 🐛 516 | 🌐 Rust | 📅 2026-09-18: Adds static typing to JavaScript to improve developer productivity and code quality.
...
* [vscodium](https://github.com/VSCodium/vscodium) ⭐ 33,284 | 🐛 145 | 🌐 Shell | 📅 2026-09-16: binary releases of VS Code without MS branding/telemetry/licensing
  * [awesome-vscode](https://github.com/viatsko/awesome-vscode) ⭐ 29,045 | 🐛 62 | 🌐 JavaScript | 📅 2026-06-21: art A curated list of delightful VS Code packages and resources.
...
* TDD C:
  * [Google Test](https://github.com/google/googletest) ⭐ 39,551 | 🐛 506 | 🌐 C++ | 📅 2026-09-17: Google Testing and Mocking Framework.
...
* [Makefile Tutorial by Example](https://makefiletutorial.com/) and [repo](https://github.com/theicfire/makefiletutorial) ⭐ 5,986 | 🐛 8 | 🌐 SCSS | 📅 2025-06-02
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,740 | 🐛 320 | 🌐 JavaScript | 📅 2026-04-08: A simple and modern GTK eBook viewer, built with GJS and Epub.js.
...
* [A curated list of awesome Python frameworks, libraries, software and resources](https://github.com/vinta/awesome-python#authentication) ⭐ 321,374 | 🐛 21 | 🌐 Python | 📅 2026-09-15
* [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) ⭐ 224,685 | 🐛 307 | 🌐 Python | 📅 2026-09-18: All Algorithms implemented in Python
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,409 | 🐛 79 | 🌐 Python | 📅 2026-09-14 framework, high performance, easy to learn, fast to code, ready for production
* cython [dtoa.c](https://github.com/python/cpython/blob/master/Python/dtoa.c) ⭐ 77,204 | 🐛 9,687 | 🌐 Python | 📅 2026-09-18
* [Rich](https://github.com/willmcgugan/rich) ⭐ 57,385 | 🐛 377 | 🌐 Python | 📅 2026-06-23 is a Python library for rich text and beautiful formatting in the terminal.
* [black](https://github.com/ambv/black/) ⭐ 41,845 | 🐛 311 | 🌐 Python | 📅 2026-09-17: The uncompromising Python code formatter
...
* [Course Files for Complete Python 3 Bootcamp Course on Udemy](https://github.com/Pierian-Data/Complete-Python-3-Bootcamp) ⭐ 29,771 | 🐛 274 | 🌐 Jupyter Notebook | 📅 2025-06-24
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,354 | 🐛 395 | 🌐 Rust | 📅 2026-09-18A Python Interpreter written in Rust
* [kivy](https://github.com/kivy/kivy) ⭐ 19,018 | 🐛 847 | 🌐 Python | 📅 2026-09-15: Open source UI framework written in Python, running on Windows, Linux, macOS, Android and iOS.
* [Modular visual interface for GDB in Python](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,252 | 🐛 19 | 🌐 Python | 📅 2026-07-17
...
* [cinder](https://github.com/facebookincubator/cinder) ⭐ 3,793 | 🐛 31 | 🌐 Python | 📅 2026-09-18
...
* [OpenTelemetry Python](https://github.com/open-telemetry/opentelemetry-python) ⭐ 2,637 | 🐛 425 | 🌐 Python | 📅 2026-09-17: OpenTelemetry Python API and SDK
* [austin](https://github.com/P403n1x87/austin) ⭐ 2,210 | 🐛 10 | 🌐 C | 📅 2026-09-17: Python frame stack sampler for CPython. Austin has a [tui](https://github.com/P403n1x87/austin-tui) ⭐ 665 | 🐛 2 | 🌐 Python | 📅 2026-06-04: The top-like text-based user interface for Austin.
...
* [vyper](https://github.com/ethereum/vyper/) ⭐ 5,180 | 🐛 626 | 🌐 Python | 📅 2026-09-17:
...
* Agda:
  * [Agda 2](https://github.com/agda/agda) ⭐ 2,930 | 🐛 1,047 | 🌐 Haskell | 📅 2026-09-17
...
* Answer Set Programming(ASP): offers a simple and powerful modeling language to solve combinatorial problems.
  * [Potassco](https://potassco.org/), [clingo](https://potassco.org/clingo/) and [github](https://github.com/potassco/clingo) ⭐ 832 | 🐛 14 | 🌐 C++ | 📅 2026-09-17.
* Brainfuck:
  * [Brainfuck](https://www.dcode.fr/brainfuck-language) encoder/decoder.
* Dafny:
  * [dafny](https://github.com/Microsoft/dafny) ⭐ 3,545 | 🐛 1,390 | 🌐 C# | 📅 2026-09-15: Dafny is a verification-aware programming language.
* Clean:
...
* Elixir:
  * [Nerves](https://github.com/nerves-project/nerves) ⭐ 2,495 | 🐛 22 | 🌐 Elixir | 📅 2026-09-16: Craft and deploy bulletproof embedded software in Elixir. [official site](http://nerves-project.org)
  * [dialyxir](https://github.com/jeremyjh/dialyxir) ⭐ 1,796 | 🐛 74 | 🌐 Elixir | 📅 2026-09-05: Mix tasks to simplify use of Dialyzer in Elixir projects.
...
* Go:
  * [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 184,565 | 🐛 230 | 🌐 Go | 📅 2026-09-16: A curated list of awesome Go frameworks, libraries and software
...
* Lua:
  * [xmake](https://github.com/xmake-io/xmake) ⭐ 12,220 | 🐛 256 | 🌐 Lua | 📅 2026-09-17: 🔥 A cross-platform build [utility based on Lua](https://xmake.io)
* Nim:
  * [nim](https://nim-lang.org/): Efficient and expressive programming. [github](https://github.com/nim-lang/nim) ⭐ 18,234 | 🐛 2,195 | 🌐 Nim | 📅 2026-09-17
* Perl:
...
* Rust:
  * [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,402 | 🐛 13 | 🌐 Rust | 📅 2026-09-17: A curated list of Rust code and resources.
...
* V:
  * [V](https://github.com/vlang-io/V) ⭐ 37,868 | 🐛 106 | 🌐 V | 📅 2026-09-18: Simple, fast, safe, compiled language for creating maintainable software. Supports translation from C/C++.
  * [vlang](https://github.com/vlang/v) ⭐ 37,868 | 🐛 106 | 🌐 V | 📅 2026-09-18: Simple, fast, safe, compiled language for developing maintainable software. Supports translation from C and (soon) C++. Compiles itself in <1s.
* Verilog:
...
* Starting Pull Requests:
  * [Awesome First PR Opportunities](https://github.com/MunGell/awesome-for-beginners) ⭐ 89,359 | 🐛 151 | 📅 2026-07-25
...
* [.gitignore](https://github.com/github/gitignore) ⭐ 175,817 | 🐛 75 | 📅 2026-09-11: A collection of useful .gitignore templates
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,435 | 🐛 1,031 | 🌐 Go | 📅 2026-09-17: simple terminal UI for git commands
* [gitea](https://github.com/go-gitea/gitea) ⭐ 58,054 | 🐛 2,464 | 🌐 Go | 📅 2026-09-18: Git with a cup of tea, painless self-hosted git service
* [gogs](https://github.com/gogs/gogs) ⭐ 47,819 | 🐛 1,014 | 🌐 Go | 📅 2026-09-12: Gogs is a painless self-hosted Git service.
* [github-cli](https://github.com/cli/cli) ⭐ 46,315 | 🐛 1,086 | 🌐 Go | 📅 2026-09-15:  GitHub’s official command line tool
* [husky](https://github.com/typicode/husky) ⭐ 35,323 | 🐛 107 | 🌐 JavaScript | 📅 2026-03-19: Git hooks made easy
* [Learn git branching](https://learngitbranching.js.org/): An interactive git visualization to challenge and educate! [github](https://github.com/pcottle/learnGitBranching) ⭐ 34,045 | 🐛 56 | 🌐 JavaScript | 📅 2026-09-17.
* [cz-cli](https://github.com/commitizen/cz-cli) ⭐ 17,501 | 🐛 195 | 🌐 JavaScript | 📅 2026-09-04: The commitizen command line utility.
* [lint-staged](https://github.com/okonet/lint-staged) ⭐ 14,733 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-12: Run linters on git staged files
...
* [Pro Git book](https://git-scm.com/book/en/v2), written by Scott Chacon and Ben Straub ([github](https://github.com/progit/progit2) ⭐ 6,591 | 🐛 218 | 🌐 CSS | 📅 2026-05-25 repo)
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,078 | 🐛 7 | 🌐 Shell | 📅 2026-09-17 is a utility tool for git taking advantage of fuzzy finder fzf. [Interactive Git Commands With Previews Powered By fzf Fuzzy Finder](https://www.linuxuprising.com/2019/11/forgit-interactive-git-commands-with.html)
...
* [Forge](https://github.com/magit/forge/) ⭐ 1,574 | 🐛 5 | 🌐 Emacs Lisp | 📅 2026-09-17: Work with Git forges from the comfort of Magit
...
* [SkyWater Open Source PDK](https://github.com/google/skywater-pdk) ⭐ 3,713 | 🐛 200 | 🌐 Python | 📅 2026-07-21: Open source process design kit for usage with SkyWater Technology Foundry's 130nm node.
* [Ariane is a 6-stage RISC-V CPU](https://github.com/pulp-platform/ariane) ⭐ 3,120 | 🐛 250 | 🌐 Assembly | 📅 2026-09-17
* [cva6](https://github.com/openhwgroup/cva6) ⭐ 3,120 | 🐛 250 | 🌐 Assembly | 📅 2026-09-17: The CORE-V CVA6 is an Application class 6-stage RISC-V CPU capable of booting Linux.
...
* [VGChips](https://github.com/furrtek/VGChips) ⭐ 229 | 🐛 24 | 🌐 Verilog | 📅 2026-09-06: Video Game custom chips reverse-engineered from silicon.
...
* [How to create an OS from scratch](https://github.com/cfenollosa/os-tutorial) ⭐ 30,710 | 🐛 130 | 🌐 C | 📅 2026-02-04
...
* [GraalVM](https://github.com/oracle/graal) ⭐ 21,702 | 🐛 849 | 🌐 Java | 📅 2026-09-17: GraalVM is a universal virtual machine for running applications written in JavaScript, Python, Ruby, R, JVM-based languages like Java, Scala, Clojure, Kotlin, and LLVM-based languages such as C and C++. [GraalVM Implementation of Python](https://github.com/graalvm/graalpython) ⭐ 1,643 | 🐛 67 | 🌐 Python | 📅 2026-09-17
* [Compiler Explorer](https://godbolt.org/): Run compilers interactively from your web browser and interact with the assembly. [github](https://github.com/mattgodbolt/compiler-explorer) ⭐ 19,079 | 🐛 844 | 🌐 TypeScript | 📅 2026-09-18, [how it works](https://xania.org/201609/how-compiler-explorer-runs-on-amazon).
...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,545 | 🐛 484 | 🌐 C++ | 📅 2026-09-11: Tesseract Open Source OCR Engine (main repository)
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 30,000 | 🐛 531 | 🌐 Python | 📅 2025-12-05: Ready-to-use OCR with 40+ languages supported including Chinese, Japanese, Korean and Thai.
* [annoy](https://github.com/spotify/annoy) ⭐ 14,300 | 🐛 86 | 🌐 C++ | 📅 2025-10-29: Approximate Nearest Neighbors in C++/Python optimized for memory usage and loading/saving to disk
...
* [faceswap](https://github.com/deepfakes/faceswap) ⭐ 57,559 | 🐛 15 | 🌐 Python | 📅 2026-08-05: Non official project based on original /r/Deepfakes thread. Many thanks to him!
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 166,262 | 🐛 2,416 | 🌐 Python | 📅 2026-09-18: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch.
* [nanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 63,193 | 🐛 349 | 🌐 Python | 📅 2025-11-12: The simplest, fastest repository for training/finetuning medium-sized GPTs.
* [Industrial-strength Natural Language Processing (NLP) with Python and Cython](https://github.com/explosion/spaCy/) ⭐ 33,906 | 🐛 245 | 🌐 Python | 📅 2026-08-24
...
* [google-10000-english](https://github.com/first20hours/google-10000-english) ⭐ 4,477 | 🐛 28 | 📅 2023-05-17: This repo contains a list of the 10,000 most common English words in order of frequency, as determined by n-gram frequency analysis of the Google's Trillion Word Corpus.
...
* [Real-Time Voice Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning) ⭐ 60,144 | 🐛 177 | 🌐 Python | 📅 2026-03-09: Clone a voice in 5 seconds to generate arbitrary speech in real-time
...
* [vosk-api](https://github.com/alphacep/vosk-api) ⭐ 15,134 | 🐛 605 | 🌐 Jupyter Notebook | 📅 2026-08-09: Offline speech recognition API for Android, iOS, Raspberry Pi and servers with Python, Java, C# and Node.
* [CARLA](https://carla.org): Open-source simulator for [autonomous driving research](https://github.com/carla-simulator/carla) ⭐ 14,406 | 🐛 1,195 | 🌐 C++ | 📅 2026-09-18.
...
* Autonomous Vehicles:
  * [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,492 | 🐛 780 | 🌐 C++ | 📅 2026-09-15: Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
...
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,357 | 🐛 760 | 🌐 C# | 📅 2026-09-14: is an open source and cross-platform machine learning framework for .NET.
* [DeepLabCut](http://www.mackenziemathislab.org/deeplabcut): is an efficient method for 3D markerless pose estimation based on transfer learning with deep neural networks that achieves excellent results (i.e. you can match human labeling accuracy) with minimal training data (typically 50-200 frames). [repo](https://github.com/DeepLabCut/DeepLabCut) ⭐ 5,771 | 🐛 44 | 🌐 Python | 📅 2026-09-18
...
* [Stable Diffusion](https://github.com/CompVis/stable-diffusion) ⭐ 73,442 | 🐛 619 | 🌐 Jupyter Notebook | 📅 2024-06-18: is a latent text-to-image diffusion model. Thanks to a generous compute donation from Stability AI and support from LAION, we were able to train a Latent Diffusion Model on 512x512 images from a subset of the LAION-5B database.
* [Wan](https://github.com/Wan-Video/Wan2.2) ⭐ 17,542 | 🐛 299 | 🌐 Python | 📅 2026-03-17: Open and Advanced Large-Scale Video Generative Models
...
* [fiftyone](https://github.com/voxel51/fiftyone) ⭐ 11,094 | 🐛 717 | 🌐 TypeScript | 📅 2026-09-18: The open-source tool for building high-quality datasets and computer vision models
...
*Frameworks for Neural Networks and Deep Learning. See: [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,934 | 🐛 86 | 📅 2025-05-26.*

* [Keras](https://github.com/fchollet/keras) ⭐ 64,320 | 🐛 202 | 🌐 Python | 📅 2026-09-18 - A high-level neural networks library and capable of running on top of either TensorFlow or Theano.
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 103,077 | 🐛 17,595 | 🌐 Python | 📅 2026-09-18: Tensors and Dynamic neural networks in Python with strong GPU acceleration a ([tour](http://blog.christianperone.com/2018/03/pytorch-internal-architecture-tour/)):
* [tinygrad](https://github.com/geohot/tinygrad) ⭐ 33,613 | 🐛 189 | 🌐 Python | 📅 2026-09-18: You like pytorch? You like [micrograd](https://github.com/karpathy/micrograd) ⭐ 17,568 | 🐛 80 | 🌐 Jupyter Notebook | 📅 2026-08-03? You love tinygrad! ❤️
* [vid2vid](https://github.com/NVIDIA/vid2vid) ⭐ 8,693 | 🐛 111 | 🌐 Python | 📅 2022-05-17: Pytorch implementation of our method for high-resolution (e.g. 2048x1024) photorealistic video-to-video translation.
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 200,160 | 🐛 3,175 | 🌐 C++ | 📅 2026-09-18 - The most popular Deep Learning framework created by Google.
...
* [Ludwig](https://github.com/uber/ludwig) ⭐ 11,758 | 🐛 1 | 🌐 Python | 📅 2026-09-14: [is a toolbox built](https://uber.github.io/ludwig/) on top of TensorFlow that allows to train and test deep learning models without the need to write code.
...
* Good channels:
  * [3blue1brown](https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw/): 3blue1brown, by Grant Sanderson, is some combination of math and entertainment, depending on your disposition ([site](https://www.3blue1brown.com/)) and [manim](https://github.com/3b1b/manim) ⭐ 94,023 | 🐛 500 | 🌐 Python | 📅 2026-09-09(Animation engine for explanatory math videos).
...
* [pycm](https://github.com/sepandhaghighi/pycm) ⭐ 1,506 | 🐛 16 | 🌐 Python | 📅 2026-09-17: Multi-class confusion matrix library in Python.
...
* [Awesome Data Science](https://github.com/bulutyazilim/awesome-datascience) ⭐ 30,004 | 🐛 6 | 📅 2026-09-09
* [The Data Engineering Cookbook](https://github.com/andkret/Cookbook) ⭐ 15,422 | 🐛 129 | 🌐 Python | 📅 2026-07-23
* [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,329 | 🐛 1,350 | 🌐 Python | 📅 2026-09-14: Official repository for Spyder - The Scientific Python Development Environment
...
* [RAPIDS](http://rapids.ai): Open GPU Data Science. The RAPIDS suite of software libraries gives you the freedom to execute end-to-end data science and analytics pipelines entirely on GPUs. It relies on NVIDIA® CUDA® primitives for low-level compute optimization, but exposes that GPU parallelism and high-bandwidth memory speed through user-friendly Python interfaces. [cuml](https://github.com/rapidsai/cuml) ⭐ 5,282 | 🐛 792 | 🌐 Python | 📅 2026-09-17 - RAPIDS Machine Learning Library.
...
* Jupyter:
  ...
  * [jupytext](https://github.com/mwouts/jupytext) ⭐ 7,249 | 🐛 167 | 🌐 Python | 📅 2026-09-15: Jupyter notebooks as Markdown documents, Julia, Python or R scripts
...
* R Lang
  * [brms](https://github.com/paul-buerkner/brms) ⭐ 1,428 | 🐛 156 | 🌐 R | 📅 2026-09-16: R package for Bayesian generalized multivariate non-linear multilevel models using Stan
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 66,109 | 🐛 898 | 🌐 Go | 📅 2026-09-17: The Prometheus monitoring system and time series database.
* [dart](https://github.com/unit8co/darts) ⭐ 9,521 | 🐛 227 | 🌐 Python | 📅 2026-09-17: A python library for easy manipulation and forecasting of time series.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,188 | 🐛 164 | 🌐 C++ | 📅 2026-08-10: The Time Series Visualization Tool that you deserve.
...
* [amsterdam-schema](https://github.com/Amsterdam/amsterdam-schema) ⭐ 22 | 🐛 6 | 🌐 Python | 📅 2026-09-17: Data modeling & verification for the City of Amsterdam's open data - based on JSON Schema
...
* [ImageMagick creates huge temporary files · Issue #395 · ImageMagick/ImageMagick](https://github.com/ImageMagick/ImageMagick/issues/395) ⭐ 17,460 | 🐛 164 | 🌐 C | 📅 2026-09-18
* [roughViz](https://github.com/jwilber/roughViz) ⭐ 7,157 | 🐛 13 | 🌐 JavaScript | 📅 2024-04-26: Reusable JavaScript library for creating sketchy/hand-drawn styled charts in the browser.
...
* [OpenSubdiv](http://graphics.pixar.com/opensubdiv/docs/intro.html) ([github](https://github.com/PixarAnimationStudios/OpenSubdiv) ⭐ 3,073 | 🐛 58 | 🌐 C++ | 📅 2026-08-19): is a set of open source libraries that implement high performance subdivision surface (subdiv) evaluation on massively parallel CPU and GPU architectures.
...
* GGplot2:
  ...
  * [ggseg](https://github.com/LCBC-UiO/ggseg) ⭐ 273 | 🐛 5 | 🌐 R | 📅 2026-09-11: Plotting tool for brain atlases, in ggplot.
...
* [jax](https://github.com/google/jax) ⭐ 36,308 | 🐛 2,581 | 🌐 Python | 📅 2026-09-18: Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more
* [micro](https://micro-editor.github.io/): a modern and intuitive [terminal-based text editor](https://github.com/zyedidia/micro#linux-clipboard-support) ⭐ 29,599 | 🐛 935 | 🌐 Go | 📅 2026-09-18.
* [pyodide](https://github.com/iodide-project/pyodide) ⭐ 14,836 | 🐛 399 | 🌐 Python | 📅 2026-09-17: The Python scientific stack, compiled to WebAssembly
...
* [Rack](https://github.com/VCVRack/Rack) ⭐ 4,420 | 🐛 307 | 🌐 C++ | 📅 2025-11-04: The virtual Eurorack studio
...
* [This program generates bitmaps that are locally similar to the input bitmap](https://github.com/mxgmn/WaveFunctionCollapse) ⭐ 25,335 | 🐛 9 | 🌐 C# | 📅 2026-03-22
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,985 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-16: Easily add particles animations to your website. Compatible also with React, Vue.js (2.x and 3.x), Angular, Svelte, jQuery, Preact, Inferno.
* [Walk through an infinite, procedurally generated city](https://github.com/marian42/wavefunctioncollapse) ⭐ 4,859 | 🐛 9 | 🌐 C# | 📅 2021-03-28
* [An interactive, explorable explanation about the peculiar magic of sound waves.](https://github.com/joshwcomeau/waveforms) ⭐ 1,481 | 🐛 4 | 🌐 JavaScript | 📅 2018-02-21
* [SOFA](https://www.sofa-framework.org/): is an efficient framework dedicated to research, prototyping and development of physics-based simulations. [github](https://github.com/sofa-framework/sofa/) ⭐ 1,256 | 🐛 454 | 🌐 C++ | 📅 2026-09-18.
...
* [gqrx](https://gqrx.dk/): is an open source software defined radio receiver (SDR) powered by the GNU Radio and the Qt graphical toolkit. [Gqrx](https://github.com/csete/gqrx) ⭐ 3,683 | 🐛 269 | 🌐 C++ | 📅 2026-08-06
...
* CDS Astro:
  * [Aladin Lite](https://github.com/cds-astro/aladin-lite) ⭐ 156 | 🐛 65 | 🌐 JavaScript | 📅 2026-09-17: An astronomical HiPS visualizer in the browser.
...
* [Open MCT](https://nasa.github.io/openmct/): is a next-generation mission control framework for visualization of data on desktop and mobile devices - [github](https://github.com/nasa/openmct) ⭐ 13,126 | 🐛 1,093 | 🌐 JavaScript | 📅 2026-09-11
* [fprime](https://github.com/nasa/fprime) ⭐ 11,760 | 🐛 468 | 🌐 C++ | 📅 2026-09-17: A flight software and embedded systems framework.
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,656 | 🐛 14 | 🌐 HTML | 📅 2026-09-03: A build-it-yourself, 6-wheel rover based on the rovers on Mars!
...
* [MNE-Python](https://github.com/mne-tools/mne-python) ⭐ 3,519 | 🐛 616 | 🌐 Python | 📅 2026-09-17: Magnetoencephalography (MEG) and Electroencephalography (EEG) in Python
...
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 950 | 🐛 20 | 🌐 R | 📅 2026-09-18: Easy access to shapefiles of the Brazilian Institute of Geography and Statistics (IBGE) and other official spatial data sets of Brazil.
...
* [Awesome-Design-Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 41,237 | 🐛 204 | 🌐 JavaScript | 📅 2024-07-28: The best design tools for everything.
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,491 | 🐛 284 | 🌐 C++ | 📅 2026-09-18:Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
...
* [gb-studio](https://github.com/chrismaltby/gb-studio) ⭐ 9,406 | 🐛 806 | 🌐 TypeScript | 📅 2026-09-17: A free and easy to use retro adventure game creator for your favourite [handheld video game system](https://www.gbstudio.dev)
* [sm64](https://github.com/n64decomp/sm64) ⭐ 8,778 | 🐛 29 | 🌐 C | 📅 2024-02-04: A Super Mario 64 decompilation, brought to you by a bunch of clever folks.
...
* [Citybound](https://github.com/citybound/citybound) ⭐ 8,165 | 🐛 153 | 🌐 Rust | 📅 2023-01-07: Citybound is a city building game with a focus on realism, collaborative planning and simulation of microscopic details.
* [OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,490 | 🐛 59 | 🌐 C++ | 📅 2026-08-31: A Framework for Reinforcement Learning in Games.
* [Zelda 3 in C](https://github.com/snesrev/zelda3) ⭐ 4,772 | 🐛 89 | 🌐 C | 📅 2023-12-27: A reimplementation of Zelda 3.
...
* [Hypersomnia](https://github.com/TeamHypersomnia/Hypersomnia) ⭐ 1,648 | 🐛 13 | 🌐 C++ | 📅 2026-09-18: Multiplayer top-down shooter made from scratch. Comes with an in-game Editor!
...
* [Clspv](https://github.com/google/clspv) ⭐ 730 | 🐛 63 | 🌐 LLVM | 📅 2026-09-15 is a prototype compiler for a subset of OpenCL C to Vulkan compute shaders.
...
* [veyon](https://github.com/veyon/veyon/) ⭐ 1,964 | 🐛 224 | 🌐 C++ | 📅 2026-09-15: Cross-platform computer monitoring and classroom management.

## Studies

* [Path to a free self-taught education in Computer Science!](https://github.com/ossu/computer-science) ⭐ 209,094 | 🐛 28 | 🌐 HTML | 📅 2026-07-14
* [the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,820 | 🐛 200 | 🌐 Jupyter Notebook | 📅 2026-05-20: One has no future if one couldn't teach themself.
...
* [FreshRSS](https://github.com/FreshRSS/FreshRSS) ⭐ 16,060 | 🐛 674 | 🌐 PHP | 📅 2026-09-14: A free, self-hostable aggregator…
* guardian [frontend](https://github.com/guardian/frontend) ⭐ 5,899 | 🐛 226 | 🌐 Scala | 📅 2026-09-17: Source for theguardian.com
...
* [Apache Flink](https://github.com/apache/flink) ⭐ 26,341 | 🐛 381 | 🌐 Java | 📅 2026-09-18: Apache Flink is an open source stream processing framework with powerful stream- and batch-processing capabilities.
* [lists](https://github.com/jnv/lists) ⭐ 11,488 | 🐛 27 | 📅 2026-03-23: The definitive list of lists (of lists) curated on GitHub
...
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 370,557 | 🐛 614 | 🌐 Python | 📅 2026-09-15: Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 361,122 | 🐛 125 | 📅 2025-08-28: A complete computer science study plan to become a software engineer.
* [GitHub Résumé](https://github.com/resume/resume.github.com) ⭐ 62,891 | 🐛 77 | 🌐 JavaScript | 📅 2023-02-15
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 52,141 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-24: Companies that don't have a broken hiring process.
...
* [OpenResume](https://www.open-resume.com/) Create a professional resume easily with this free, open-source, and powerful [resume builder](https://github.com/xitanggg/open-resume) ⭐ 8,909 | 🐛 144 | 🌐 TypeScript | 📅 2024-10-29.
...
* [awesome-scifi](https://github.com/sindresorhus/awesome-scifi) ⭐ 5,047 | 🐛 1 | 📅 2025-12-22: I asked on Twitter for recommendations as I want to get into reading Sci-Fi novels. The below is the result. Thanks everyone for recommending your favorites! :)
...
* [📚 Freely available programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 397,064 | 🐛 81 | 🌐 Python | 📅 2026-09-15
