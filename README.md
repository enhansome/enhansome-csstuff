...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 358,665 | 🐛 124 | 📅 2025-08-28
* [The Book of Secret Knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) ⭐ 238,223 | 🐛 163 | 📅 2024-11-19
* [z3](https://github.com/Z3Prover/z3) ⭐ 12,556 | 🐛 88 | 🌐 C++ | 📅 2026-08-14: The Z3 Theorem Prover
...
* [ClickHouse](https://github.com/ClickHouse/ClickHouse) ⭐ 49,234 | 🐛 6,917 | 🌐 C++ | 📅 2026-08-14: is a free analytics DBMS for big data.
* [HikariCP](https://github.com/brettwooldridge/HikariCP) ⭐ 21,183 | 🐛 543 | 🌐 Java | 📅 2026-06-14: 光 HikariCP・A solid, high-performance, JDBC connection pool at last.
* [quick-SQL-cheatsheet](https://github.com/enochtangg/quick-SQL-cheatsheet) ⭐ 5,446 | 🐛 11 | 📅 2020-10-01: A quick reminder of all SQL queries and examples on how to use them.
...
* [Every Programmer Should Know thinking](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,250 | 🐛 25 | 📅 2025-12-29: A collection of (mostly) technical things every software developer should know
...
* [Prettier is an opinionated code formatter](https://github.com/prettier/prettier) ⭐ 52,200 | 🐛 1,437 | 🌐 JavaScript | 📅 2026-08-13
...
* [dev.to](https://github.com/thepracticaldev/dev.to) ⭐ 22,762 | 🐛 123 | 🌐 Ruby | 📅 2026-08-13: Where programmers share ideas and help each other grow
* [Flow](https://github.com/facebook/flow) ⭐ 22,276 | 🐛 524 | 🌐 Rust | 📅 2026-08-14: Adds static typing to JavaScript to improve developer productivity and code quality.
* [Quine Relay](https://github.com/mame/quine-relay) ⭐ 14,566 | 🐛 18 | 🌐 Ruby | 📅 2025-10-24: An uroboros program with 100+ programming languages.
...
* (pt-br) [Canais Brasileiros para Pessoas Desenvolvedoras](https://github.com/carolcodes/youtube-br-desenvolvimento) ⭐ 2,504 | 🐛 0 | 🌐 Ruby | 📅 2025-03-24: Repositório de canais no Youtube BR sobre desenvolvimento.
...
* [vscodium](https://github.com/VSCodium/vscodium) ⭐ 32,813 | 🐛 139 | 🌐 Shell | 📅 2026-08-12: binary releases of VS Code without MS branding/telemetry/licensing
  * [awesome-vscode](https://github.com/viatsko/awesome-vscode) ⭐ 28,956 | 🐛 45 | 🌐 JavaScript | 📅 2026-06-21: art A curated list of delightful VS Code packages and resources.
...
* GDB:
  ...
  * [gdbgui](https://github.com/cs01/gdbgui/) ⭐ 10,348 | 🐛 179 | 🌐 TypeScript | 📅 2025-06-29: Browser-based frontend to gdb (gnu debugger). Add breakpoints, view the stack, visualize data structures, and more in C, C++, Go, Rust, and Fortran. Run gdbgui from the terminal and a new tab will open in your browser.
...
* [CppCoreGuidelines](https://github.com/isocpp/CppCoreGuidelines) ⭐ 45,241 | 🐛 245 | 🌐 CSS | 📅 2026-08-06: The C++ Core Guidelines are a set of tried-and-true guidelines, rules, and best practices about coding in C++
* [Microsoft's C++ Standard Library](https://github.com/microsoft/STL) ⭐ 11,127 | 🐛 582 | 🌐 C++ | 📅 2026-08-13: MSVC's implementation of the C++ Standard Library.
* mozilla [rr](https://github.com/mozilla/rr) ⭐ 10,619 | 🐛 478 | 🌐 C++ | 📅 2026-08-11: is a lightweight tool for recording, replaying and debugging execution of applications (trees of processes and threads). Debugging extends gdb with very efficient reverse-execution, which in combination with standard gdb/x86 features like hardware data watchpoints, makes debugging much more fun.
* [GuiLite](https://github.com/idea4good/GuiLite) ⭐ 7,760 | 🐛 18 | 🌐 C++ | 📅 2025-10-22: heavy\_check\_markThe smallest UI framework for all platform -- 5K lines code
...
* [memory-profiler](https://github.com/nokia/memory-profiler) ⭐ 4,798 | 🐛 52 | 🌐 C | 📅 2023-07-28
...
* [Exercises for people learning the C programming language](https://github.com/AllenDowney/ExercisesInC) ⭐ 117 | 🐛 4 | 🌐 C | 📅 2020-10-12 by Allen B. Downey
...
* TDD C:
  * [Google Test](https://github.com/google/googletest) ⭐ 38,924 | 🐛 491 | 🌐 C++ | 📅 2026-08-13: Google Testing and Mocking Framework.
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,629 | 🐛 308 | 🌐 JavaScript | 📅 2026-04-08: A simple and modern GTK eBook viewer, built with GJS and Epub.js.
...
* [A curated list of awesome Python frameworks, libraries, software and resources](https://github.com/vinta/awesome-python#authentication) ⭐ 313,829 | 🐛 26 | 🌐 Python | 📅 2026-08-05
* [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) ⭐ 223,734 | 🐛 1,024 | 🌐 Python | 📅 2026-08-03: All Algorithms implemented in Python
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,579 | 🐛 72 | 🌐 Python | 📅 2026-08-12 framework, high performance, easy to learn, fast to code, ready for production
* cython [dtoa.c](https://github.com/python/cpython/blob/master/Python/dtoa.c) ⭐ 74,321 | 🐛 9,486 | 🌐 Python | 📅 2026-08-14
...
* [black](https://github.com/ambv/black/) ⭐ 41,802 | 🐛 302 | 🌐 Python | 📅 2026-08-10: The uncompromising Python code formatter
* [wtfpython](https://github.com/satwikkansal/wtfpython#-is-not--is-not-is-not-) ⭐ 37,054 | 🐛 72 | 🌐 Python | 📅 2026-01-13: A collection of surprising Python snippets and lesser-known features.
* [wtfpython](https://github.com/satwikkansal/wtfpython) ⭐ 37,054 | 🐛 72 | 🌐 Python | 📅 2026-01-13: What the f\*ck Python? ￼
* [Course Files for Complete Python 3 Bootcamp Course on Udemy](https://github.com/Pierian-Data/Complete-Python-3-Bootcamp) ⭐ 29,699 | 🐛 268 | 🌐 Jupyter Notebook | 📅 2025-06-24
* [RustPython](https://github.com/RustPython/RustPython) ⭐ 22,281 | 🐛 408 | 🌐 Rust | 📅 2026-08-13A Python Interpreter written in Rust
* [kivy](https://github.com/kivy/kivy) ⭐ 18,991 | 🐛 851 | 🌐 Python | 📅 2026-08-12: Open source UI framework written in Python, running on Windows, Linux, macOS, Android and iOS.
* [Modular visual interface for GDB in Python](https://github.com/cyrus-and/gdb-dashboard) ⭐ 12,238 | 🐛 19 | 🌐 Python | 📅 2026-07-17
...
* [Coconut Lang](https://github.com/evhub/coconut) ⭐ 4,350 | 🐛 90 | 🌐 Python | 📅 2026-02-16
* [cinder](https://github.com/facebookincubator/cinder) ⭐ 3,792 | 🐛 33 | 🌐 Python | 📅 2026-08-13
...
* [OpenTelemetry Python](https://github.com/open-telemetry/opentelemetry-python) ⭐ 2,587 | 🐛 395 | 🌐 Python | 📅 2026-08-13: OpenTelemetry Python API and SDK
...
* [vyper](https://github.com/ethereum/vyper/) ⭐ 5,179 | 🐛 693 | 🌐 Python | 📅 2026-08-12:
...
* Agda:
  * [Agda 2](https://github.com/agda/agda) ⭐ 2,913 | 🐛 1,044 | 🌐 Haskell | 📅 2026-08-13
...
* Answer Set Programming(ASP): offers a simple and powerful modeling language to solve combinatorial problems.
  * [Potassco](https://potassco.org/), [clingo](https://potassco.org/clingo/) and [github](https://github.com/potassco/clingo) ⭐ 822 | 🐛 16 | 🌐 C++ | 📅 2026-08-10.
* Brainfuck:
  * [Brainfuck](https://www.dcode.fr/brainfuck-language) encoder/decoder.
* Dafny:
  * [dafny](https://github.com/Microsoft/dafny) ⭐ 3,497 | 🐛 1,375 | 🌐 C# | 📅 2026-08-09: Dafny is a verification-aware programming language.
* Clean:
...
* Elixir:
  * [Nerves](https://github.com/nerves-project/nerves) ⭐ 2,483 | 🐛 22 | 🌐 Elixir | 📅 2026-08-13: Craft and deploy bulletproof embedded software in Elixir. [official site](http://nerves-project.org)
...
* Go:
  * [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 181,003 | 🐛 209 | 🌐 Go | 📅 2026-08-13: A curated list of awesome Go frameworks, libraries and software
  * [lattigo](https://github.com/lca1/lattigo) ⭐ 1,437 | 🐛 7 | 🌐 Go | 📅 2026-06-16: A lattice-based cryptographic library in Go.
...
* Java:
  * [1brc](https://github.com/gunnarmorling/1brc) ⭐ 8,105 | 🐛 41 | 🌐 Java | 📅 2024-08-20: [The One Billion Row Challenge](https://www.morling.dev/blog/one-billion-row-challenge/) -- A fun exploration of how quickly 1B rows from a text file can be aggregated with Java
...
* JavaScript:
  * [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,466 | 🐛 403 | 🌐 JavaScript | 📅 2026-07-26: Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
...
* Lua:
  * [xmake](https://github.com/xmake-io/xmake) ⭐ 12,141 | 🐛 251 | 🌐 Lua | 📅 2026-08-13: 🔥 A cross-platform build [utility based on Lua](https://xmake.io)
* Nim:
  * [nim](https://nim-lang.org/): Efficient and expressive programming. [github](https://github.com/nim-lang/nim) ⭐ 18,171 | 🐛 2,187 | 🌐 Nim | 📅 2026-08-13
* Perl:
...
* PHP:
  * [A curated list of bookmarks, packages, tutorials, videos and other cool resources from the Laravel ecosystem](https://github.com/chiraggude/awesome-laravel) ⭐ 13,087 | 🐛 85 | 📅 2024-07-03
...
* Rust:
  * [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 58,825 | 🐛 10 | 🌐 Rust | 📅 2026-08-13: A curated list of Rust code and resources.
...
* V:
  * [V](https://github.com/vlang-io/V) ⭐ 37,794 | 🐛 90 | 🌐 V | 📅 2026-08-14: Simple, fast, safe, compiled language for creating maintainable software. Supports translation from C/C++.
  * [vlang](https://github.com/vlang/v) ⭐ 37,794 | 🐛 90 | 🌐 V | 📅 2026-08-14: Simple, fast, safe, compiled language for developing maintainable software. Supports translation from C and (soon) C++. Compiles itself in <1s.
* Verilog:
...
* [Meld](https://github.com/yousseb/meld/) ⭐ 2,389 | 🐛 97 | 🌐 Python | 📅 2023-11-10: Meld is a visual diff and merge tool targeted at developers. Meld helps you compare files, directories, and version controlled projects. It provides two- and three-way comparison of both files and directories, and supports many version control systems including Git, Mercurial, Bazaar and Subversion.
...
* Starting Pull Requests:
  * [Awesome First PR Opportunities](https://github.com/MunGell/awesome-for-beginners) ⭐ 88,350 | 🐛 140 | 📅 2026-07-25
...
* [.gitignore](https://github.com/github/gitignore) ⭐ 175,282 | 🐛 83 | 📅 2026-07-23: A collection of useful .gitignore templates
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,318 | 🐛 1,019 | 🌐 Go | 📅 2026-08-13: simple terminal UI for git commands
* [gitea](https://github.com/go-gitea/gitea) ⭐ 57,360 | 🐛 2,617 | 🌐 Go | 📅 2026-08-14: Git with a cup of tea, painless self-hosted git service
* [gogs](https://github.com/gogs/gogs) ⭐ 47,734 | 🐛 1,010 | 🌐 Go | 📅 2026-08-06: Gogs is a painless self-hosted Git service.
* [github-cli](https://github.com/cli/cli) ⭐ 45,860 | 🐛 1,053 | 🌐 Go | 📅 2026-08-13:  GitHub’s official command line tool
* [husky](https://github.com/typicode/husky) ⭐ 35,269 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19: Git hooks made easy
* [Learn git branching](https://learngitbranching.js.org/): An interactive git visualization to challenge and educate! [github](https://github.com/pcottle/learnGitBranching) ⭐ 33,870 | 🐛 58 | 🌐 JavaScript | 📅 2026-08-11.
* [cz-cli](https://github.com/commitizen/cz-cli) ⭐ 17,504 | 🐛 194 | 🌐 JavaScript | 📅 2026-08-11: The commitizen command line utility.
* [lint-staged](https://github.com/okonet/lint-staged) ⭐ 14,712 | 🐛 9 | 🌐 JavaScript | 📅 2026-08-08: Run linters on git staged files
* [git-blame-someone-else](https://github.com/jayphelps/git-blame-someone-else) ⭐ 11,696 | 🐛 21 | 🌐 Shell | 📅 2023-12-04: Blame someone else for your bad code.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,058 | 🐛 13 | 🌐 Shell | 📅 2026-08-01 is a utility tool for git taking advantage of fuzzy finder fzf. [Interactive Git Commands With Previews Powered By fzf Fuzzy Finder](https://www.linuxuprising.com/2019/11/forgit-interactive-git-commands-with.html)
...
* [Forge](https://github.com/magit/forge/) ⭐ 1,569 | 🐛 10 | 🌐 Emacs Lisp | 📅 2026-07-31: Work with Git forges from the comfort of Magit
...
* GitHub Profiles:
  * [Awesome Readme Stats](https://github.com/anmol098/waka-readme-stats) ⭐ 3,978 | 🐛 64 | 🌐 Python | 📅 2026-08-04
...
* [SkyWater Open Source PDK](https://github.com/google/skywater-pdk) ⭐ 3,651 | 🐛 199 | 🌐 Python | 📅 2026-07-21: Open source process design kit for usage with SkyWater Technology Foundry's 130nm node.
* [Ariane is a 6-stage RISC-V CPU](https://github.com/pulp-platform/ariane) ⭐ 3,065 | 🐛 264 | 🌐 Assembly | 📅 2026-08-13
* [cva6](https://github.com/openhwgroup/cva6) ⭐ 3,065 | 🐛 264 | 🌐 Assembly | 📅 2026-08-13: The CORE-V CVA6 is an Application class 6-stage RISC-V CPU capable of booting Linux.
...
* [How to create an OS from scratch](https://github.com/cfenollosa/os-tutorial) ⭐ 30,653 | 🐛 130 | 🌐 C | 📅 2026-02-04
* [Mezzano](https://github.com/froggey/Mezzano/) ⭐ 3,881 | 🐛 14 | 🌐 Common Lisp | 📅 2026-06-16: An operating system written in Common Lisp.
* [bootOS](https://github.com/nanochess/bootOS) ⭐ 2,131 | 🐛 0 | 🌐 Assembly | 📅 2026-08-01 is a monolithic operating system in 512 bytes of x86 machine code.
* [Write your Own Virtual Machine](https://justinmeiners.github.io/lc3-vm/) with code repo: [lc3-vm](https://github.com/justinmeiners/lc3-vm) ⭐ 2,083 | 🐛 3 | 🌐 Makefile | 📅 2026-04-02
* [interim](https://github.com/mntmn/interim) ⭐ 1,315 | 🐛 12 | 🌐 C | 📅 2021-06-11: The Interim Operating System
* [Incompatible Timesharing System](https://github.com/PDP-10/its) ⭐ 949 | 🐛 504 | 🌐 Assembly | 📅 2026-07-31: ITS, the Incompatible Timesharing System, is an operating system for the PDP-10 computer family. It was created by hackers at MIT in the 1960s. The MIT site was shut down in 1990, but enthusiasts continue to operate ITS systems to this day.
...
* [GraalVM](https://github.com/oracle/graal) ⭐ 21,662 | 🐛 842 | 🌐 Java | 📅 2026-08-13: GraalVM is a universal virtual machine for running applications written in JavaScript, Python, Ruby, R, JVM-based languages like Java, Scala, Clojure, Kotlin, and LLVM-based languages such as C and C++. [GraalVM Implementation of Python](https://github.com/graalvm/graalpython) ⭐ 1,634 | 🐛 60 | 🌐 Python | 📅 2026-08-13
* [Compiler Explorer](https://godbolt.org/): Run compilers interactively from your web browser and interact with the assembly. [github](https://github.com/mattgodbolt/compiler-explorer) ⭐ 18,971 | 🐛 824 | 🌐 TypeScript | 📅 2026-08-14, [how it works](https://xania.org/201609/how-compiler-explorer-runs-on-amazon).
...
* [tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 75,911 | 🐛 487 | 🌐 C++ | 📅 2026-08-13: Tesseract Open Source OCR Engine (main repository)
...
* [faceswap](https://github.com/deepfakes/faceswap) ⭐ 57,453 | 🐛 11 | 🌐 Python | 📅 2026-08-05: Non official project based on original /r/Deepfakes thread. Many thanks to him!
...
* [Transformers](https://github.com/huggingface/transformers) ⭐ 164,084 | 🐛 2,387 | 🌐 Python | 📅 2026-08-13: State-of-the-art Natural Language Processing for TensorFlow 2.0 and PyTorch.
* [nanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,093 | 🐛 351 | 🌐 Python | 📅 2025-11-12: The simplest, fastest repository for training/finetuning medium-sized GPTs.
* [Industrial-strength Natural Language Processing (NLP) with Python and Cython](https://github.com/explosion/spaCy/) ⭐ 33,817 | 🐛 232 | 🌐 Python | 📅 2026-08-07
...
* [Argdown](https://argdown.org/): A simple syntax for complex argumentation. [argdown repo](https://github.com/christianvoigt/argdown) ⭐ 1,026 | 🐛 96 | 🌐 TypeScript | 📅 2026-08-11
...
* [google-10000-english](https://github.com/first20hours/google-10000-english) ⭐ 4,456 | 🐛 28 | 📅 2023-05-17: This repo contains a list of the 10,000 most common English words in order of frequency, as determined by n-gram frequency analysis of the Google's Trillion Word Corpus.
...
* [Real-Time Voice Cloning](https://github.com/CorentinJ/Real-Time-Voice-Cloning) ⭐ 60,090 | 🐛 176 | 🌐 Python | 📅 2026-03-09: Clone a voice in 5 seconds to generate arbitrary speech in real-time
...
* [DeepMind Research](https://github.com/deepmind/deepmind-research) ⭐ 15,151 | 🐛 341 | 🌐 Jupyter Notebook | 📅 2026-06-17: This repository contains implementations and illustrative code to accompany DeepMind publications.
...
* [CARLA](https://carla.org): Open-source simulator for [autonomous driving research](https://github.com/carla-simulator/carla) ⭐ 14,294 | 🐛 1,189 | 🌐 C++ | 📅 2026-08-14.
...
* Autonomous Vehicles:
  * [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,397 | 🐛 780 | 🌐 C++ | 📅 2026-06-30: Open source simulator for autonomous vehicles built on Unreal Engine / Unity, from Microsoft AI & Research.
...
* [DeepLabCut](http://www.mackenziemathislab.org/deeplabcut): is an efficient method for 3D markerless pose estimation based on transfer learning with deep neural networks that achieves excellent results (i.e. you can match human labeling accuracy) with minimal training data (typically 50-200 frames). [repo](https://github.com/DeepLabCut/DeepLabCut) ⭐ 5,735 | 🐛 44 | 🌐 Python | 📅 2026-08-13
...
* [Stable Diffusion](https://github.com/CompVis/stable-diffusion) ⭐ 73,303 | 🐛 619 | 🌐 Jupyter Notebook | 📅 2024-06-18: is a latent text-to-image diffusion model. Thanks to a generous compute donation from Stability AI and support from LAION, we were able to train a Latent Diffusion Model on 512x512 images from a subset of the LAION-5B database.
* [Wan](https://github.com/Wan-Video/Wan2.2) ⭐ 17,112 | 🐛 286 | 🌐 Python | 📅 2026-03-17: Open and Advanced Large-Scale Video Generative Models
* [Bbrain.js](https://github.com/BrainJS/brain.js) ⭐ 14,866 | 🐛 90 | 🌐 TypeScript | 📅 2024-09-26: 🤖 Neural networks in JavaScript
* [Paddle Fluid](https://www.paddlepaddle.org.cn/) with [Pre-trained and Reproduced Deep Learning Models](https://github.com/PaddlePaddle/models) ⭐ 6,934 | 🐛 870 | 🌐 Python | 📅 2025-01-15, [ERNIE](https://github.com/PaddlePaddle/ERNIE) ⭐ 7,737 | 🐛 83 | 🌐 Python | 📅 2026-07-24:  An Implementation of ERNIE For Language Understanding (including Pre-training models and Fine-tuning tools).
...
* [Random Forest vs Neural Network](https://mljar.com/blog/random-forest-vs-neural-network-classification/)(classification, tabular data) - [github](https://github.com/mljar/mljar-supervised) ⭐ 3,280 | 🐛 128 | 🌐 Python | 📅 2026-07-27
...
* [fiftyone](https://github.com/voxel51/fiftyone) ⭐ 11,011 | 🐛 661 | 🌐 TypeScript | 📅 2026-08-14: The open-source tool for building high-quality datasets and computer vision models
...
*Frameworks for Neural Networks and Deep Learning. See: [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,752 | 🐛 84 | 📅 2025-05-26.*

* [Keras](https://github.com/fchollet/keras) ⭐ 64,228 | 🐛 217 | 🌐 Python | 📅 2026-08-13 - A high-level neural networks library and capable of running on top of either TensorFlow or Theano.
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 102,363 | 🐛 17,244 | 🌐 Python | 📅 2026-08-14: Tensors and Dynamic neural networks in Python with strong GPU acceleration a ([tour](http://blog.christianperone.com/2018/03/pytorch-internal-architecture-tour/)):
* [tinygrad](https://github.com/geohot/tinygrad) ⭐ 33,450 | 🐛 180 | 🌐 Python | 📅 2026-08-14: You like pytorch? You like [micrograd](https://github.com/karpathy/micrograd) ⭐ 17,111 | 🐛 78 | 🌐 Jupyter Notebook | 📅 2026-08-03? You love tinygrad! ❤️
...
* [Alias-Free Generative Adversarial Networks (StyleGAN3)](https://github.com/NVlabs/stylegan3) ⭐ 6,940 | 🐛 192 | 🌐 Python | 📅 2023-09-12: Official PyTorch implementation of StyleGAN3.
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 197,008 | 🐛 2,857 | 🌐 C++ | 📅 2026-08-14 - The most popular Deep Learning framework created by Google.
...
* [Ludwig](https://github.com/uber/ludwig) ⭐ 11,748 | 🐛 3 | 🌐 Python | 📅 2026-08-10: [is a toolbox built](https://uber.github.io/ludwig/) on top of TensorFlow that allows to train and test deep learning models without the need to write code.
...
* Good channels:
  * [3blue1brown](https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw/): 3blue1brown, by Grant Sanderson, is some combination of math and entertainment, depending on your disposition ([site](https://www.3blue1brown.com/)) and [manim](https://github.com/3b1b/manim) ⭐ 90,915 | 🐛 491 | 🌐 Python | 📅 2026-08-11(Animation engine for explanatory math videos).
...
* [spyder](https://github.com/spyder-ide/spyder) ⭐ 9,289 | 🐛 1,346 | 🌐 Python | 📅 2026-08-14: Official repository for Spyder - The Scientific Python Development Environment
...
* [RAPIDS](http://rapids.ai): Open GPU Data Science. The RAPIDS suite of software libraries gives you the freedom to execute end-to-end data science and analytics pipelines entirely on GPUs. It relies on NVIDIA® CUDA® primitives for low-level compute optimization, but exposes that GPU parallelism and high-bandwidth memory speed through user-friendly Python interfaces. [cuml](https://github.com/rapidsai/cuml) ⭐ 5,251 | 🐛 843 | 🌐 Python | 📅 2026-08-13 - RAPIDS Machine Learning Library.
...
* Python:
  ...
  * [arviz](https://github.com/arviz-devs/arviz) ⭐ 1,845 | 🐛 111 | 🌐 TeX | 📅 2026-08-11: Python package to plot and analyse samples from probabilistic models
  ...
  * [pyjanitor](https://github.com/ericmjl/pyjanitor) ⭐ 1,500 | 🐛 108 | 🌐 Python | 📅 2026-08-11: Python implementation of R package Janitor
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,733 | 🐛 888 | 🌐 Go | 📅 2026-08-13: The Prometheus monitoring system and time series database.
* [dart](https://github.com/unit8co/darts) ⭐ 9,490 | 🐛 218 | 🌐 Python | 📅 2026-08-06: A python library for easy manipulation and forecasting of time series.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,111 | 🐛 157 | 🌐 C++ | 📅 2026-08-10: The Time Series Visualization Tool that you deserve.
* [OpenTSDB](http://opentsdb.net/): A scalable, distributed Time Series Database. [repo](https://github.com/OpenTSDB/opentsdb) ⭐ 5,066 | 🐛 538 | 🌐 Java | 📅 2024-12-12
...
* [amsterdam-schema](https://github.com/Amsterdam/amsterdam-schema) ⭐ 21 | 🐛 6 | 🌐 Python | 📅 2026-08-13: Data modeling & verification for the City of Amsterdam's open data - based on JSON Schema
...
* [ImageMagick creates huge temporary files · Issue #395 · ImageMagick/ImageMagick](https://github.com/ImageMagick/ImageMagick/issues/395) ⭐ 17,160 | 🐛 161 | 🌐 C | 📅 2026-08-12
...
* [Pseudo-bandlimited pixel art filtering in 3D – a mathematical derivation](http://themaister.net/blog/2018/08/25/pseudo-bandlimited-pixel-art-filtering-in-3d-a-mathematical-derivation/) [github](https://github.com/Themaister/Granite) ⭐ 1,932 | 🐛 2 | 🌐 C++ | 📅 2026-08-13
...
* Color Palettes:
  * [wesanderson](https://github.com/karthik/wesanderson) ⭐ 2,144 | 🐛 23 | 🌐 R | 📅 2024-06-13: A Wes Anderson color palette for R.
  ...
  * [Palettes for R based on the Scientific Colour-Maps](https://github.com/thomasp85/scico) ⭐ 480 | 🐛 4 | 🌐 R | 📅 2023-12-09: This is a small package to provide access to the colour palettes developed by Fabio Crameri..
...
* [jax](https://github.com/google/jax) ⭐ 36,157 | 🐛 2,572 | 🌐 Python | 📅 2026-08-14: Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more
* [micro](https://micro-editor.github.io/): a modern and intuitive [terminal-based text editor](https://github.com/zyedidia/micro#linux-clipboard-support) ⭐ 29,332 | 🐛 1,030 | 🌐 Go | 📅 2026-08-14.
* [pyodide](https://github.com/iodide-project/pyodide) ⭐ 14,787 | 🐛 399 | 🌐 Python | 📅 2026-08-14: The Python scientific stack, compiled to WebAssembly
...
* [Sonic Visualiser](https://www.sonicvisualiser.org/) is a free, open-source application for Windows, Linux, and Mac, designed to be the first program you reach for when want to study a music recording closely. It's designed for musicologists, archivists, signal-processing researchers, and anyone else looking for a friendly way to look at what lies inside the audio file. [github repo](https://github.com/sonic-visualiser/sonic-visualiser) ⭐ 881 | 🐛 83 | 🌐 C++ | 📅 2025-12-07
...
* [This program generates bitmaps that are locally similar to the input bitmap](https://github.com/mxgmn/WaveFunctionCollapse) ⭐ 25,264 | 🐛 9 | 🌐 C# | 📅 2026-03-22
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,950 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13: Easily add particles animations to your website. Compatible also with React, Vue.js (2.x and 3.x), Angular, Svelte, jQuery, Preact, Inferno.
* [Walk through an infinite, procedurally generated city](https://github.com/marian42/wavefunctioncollapse) ⭐ 4,857 | 🐛 9 | 🌐 C# | 📅 2021-03-28
* [An interactive, explorable explanation about the peculiar magic of sound waves.](https://github.com/joshwcomeau/waveforms) ⭐ 1,481 | 🐛 4 | 🌐 JavaScript | 📅 2018-02-21
* [SOFA](https://www.sofa-framework.org/): is an efficient framework dedicated to research, prototyping and development of physics-based simulations. [github](https://github.com/sofa-framework/sofa/) ⭐ 1,241 | 🐛 447 | 🌐 C++ | 📅 2026-08-11.
...
* [gqrx](https://gqrx.dk/): is an open source software defined radio receiver (SDR) powered by the GNU Radio and the Qt graphical toolkit. [Gqrx](https://github.com/csete/gqrx) ⭐ 3,654 | 🐛 263 | 🌐 C++ | 📅 2026-08-06
...
* [AstroML](https://github.com/astroML/astroML) ⭐ 1,197 | 🐛 71 | 🌐 Python | 📅 2024-05-25: Machine learning, statistics, and data mining for astronomy and astrophysics
* [astroquery](https://github.com/astropy/astroquery) ⭐ 788 | 🐛 409 | 🌐 Python | 📅 2026-08-13: Functions and classes to access online data resources. Maintainers: @keflavich and @bsipocz and @ceb8
...
* CDS Astro:
  * [ipyaladin](https://github.com/cds-astro/ipyaladin) ⭐ 156 | 🐛 13 | 🌐 Python | 📅 2026-08-05: An IPython Widget for Aladin Lite
...
* [Open MCT](https://nasa.github.io/openmct/): is a next-generation mission control framework for visualization of data on desktop and mobile devices - [github](https://github.com/nasa/openmct) ⭐ 13,082 | 🐛 1,062 | 🌐 JavaScript | 📅 2026-08-13
* [fprime](https://github.com/nasa/fprime) ⭐ 11,654 | 🐛 428 | 🌐 C++ | 📅 2026-08-14: A flight software and embedded systems framework.
* [JPL Open Source Rover Project](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,575 | 🐛 18 | 🌐 Prolog | 📅 2026-08-13: A build-it-yourself, 6-wheel rover based on the rovers on Mars!
...
* [Awesome-Bioinformatics](https://github.com/danielecook/Awesome-Bioinformatics) ⭐ 4,230 | 🐛 33 | 📅 2026-04-07: A curated list of awesome Bioinformatics libraries and software.
* [MNE-Python](https://github.com/mne-tools/mne-python) ⭐ 3,481 | 🐛 636 | 🌐 Python | 📅 2026-08-12: Magnetoencephalography (MEG) and Electroencephalography (EEG) in Python
...
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,223 | 🐛 430 | 🌐 Python | 📅 2026-08-12: Python tools for geographic data
* [plus codes](https://plus.codes/). [open-location-code](https://github.com/google/open-location-code) ⭐ 4,343 | 🐛 60 | 🌐 Java | 📅 2026-03-30: Open Location Code is a library to generate short codes that can be used like street addresses, for places where street addresses don't exist.
...
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 936 | 🐛 19 | 🌐 R | 📅 2026-07-07: Easy access to shapefiles of the Brazilian Institute of Geography and Statistics (IBGE) and other official spatial data sets of Brazil.
...
* [surpriver](https://github.com/tradytics/surpriver) ⭐ 1,871 | 🐛 13 | 🌐 Python | 📅 2021-08-13: Find big moving stocks before they move using machine learning and anomaly detection.
...
* [Awesome-Design-Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 40,871 | 🐛 178 | 🌐 JavaScript | 📅 2024-07-28: The best design tools for everything.
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 17,396 | 🐛 287 | 🌐 C | 📅 2026-08-14:Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library.
...
* [gb-studio](https://github.com/chrismaltby/gb-studio) ⭐ 9,361 | 🐛 795 | 🌐 TypeScript | 📅 2026-08-13: A free and easy to use retro adventure game creator for your favourite [handheld video game system](https://www.gbstudio.dev)
* [sm64](https://github.com/n64decomp/sm64) ⭐ 8,717 | 🐛 28 | 🌐 C | 📅 2024-02-04: A Super Mario 64 decompilation, brought to you by a bunch of clever folks.
* [MarkovJunior](https://github.com/mxgmn/MarkovJunior) ⭐ 8,158 | 🐛 9 | 🌐 C# | 📅 2026-03-20: Probabilistic PL based on pattern matching and constraint propagation, 148 examples.
...
* [OpenSpiel](https://github.com/deepmind/open_spiel) ⭐ 5,409 | 🐛 48 | 🌐 C++ | 📅 2026-08-12: A Framework for Reinforcement Learning in Games.
* [Zelda 3 in C](https://github.com/snesrev/zelda3) ⭐ 4,722 | 🐛 88 | 🌐 C | 📅 2023-12-27: A reimplementation of Zelda 3.
...
* [Hypersomnia](https://github.com/TeamHypersomnia/Hypersomnia) ⭐ 1,615 | 🐛 13 | 🌐 C++ | 📅 2026-06-21: Multiplayer top-down shooter made from scratch. Comes with an in-game Editor!
...
* [Links Awakening DX Disassembly](https://github.com/zladx/LADX-Disassembly) ⭐ 896 | 🐛 22 | 🌐 Assembly | 📅 2026-08-13: Disassembly of Legend of Zelda: Links Awakening DX.
...
* [Clspv](https://github.com/google/clspv) ⭐ 725 | 🐛 89 | 🌐 LLVM | 📅 2026-08-10 is a prototype compiler for a subset of OpenCL C to Vulkan compute shaders.
...
* [veyon](https://github.com/veyon/veyon/) ⭐ 1,926 | 🐛 219 | 🌐 C++ | 📅 2026-08-12: Cross-platform computer monitoring and classroom management.

## Studies

* [Path to a free self-taught education in Computer Science!](https://github.com/ossu/computer-science) ⭐ 207,971 | 🐛 24 | 🌐 HTML | 📅 2026-07-14
* [the-craft-of-selfteaching](https://github.com/selfteaching/the-craft-of-selfteaching) ⭐ 16,331 | 🐛 199 | 🌐 Jupyter Notebook | 📅 2026-05-20: One has no future if one couldn't teach themself.
...
* [Awesome Accessibility](https://github.com/brunopulis/awesome-a11y) ⭐ 1,976 | 🐛 59 | 📅 2026-08-03: A curate list about A11Y
...
* [FreshRSS](https://github.com/FreshRSS/FreshRSS) ⭐ 15,770 | 🐛 659 | 🌐 PHP | 📅 2026-08-12: A free, self-hostable aggregator…
* guardian [frontend](https://github.com/guardian/frontend) ⭐ 5,897 | 🐛 194 | 🌐 Scala | 📅 2026-08-13: Source for theguardian.com
...
* [Sanic](https://github.com/sanic-org/sanic) ⭐ 18,645 | 🐛 144 | 🌐 Python | 📅 2026-07-29: Async Python 3.7+ web server/framework | Build fast. Run fast.
...
* [Philosophy](https://github.com/Jfaler/Philosophize) ⭐ 362 | 🐛 1 | 📅 2020-12-27: 📚 A curated list of philosophy resources.
* [Translating and Interpreting Chinese Philosophy](https://plato.stanford.edu/entries/chinese-translate-interpret/)

## General

* [Apache Flink](https://github.com/apache/flink) ⭐ 26,264 | 🐛 380 | 🌐 Java | 📅 2026-08-14: Apache Flink is an open source stream processing framework with powerful stream- and batch-processing capabilities.
* [lists](https://github.com/jnv/lists) ⭐ 11,414 | 🐛 20 | 📅 2026-03-23: The definitive list of lists (of lists) curated on GitHub
* [awesome-uses](https://github.com/wesbos/awesome-uses) ⭐ 5,298 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-13: A list of /uses pages that detail apps and gear used by professional web developers.
...
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 363,671 | 🐛 601 | 🌐 Python | 📅 2026-03-20: Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 358,665 | 🐛 124 | 📅 2025-08-28: A complete computer science study plan to become a software engineer.
...
* [test-your-sysadmin-skills](https://github.com/trimstray/test-your-sysadmin-skills) ⭐ 11,835 | 🐛 19 | 📅 2024-11-19
* [OpenResume](https://www.open-resume.com/) Create a professional resume easily with this free, open-source, and powerful [resume builder](https://github.com/xitanggg/open-resume) ⭐ 8,834 | 🐛 141 | 🌐 TypeScript | 📅 2024-10-29.
...
* [awesome-scifi](https://github.com/sindresorhus/awesome-scifi) ⭐ 5,001 | 🐛 0 | 📅 2025-12-22: I asked on Twitter for recommendations as I want to get into reading Sci-Fi novels. The below is the result. Thanks everyone for recommending your favorites! :)
...
* [📚 Freely available programming books](https://github.com/EbookFoundation/free-programming-books) ⭐ 394,351 | 🐛 80 | 🌐 Python | 📅 2026-08-11
